...
def change_label_label_map_filter_init_docstring():
    ...
    if isinstance(itk.ChangeLabelLabelMapFilter, itkTemplate.itkTemplate):
        change_label_label_map_filter.__doc__ += itkHelpers.filter_args(filter_object)[0]
        change_label_label_map_filter.__doc__ += "\n"
        change_label_label_map_filter.__doc__ += itkHelpers.filter_args(filter_object)[1]
    else:
