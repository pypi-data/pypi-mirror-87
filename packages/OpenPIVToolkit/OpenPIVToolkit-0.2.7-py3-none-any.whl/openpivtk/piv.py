...
def piv():
    ...
    im1 = pkg.resource_filename('openpivtk','examples/test5/frame_a.tif')
    im2 = pkg.resource_filename('openpivtk','examples/test5/frame_b.tif')
