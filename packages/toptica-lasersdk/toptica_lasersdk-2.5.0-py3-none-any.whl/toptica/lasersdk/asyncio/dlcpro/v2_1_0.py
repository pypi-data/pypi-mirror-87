# Generated from 'v2_1_0.xml' on 2020-11-30 09:07:57.338826
...
class NloLaserHeadAutoNloOptFactorySettings:
    def __init__(self, client: Client, name: str) -> None:
        ...
        self._single_mode_optimization_enabled = MutableDecopBoolean(client, name + ':single-mode-optimization-enabled')
    ...
    @property
    def single_mode_optimization_enabled(self) -> 'MutableDecopBoolean':
