...
#   `tensorflow_probability/substrates/numpy/distributions/gumbel.py`
...
from tensorflow_probability.substrates.numpy.bijectors import gumbel_cdf as gumbel_cdf_bijector
