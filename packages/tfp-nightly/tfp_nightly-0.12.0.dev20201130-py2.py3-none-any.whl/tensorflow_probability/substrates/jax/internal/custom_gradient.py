...
#   `tensorflow_probability/substrates/jax/internal/custom_gradient.py`
...
from tensorflow_probability.python.internal.backend.jax import private as array_ops  # pylint: disable=g-direct-tensorflow-import
