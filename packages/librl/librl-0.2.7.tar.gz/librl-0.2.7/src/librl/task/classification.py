...
class ClassificationTask(_Task):
    def __init__(self, classifier=None, criterion=None, train_data_iter=None, 
        validation_data_iter=None, train_percent=1.0, validation_percent=1.0,
        train=True, **kwargs
    ):
        ...
        assert (0.0 < train_percent <= 1.0 and 0.0 < validation_percent <= 1.0)
