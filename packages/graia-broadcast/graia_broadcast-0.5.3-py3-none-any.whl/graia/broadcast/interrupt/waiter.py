...
class Waiter(metaclass=ABCMeta):
    ...
    def create_using_function(cls,
        ...
        def wrapper(func):
            return type("SingleWaiter", (cls.create(
                listening_events, using_dispatchers, using_decorators,
                priority, enable_internal_access, block_propagation
            ),), {
