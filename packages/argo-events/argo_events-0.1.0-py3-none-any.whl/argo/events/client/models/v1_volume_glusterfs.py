...
class V1VolumeGlusterfs(object):
    ...
    def __init__(self, endpoints=None, path=None, read_only=None, local_vars_configuration=None):  # noqa: E501
        """V1VolumeGlusterfs - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def endpoints(self):
        """Gets the endpoints of this V1VolumeGlusterfs.  # noqa: E501
        ...
        :return: The endpoints of this V1VolumeGlusterfs.  # noqa: E501
        :rtype: str
        """
    ...
    def endpoints(self, endpoints):
        """Sets the endpoints of this V1VolumeGlusterfs.

        EndpointsName is the endpoint name that details Glusterfs topology. More info: https://examples.k8s.io/volumes/glusterfs/README.md#create-a-pod  # noqa: E501

        :param endpoints: The endpoints of this V1VolumeGlusterfs.  # noqa: E501
        :type: str
        """
    ...
    @path.setter
    def path(self, path):
        """Sets the path of this V1VolumeGlusterfs.

        Path is the Glusterfs volume path. More info: https://examples.k8s.io/volumes/glusterfs/README.md#create-a-pod  # noqa: E501

        :param path: The path of this V1VolumeGlusterfs.  # noqa: E501
        :type: str
        """
    ...
    @property
    def read_only(self):
        """Gets the read_only of this V1VolumeGlusterfs.  # noqa: E501
        ...
        :return: The read_only of this V1VolumeGlusterfs.  # noqa: E501
        :rtype: bool
        """
    ...
    def read_only(self, read_only):
        """Sets the read_only of this V1VolumeGlusterfs.

        ReadOnly here will force the Glusterfs volume to be mounted with read-only permissions. Defaults to false. More info: https://examples.k8s.io/volumes/glusterfs/README.md#create-a-pod  # noqa: E501

        :param read_only: The read_only of this V1VolumeGlusterfs.  # noqa: E501
        :type: bool
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, V1VolumeGlusterfs):
            return False
