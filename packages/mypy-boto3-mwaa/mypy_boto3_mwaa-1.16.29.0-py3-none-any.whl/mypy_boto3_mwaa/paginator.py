...
class ListEnvironmentsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListEnvironments.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.16.29/reference/services/mwaa.html#MWAA.Paginator.ListEnvironments.paginate)
        """
