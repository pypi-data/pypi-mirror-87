...
class UserRequestInfoSpec(object):
    ...
    def requested_resource(self):
        ...
        The resource the user is requesting. For example an application name if the request_type is application_access.   # noqa: E501
    ...
    def requested_resource_type(self, requested_resource_type):
        ...
        allowed_values = ["application_access"]  # noqa: E501
    ...
    def state(self):
        ...
        The state of the application access request  # noqa: E501
