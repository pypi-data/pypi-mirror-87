...
class UpdateData(typing.Generic[QuantConnect_Lean_Engine_DataFeeds_UpdateData_T], System.Object):
    ...
    def __init__(self, target: QuantConnect_Lean_Engine_DataFeeds_UpdateData_T, dataType: System.Type, data: System.Collections.Generic.IReadOnlyList[QuantConnect.Data.BaseData], isInternalConfig: bool, containsFillForwardData: typing.Optional[bool] = None) -> None:
        """
...
class LiveSynchronizer(QuantConnect.Lean.Engine.DataFeeds.Synchronizer):
    ...
    def OnSubscriptionNewDataAvailable(self, sender: System.Object, args: System.EventArgs) -> None:
        """This method is protected."""
        ...
...
class BaseDataExchange(System.Object):
    ...
    class EnumeratorHandler(System.Object):
        ...
        @typing.overload
        def __init__(self, symbol: typing.Union[QuantConnect.Symbol, str], enumerator: System.Collections.Generic.IEnumerator[QuantConnect.Data.BaseData], shouldMoveNext: typing.Callable[[], bool] = None, handleData: typing.Callable[[], QuantConnect.Data.BaseData] = None) -> None:
            """
    ...
    @typing.overload
    def AddEnumerator(self, symbol: typing.Union[QuantConnect.Symbol, str], enumerator: System.Collections.Generic.IEnumerator[QuantConnect.Data.BaseData], shouldMoveNext: typing.Callable[[], bool] = None, enumeratorFinished: typing.Callable[[], QuantConnect.Lean.Engine.DataFeeds.BaseDataExchange.EnumeratorHandler] = None) -> None:
        """
        Adds the enumerator to this exchange. If it has already been added
        then it will remain registered in the exchange only once
    ...
    @typing.overload
    def SetDataHandler(self, symbol: typing.Union[QuantConnect.Symbol, str], handler: typing.Callable[[], QuantConnect.Data.BaseData]) -> None:
        """
        Sets the specified hander function to handle data for the handler's symbol
    ...
    def AddDataHandler(self, symbol: typing.Union[QuantConnect.Symbol, str], handler: typing.Callable[[], QuantConnect.Data.BaseData]) -> None:
        """
...
class DataManager(System.Object, QuantConnect.Interfaces.IAlgorithmSubscriptionManager, QuantConnect.Lean.Engine.DataFeeds.IDataFeedSubscriptionManager, QuantConnect.Lean.Engine.DataFeeds.IDataManager):
    ...
    @typing.overload
    def Add(self, symbol: typing.Union[QuantConnect.Symbol, str], resolution: typing.Optional[QuantConnect.Resolution] = None, fillForward: bool = True, extendedMarketHours: bool = False, isFilteredSubscription: bool = True, isInternalFeed: bool = False, isCustomData: bool = False, subscriptionDataTypes: System.Collections.Generic.List[System.Tuple[System.Type, QuantConnect.TickType]] = None, dataNormalizationMode: QuantConnect.DataNormalizationMode = ...) -> System.Collections.Generic.List[QuantConnect.Data.SubscriptionDataConfig]:
        """
        Creates and adds a list of SubscriptionDataConfig for a given symbol and configuration.
