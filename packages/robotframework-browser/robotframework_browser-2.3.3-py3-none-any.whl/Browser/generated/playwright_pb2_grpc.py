...
class PlaywrightStub(object):
    ...
    def __init__(self, channel):
        ...
        self.CallExtensionKeyword = channel.unary_unary(
...
def add_PlaywrightServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'CallExtensionKeyword': grpc.unary_unary_rpc_method_handler(
...
class Playwright(object):
    ...
    def CallExtensionKeyword(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/Playwright/CallExtensionKeyword',
