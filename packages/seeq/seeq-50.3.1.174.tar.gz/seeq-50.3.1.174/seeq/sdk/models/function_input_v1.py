...
class FunctionInputV1(object):
    ...
    def __init__(self, additional_properties=None, data_id=None, description=None, formula=None, host_id=None, name=None, package_name=None, parameters=None, properties=None, scoped_to=None, type=None):
        """
