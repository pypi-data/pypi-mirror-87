...
def create_summary_file(table ,number ):
...
def validate():
    ...
    if table[number] == total:
        ...
        create_file("standard.csv", standard_seq)
        create_file("non_standard.csv", non_standard_seq)
        create_summary_file(table, number)
