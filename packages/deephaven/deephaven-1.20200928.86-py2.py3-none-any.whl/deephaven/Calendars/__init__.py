...
def calendar(*args):
    ...
    *Overload 1*  
      ...
      :return: (com.illumon.util.calendar.BusinessCalendar) business calendar
      
    *Overload 2*  
      :return: (com.illumon.util.calendar.BusinessCalendar) default business calendar.  The deault is specified by the Calendar.default property.
    """
