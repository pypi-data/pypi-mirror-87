...
from fibomat.linalg import TransformableBase, boundingbox, Vector, DimVector
from fibomat.dimensioned_object import DimObj
...
class LayoutBase(abc.ABC):
    ...
    def layout_elements(self) -> Iterator[TransformableBase]:
