...
class ListBackendJobsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListBackendJobs.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.16.29/reference/services/amplifybackend.html#AmplifyBackend.Paginator.ListBackendJobs.paginate)
        """
