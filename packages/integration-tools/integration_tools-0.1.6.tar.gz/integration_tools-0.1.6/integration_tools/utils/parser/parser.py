...
def parse_parameters(parser: argparse.ArgumentParser):
    ...
    parser.add_argument("results_path", type=_dir_path, help="The path to the folder in which the results should be "
                                                            "placed", default=os.getcwd(),required=False)

    parser.add_argument('-xy', '--xy_architecture', nargs='+', help='The architecture of the xy vae', type=str)
    parser.add_argument('-x', '--x_architecture', nargs='+', help='The architecture of the x vae', type=str)
    parser.add_argument('-y', '--y_architecture', nargs='+', help='The architecture of the y vae', type=str)
