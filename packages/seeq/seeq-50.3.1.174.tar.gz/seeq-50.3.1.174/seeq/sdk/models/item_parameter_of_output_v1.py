...
class ItemParameterOfOutputV1(object):
    ...
    def __init__(self, ancestors=None, has_children=False, href=None, id=None, is_archived=False, is_generated=False, is_redacted=False, name=None, parameter_of=None, type=None):
        """
    ...
    def href(self):
        """
        Gets the href of this ItemParameterOfOutputV1.
        The href that can be used to interact with the item

        :return: The href of this ItemParameterOfOutputV1.
        :rtype: str
        """
        return self._href
    ...
    def href(self, href):
        """
        Sets the href of this ItemParameterOfOutputV1.
        The href that can be used to interact with the item

        :param href: The href of this ItemParameterOfOutputV1.
        :type: str
        """
        if href is None:
