...
class rootType(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, markup=None, gds_collector_=None, **kwargs_):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='rootType', pretty_print=True):
        ...
        if pretty_print:
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'rootType':
        ...
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='rootType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='rootType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='rootType'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='rootType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        for markup_ in self.markup:
            namespaceprefix_ = self.markup_nsprefix_ + ':' if (UseCapturedNS_ and self.markup_nsprefix_) else ''
...
class markupType(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, embedded=None, nested=None, valueOf_=None, mixedclass_=None, content_=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
        ...
        self.embedded_nsprefix_ = None
        if nested is None:
            self.nested = []
        else:
            self.nested = nested
        self.nested_nsprefix_ = None
    ...
    def insert_nested_at(self, index, value):
        self.nested.insert(index, value)
    def replace_nested_at(self, index, value):
        self.nested[index] = value
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='markupType', pretty_print=True):
        ...
        if pretty_print:
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'markupType':
            name_ = self.original_tagname_
        if UseCapturedNS_ and self.ns_prefix_:
            namespaceprefix_ = self.ns_prefix_ + ':'
        showIndent(outfile, level, pretty_print)
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='markupType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='markupType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='markupType'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='markupType', fromsubclass_=False, pretty_print=True):
        ...
        for embedded_ in self.embedded:
            namespaceprefix_ = self.embedded_nsprefix_ + ':' if (UseCapturedNS_ and self.embedded_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
        ...
        for nested_ in self.nested:
            namespaceprefix_ = self.nested_nsprefix_ + ':' if (UseCapturedNS_ and self.nested_nsprefix_) else ''
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'embedded' and child_.text is not None:
            ...
            valuestr_ = self.gds_parse_string(valuestr_, node, 'embedded')
            valuestr_ = self.gds_validate_string(valuestr_, node, 'embedded')
            obj_ = self.mixedclass_(MixedContainer.CategorySimple,
                MixedContainer.TypeString, 'embedded', valuestr_)
            self.content_.append(obj_)
            self.embedded_nsprefix_ = child_.prefix
...
class nestedType(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, nested1=None, nested2=None, nested3=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
        ...
        self.nested1_nsprefix_ = None
        if nested2 is None:
            self.nested2 = []
        else:
            self.nested2 = nested2
        self.nested2_nsprefix_ = None
        if nested3 is None:
            self.nested3 = []
        else:
            self.nested3 = nested3
        self.nested3_nsprefix_ = None
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
    ...
    def insert_nested3_at(self, index, value):
        self.nested3.insert(index, value)
    def replace_nested3_at(self, index, value):
        self.nested3[index] = value
    def hasContent_(self):
        if (
            self.nested1 or
            self.nested2 or
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='nestedType', pretty_print=True):
        ...
        if pretty_print:
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'nestedType':
            name_ = self.original_tagname_
        if UseCapturedNS_ and self.ns_prefix_:
            namespaceprefix_ = self.ns_prefix_ + ':'
        showIndent(outfile, level, pretty_print)
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='nestedType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='nestedType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='nestedType'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='nestedType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        for nested1_ in self.nested1:
            namespaceprefix_ = self.nested1_nsprefix_ + ':' if (UseCapturedNS_ and self.nested1_nsprefix_) else ''
        ...
        for nested2_ in self.nested2:
            namespaceprefix_ = self.nested2_nsprefix_ + ':' if (UseCapturedNS_ and self.nested2_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
        ...
        for nested3_ in self.nested3:
            namespaceprefix_ = self.nested3_nsprefix_ + ':' if (UseCapturedNS_ and self.nested3_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'nested1':
            ...
            value_ = child_.text
            value_ = self.gds_parse_string(value_, node, 'nested2')
            value_ = self.gds_validate_string(value_, node, 'nested2')
            self.nested2.append(value_)
            self.nested2_nsprefix_ = child_.prefix
        elif nodeName_ == 'nested3' and child_.text:
            sval_ = child_.text
            ival_ = self.gds_parse_integer(sval_, node, 'nested3')
            ival_ = self.gds_validate_integer(ival_, node, 'nested3')
            self.nested3.append(ival_)
            self.nested3_nsprefix_ = child_.prefix
...
class nested1Type(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, nestedA1=None, nestedA2=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
        ...
        self.nestedA1_nsprefix_ = None
        if nestedA2 is None:
            self.nestedA2 = []
        else:
            self.nestedA2 = nestedA2
        self.nestedA2_nsprefix_ = None
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
    ...
    def insert_nestedA2_at(self, index, value):
        self.nestedA2.insert(index, value)
    def replace_nestedA2_at(self, index, value):
        self.nestedA2[index] = value
    def hasContent_(self):
        if (
            self.nestedA1 or
            self.nestedA2
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='nested1Type', pretty_print=True):
        ...
        if pretty_print:
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'nested1Type':
            name_ = self.original_tagname_
        if UseCapturedNS_ and self.ns_prefix_:
            namespaceprefix_ = self.ns_prefix_ + ':'
        showIndent(outfile, level, pretty_print)
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='nested1Type')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='nested1Type', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='nested1Type'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='nested1Type', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        for nestedA1_ in self.nestedA1:
            namespaceprefix_ = self.nestedA1_nsprefix_ + ':' if (UseCapturedNS_ and self.nestedA1_nsprefix_) else ''
        ...
        for nestedA2_ in self.nestedA2:
            namespaceprefix_ = self.nestedA2_nsprefix_ + ':' if (UseCapturedNS_ and self.nestedA2_nsprefix_) else ''
...
class nested1AType(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, nestedB1=None, nestedB2=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
        ...
        self.nestedB1_nsprefix_ = None
        if nestedB2 is None:
            self.nestedB2 = []
        else:
            self.nestedB2 = nestedB2
        self.nestedB2_nsprefix_ = None
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
    ...
    def insert_nestedB2_at(self, index, value):
        self.nestedB2.insert(index, value)
    def replace_nestedB2_at(self, index, value):
        self.nestedB2[index] = value
    def hasContent_(self):
        if (
            self.nestedB1 or
            self.nestedB2
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='nested1AType', pretty_print=True):
        ...
        if pretty_print:
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'nested1AType':
            name_ = self.original_tagname_
        if UseCapturedNS_ and self.ns_prefix_:
            namespaceprefix_ = self.ns_prefix_ + ':'
        showIndent(outfile, level, pretty_print)
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='nested1AType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='nested1AType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='nested1AType'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='nested1AType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        for nestedB1_ in self.nestedB1:
            namespaceprefix_ = self.nestedB1_nsprefix_ + ':' if (UseCapturedNS_ and self.nestedB1_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
        ...
        for nestedB2_ in self.nestedB2:
            namespaceprefix_ = self.nestedB2_nsprefix_ + ':' if (UseCapturedNS_ and self.nestedB2_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'nestedB1':
            value_ = child_.text
            value_ = self.gds_parse_string(value_, node, 'nestedB1')
            value_ = self.gds_validate_string(value_, node, 'nestedB1')
            self.nestedB1.append(value_)
            self.nestedB1_nsprefix_ = child_.prefix
        elif nodeName_ == 'nestedB2':
            value_ = child_.text
            value_ = self.gds_parse_string(value_, node, 'nestedB2')
            value_ = self.gds_validate_string(value_, node, 'nestedB2')
            self.nestedB2.append(value_)
            self.nestedB2_nsprefix_ = child_.prefix
