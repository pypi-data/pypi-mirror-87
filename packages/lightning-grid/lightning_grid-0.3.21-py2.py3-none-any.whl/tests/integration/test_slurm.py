...
class TestCancel:
    ...
    def test_slurm_status_fails(self):
        ...
        with monkeypatched(resolvers, 'get_slurm_status', get_slurm_status):
    ...
    def test_slurm_status_query_fails(self):
    ...
    def test_slurm_status_succeeds(self):
    ...
    def test_slurm_submit_fails(self, tmp_path):
        ...
        with monkeypatched(resolvers, 'train_slurm_script',
                           train_slurm_script):
            result = RUNNER.invoke(cli.slurm, [
                "train",
                script.as_posix(),
    ...
    def test_slurm_submit_fails_with_ex(self, tmp_path):
    ...
    def test_slurm_submit_succeeds(self, tmp_path):
    ...
    def test_slurm_get_token_succeeds(self, tmp_path):
        ...
        with monkeypatched(resolvers, 'get_slurm_auth_token',
    ...
    def test_slurm_get_token_fails(self, tmp_path):
    ...
    def test_slurm_get_token_fails_with_ex(self, tmp_path):
