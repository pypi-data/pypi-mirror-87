...
_swig_new_instance_method = _vnl_matrix_refPython.SWIG_PyInstanceMethod_New
_swig_new_static_method = _vnl_matrix_refPython.SWIG_PyStaticMethod_New
...
class vnl_matrix_refD(itk.vnl_matrixPython.vnl_matrixD):
    ...
    non_const = _swig_new_instance_method(_vnl_matrix_refPython.vnl_matrix_refD_non_const)
...
class vnl_matrix_refF(itk.vnl_matrixPython.vnl_matrixF):
    ...
    non_const = _swig_new_instance_method(_vnl_matrix_refPython.vnl_matrix_refF_non_const)
