...
class V1Agent(object):
    ...
    def __init__(self, uuid=None, name=None, description=None, tags=None, live_state=None, namespace=None, version_api=None, version=None, content=None, created_at=None, updated_at=None, status=None, settings=None, local_vars_configuration=None):  # noqa: E501
