...
@error_decorator(use_parent_error_code=True)
class InvalidArgumentTypeWithCondition(InvalidArgumentType):
    @property
    def message_format(self) -> str:
...
@error_decorator(use_parent_error_code=True)
class TimeseriesDfInvalidArgNoValidationData(ArgumentInvalid):
    @property
    def message_format(self) -> str:
...
@error_decorator(use_parent_error_code=True)
class TimeseriesInvalidShortGrainHandlingConfig(ArgumentInvalid):
    @property
    def message_format(self) -> str:
        return AutoMLErrorStrings.TIMESERIES_INVALID_SHORT_GRAIN_HANDLING
...
@error_decorator(use_parent_error_code=True)
class TimeseriesInsufficientDataValidateTrainData(TimeseriesInsufficientData):
    @property
    def message_format(self) -> str:
...
class UnhashableValueInColumn(BadData):
    @property
    def message_format(self) -> str:
        return AutoMLErrorStrings.UNHASHABLE_VALUE_IN_COLUMN
...
@error_decorator(use_parent_error_code=True)
class TimeseriesGrainAbsentValidateTrainValidData(TimeseriesGrainAbsent):
    @property
    def message_format(self):
...
@error_decorator(use_parent_error_code=True)
class TimeseriesGrainAbsentNoGrainInTrain(TimeseriesGrainAbsent):
    @property
    def message_format(self):
...
@error_decorator(use_parent_error_code=True)
class TimeseriesGrainAbsentNoLastDate(TimeseriesGrainAbsent):
    @property
    def message_format(self):
...
@error_decorator(use_parent_error_code=True)
class TimeseriesGrainAbsentNoDataContext(TimeseriesGrainAbsent):
    @property
    def message_format(self):
...
@error_decorator(details_uri="https://docs.microsoft.com/azure/machine-learning/"
                             "resource-known-issues#automated-machine-learning")
class AutoMLImportError(AutoMLInternal):
    @property
    def message_format(self):
        return AutoMLErrorStrings.UNEXPECTED_IMPORT
...
class ManagedLocalScriptError(AutoMLInternal):
    @property
    def message_format(self):
        return AutoMLErrorStrings.LOCAL_MANAGED_SCRIPT_ERROR
