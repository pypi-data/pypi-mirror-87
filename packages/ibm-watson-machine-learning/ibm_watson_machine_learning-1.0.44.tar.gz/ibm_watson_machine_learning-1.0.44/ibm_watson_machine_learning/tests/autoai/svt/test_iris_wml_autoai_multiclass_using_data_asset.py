...
from ibm_watson_machine_learning.helpers.connections import AssetLocation, DataConnection
...
class TestAutoAIRemote(unittest.TestCase):
    ...
    asset_id = '3c1a2156-e816-4f4a-8ea3-4e823f16eb2d'
    ...
    def test_02_save_remote_data_and_DataConNection_setup(self):
        TestAutoAIRemote.data_connection = DataConnection(location=AssetLocation(asset_id=self.asset_id))
