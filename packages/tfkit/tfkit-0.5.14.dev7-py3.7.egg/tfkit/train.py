...
def optimizer(model, lr):
    ...
    optimizer_grouped_parameters = [
        {'params': [p for n, p in param_optimizer if any(nd in n for nd in larger_lr)], 'lr': lr * 10},
        {'params': [p for n, p in param_optimizer if not any(nd in n for nd in larger_lr)], 'lr': lr}]
