...
Usage:
  autoseeder-cli [show_config] <list | get_csv | submit | find_urls | view | save_screenshot | save_screenshots | save_screenshots_all>
...
def main(args):
    try:
        ...
        if args.get("list"):
            ...
            env_vars = process_env_args()
            do_save_all_screenshots(args["<uuid>"], args["<output_path>"], base_url=env_vars["base_url"], token=env_vars["token"])
