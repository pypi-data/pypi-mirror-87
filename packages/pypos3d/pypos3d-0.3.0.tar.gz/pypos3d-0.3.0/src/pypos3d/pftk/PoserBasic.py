...
class PoserToken:
  ...
  E_showPreview = PToken("showPreview", False, None, False) # v5
  ...
  E_inputsCollapsed = PToken("inputsCollapsed", False, None, False)
  ...
  E_customData = PToken("customData", True, "StructuredAttribut", False)
  # PToken.E_frontImage = PoserToken("frontImage", True, FrontImage.__class__)
  E_data = PToken("data", False, None, False)
