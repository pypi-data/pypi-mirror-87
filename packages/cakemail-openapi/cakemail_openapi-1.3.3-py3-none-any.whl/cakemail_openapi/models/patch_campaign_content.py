...
class PatchCampaignContent(object):
    ...
    def __init__(self, subject=None, html=None, text=None, json=None, type=None, encoding=None, default_unsubscribe_link=None, local_vars_configuration=None):  # noqa: E501
