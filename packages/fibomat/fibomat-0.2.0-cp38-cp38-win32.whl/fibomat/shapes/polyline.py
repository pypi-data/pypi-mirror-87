...
from fibomat.linalg import VectorArray, VectorLike, Vector, VectorArrayLike, boundingbox


class Polyline(shape.Shape, ArcSplineCompatible):
    """Polyline"""

    def __init__(self, points: VectorArrayLike, description: Optional[str] = None, _closed: bool = False):
        """
        Args:
