...
class ThresholdMetricInputV1(object):
    ...
    def __init__(self, aggregation_function=None, bounding_condition=None, bounding_condition_maximum_duration=None, duration=None, measured_item=None, measured_item_maximum_duration=None, name=None, neutral_color=None, number_format=None, period=None, scoped_to=None, thresholds=None):
        """
