...
setup(
  name = 'bitbarconnector',         # How you named your package folder (MyLib)
  packages = ['bitbarconnector'],   # Chose the same as "name"
  ...
  download_url = 'https://github.com/singh-tajinder/bitbarconnector/archive/v_01.01.tar.gz',    # I explain this later on
