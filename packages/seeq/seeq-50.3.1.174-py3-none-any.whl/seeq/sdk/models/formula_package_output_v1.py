...
class FormulaPackageOutputV1(object):
    ...
    def __init__(self, created_at=None, creator_contact_info=None, creator_name=None, datasource=None, description=None, docs=None, effective_permissions=None, functions=None, href=None, id=None, installer=None, is_archived=False, is_redacted=False, name=None, status_message=None, type=None, updated_at=None, version_string=None):
        """
    ...
    def datasource(self):
        ...
        The datasource for the FormulaPackage.
    ...
    def href(self):
        """
        Gets the href of this FormulaPackageOutputV1.
        The href that can be used to interact with the item

        :return: The href of this FormulaPackageOutputV1.
        :rtype: str
        """
        return self._href
    ...
    def href(self, href):
        """
        Sets the href of this FormulaPackageOutputV1.
        The href that can be used to interact with the item

        :param href: The href of this FormulaPackageOutputV1.
        :type: str
        """
        if href is None:
