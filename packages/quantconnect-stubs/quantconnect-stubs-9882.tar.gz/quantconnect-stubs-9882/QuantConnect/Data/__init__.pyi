...
QuantConnect_Data_Slice_T = typing.TypeVar('QuantConnect_Data_Slice_T')
QuantConnect_Data_SliceExtensions_T = typing.TypeVar('QuantConnect_Data_SliceExtensions_T')
...
class IBaseData(metaclass=abc.ABCMeta):
    ...
    @property
    @abc.abstractmethod
    def DataType(self) -> QuantConnect.MarketDataType:
        """Market Data Type of this data - does it come in individual price packets or is it grouped into OHLC."""
        ...

    @DataType.setter
    @abc.abstractmethod
    def DataType(self, value: QuantConnect.MarketDataType):
        """Market Data Type of this data - does it come in individual price packets or is it grouped into OHLC."""
        ...
...
class Slice(QuantConnect.ExtendedDictionary[typing.Any], System.Collections.Generic.IEnumerable[System.Collections.Generic.KeyValuePair[QuantConnect.Symbol, QuantConnect.Data.BaseData]], typing.Iterable[System.Collections.Generic.KeyValuePair[QuantConnect.Symbol, QuantConnect.Data.BaseData]]):
    ...
    @typing.overload
    def Get(self) -> QuantConnect.Data.Market.DataDictionary[QuantConnect_Data_Slice_T]:
        """
        Gets the DataDictionary{T} for all data of the specified type
        
        :returns: The DataDictionary{T} containing the data of the specified type
        """
        ...

    @typing.overload
    def Get(self, type: System.Type) -> typing.Any:
        """
    ...
    @staticmethod
    def GetImpl(type: System.Type, instance: QuantConnect.Data.Slice) -> typing.Any:
        """
        Gets the data of the specified type.
    ...
    @typing.overload
    def Get(self, symbol: typing.Union[QuantConnect.Symbol, str]) -> QuantConnect_Data_Slice_T:
        """
...
class DynamicData(QuantConnect.Data.BaseData, IDynamicMetaObjectProvider, metaclass=abc.ABCMeta):
    ...
    def SetProperty(self, name: str, value: System.Object) -> System.Object:
        """
...
class HistoryRequest(System.Object):
    ...
    @ExchangeHours.setter
    def ExchangeHours(self, value: QuantConnect.Securities.SecurityExchangeHours):
        """Gets the exchange hours used for processing fill forward requests"""
        ...
    ...
    @DataType.setter
    def DataType(self, value: System.Type):
        """Gets the data type used to process the subscription request, this type must derive from BaseData"""
        ...
...
class SubscriptionManager(System.Object):
    ...
    def LookupSubscriptionConfigDataTypes(self, symbolSecurityType: QuantConnect.SecurityType, resolution: QuantConnect.Resolution, isCanonical: bool) -> System.Collections.Generic.List[System.Tuple[System.Type, QuantConnect.TickType]]:
        """
...
class GetSetPropertyDynamicMetaObject(DynamicMetaObject):
    ...
    def __init__(self, expression: typing.Any, value: System.Object, setPropertyMethodInfo: System.Reflection.MethodInfo, getPropertyMethodInfo: System.Reflection.MethodInfo) -> None:
        ...
...
class HistoryProviderInitializeParameters(System.Object):
    ...
    @property
    def StatusUpdateAction(self) -> typing.Callable[[], int]:
...
class SubscriptionDataConfigExtensions(System.Object):
    ...
    @staticmethod
    def GetHighestResolution(subscriptionDataConfigs: System.Collections.Generic.IEnumerable[QuantConnect.Data.SubscriptionDataConfig]) -> QuantConnect.Resolution:
        """
    ...
    @staticmethod
    def DataNormalizationMode(subscriptionDataConfigs: System.Collections.Generic.IEnumerable[QuantConnect.Data.SubscriptionDataConfig]) -> QuantConnect.DataNormalizationMode:
        """
...
class SliceExtensions(System.Object):
    ...
    @staticmethod
    @typing.overload
    def Get(dataDictionaries: System.Collections.Generic.IEnumerable[QuantConnect.Data.Market.DataDictionary[QuantConnect_Data_SliceExtensions_T]], symbol: typing.Union[QuantConnect.Symbol, str]) -> System.Collections.Generic.IEnumerable[QuantConnect_Data_SliceExtensions_T]:
        """
    ...
    @staticmethod
    @typing.overload
    def Get(dataDictionaries: System.Collections.Generic.IEnumerable[QuantConnect.Data.Market.DataDictionary[QuantConnect_Data_SliceExtensions_T]], symbol: typing.Union[QuantConnect.Symbol, str], field: str) -> System.Collections.Generic.IEnumerable[float]:
        """
    ...
    @staticmethod
    @typing.overload
    def Get(slices: System.Collections.Generic.IEnumerable[QuantConnect.Data.Slice]) -> System.Collections.Generic.IEnumerable[QuantConnect.Data.Market.DataDictionary[QuantConnect_Data_SliceExtensions_T]]:
        """
    ...
    @staticmethod
    @typing.overload
    def Get(slices: System.Collections.Generic.IEnumerable[QuantConnect.Data.Slice], symbol: typing.Union[QuantConnect.Symbol, str]) -> System.Collections.Generic.IEnumerable[QuantConnect_Data_SliceExtensions_T]:
        """
    ...
    @staticmethod
    def PushThrough(slices: System.Collections.Generic.IEnumerable[QuantConnect.Data.Slice], handler: typing.Callable[[], QuantConnect.Data.BaseData]) -> None:
        """
        Loops through the specified slices and pushes the data into the consolidators. This can be used to
        easily warm up indicators from a history call that returns slice objects.
