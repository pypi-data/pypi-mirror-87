...
class Arn(metaclass=jsii.JSIIMeta, jsii_type="monocdk.Arn"):
    ...
    def extract_resource_name(
        ...
        :stability: experimental
        """
        return jsii.sinvoke(cls, "extractResourceName", [arn, resource_type])
...
class BundlingDockerImage(
    ...
    def from_asset(
        ...
        *,
        ...
        :param file: (experimental) Name of the Dockerfile. Default: - The Dockerfile immediately within the build context path
...
class ConstructNode(metaclass=jsii.JSIIMeta, jsii_type="monocdk.ConstructNode"):
    ...
    def synth(
        ...
        *,
        ...
        runtime_info: typing.Optional[_RuntimeInfo_f8aa8495] = None,
...
class DockerBuildOptions:
    ...
    def file(self) -> typing.Optional[builtins.str]:
        """(experimental) Name of the Dockerfile.
...
class DockerImageAssetSource:
    def __init__(
        ...
        *,
        ...
        """
        :param directory_name: (experimental) The directory where the Dockerfile is stored, must be relative to the cloud assembly root.
        ...
        :param docker_build_args: (experimental) Build args to pass to the ``docker build`` command. Since Docker build arguments are resolved before deployment, keys and values cannot refer to unresolved tokens (such as ``lambda.functionArn`` or ``queue.queueUrl``). Default: - no build args are passed
        :param docker_build_target: (experimental) Docker target to build to. Default: - no target
        :param docker_file: (experimental) Path to the Dockerfile (relative to the directory). Default: - no file
...
class FileAssetSource:
    def __init__(
        ...
        *,
        ...
        :param file_name: (experimental) The path, relative to the root of the cloud assembly, in which this asset source resides. This can be a path to a file or a directory, dependning on the packaging type.
        :param packaging: (experimental) Which type of packaging to perform.
...
class Fn(metaclass=jsii.JSIIMeta, jsii_type="monocdk.Fn"):
    ...
    def split(
        ...
        """(experimental) To split a string into a list of string values so that you can select an element from the resulting string list, use the ``Fn::Split`` intrinsic function.
...
class AssetStaging(
    ...
    def absolute_staged_path(self) -> builtins.str:
        ...
        :stability: experimental
        """
        return jsii.get(self, "absoluteStagedPath")
