...
templates = (
  ...
  ('BandNode', 'itk::BandNode', 'itkBandNodeI2D', False, 'itk::Index<2>, double'),
  ...
  ('BandNode', 'itk::BandNode', 'itkBandNodeI3D', False, 'itk::Index<3>, double'),
  ...
  ('NarrowBand', 'itk::NarrowBand', 'itkNarrowBandBNI2D', True, 'itk::BandNode< itk::Index<2>, double>'),
  ...
  ('NarrowBand', 'itk::NarrowBand', 'itkNarrowBandBNI3D', True, 'itk::BandNode< itk::Index<3>, double>'),
  ...
  ('NarrowBandImageFilterBase', 'itk::NarrowBandImageFilterBase', 'itkNarrowBandImageFilterBaseID2ID2', True, 'itk::Image< double,2 >, itk::Image< double,2 >'),
  ('NarrowBandImageFilterBase', 'itk::NarrowBandImageFilterBase', 'itkNarrowBandImageFilterBaseID3ID3', True, 'itk::Image< double,3 >, itk::Image< double,3 >'),
)
