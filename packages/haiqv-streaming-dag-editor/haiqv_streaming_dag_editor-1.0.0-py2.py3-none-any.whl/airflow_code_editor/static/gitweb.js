...
webui.TreeView = function(commitView) {
    ...
    function Entry(line) {
        ...
        self.href = function() {
            ...
            if (self.local) { // local file/dir
                ...
                return '/' + prefix + '/code_editor/files/~git/' + self.object + '/' + self.name;
            }
        }
        ...
        self.downloadHref = function() {
            ...
            if (self.type == 'tree') { // tree
                ...
                return '/' + prefix + '/code_editor/files' + self.object;
            } else { // git blob
                return '/' + prefix + '/code_editor/files/~git/' + self.object + '/' + self.name;
            }
        }
    ...
    self.editorLoad = function(path) {
        ...
        jQuery.get('/' + prefix + '/code_editor/files' + path, function(res) {
    ...
    self.editorSave = function(path) {
        ...
        jQuery.post("/" + prefix + "/code_editor/files" + path, data, function(res) {
            if (res.error) {
