...
class itkSubtractImageFilterID2ID2ID2(itk.itkBinaryGeneratorImageFilterPython.itkBinaryGeneratorImageFilterID2ID2ID2):
    ...
    operator+()
    example{Filtering/ImageIntensity/SubtractTwoImages,Subtract Two
    Images}  example{Filtering/ImageIntensity/SubtractConstantFromEveryPix
    el,Subtract Constant From Every Pixel} 
    """
