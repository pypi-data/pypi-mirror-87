...
loc_cfg_file = os.path.join(os.path.dirname(os.path.realpath(__file__)), "config.py")
def_cfg_file = os.path.join(
    os.path.dirname(os.path.realpath(__file__)), "default_config.py"
)
...
if os.path.exists(cfg_file):
    ...
    copyfile(def_cfg_file, loc_cfg_file)
