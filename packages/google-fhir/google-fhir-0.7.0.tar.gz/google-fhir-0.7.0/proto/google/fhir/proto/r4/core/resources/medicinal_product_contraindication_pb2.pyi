...
class MedicinalProductContraindication(google___protobuf___message___Message):
    ...
    class OtherTherapy(google___protobuf___message___Message):
        ...
        @property
        def medication(self) -> type___MedicinalProductContraindication.OtherTherapy.MedicationX: ...
        ...
        def __init__(self,
            *,
            ...
            medication : typing___Optional[type___MedicinalProductContraindication.OtherTherapy.MedicationX] = None,
            ) -> None: ...
    ...
    @property
    def disease(self) -> proto___google___fhir___proto___r4___core___datatypes_pb2___CodeableConcept: ...
    ...
    @property
    def therapeutic_indication(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[proto___google___fhir___proto___r4___core___datatypes_pb2___Reference]: ...

    @property
    def other_therapy(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[type___MedicinalProductContraindication.OtherTherapy]: ...
    ...
    def __init__(self,
        *,
        ...
        disease : typing___Optional[proto___google___fhir___proto___r4___core___datatypes_pb2___CodeableConcept] = None,
        ...
        therapeutic_indication : typing___Optional[typing___Iterable[proto___google___fhir___proto___r4___core___datatypes_pb2___Reference]] = None,
        other_therapy : typing___Optional[typing___Iterable[type___MedicinalProductContraindication.OtherTherapy]] = None,
    ...
    def HasField(self, field_name: typing_extensions___Literal[u"disease",b"disease",u"disease_status",b"disease_status",u"id",b"id",u"implicit_rules",b"implicit_rules",u"language",b"language",u"meta",b"meta",u"text",b"text"]) -> builtin___bool: ...
    def ClearField(self, field_name: typing_extensions___Literal[u"comorbidity",b"comorbidity",u"contained",b"contained",u"disease",b"disease",u"disease_status",b"disease_status",u"extension",b"extension",u"id",b"id",u"implicit_rules",b"implicit_rules",u"language",b"language",u"meta",b"meta",u"modifier_extension",b"modifier_extension",u"other_therapy",b"other_therapy",u"population",b"population",u"subject",b"subject",u"text",b"text",u"therapeutic_indication",b"therapeutic_indication"]) -> None: ...
type___MedicinalProductContraindication = MedicinalProductContraindication
