...
class ModuleStep(ModuleStepBase):
    ...
    :param inputs_map: A dictionary that maps the names of port definitions of the ModuleVersion to
                        the step's inputs.
    :type inputs_map: dict({(str): (azureml.pipeline.core.graph.InputPortBinding
    ...
    :param outputs_map: A dictionary that maps the names of port definitions of the ModuleVersion to
                        the step's outputs.
    :type outputs_map: dict({(str): (azureml.pipeline.core.graph.OutputPortBinding
                    or azureml.data.data_reference.DataReference
                    or azureml.pipeline.core.PortDataReference
                    or azureml.pipeline.core.builder.PipelineData
                    or azureml.pipeline.core.pipeline_output_dataset.PipelineOutputAbstractDataset)})
    ...
    def __init__(self, module=None, version=None, module_version=None,
        ...
        :param outputs_map: A dictionary that maps the names of port definitions of the ModuleVersion to
                        the step's outputs.
        :type outputs_map: dict({(str): (azureml.pipeline.core.graph.InputPortBinding
                        or azureml.data.data_reference.DataReference
                        or azureml.pipeline.core.PortDataReference
                        or azureml.pipeline.core.builder.PipelineData
                        or azureml.pipeline.core.pipeline_output_dataset.PipelineOutputDataset)})
        ...
        :type runconfig_pipeline_params: {str: azureml.pipeline.core.graph.PipelineParameter}
        :param arguments: A list of command line arguments for the Python script file. The arguments will be delivered
                        to the compute target via arguments in RunConfiguration.
                        For more details how to handle arguments such as special symbols, see the
                        arguments in :class:`azureml.core.RunConfiguration`
