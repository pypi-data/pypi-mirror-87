...
from openapi_client.models.repository_status_model import RepositoryStatusModel  # noqa: E501
from openapi_client.rest import ApiException

class TestRepositoryStatusModel(unittest.TestCase):
    """RepositoryStatusModel unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test RepositoryStatusModel
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = openapi_client.models.repository_status_model.RepositoryStatusModel()  # noqa: E501
        if include_optional :
            return RepositoryStatusModel(
                ok = True, 
                systems = {
                    'key' : openapi_client.models.repository_status_model_systems.RepositoryStatusModel_systems(
                        ok = True, 
                        critical = True, 
                        message = '0', )
                    }
    ...
    def testRepositoryStatusModel(self):
        """Test RepositoryStatusModel"""
