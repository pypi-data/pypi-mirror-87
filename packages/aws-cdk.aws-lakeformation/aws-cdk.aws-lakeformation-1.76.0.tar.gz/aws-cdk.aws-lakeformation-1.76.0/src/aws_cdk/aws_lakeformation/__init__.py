...
class CfnDataLakeSettings(
    ...
    def trusted_resource_owners(self) -> typing.Optional[typing.List[builtins.str]]:
        ...
        """
        return jsii.get(self, "trustedResourceOwners")

    @trusted_resource_owners.setter # type: ignore
...
class CfnPermissions(
    ...
    @data_lake_principal.setter # type: ignore
    def data_lake_principal(
        self,
    ...
    @permissions_with_grant_option.setter # type: ignore
    def permissions_with_grant_option(
        self,
        value: typing.Optional[typing.List[builtins.str]],
    ) -> None:
...
class CfnResource(
    ...
    @resource_arn.setter # type: ignore
    ...
    @use_service_linked_role.setter # type: ignore
    def use_service_linked_role(
        self,
