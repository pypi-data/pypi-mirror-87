...
class DevelopCmd(develop):
    prefix_targets = [
        ("nbconvert/templates", 'tpds_tpl'),
        ("voila/templates", 'tpds_tpl'),
    ]
    def run(self):
...
setup(
    name='voila-tpds_tpl',
    version="0.1",
    description="A TPDS template for Voila",
    data_files=data_files,
    install_requires=['voila>=0.2.3'],
    include_package_data=True,
    author='Gowthami',
    author_email='gowthamicherukuri07@gmail.com',
    url='https://github.com/GowthamiCherukuri/voila-tpds_tpls',
    keywords=[
        'ipython',
        'jupyter',
        'widgets',
