...
class itkAmoebaOptimizer(itkSingleValuedNonLinearVnlOptimizer):
    ...
    example{Numerics/Optimizers/AmoebaOptimizer, Amoeba Optimization} 
    """
...
class itkExhaustiveOptimizer(itkSingleValuedNonLinearOptimizer):
    ...
    example{Numerics/Optimizers/ExhaustiveOptimizer,Exhaustive Optimizer}
...
class itkLevenbergMarquardtOptimizer(itkMultipleValuedNonLinearVnlOptimizer):
    ...
    example{Numerics/Optimizers/LevenbergMarquardtOptimization, Levenberg-
    Marquardt Optimiztion} 
    """
