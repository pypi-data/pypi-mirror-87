...
segFileBase = '/bmrNAS/people/barma7/bilateral/dess_study/data/marco_study_copy/%s/data/%s/%s/fc/fc_manual.nii.gz';
...
for subject in dataset_map.keys():
	for scan_id in dataset_map[subject]:
		for knee in knee_sides:
			...
			sio.savemat(os.path.join(save_dir, 'matFile.mat'), {'echo1': echo1, 'echo2': echo2, 'seg': seg})
