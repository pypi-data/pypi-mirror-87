...
# source: th2_grpc_act_temp/act_template.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='th2_grpc_act_temp/act_template.proto',
  package='',
  syntax='proto3',
  serialized_options=b'\n\031com.exactpro.th2.act.grpcP\001',
  create_key=_descriptor._internal_create_key,
  serialized_pb=b'\n$th2_grpc_act_temp/act_template.proto\x1a\x1cth2_grpc_common/common.proto\"Y\n\x13SendMessageResponse\x12\x1e\n\x06status\x18\x01 \x01(\x0b\x32\x0e.RequestStatus\x12\"\n\rcheckpoint_id\x18\x02 \x01(\x0b\x32\x0b.Checkpoint\"\x92\x01\n\x13PlaceMessageRequest\x12\x19\n\x07message\x18\x01 \x01(\x0b\x32\x08.Message\x12(\n\rconnection_id\x18\x02 \x01(\x0b\x32\r.ConnectionIDB\x02\x18\x01\x12!\n\x0fparent_event_id\x18\x04 \x01(\x0b\x32\x08.EventID\x12\x13\n\x0b\x64\x65scription\x18\x05 \x01(\t\"~\n\x14PlaceMessageResponse\x12\"\n\x10response_message\x18\x01 \x01(\x0b\x32\x08.Message\x12\x1e\n\x06status\x18\x02 \x01(\x0b\x32\x0e.RequestStatus\x12\"\n\rcheckpoint_id\x18\x03 \x01(\x0b\x32\x0b.Checkpoint2\xcb\x05\n\x03\x41\x63t\x12>\n\rplaceOrderFIX\x12\x14.PlaceMessageRequest\x1a\x15.PlaceMessageResponse\"\x00\x12\x44\n\x13placeOrderCancelFIX\x12\x14.PlaceMessageRequest\x1a\x15.PlaceMessageResponse\"\x00\x12K\n\x1aplaceOrderCancelReplaceFIX\x12\x14.PlaceMessageRequest\x1a\x15.PlaceMessageResponse\"\x00\x12O\n\x1eplaceOrderMassCancelRequestFIX\x12\x14.PlaceMessageRequest\x1a\x15.PlaceMessageResponse\"\x00\x12\x45\n\x14placeQuoteRequestFIX\x12\x14.PlaceMessageRequest\x1a\x15.PlaceMessageResponse\"\x00\x12>\n\rplaceQuoteFIX\x12\x14.PlaceMessageRequest\x1a\x15.PlaceMessageResponse\"\x00\x12\x44\n\x13placeQuoteCancelFIX\x12\x14.PlaceMessageRequest\x1a\x15.PlaceMessageResponse\"\x00\x12\x46\n\x15placeQuoteResponseFIX\x12\x14.PlaceMessageRequest\x1a\x15.PlaceMessageResponse\"\x00\x12N\n\x1dplaceSecurityStatusRequestFIX\x12\x14.PlaceMessageRequest\x1a\x15.PlaceMessageResponse\"\x00\x12;\n\x0bsendMessage\x12\x14.PlaceMessageRequest\x1a\x14.SendMessageResponse\"\x00\x42\x1d\n\x19\x63om.exactpro.th2.act.grpcP\x01\x62\x06proto3'
  ,
...
SendMessageResponse = _reflection.GeneratedProtocolMessageType('SendMessageResponse', (_message.Message,), {
  ...
  '__module__' : 'th2_grpc_act_temp.act_template_pb2'
...
_ACT = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    full_name='Act.placeOrderCancelFIX',
    index=1,
    containing_service=None,
    input_type=_PLACEMESSAGEREQUEST,
    output_type=_PLACEMESSAGERESPONSE,
  ...
  _descriptor.MethodDescriptor(
    name='placeOrderCancelReplaceFIX',
    full_name='Act.placeOrderCancelReplaceFIX',
    index=2,
    containing_service=None,
    input_type=_PLACEMESSAGEREQUEST,
    output_type=_PLACEMESSAGERESPONSE,
  ...
  _descriptor.MethodDescriptor(
    name='placeSecurityStatusRequestFIX',
    full_name='Act.placeSecurityStatusRequestFIX',
    index=8,
    containing_service=None,
    input_type=_PLACEMESSAGEREQUEST,
    output_type=_PLACEMESSAGERESPONSE,
