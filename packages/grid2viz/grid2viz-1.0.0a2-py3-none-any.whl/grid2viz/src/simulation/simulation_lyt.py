...
def layout(scenario, studied_agent):
    ...
    network_graph = make_network(episode).plot_obs(observation=episode.observations[0])
    return html.Div(
        id="simulation_page",
        children=[
