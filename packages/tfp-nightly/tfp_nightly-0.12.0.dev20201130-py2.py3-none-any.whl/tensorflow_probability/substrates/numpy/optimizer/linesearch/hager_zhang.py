...
#   `tensorflow_probability/substrates/numpy/optimizer/linesearch/hager_zhang.py`
...
from tensorflow_probability.substrates.numpy.optimizer.linesearch.internal import hager_zhang_lib as hzl
