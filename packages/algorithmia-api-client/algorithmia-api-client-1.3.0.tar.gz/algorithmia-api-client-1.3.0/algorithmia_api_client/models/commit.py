...
class Commit(object):
    ...
    def __init__(self, id=None, short_message=None, message=None, author=None, local_vars_configuration=None):  # noqa: E501
    ...
    def short_message(self, short_message):
        ...
        :type: str
        """
        if self.local_vars_configuration.client_side_validation and short_message is None:  # noqa: E501
