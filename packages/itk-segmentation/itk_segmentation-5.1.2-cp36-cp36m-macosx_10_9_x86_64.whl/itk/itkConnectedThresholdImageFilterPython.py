...
class itkConnectedThresholdImageFilterEnums(object):
    ...
    def __init__(self, *args):
        r"""
        __init__(itkConnectedThresholdImageFilterEnums self) -> itkConnectedThresholdImageFilterEnums
        __init__(itkConnectedThresholdImageFilterEnums self, itkConnectedThresholdImageFilterEnums arg0) -> itkConnectedThresholdImageFilterEnums
        """
...
class itkConnectedThresholdImageFilterID2ID2(itk.itkImageToImageFilterAPython.itkImageToImageFilterID2ID2):
    ...
    example{Segmentation/RegionGrowing/ConnectedComponentsInImage,Conne
    cted Components In Image} 
    """
...
def connected_threshold_image_filter_init_docstring():
    ...
    import itkTemplate
    import itkHelpers
    if isinstance(itk.ConnectedThresholdImageFilter, itkTemplate.itkTemplate):
        filter_object = itk.ConnectedThresholdImageFilter.values()[0]
    else:
        filter_object = itk.ConnectedThresholdImageFilter
