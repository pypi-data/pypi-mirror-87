...
from azureml.contrib.automl.dnn.vision.object_detection_yolo.common.constants import ArtifactLiterals
from torchvision.ops._register_onnx_ops import _onnx_opset_version

from .common import Conv, Bottleneck, SPP, Focus, BottleneckCSP, Concat, Hardswish
...
class Model(nn.Module):
    ...
    def __init__(self, model_cfg='yolov5m.yaml', ch=3, nc=None):
        ...
        # Collection of settings (for instance inference config)
        self.settings = {}
    ...
    def restore_model(self, model_dict=None, **kwargs):
        ...
        """
        self.model, _ = parse_model(self.yaml, ch=[self.ch])
        # update stride in Detect()
