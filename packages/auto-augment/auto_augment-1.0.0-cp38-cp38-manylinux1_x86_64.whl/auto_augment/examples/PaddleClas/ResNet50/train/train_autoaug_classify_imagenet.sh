...
config="examples/PaddleClas/ResNet50/train/ResNet50_imagenet_pba.yaml"
...
model_save_dir="./work_dirs/pbt_classifer/test_aug_imagenet_resnet50/train"
#woorker_log="--log_dir $model_save_dir"
mkdir -p ${model_save_dir}
python -m paddle.distributed.launch \
    --selected_gpus="0,1,2,3,4" \
    ${woorker_log} \
