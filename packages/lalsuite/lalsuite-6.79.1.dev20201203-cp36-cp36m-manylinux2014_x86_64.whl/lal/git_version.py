...
id = "410534314f4060fc51056b91d43b6102517c7509"
date = "2020-12-1 20:53:17 +0000"
branch = "None"
tag = "None"
if tag == "None":
    tag = None
...
def check_match(foreign_id, onmismatch="raise"):
    ...
    if foreign_id == "410534314f4060fc51056b91d43b6102517c7509":
        return
    msg = "Program id (410534314f4060fc51056b91d43b6102517c7509) does not match given id (%s)." % foreign_id
    if onmismatch == "raise":
