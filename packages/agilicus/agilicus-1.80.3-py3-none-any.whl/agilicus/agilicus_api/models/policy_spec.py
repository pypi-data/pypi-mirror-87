...
class PolicySpec(object):
    ...
    def default_action(self, default_action):
        ...
        if (self.local_vars_configuration.client_side_validation and
                default_action is not None and len(default_action) > 100):
            raise ValueError("Invalid value for `default_action`, length must be less than or equal to `100`")  # noqa: E501
