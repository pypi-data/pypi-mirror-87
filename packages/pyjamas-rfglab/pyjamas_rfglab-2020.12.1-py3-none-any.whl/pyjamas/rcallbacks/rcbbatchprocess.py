...
class RCBBatchProcess(RCallback):
    ...
    NOTEBOOK_EXTENSION_BM = '.ipynb'
    SCRIPT_FILENAME_APPENDIX_BM: str = '_analysis_script' + NOTEBOOK_EXTENSION_BM
    ...
    MEASUREMENTS_ABS = ['area (\u03BCm\u00B2)', 'perimeter (\u03BCm)', 'circularity (dimensionless)',
                        'raw pixel values interior', 'raw pixel values perimeter', 'image mean', 'image mode',
    ...
    def batch_measure(self, parameters: dict) -> bool:
        ...
        if self.compile_data_flag:
            ...
            if self.save_results:
                data_path = self._save_data(all_data, parameters)
    ...
    def _save_notebook(self, parameters: dict, data_path: str) -> bool:
        ...
        fname = RUtils.set_extension(data_path, RCBBatchProcess.NOTEBOOK_EXTENSION_BM)
