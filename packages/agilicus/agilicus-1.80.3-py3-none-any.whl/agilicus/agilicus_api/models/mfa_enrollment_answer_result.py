...
class MFAEnrollmentAnswerResult(object):
    ...
    def __init__(self, action=None, supported_mfa_methods=None, local_vars_configuration=None):  # noqa: E501
        """MFAEnrollmentAnswerResult - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def action(self):
        """Gets the action of this MFAEnrollmentAnswerResult.  # noqa: E501

        The action to take as a result of the question. enroll - the user should be prompted to enroll a multi-factor authentication method dont_enroll - the user does not need to enroll a multi-factor authentication method enrollment_error - the user would be prompted to enroll but is unable to enroll. An example of this is if the enrollment request is outside the time window allowed by an organisation   # noqa: E501

        :return: The action of this MFAEnrollmentAnswerResult.  # noqa: E501
        :rtype: str
        """
        return self._action
    ...
    def action(self, action):
        """Sets the action of this MFAEnrollmentAnswerResult.

        The action to take as a result of the question. enroll - the user should be prompted to enroll a multi-factor authentication method dont_enroll - the user does not need to enroll a multi-factor authentication method enrollment_error - the user would be prompted to enroll but is unable to enroll. An example of this is if the enrollment request is outside the time window allowed by an organisation   # noqa: E501

        :param action: The action of this MFAEnrollmentAnswerResult.  # noqa: E501
        :type: str
        """
        if self.local_vars_configuration.client_side_validation and action is None:  # noqa: E501
            raise ValueError("Invalid value for `action`, must not be `None`")  # noqa: E501
        allowed_values = ["enroll", "dont_enroll", "enrollment_error"]  # noqa: E501
    ...
    def supported_mfa_methods(self):
        """Gets the supported_mfa_methods of this MFAEnrollmentAnswerResult.  # noqa: E501

        The list of supported multi-factor challenge methods for the organisation  # noqa: E501

        :return: The supported_mfa_methods of this MFAEnrollmentAnswerResult.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def supported_mfa_methods(self, supported_mfa_methods):
        """Sets the supported_mfa_methods of this MFAEnrollmentAnswerResult.

        The list of supported multi-factor challenge methods for the organisation  # noqa: E501

        :param supported_mfa_methods: The supported_mfa_methods of this MFAEnrollmentAnswerResult.  # noqa: E501
        :type: list[str]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MFAEnrollmentAnswerResult):
            return False
