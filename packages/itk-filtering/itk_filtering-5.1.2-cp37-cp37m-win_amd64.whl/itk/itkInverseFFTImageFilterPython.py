...
class itkInverseFFTImageFilterICF2IF2(itk.itkImageToImageFilterBPython.itkImageToImageFilterICF2IF2):
    ...
    {Filtering/FFT/ComputeInverseFFTOfImage,Compute Inverse FFT Of Image}
...
def inverse_fft_image_filter_init_docstring():
    ...
    if isinstance(itk.InverseFFTImageFilter, itkTemplate.itkTemplate):
        inverse_fft_image_filter.__doc__ += itkHelpers.filter_args(filter_object)[0]
        inverse_fft_image_filter.__doc__ += "\n"
        inverse_fft_image_filter.__doc__ += itkHelpers.filter_args(filter_object)[1]
    else:
