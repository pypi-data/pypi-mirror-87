...
def printUeffInKelvin(p_fit):
    ...
    if 'Ueff' in quantities:
        ...
        Ueffval = p_fit['params'][index]/kB
        Ueffsigma = p_fit['sigmas'][index]/kB
...
if __name__ == '__main__':
    ...
    fileName = 'data\\dy_dbm\\20180209DyII_ac0.dat'
    
    # Molar weight of the sample
    molWeight = 988.42 # in g/mol
    
    # Mass of the sample that was used (in g)
    sampleMass = 17.8*10**-3 # in g
    ...
    TvsTaufileName = 'Dy_DBM_ac0Oe.dat'
    ...
    #addPartialModel(fig3, T, tau, 18, 25, p_fit, plotType='O')
