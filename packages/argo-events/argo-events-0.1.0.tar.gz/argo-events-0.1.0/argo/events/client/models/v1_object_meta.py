...
class V1ObjectMeta(object):
    ...
    openapi_types = {
        ...
        'generation': 'int',
        'labels': 'dict(str, str)',
        'managed_fields': 'list[V1ObjectMetaManagedFields]',
        'name': 'str',
        'namespace': 'str',
        'owner_references': 'list[V1ObjectMetaOwnerReferences]',
    ...
    def managed_fields(self):
        ...
        :rtype: list[V1ObjectMetaManagedFields]
        """
    ...
    def managed_fields(self, managed_fields):
        ...
        :type: list[V1ObjectMetaManagedFields]
        """
    ...
    def owner_references(self):
        ...
        :rtype: list[V1ObjectMetaOwnerReferences]
        """
    ...
    def owner_references(self, owner_references):
        ...
        :type: list[V1ObjectMetaOwnerReferences]
        """
