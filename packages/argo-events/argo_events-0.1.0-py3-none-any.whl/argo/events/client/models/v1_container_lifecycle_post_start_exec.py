...
class V1ContainerLifecyclePostStartExec(object):
    ...
    def __init__(self, command=None, local_vars_configuration=None):  # noqa: E501
        """V1ContainerLifecyclePostStartExec - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def command(self):
        """Gets the command of this V1ContainerLifecyclePostStartExec.  # noqa: E501
        ...
        :return: The command of this V1ContainerLifecyclePostStartExec.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def command(self, command):
        """Sets the command of this V1ContainerLifecyclePostStartExec.

        Command is the command line to execute inside the container, the working directory for the command  is root ('/') in the container's filesystem. The command is simply exec'd, it is not run inside a shell, so traditional shell instructions ('|', etc) won't work. To use a shell, you need to explicitly call out to that shell. Exit status of 0 is treated as live/healthy and non-zero is unhealthy.  # noqa: E501

        :param command: The command of this V1ContainerLifecyclePostStartExec.  # noqa: E501
        :type: list[str]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, V1ContainerLifecyclePostStartExec):
            return False
