...
class Repository(WMLResource):
    ...
    def create_member(self, space_uid,meta_props):
        ...
        if self._client.WSD:
            ...
            u'Spaces API are not supported in Watson Studio Desktop.')
    ...
    def clone(self, artifact_id, space_id=None, action="copy", rev_id=None):
        """
            ...
            **Example**
            ...
            """
        if self._client.WSD:
            raise WMLClientError('Cloning is not supported for IBM Watson Studio Desktop.')
    ...
    def create_pipeline_revision(self, pipeline_uid):
        ...
        :param pipeline_uid:  Unique ID of the Pipeline
    ...
    def create_function_revision(self, function_uid):
        ...
        :param function_uid:  Unique ID of the function.
    ...
    def create_experiment_revision(self, experiment_uid):
        ...
        :param experiment_uid:  Unique ID of the experiment.
        ...
        return self._client.experiments.create_revision(experiment_uid= experiment_uid)
    ...
    def update_space(self, space_uid, changes):
        ...
        """
        if self._client.WSD:
            raise WMLClientError('Spaces APIs are not supported in IBM Watson Studio Desktop.')
    ...
    def load(self, artifact_uid):
        ...
        return self._client._models.load(self,artifact_uid)

    @docstring_parameter({'str_type': STR_TYPE_NAME})
    def download(self, artifact_uid, filename='downloaded_artifact.tar.gz', rev_uid=None):
        """
        ...
        if res['model'] is True:
            return self._client._models.download(artifact_uid, filename, rev_uid)
        elif res['function'] is True:
    ...
    def delete(self, artifact_uid):
        ...
        if response.status_code == 200 or response.status_code == 204:
            if response.status_code == 200:
                return self._handle_response(200, u'delete assets', response)
            else:
        ...
        """
           ...
           **Output**
           ...
           .. important::
                ...
                **return type**: dict
                dict (if model_uid is not None) or {"resources": [dict]} (if model_uid is None)\n
    ...
    def get_model_revision_details(self, model_uid, rev_uid):
        ...
        if not self._client.ICP_30:
            raise WMLClientError('Not supported. Revisions APIs are supported only for WML Cloud Pack for Data 3.0 and above.')
        ...
        """
           ...
           **Output**
           ...
           .. important::
                ...
                **return type**: dict
                dict (if pipeline_uid is not None) or {"resources": [dict]} (if pipeline_uid is None)\n
        ...
        """
           ...
           **Output**
           ...
           .. important::
                ...
                **return type**: dict
                dict (if space_uid is not None) or {"resources": [dict]} (if space_uid is None)\n
    ...
    def get_members_details(self, space_uid, member_id=None, limit=None):
        """
           ...
           **Output**
           ...
           .. important::
                ...
                **return type**: dict
                dict (if member_id is not None) or {"resources": [dict]} (if member_id is None)\n
        ...
        if self._client.WSD:
            raise WMLClientError('Space Member APIs are not supported in IBM Watson Studio Desktop.')
