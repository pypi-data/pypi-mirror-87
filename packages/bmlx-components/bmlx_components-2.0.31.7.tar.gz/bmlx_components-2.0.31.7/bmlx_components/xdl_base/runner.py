...
class XdlRunner(object):
    ...
    def gen_save_metrics_hook(self, metric_tensors, ts_tensor):
        if (
            xdl.get_task_index() != 0
            or not metric_tensors
    ...
    def run(self, reader: xdl.DataReader):
        ...
        hooks.extend(self.gen_save_metrics_hook(metric_tensors, max_timestamp))
