...
import ragex.community.database.schema_migrations.alembic.utils as migration_utils
...
migrations: Dict[Text, Dict[Text, List[Union[Text, Dict[Text, Text]]]]] = {
    "analytics_cache": {
...
def upgrade():
    ...
    from ragex.community.database.schema_migrations.alembic.versions.migration_2019_07_05_indexes_for_logs_and_nlu_training_data_b4a9bd47b6e0 import (
    ...
    # Fix wrong index
    from ragex.community.database.schema_migrations.alembic.versions.migration_2019_07_22_add_index_to_event_timestamps_45546b047abe import (
        NEW_INDEX_NAME,
    )
