...
class amlListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by amlParser#intValue.
    def enterIntValue(self, ctx:amlParser.IntValueContext):
        pass

    # Exit a parse tree produced by amlParser#intValue.
    def exitIntValue(self, ctx:amlParser.IntValueContext):
        pass


    # Enter a parse tree produced by amlParser#floatValue.
    def enterFloatValue(self, ctx:amlParser.FloatValueContext):
        pass

    # Exit a parse tree produced by amlParser#floatValue.
    def exitFloatValue(self, ctx:amlParser.FloatValueContext):
        pass


    # Enter a parse tree produced by amlParser#number.
    def enterNumber(self, ctx:amlParser.NumberContext):
        pass

    # Exit a parse tree produced by amlParser#number.
    def exitNumber(self, ctx:amlParser.NumberContext):
        pass


    # Enter a parse tree produced by amlParser#stringValue.
    def enterStringValue(self, ctx:amlParser.StringValueContext):
        pass

    # Exit a parse tree produced by amlParser#stringValue.
    def exitStringValue(self, ctx:amlParser.StringValueContext):
        pass


    # Enter a parse tree produced by amlParser#tagValue.
    def enterTagValue(self, ctx:amlParser.TagValueContext):
        pass

    # Exit a parse tree produced by amlParser#tagValue.
    def exitTagValue(self, ctx:amlParser.TagValueContext):
        pass


    # Enter a parse tree produced by amlParser#identifierValue.
    def enterIdentifierValue(self, ctx:amlParser.IdentifierValueContext):
        pass

    # Exit a parse tree produced by amlParser#identifierValue.
    def exitIdentifierValue(self, ctx:amlParser.IdentifierValueContext):
        pass
