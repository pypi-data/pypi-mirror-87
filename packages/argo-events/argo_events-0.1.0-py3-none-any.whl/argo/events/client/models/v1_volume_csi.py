...
class V1VolumeCsi(object):
    ...
    openapi_types = {
        'driver': 'str',
        'fs_type': 'str',
        'node_publish_secret_ref': 'V1VolumeCephfsSecretRef',
        'read_only': 'bool',
    ...
    @property
    def driver(self):
        """Gets the driver of this V1VolumeCsi.  # noqa: E501
        ...
        :return: The driver of this V1VolumeCsi.  # noqa: E501
        :rtype: str
        """
        return self._driver
    ...
    def driver(self, driver):
        """Sets the driver of this V1VolumeCsi.

        Driver is the name of the CSI driver that handles this volume. Consult with your admin for the correct name as registered in the cluster.  # noqa: E501

        :param driver: The driver of this V1VolumeCsi.  # noqa: E501
        :type: str
        """
    ...
    @property
    def fs_type(self):
        """Gets the fs_type of this V1VolumeCsi.  # noqa: E501
        ...
        :return: The fs_type of this V1VolumeCsi.  # noqa: E501
        :rtype: str
        """
    ...
    def fs_type(self, fs_type):
        """Sets the fs_type of this V1VolumeCsi.

        Filesystem type to mount. Ex. \"ext4\", \"xfs\", \"ntfs\". If not provided, the empty value is passed to the associated CSI driver which will determine the default filesystem to apply.  # noqa: E501

        :param fs_type: The fs_type of this V1VolumeCsi.  # noqa: E501
        :type: str
        """
    ...
    def node_publish_secret_ref(self):
        """Gets the node_publish_secret_ref of this V1VolumeCsi.  # noqa: E501


        :return: The node_publish_secret_ref of this V1VolumeCsi.  # noqa: E501
    ...
    def node_publish_secret_ref(self, node_publish_secret_ref):
        """Sets the node_publish_secret_ref of this V1VolumeCsi.


        :param node_publish_secret_ref: The node_publish_secret_ref of this V1VolumeCsi.  # noqa: E501
    ...
    @property
    def read_only(self):
        """Gets the read_only of this V1VolumeCsi.  # noqa: E501

        Specifies a read-only configuration for the volume. Defaults to false (read/write).  # noqa: E501

        :return: The read_only of this V1VolumeCsi.  # noqa: E501
        :rtype: bool
        """
    ...
    def read_only(self, read_only):
        """Sets the read_only of this V1VolumeCsi.

        Specifies a read-only configuration for the volume. Defaults to false (read/write).  # noqa: E501

        :param read_only: The read_only of this V1VolumeCsi.  # noqa: E501
        :type: bool
        """
    ...
    def volume_attributes(self):
        """Gets the volume_attributes of this V1VolumeCsi.  # noqa: E501
        ...
        :return: The volume_attributes of this V1VolumeCsi.  # noqa: E501
        :rtype: dict(str, str)
        """
    ...
    def volume_attributes(self, volume_attributes):
        """Sets the volume_attributes of this V1VolumeCsi.

        VolumeAttributes stores driver-specific properties that are passed to the CSI driver. Consult your driver's documentation for supported values.  # noqa: E501

        :param volume_attributes: The volume_attributes of this V1VolumeCsi.  # noqa: E501
        :type: dict(str, str)
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, V1VolumeCsi):
            return False
