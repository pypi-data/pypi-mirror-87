...
#   self.cw('{NULL}};')
        ...
        # --- This routine initializes the pkg object. This is separated from the init package
        ...
        self.cw('  PyModule_AddObject(module, "' + self.pkgname + '", (PyObject *)' + self.pkgname + 'Object);')
