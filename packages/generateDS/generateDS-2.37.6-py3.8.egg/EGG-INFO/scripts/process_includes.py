...
def fix_top_level_simpletype_elements(root, rename_data):
    ...
    for e in el_decls:
        ...
        create_complex_simplecontent_item(
            root, orig_name, st.get('name'), prefix, rename_data)


def create_complex_simplecontent_item(
        root, ct_name, st_name, prefix, rename_data):
