...
class ModelDefinition(WMLResource):
    ...
    def update(self, model_definition_id, meta_props=None, file_path=None):
        """
            ...
            :param model_definition_id:  model_definition ID
    ...
    def create_revision(self, model_definition_uid):
        """
           ...
           :param model_definition: model_definition ID. Mandatory
           :type model_definition: {str_type}
    ...
    def get_revision_details(self, model_definition_uid, rev_uid=None):
        """
           ...
           :param model_definition_uid: model_definition ID. Mandatory
           :type model_definition_uid: {str_type}
