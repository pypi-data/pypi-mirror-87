...
class _PrivateModels:
    ...
    class Forecasting:
        ...
        # Add ExponentialSmoothing model name after it is added to forecasting_models
...
class ModelClassNames:
    ...
    class ForecastingModelClassNames(RegressionModelClassNames):
        ...
        AutoArima = 'AutoArima'
        Average = 'Average'
        # Add ExponentialSmoothing class name after it is added to forecasting_models
        # ExponentialSmoothing = 'ExponentialSmoothing'
        Naive = 'Naive'
        Prophet = 'Prophet'
        SeasonalAverage = 'SeasonalAverage'
...
class _PrivateModelNames:
    ...
    """
    # Example of adding new model to the list:
    # PrivateForecastingModelList = [
    #     ModelName(
    #         _PrivateModels.Forecasting.ExponentialSmoothing,
    #         None,
...
class TelemetryConstants:
    ...
    # Setup
    FeaturizationStrategy = "automl.featurization-strategy"
    FeaturizationStrategyUserFacingName = "Deciding featurization actions"
    DataFetch = "automl.data-fetch"
    DataFetchUserFacingName = "Fetching input data"
    DataValidation = "automl.data-validation"
    DataValidationUserFacingName = "Validating input data"

    # Featurization Status
    Featurization = "automl.featurization"
    FeaturizationUserFacingName = "Featurizing data"

    # Training
    Training = "automl.training"
    TrainingUserFacingName = "Training model"
    Validation = "automl.validation"
    ValidationUserFacingName = "Validating model quality"
    MetadataUploading = "automl.metadata-uploading"
    MetadataUploadingUserFacingName = "Uploading run output metadata"
