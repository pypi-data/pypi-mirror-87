...
from ...models.custom_entity_unarchive_request import CustomEntityUnarchiveRequest
...
def _get_kwargs(
    *,
    client: Client,
    json_body: CustomEntityUnarchiveRequest,
) -> Dict[str, Any]:
    url = "{}/custom-entities:unarchive".format(client.base_url)
