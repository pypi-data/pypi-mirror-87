...
from miwork.api_app_link import APIAppLinkMixin
from miwork.api_application import APIApplicationMixin
from miwork.api_approval import APIApprovalMixin
from miwork.api_bot import APIBotMixin
from miwork.api_calendar import APICalendarMixin
from miwork.api_callback import APICallbackMixin
from miwork.api_chat import APIChatMixin
from miwork.api_contact import APIContactMixin
from miwork.api_drive_comment import APIDriveCommentMixin
from miwork.api_drive_doc import APIDriveDocMixin
from miwork.api_drive_file import APIDriveFileMixin
from miwork.api_drive_folder import APIDriveFolderMixin
from miwork.api_drive_permission import APIDrivePermissionMixin
from miwork.api_drive_sheet import APIDriveSheetMixin
from miwork.api_drive_suite import APIDriveSuiteMixin
from miwork.api_duty import APIDutyMixin
from miwork.api_file import APIFileMixin
from miwork.api_id import APIIDMixin
from miwork.api_image import APIImageMixin
from miwork.api_meeting_room import APIMeetingRoomMixin
from miwork.api_message import APIMessageMixin
from miwork.api_mina import APIMinaMixin
from miwork.api_oauth import APIOAuthMixin
from miwork.api_pay import APIPayMixin
from miwork.api_user import APIUserMixin
from miwork.exception import LarkGetAppTicketFail, LarkInvalidArguments, LarkUnknownError, gen_exception
from miwork.helper import to_native
from miwork.internal_cache import _Cache

logger = logging.getLogger('open_lark')
...
class OpenLark(APIIDMixin,
    ...
    def _gen_request_url(self, path, app='normal'):
        ...
        hosts = {
            ...
            0: {
                # online
                1: {
                    'normal': 'https://open.f.mioffice.cn',  # 'https://open.feishu.cn',
    ...
    def tenant_access_token(self):
        ...
        key_token = 'open_lark:tenant_token:{}:{}'.format(self.app_id, self.tenant_key)
