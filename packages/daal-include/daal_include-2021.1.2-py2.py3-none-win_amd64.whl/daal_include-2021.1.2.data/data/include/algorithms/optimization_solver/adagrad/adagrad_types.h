 ...
 *
 * \snippet optimization_solver/adagrad/adagrad_types.h interface1::Parameter source code
 */
...
* \brief %Input class for the Adaptive gradient descent algorithm    \DAAL_DEPRECATED
*
* \snippet optimization_solver/adagrad/adagrad_types.h interface1::Input source code
*/
...
* \brief Results obtained with the compute() method of the adagrad algorithm in the batch processing mode    \DAAL_DEPRECATED
*/
