 ...
 *  \brief Class containing methods to compute naive Bayes training results   \DAAL_DEPRECATED
 *
 ...
 *  \brief Algorithm class for training the naive Bayes model   \DAAL_DEPRECATED
