...
class GetConnectorsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [GetConnectors.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.16.28/reference/services/sms.html#SMS.Paginator.GetConnectors.paginate)
        """
...
class GetReplicationJobsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [GetReplicationJobs.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.16.28/reference/services/sms.html#SMS.Paginator.GetReplicationJobs.paginate)
        """
...
class GetReplicationRunsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [GetReplicationRuns.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.16.28/reference/services/sms.html#SMS.Paginator.GetReplicationRuns.paginate)
        """
...
class GetServersPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [GetServers.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.16.28/reference/services/sms.html#SMS.Paginator.GetServers.paginate)
        """
...
class ListAppsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListApps.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.16.28/reference/services/sms.html#SMS.Paginator.ListApps.paginate)
        """
