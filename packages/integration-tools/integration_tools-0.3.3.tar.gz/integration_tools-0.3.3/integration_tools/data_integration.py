        ...
        for configuration in self.configuration_list:
            ...
            while not stop:
                ...
                for patient_train_batch in self.xy_train_dataloader:
                    field0_batch, field1_batch = patient_train_batch['FIELD0'].squeeze(), patient_train_batch['FIELD1'].squeeze()
                ...
                with torch.no_grad():
                    ...
                    for validation_patient_batch in self.xy_validation_dataloader:
                        field0_batch, field1_batch = validation_patient_batch['FIELD0'].squeeze(), validation_patient_batch[
                            'FIELD1'].squeeze()
