...
#   `tensorflow_probability/substrates/numpy/experimental/util/__init__.py`
...
# from tensorflow_probability.substrates.numpy.experimental.util.deferred_module import DeferredModule
