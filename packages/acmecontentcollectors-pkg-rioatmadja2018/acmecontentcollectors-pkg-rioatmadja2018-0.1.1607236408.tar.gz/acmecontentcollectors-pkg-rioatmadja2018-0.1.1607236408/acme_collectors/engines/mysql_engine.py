...
class MySQLEngine(object):
    ...
    def __init__(self, credentials_path: str):
        ...
        self.host: str = os.getenv('MYSQL_SERVER')
        self.port: str = os.getenv('MYSQL_PORT')
        self.user: str = os.getenv('MYSQL_USER')
        self.root_user: str = os.getenv('MYSQL_ROOT_USER')
    ...
    def mysql_connection(self, user: str = 'root') -> Connection:
        ...
        try:
            conn = pymysql.connect(host=self.host, user=user, passwd=self.passwd, db=self.db)
            return conn
