...
class Torque(wx.Panel):
    ...
    def __set_properties(self):
        ...
        self.text_ctrl_power_in.SetMinSize((160, 36))
        self.SetBackgroundColour(wx.Colour(40, 40, 40))
        self.SetForegroundColour(wx.Colour(255, 255, 255))
        self.SetFont(self.font_16)
        self.text_ctrl_power_in.SetFont(self.font_14)
        self.text_ctrl_rpm_in.SetFont(self.font_14)
        self.text_ctrl_torque_out.SetFont(self.font_14)
        self.text_ctrl_torque_out_metric.SetFont(self.font_14)

    def __do_layout(self):
        main_sizer = wx.BoxSizer(wx.VERTICAL)
        grid_sizer_1 = wx.FlexGridSizer(7, 3, 4, 4)
        # The first row is blank for spacing
        grid_sizer_1.Add((90, 10), 0, 0, 0)
        grid_sizer_1.Add((0, 0), 0, 0, 0)
        grid_sizer_1.Add((0, 0), 0, 0, 0)
        grid_sizer_1.Add((60, 26), 0, 0, 0)
        label_1 = wx.StaticText(self, wx.ID_ANY, "Torque")
        grid_sizer_1.Add(label_1, 0, wx.ALIGN_CENTER_VERTICAL, 0)
        grid_sizer_1.Add((0, 0), 0, 0, 0)
        label_2 = wx.StaticText(self, wx.ID_ANY, "Power")
        ...
        grid_sizer_1.Add(self.text_ctrl_rpm_in, 0, wx.EXPAND | wx.ALIGN_CENTER_VERTICAL, 0)
        grid_sizer_1.Add((0, 0), 0, 0, 0)
        label_5 = wx.StaticText(self, wx.ID_ANY, "Torque")
        grid_sizer_1.Add(label_5, 0, wx.ALIGN_RIGHT | wx.ALIGN_CENTER_VERTICAL, 0)
        grid_sizer_1.Add(self.text_ctrl_torque_out, 0, wx.EXPAND | wx.ALIGN_CENTER_VERTICAL, 0)
        ...
        grid_sizer_1.Add(label_8, 0, wx.EXPAND | wx.ALIGN_CENTER_VERTICAL, 0)
    ...
    def on_torque_calculate(self, event):  # wxGlade: MyFrame.<event_handler>
        ...
        if str_power:
            # Maker sure str_power contains only decimal numbers and decimals '.'
            for character in str_power:
                if not (character.isdigit() or character == '.'):
                    index = str_power.find(character)
                    str_power = str_power[0:index] + str_power[(index + 1):]
