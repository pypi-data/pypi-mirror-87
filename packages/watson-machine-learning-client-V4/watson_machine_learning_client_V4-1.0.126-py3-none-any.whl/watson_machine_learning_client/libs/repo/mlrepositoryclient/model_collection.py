...
class ModelCollection:
    ...
    def upload_content(self,model_artifact, query_param):
        self._upload_pipeline_model_content(model_artifact, query_param)
    ...
    def _upload_pipeline_model_content(self, model_artifact, query_param=None):
        ...
        if query_param is not None:
            for key in query_param:
                if (key != 'async' and key != 'space_id' and key != 'project_id'):
