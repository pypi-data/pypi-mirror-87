...
class DAXClient:
    """
    [DAX.Client documentation](https://boto3.amazonaws.com/v1/documentation/api/1.16.28/reference/services/dax.html#DAX.Client)
    """
    ...
    def can_paginate(self, operation_name: str) -> bool:
        """
        [Client.can_paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.16.28/reference/services/dax.html#DAX.Client.can_paginate)
        """
    ...
    def create_cluster(
        ...
        """
        [Client.create_cluster documentation](https://boto3.amazonaws.com/v1/documentation/api/1.16.28/reference/services/dax.html#DAX.Client.create_cluster)
        """
    ...
    def create_parameter_group(
        ...
        """
        [Client.create_parameter_group documentation](https://boto3.amazonaws.com/v1/documentation/api/1.16.28/reference/services/dax.html#DAX.Client.create_parameter_group)
        """
    ...
    def create_subnet_group(
        ...
        """
        [Client.create_subnet_group documentation](https://boto3.amazonaws.com/v1/documentation/api/1.16.28/reference/services/dax.html#DAX.Client.create_subnet_group)
        """
    ...
    def decrease_replication_factor(
        ...
        """
        [Client.decrease_replication_factor documentation](https://boto3.amazonaws.com/v1/documentation/api/1.16.28/reference/services/dax.html#DAX.Client.decrease_replication_factor)
        """

    def delete_cluster(self, ClusterName: str) -> DeleteClusterResponseTypeDef:
        """
        [Client.delete_cluster documentation](https://boto3.amazonaws.com/v1/documentation/api/1.16.28/reference/services/dax.html#DAX.Client.delete_cluster)
        """
    ...
    def delete_parameter_group(
        ...
        """
        [Client.delete_parameter_group documentation](https://boto3.amazonaws.com/v1/documentation/api/1.16.28/reference/services/dax.html#DAX.Client.delete_parameter_group)
        """

    def delete_subnet_group(self, SubnetGroupName: str) -> DeleteSubnetGroupResponseTypeDef:
        """
        [Client.delete_subnet_group documentation](https://boto3.amazonaws.com/v1/documentation/api/1.16.28/reference/services/dax.html#DAX.Client.delete_subnet_group)
        """
    ...
    def describe_clusters(
        ...
        """
        [Client.describe_clusters documentation](https://boto3.amazonaws.com/v1/documentation/api/1.16.28/reference/services/dax.html#DAX.Client.describe_clusters)
        """
    ...
    def describe_default_parameters(
        ...
        """
        [Client.describe_default_parameters documentation](https://boto3.amazonaws.com/v1/documentation/api/1.16.28/reference/services/dax.html#DAX.Client.describe_default_parameters)
        """
    ...
    def describe_events(
        ...
        """
        [Client.describe_events documentation](https://boto3.amazonaws.com/v1/documentation/api/1.16.28/reference/services/dax.html#DAX.Client.describe_events)
        """
    ...
    def describe_parameter_groups(
        ...
        """
        [Client.describe_parameter_groups documentation](https://boto3.amazonaws.com/v1/documentation/api/1.16.28/reference/services/dax.html#DAX.Client.describe_parameter_groups)
        """
    ...
    def describe_parameters(
        ...
        """
        [Client.describe_parameters documentation](https://boto3.amazonaws.com/v1/documentation/api/1.16.28/reference/services/dax.html#DAX.Client.describe_parameters)
        """
    ...
    def describe_subnet_groups(
        ...
        """
        [Client.describe_subnet_groups documentation](https://boto3.amazonaws.com/v1/documentation/api/1.16.28/reference/services/dax.html#DAX.Client.describe_subnet_groups)
        """
    ...
    def generate_presigned_url(
        ...
        """
        [Client.generate_presigned_url documentation](https://boto3.amazonaws.com/v1/documentation/api/1.16.28/reference/services/dax.html#DAX.Client.generate_presigned_url)
        """
    ...
    def increase_replication_factor(
        ...
        """
        [Client.increase_replication_factor documentation](https://boto3.amazonaws.com/v1/documentation/api/1.16.28/reference/services/dax.html#DAX.Client.increase_replication_factor)
        """

    def list_tags(self, ResourceName: str, NextToken: str = None) -> ListTagsResponseTypeDef:
        """
        [Client.list_tags documentation](https://boto3.amazonaws.com/v1/documentation/api/1.16.28/reference/services/dax.html#DAX.Client.list_tags)
        """

    def reboot_node(self, ClusterName: str, NodeId: str) -> RebootNodeResponseTypeDef:
        """
        [Client.reboot_node documentation](https://boto3.amazonaws.com/v1/documentation/api/1.16.28/reference/services/dax.html#DAX.Client.reboot_node)
        """
    ...
    def tag_resource(
        ...
        """
        [Client.tag_resource documentation](https://boto3.amazonaws.com/v1/documentation/api/1.16.28/reference/services/dax.html#DAX.Client.tag_resource)
        """

    def untag_resource(self, ResourceName: str, TagKeys: List[str]) -> UntagResourceResponseTypeDef:
        """
        [Client.untag_resource documentation](https://boto3.amazonaws.com/v1/documentation/api/1.16.28/reference/services/dax.html#DAX.Client.untag_resource)
        """
    ...
    def update_cluster(
        ...
        """
        [Client.update_cluster documentation](https://boto3.amazonaws.com/v1/documentation/api/1.16.28/reference/services/dax.html#DAX.Client.update_cluster)
        """
    ...
    def update_parameter_group(
        ...
        """
        [Client.update_parameter_group documentation](https://boto3.amazonaws.com/v1/documentation/api/1.16.28/reference/services/dax.html#DAX.Client.update_parameter_group)
        """
    ...
    def update_subnet_group(
        ...
        """
        [Client.update_subnet_group documentation](https://boto3.amazonaws.com/v1/documentation/api/1.16.28/reference/services/dax.html#DAX.Client.update_subnet_group)
        """
