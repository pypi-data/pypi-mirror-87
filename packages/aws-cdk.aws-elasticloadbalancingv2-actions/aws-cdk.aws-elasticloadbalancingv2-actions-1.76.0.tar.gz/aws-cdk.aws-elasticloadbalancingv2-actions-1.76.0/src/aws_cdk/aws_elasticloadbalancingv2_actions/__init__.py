...
class AuthenticateCognitoAction(
    ...
    def __init__(
        self,
        *,
        next: aws_cdk.aws_elasticloadbalancingv2.ListenerAction,
        user_pool: aws_cdk.aws_cognito.IUserPool,
        user_pool_client: aws_cdk.aws_cognito.IUserPoolClient,
        user_pool_domain: aws_cdk.aws_cognito.IUserPoolDomain,
        authentication_request_extra_params: typing.Optional[typing.Mapping[builtins.str, builtins.str]] = None,
        on_unauthenticated_request: typing.Optional[aws_cdk.aws_elasticloadbalancingv2.UnauthenticatedAction] = None,
...
class AuthenticateCognitoActionProps:
    ...
    def on_unauthenticated_request(
        self,
    ) -> typing.Optional[aws_cdk.aws_elasticloadbalancingv2.UnauthenticatedAction]:
