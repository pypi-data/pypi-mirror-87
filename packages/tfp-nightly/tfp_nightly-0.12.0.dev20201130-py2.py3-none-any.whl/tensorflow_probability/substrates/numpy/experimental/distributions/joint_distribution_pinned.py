...
#   `tensorflow_probability/substrates/numpy/experimental/distributions/joint_distribution_pinned.py`
...
from tensorflow_probability.substrates.numpy.distributions import joint_distribution
...
class JointDistributionPinned(object):
  ...
  * `sample_unpinned`, `sample_weighted`
  ...
  uniform_init = tf.nest.map_structure(
      lambda s: tf.random.stateless_uniform(tf.concat([[batch], s], axis=0), -2., 2.),
      pulled_back_shape)
