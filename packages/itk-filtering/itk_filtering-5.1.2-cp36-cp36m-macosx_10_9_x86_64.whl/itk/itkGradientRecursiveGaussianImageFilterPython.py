...
class itkGradientRecursiveGaussianImageFilterID2ICVF22(itk.itkImageToImageFilterBPython.itkImageToImageFilterID2ICVF22):
    ...
    example{Filtering/ImageGradient/ApplyGradientRecursiveGaussianWithV
    ectorInput,Apply GradientRecursiveGaussianImageFilter on Image with
    Vector type}
    example{Filtering/ImageGradient/ImplementationOfSnakes,Implementation
    Of Snakes} 
    """
