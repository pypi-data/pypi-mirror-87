...
class TransactionStatusRoutesApi(object):
    ...
    def get_transaction_statuses(self, transaction_hashes, **kwargs):  # noqa: E501
        """Get transaction statuses  # noqa: E501

        Returns an array of transaction statuses for a given array of transaction hashes.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_transaction_statuses(transaction_hashes, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.get_transaction_statuses_with_http_info(transaction_hashes, **kwargs)  # noqa: E501

    def get_transaction_statuses_with_http_info(self, transaction_hashes, **kwargs):  # noqa: E501
        """Get transaction statuses  # noqa: E501

        Returns an array of transaction statuses for a given array of transaction hashes.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_transaction_statuses_with_http_info(transaction_hashes, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('transaction_hashes' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `transaction_hashes` when calling `get_transaction_statuses`")  # noqa: E501
