...
class Store:
    ...
    def join(
        self, other: Store, *, mapping: Optional[Mapping[str, str]] = None,
    ):
        ...
        * ``no_measures``: All of the non-numeric columns from the destination store, as well as those containing integers, will be converted into hierarchies.
          No measures will be created in this mode.
        * ``auto``: The same hierarchies will be created as in the ``no_measures`` mode.
          Additionaly, columns containing numeric values, or arrays, except for columns which contain only integers, will be converted into measures.
        ...
        self._java_api.create_join(
            store=self, other_store=other, mappings=mapping,
        )
    ...
    def load_spark(
        ...
        *,
        ...
        self.load_parquet(
            parquet_file, in_all_scenarios=in_all_scenarios, truncate=truncate,
        )
