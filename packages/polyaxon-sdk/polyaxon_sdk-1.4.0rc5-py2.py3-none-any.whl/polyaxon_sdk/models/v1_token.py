...
class V1Token(object):
    ...
    def __init__(self, uuid=None, key=None, name=None, scopes=None, services=None, started_at=None, expires_at=None, created_at=None, updated_at=None, local_vars_configuration=None):  # noqa: E501
