...
class AgentsV1Api(object):
    ...
    def delete_agent(self, owner, uuid, **kwargs):  # noqa: E501
        ...
        :param str owner: Owner of the namespace (required)
        :param str uuid: Uuid identifier of the entity (required)
        :param str entity: Owner of the namespace.
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
    ...
    def get_agent_statuses(self, owner, uuid, **kwargs):  # noqa: E501
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.get_agent_statuses_with_http_info(owner, uuid, **kwargs)  # noqa: E501
    ...
    def get_agent_statuses_with_http_info(self, owner, uuid, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('owner' not in local_var_params or  # noqa: E501
                                                        local_var_params['owner'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `owner` when calling `get_agent_statuses`")  # noqa: E501
        # verify the required parameter 'uuid' is set
        if self.api_client.client_side_validation and ('uuid' not in local_var_params or  # noqa: E501
                                                        local_var_params['uuid'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `uuid` when calling `get_agent_statuses`")  # noqa: E501
