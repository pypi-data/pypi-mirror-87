...
class IRoadmapDataProvider(Interface):
    """Extension point for preparing and filtering data used to create the roadmap page."""

    def add_data(self, req, data):
        """Add data to or remove data from the data dictionary. Returns the modified data dictionary."""
