...
class SubscriptionsApi(object):
    ...
    def get_channels_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api('/subscriptions', 'GET',
                                        ...
                                        response_type='GetChannelsOutputV1',
    ...
    def update_subscription(self, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.update_subscription(channel_id=channel_id_value, body=body_value, callback=callback_function)
    ...
    def update_subscription_with_http_info(self, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.update_subscription_with_http_info(channel_id=channel_id_value, body=body_value, callback=callback_function)
