...
_VALUE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='pickled', full_name='Value.pickled', index=25,
  ...
  nested_types=[_VALUE_LIST, _VALUE_SLICE, _VALUE_DICT, _VALUE_COMPLEX, _VALUE_KEY, _VALUE_TYPEDVALUE, _VALUE_INTERVALARRAY, ],
  enum_types=[
  ],
  serialized_options=None,
  is_extendable=False,
...
Value = _reflection.GeneratedProtocolMessageType('Value', (_message.Message,), dict(
  ...
  IntervalArray = _reflection.GeneratedProtocolMessageType('IntervalArray', (_message.Message,), dict(
