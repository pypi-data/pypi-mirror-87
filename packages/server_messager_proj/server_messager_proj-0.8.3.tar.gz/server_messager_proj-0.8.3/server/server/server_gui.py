...
from server.server.server.start_window import StatWindow
from server.server.server.config_window import ConfigWindow
from server.server.server.add_user import RegisterUser
from server.server.server.remove_user import DelUserDialog
...
class MainWindow(QMainWindow):
    ...
    def __init__(self, database, server, config):
        ...
        # Статусбар
        self.statusBar()
        self.statusBar().showMessage('Server activate')
        ...
        self.setWindowTitle('Testing messager.Server interface')
    ...
    def create_users_model(self):
        '''Таблица активных пользователй'''
        list_users = self.database.active_users()
