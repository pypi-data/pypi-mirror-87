...
from yolov5processor.utils.google_utils import gsutil_getsize
from yolov5processor.utils.torch_utils import init_seeds as init_torch_seeds
...
def kmean_anchors(path='./data/coco128.yaml', n=9, img_size=640, thr=4.0, gen=1000, verbose=True):
    ...
    if isinstance(path, str):  # *.yaml file
        ...
        from yolov5processor.utils.datasets import LoadImagesAndLabels
