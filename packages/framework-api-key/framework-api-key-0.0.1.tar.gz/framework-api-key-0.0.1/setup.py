...
setup(
    name="framework-api-key",
    version=get_version("framework_api_key"),
    description="API key permissions for the Django REST Framework",
    long_description=get_long_description(),
    long_description_content_type="text/markdown",
    url="https://github.com/souheyltoumi",
    author="souheil.toumi14",
    author_email="souheil.toumi14@gmail.com",
