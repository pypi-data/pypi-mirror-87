...
class Configuration(object):
    ...
    :param signing_info: Configuration parameters for HTTP signature.
        Must be an instance of agilicus_api.signing.HttpSigningConfiguration
    ...
    You can programmatically set the cookie:
      conf = agilicus_api.Configuration(
    ...
    Note you can use the constants defined in the agilicus_api.signing module, and you can
    ...
    are not going to be modified in transit.
      ...
      conf = agilicus_api.Configuration(
        signing_info = agilicus_api.signing.HttpSigningConfiguration(
            key_id =                 'my-key-id',
    ...
    def __init__(self, host="https://api.agilicus.com",
    ...
    def to_debug_report(self):
        ...
        return "Python SDK Debug Report:\n"\
               ...
               "Version of the API: 2020.12.03\n"\
               "SDK Package Version: 1.80.9".\
