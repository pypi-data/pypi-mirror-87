...
from ...models.aa_sequence_list import AaSequenceList
...
def _parse_response(*, response: httpx.Response) -> Optional[Union[AaSequenceList, BadRequestError]]:
    if response.status_code == 200:
        return AaSequenceList.from_dict(cast(Dict[str, Any], response.json()))
    if response.status_code == 400:
        return BadRequestError.from_dict(cast(Dict[str, Any], response.json()))
    return None


def _build_response(*, response: httpx.Response) -> Response[Union[AaSequenceList, BadRequestError]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    mentions: Optional[List[str]] = None,
    ids: Optional[str] = None,
) -> Response[Union[AaSequenceList, BadRequestError]]:
    kwargs = _get_kwargs(
        client=client,
        page_size=page_size,
...
def sync(
    *,
    ...
    mentions: Optional[List[str]] = None,
    ids: Optional[str] = None,
) -> Optional[Union[AaSequenceList, BadRequestError]]:
    """ List AA sequences """
