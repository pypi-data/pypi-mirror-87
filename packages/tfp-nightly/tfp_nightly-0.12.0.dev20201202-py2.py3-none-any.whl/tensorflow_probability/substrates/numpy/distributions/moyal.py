...
#   `tensorflow_probability/substrates/numpy/distributions/moyal.py`
...
from tensorflow_probability.substrates.numpy.bijectors import moyal_cdf as moyal_cdf_bijector
