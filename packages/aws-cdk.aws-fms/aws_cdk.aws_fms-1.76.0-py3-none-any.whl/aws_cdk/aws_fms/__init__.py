...
class CfnNotificationChannel(
    ...
    @sns_role_name.setter # type: ignore
...
class CfnPolicy(
    ...
    @exclude_resource_tags.setter # type: ignore
    def exclude_resource_tags(
        self,
    ...
    @remediation_enabled.setter # type: ignore
    def remediation_enabled(
        self,
        value: typing.Union[builtins.bool, aws_cdk.core.IResolvable],
    ) -> None:
    ...
    @security_service_policy_data.setter # type: ignore
    ...
    @delete_all_policy_resources.setter # type: ignore
    def delete_all_policy_resources(
        self,
    ...
    @exclude_map.setter # type: ignore
    def exclude_map(
        self,
    ...
    @include_map.setter # type: ignore
    def include_map(
        self,
        value: typing.Optional[typing.Union[aws_cdk.core.IResolvable, "CfnPolicy.IEMapProperty"]],
    ) -> None:
    ...
    @resource_type_list.setter # type: ignore
