...
setup(
    ...
    description="Type annotations for boto3.AutoScalingPlans 1.16.28 service, generated by mypy-boto3-buider 4.1.3",
    classifiers=[
    ...
    keywords="boto3 autoscaling-plans type-annotations boto3-stubs mypy typeshed autocomplete auto-generated",
