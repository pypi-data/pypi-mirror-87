...
snake_case_functions = ('masked_fft_normalized_correlation_image_filter', 'convolution_image_filter_base', 'fft_convolution_image_filter', 'convolution_image_filter', 'fft_normalized_correlation_image_filter', )
