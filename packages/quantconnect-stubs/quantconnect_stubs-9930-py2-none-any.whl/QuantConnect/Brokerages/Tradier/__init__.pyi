...
QuantConnect_Brokerages_Tradier_TradierBrokerage_T = typing.TypeVar('QuantConnect_Brokerages_Tradier_TradierBrokerage_T')
...
class TradierUserAccount(System.Object):
    ...
    @property
    def Status(self) -> QuantConnect.Brokerages.Tradier.TradierAccountStatus:
        ...

    @Status.setter
    def Status(self, value: QuantConnect.Brokerages.Tradier.TradierAccountStatus):
        ...

    @property
    def Classification(self) -> QuantConnect.Brokerages.Tradier.TradierAccountClassification:
        ...

    @Classification.setter
    def Classification(self, value: QuantConnect.Brokerages.Tradier.TradierAccountClassification):
        ...
...
class TradierBrokerage(QuantConnect.Brokerages.Brokerage, QuantConnect.Interfaces.IDataQueueHandler, QuantConnect.Interfaces.IHistoryProvider):
    ...
    class TradierPlaceOrderRequest(System.Object):
        """This class has no documentation."""
        ...
        @QCOrder.setter
        def QCOrder(self, value: QuantConnect.Orders.Order):
            ...

        @property
        def Classification(self) -> QuantConnect.Brokerages.Tradier.TradierOrderClass:
            ...

        @Classification.setter
        def Classification(self, value: QuantConnect.Brokerages.Tradier.TradierOrderClass):
            ...
        ...
        def __init__(self, order: QuantConnect.Orders.Order, classification: QuantConnect.Brokerages.Tradier.TradierOrderClass, holdingQuantity: float) -> None:
            ...

        def ConvertStopOrderTypes(self) -> None:
            ...
    ...
    @property
    def SessionRefreshed(self) -> typing.List[System_EventHandler]:
        """Event fired when our session has been refreshed/tokens updated"""
        ...

    @SessionRefreshed.setter
    def SessionRefreshed(self, value: typing.List[System_EventHandler]):
        """Event fired when our session has been refreshed/tokens updated"""
        ...
    ...
    def __init__(self, orderProvider: QuantConnect.Securities.IOrderProvider, securityProvider: QuantConnect.Securities.ISecurityProvider, aggregator: QuantConnect.Data.IDataAggregator, accountID: str) -> None:
        """Create a new Tradier Object:"""
        ...

    def SetTokens(self, userId: int, accessToken: str, refreshToken: str, issuedAt: datetime.datetime, lifeSpan: datetime.timedelta) -> None:
        ...

    def Execute(self, request: typing.Any, type: QuantConnect.Brokerages.Tradier.TradierApiRequestType, rootName: str = ..., attempts: int = 0, max: int = 10) -> QuantConnect_Brokerages_Tradier_TradierBrokerage_T:
    ...
    def GetBalanceDetails(self, accountId: str) -> QuantConnect.Brokerages.Tradier.TradierBalanceDetails:
        """
    ...
    def GetAccountEvents(self, accountId: int) -> System.Collections.Generic.List[QuantConnect.Brokerages.Tradier.TradierEvent]:
        """Get a list of historical events for this account:"""
        ...

    def GetGainLoss(self, accountId: int) -> System.Collections.Generic.List[QuantConnect.Brokerages.Tradier.TradierGainLoss]:
    ...
    @typing.overload
    def PlaceOrder(self, accountId: str, classification: QuantConnect.Brokerages.Tradier.TradierOrderClass, direction: QuantConnect.Brokerages.Tradier.TradierOrderDirection, symbol: str, quantity: float, price: float = 0, stop: float = 0, optionSymbol: str = ..., type: QuantConnect.Brokerages.Tradier.TradierOrderType = ..., duration: QuantConnect.Brokerages.Tradier.TradierOrderDuration = ...) -> QuantConnect.Brokerages.Tradier.TradierOrderResponse:
        """
    ...
    def ChangeOrder(self, accountId: str, orderId: int, type: QuantConnect.Brokerages.Tradier.TradierOrderType = ..., duration: QuantConnect.Brokerages.Tradier.TradierOrderDuration = ..., price: float = 0, stop: float = 0) -> QuantConnect.Brokerages.Tradier.TradierOrderResponse:
        """Update an exiting Tradier Order:"""
        ...

    @typing.overload
    def CancelOrder(self, accountId: str, orderId: int) -> QuantConnect.Brokerages.Tradier.TradierOrderResponse:
    ...
    def OnSessionRefreshed(self, e: QuantConnect.Brokerages.Tradier.TokenResponse) -> None:
        """
    ...
    @typing.overload
    def ConvertOrderType(self, type: QuantConnect.Orders.OrderType) -> QuantConnect.Brokerages.Tradier.TradierOrderType:
        """
    ...
    @typing.overload
    def ConvertStatus(self, status: QuantConnect.Brokerages.Tradier.TradierOrderStatus) -> QuantConnect.Orders.OrderStatus:
        """
    ...
    @typing.overload
    def ConvertStatus(self, status: QuantConnect.Orders.OrderStatus) -> QuantConnect.Brokerages.Tradier.TradierOrderStatus:
        """
    ...
    @staticmethod
    def ConvertDirection(direction: QuantConnect.Orders.OrderDirection, holdingQuantity: float) -> QuantConnect.Brokerages.Tradier.TradierOrderDirection:
        """
    ...
    @staticmethod
    def GetOrderDuration(timeInForce: QuantConnect.Orders.TimeInForce) -> QuantConnect.Brokerages.Tradier.TradierOrderDuration:
        """
    ...
    @staticmethod
    @typing.overload
    def ConvertOrderType(order: QuantConnect.Orders.Order) -> QuantConnect.Brokerages.Tradier.TradierOrderType:
        """
        Converts the qc order type into a tradier order type
...
class TradierBrokerageFactory(QuantConnect.Brokerages.BrokerageFactory):
    ...
    @staticmethod
    def GetTokens() -> QuantConnect.Brokerages.Tradier.TokenResponse:
        """Reads the tradier tokens from the TokensFile or from configuration"""
        ...
