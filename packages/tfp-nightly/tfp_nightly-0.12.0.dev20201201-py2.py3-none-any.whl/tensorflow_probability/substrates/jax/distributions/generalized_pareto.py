...
#   `tensorflow_probability/substrates/jax/distributions/generalized_pareto.py`
...
from tensorflow_probability.substrates.jax.bijectors import generalized_pareto as generalized_pareto_bijector
