...
class FormulaItemInputV1(object):
    ...
    def __init__(self, additional_properties=None, data_id=None, data_version_check=None, datasource_class=None, datasource_id=None, description=None, formula=None, host_id=None, name=None, package_name=None, parameters=None, scoped_to=None, security_string=None, source_security_string=None, sync_token=None, type=None):
        """
