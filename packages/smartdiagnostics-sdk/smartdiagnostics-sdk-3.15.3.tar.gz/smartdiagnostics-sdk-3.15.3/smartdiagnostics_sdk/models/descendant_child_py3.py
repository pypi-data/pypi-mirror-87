...
class DescendantChild(Model):
    ...
    def __init__(self, *, child_id: str=None, child_name: str=None, child_abbreviation: str=None, child_type: str=None, child_sort_order: int=None, child_has_children: bool=None, child_alarm_severity_level: int=None, child_is_paused: bool=None, child_is_snoozed: bool=None, **kwargs) -> None:
