...
from .device import LiteApi, MagicBoxApi, MagicianApi, MagicianGoApi, M1Api
import requests
import json
import sounddevice
import soundfile
...
class DobotEDU(object):
    ...
    @portname.setter
    def portname(self, port_name: str):
        ...
        self.__m1_api._port_name = port_name
