...
class itkAtan2ImageFilterID2ID2ID2(itk.itkBinaryGeneratorImageFilterPython.itkBinaryGeneratorImageFilterID2ID2ID2):
    ...
    example{Filtering/ImageIntensity/ApplyAtanImageFilter,Apply Atan Image
    Filter} 
    """
...
def atan2_image_filter_init_docstring():
    ...
    if isinstance(itk.Atan2ImageFilter, itkTemplate.itkTemplate):
        atan2_image_filter.__doc__ += itkHelpers.filter_args(filter_object)[0]
        atan2_image_filter.__doc__ += "\n"
        atan2_image_filter.__doc__ += itkHelpers.filter_args(filter_object)[1]
    else:
