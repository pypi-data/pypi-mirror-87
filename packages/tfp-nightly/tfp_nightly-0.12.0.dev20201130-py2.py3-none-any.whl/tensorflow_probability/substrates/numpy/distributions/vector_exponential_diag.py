...
#   `tensorflow_probability/substrates/numpy/distributions/vector_exponential_diag.py`
...
from tensorflow_probability.substrates.numpy.distributions import vector_exponential_linear_operator as velo
