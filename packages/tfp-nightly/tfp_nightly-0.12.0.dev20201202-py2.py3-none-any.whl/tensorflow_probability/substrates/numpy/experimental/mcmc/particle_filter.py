...
#   `tensorflow_probability/substrates/numpy/experimental/mcmc/particle_filter.py`
...
from tensorflow_probability.substrates.numpy.experimental.mcmc import sequential_monte_carlo_kernel as smc_kernel
