...
cred_path = f"{dir}/creds/bak"
credentials = f"{cred_path}/p8_creds.json"
token = f"{cred_path}/p8_token.pickle"
...
group_credentials = f"{cred_path}/p8_creds.json"
group_token = f"{cred_path}/p8_grptoken.pickle"
sleep_time = 10
retry = 10
nPT = "nextPageToken"
