...
_PROTO_FILE_PATTERNS = [
    ...
    (
        "bmlx_components/brec_protos/welog/recommends/*.proto",
        "bmlx_components/brec_protos",
    ),
    (
        "bmlx_components/brec_protos/welog/features/*.proto",
        "bmlx_components/brec_protos",
    ),
    (
        "bmlx_components/brec_protos/welog/profile/*.proto",
        "bmlx_components/brec_protos",
    ),
    (
        "bmlx_components/brec_protos/indigo/features/*.proto",
        "bmlx_components/brec_protos",
    ),
    (
