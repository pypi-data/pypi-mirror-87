...
class UsersApi(object):
    ...
    def autocomplete_users_and_groups_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api('/users/autocomplete/{query}', 'GET',
                                        ...
                                        response_type='IdentityPreviewListV1',
    ...
    def get_users_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api('/users', 'GET',
                                        ...
                                        post_params=form_params,
                                        files=local_var_files,
                                        response_type='UserOutputListV1',
                                        auth_settings=auth_settings,
                                        callback=params.get('callback'),
                                        _return_http_data_only=params.get('_return_http_data_only'),
                                        _preload_content=params.get('_preload_content', True),
    ...
    def update_password(self, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.update_password(id=id_value, body=body_value, callback=callback_function)
    ...
    def update_password_with_http_info(self, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.update_password_with_http_info(id=id_value, body=body_value, callback=callback_function)
    ...
    def update_user(self, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.update_user(id=id_value, body=body_value, callback=callback_function)
    ...
    def update_user_with_http_info(self, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.update_user_with_http_info(id=id_value, body=body_value, callback=callback_function)
