...
from proto.google.fhir.proto.r4.core.extensions_pb2 import (
    ObservationAllele as proto___google___fhir___proto___r4___core___extensions_pb2___ObservationAllele,
    ObservationAminoAcidChange as proto___google___fhir___proto___r4___core___extensions_pb2___ObservationAminoAcidChange,
    ObservationAncestry as proto___google___fhir___proto___r4___core___extensions_pb2___ObservationAncestry,
    ObservationPhaseSet as proto___google___fhir___proto___r4___core___extensions_pb2___ObservationPhaseSet,
    ObservationVariant as proto___google___fhir___proto___r4___core___extensions_pb2___ObservationVariant,
)
...
class ObservationGenetics(google___protobuf___message___Message):
    ...
    class Component(google___protobuf___message___Message):
        ...
        @property
        def value(self) -> type___ObservationGenetics.Component.ValueX: ...
        ...
        def __init__(self,
            *,
            ...
            value : typing___Optional[type___ObservationGenetics.Component.ValueX] = None,
    ...
    @property
    def status(self) -> type___ObservationGenetics.StatusCode: ...
    ...
    @property
    def effective(self) -> type___ObservationGenetics.EffectiveX: ...
    ...
    @property
    def value(self) -> type___ObservationGenetics.ValueX: ...
    ...
    @property
    def dna_region_name(self) -> proto___google___fhir___proto___r4___core___datatypes_pb2___String: ...

    @property
    def copy_number_event(self) -> proto___google___fhir___proto___r4___core___datatypes_pb2___CodeableConcept: ...

    @property
    def genomic_source_class(self) -> proto___google___fhir___proto___r4___core___datatypes_pb2___CodeableConcept: ...

    @property
    def interpretation_slice(self) -> proto___google___fhir___proto___r4___core___datatypes_pb2___Reference: ...

    @property
    def variant(self) -> proto___google___fhir___proto___r4___core___extensions_pb2___ObservationVariant: ...

    @property
    def amino_acid_change(self) -> proto___google___fhir___proto___r4___core___extensions_pb2___ObservationAminoAcidChange: ...

    @property
    def allele(self) -> proto___google___fhir___proto___r4___core___extensions_pb2___ObservationAllele: ...

    @property
    def ancestry(self) -> proto___google___fhir___proto___r4___core___extensions_pb2___ObservationAncestry: ...

    @property
    def phase_set(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[proto___google___fhir___proto___r4___core___extensions_pb2___ObservationPhaseSet]: ...
    ...
    def __init__(self,
        *,
        ...
        status : typing___Optional[type___ObservationGenetics.StatusCode] = None,
        ...
        effective : typing___Optional[type___ObservationGenetics.EffectiveX] = None,
        ...
        value : typing___Optional[type___ObservationGenetics.ValueX] = None,
        data_absent_reason : typing___Optional[proto___google___fhir___proto___r4___core___datatypes_pb2___CodeableConcept] = None,
        interpretation : typing___Optional[typing___Iterable[proto___google___fhir___proto___r4___core___datatypes_pb2___CodeableConcept]] = None,
        ...
        dna_region_name : typing___Optional[proto___google___fhir___proto___r4___core___datatypes_pb2___String] = None,
        copy_number_event : typing___Optional[proto___google___fhir___proto___r4___core___datatypes_pb2___CodeableConcept] = None,
        genomic_source_class : typing___Optional[proto___google___fhir___proto___r4___core___datatypes_pb2___CodeableConcept] = None,
        interpretation_slice : typing___Optional[proto___google___fhir___proto___r4___core___datatypes_pb2___Reference] = None,
        variant : typing___Optional[proto___google___fhir___proto___r4___core___extensions_pb2___ObservationVariant] = None,
        amino_acid_change : typing___Optional[proto___google___fhir___proto___r4___core___extensions_pb2___ObservationAminoAcidChange] = None,
        allele : typing___Optional[proto___google___fhir___proto___r4___core___extensions_pb2___ObservationAllele] = None,
        ancestry : typing___Optional[proto___google___fhir___proto___r4___core___extensions_pb2___ObservationAncestry] = None,
        phase_set : typing___Optional[typing___Iterable[proto___google___fhir___proto___r4___core___extensions_pb2___ObservationPhaseSet]] = None,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions___Literal[u"allele",b"allele",u"amino_acid_change",b"amino_acid_change",u"ancestry",b"ancestry",u"body_site",b"body_site",u"code",b"code",u"copy_number_event",b"copy_number_event",u"data_absent_reason",b"data_absent_reason",u"device",b"device",u"dna_region_name",b"dna_region_name",u"effective",b"effective",u"encounter",b"encounter",u"gene",b"gene",u"genomic_source_class",b"genomic_source_class",u"id",b"id",u"implicit_rules",b"implicit_rules",u"interpretation_slice",b"interpretation_slice",u"issued",b"issued",u"language",b"language",u"meta",b"meta",u"method",b"method",u"specimen",b"specimen",u"status",b"status",u"subject",b"subject",u"text",b"text",u"value",b"value",u"variant",b"variant"]) -> builtin___bool: ...
    def ClearField(self, field_name: typing_extensions___Literal[u"allele",b"allele",u"amino_acid_change",b"amino_acid_change",u"ancestry",b"ancestry",u"based_on",b"based_on",u"body_site",b"body_site",u"category",b"category",u"code",b"code",u"component",b"component",u"contained",b"contained",u"copy_number_event",b"copy_number_event",u"data_absent_reason",b"data_absent_reason",u"derived_from",b"derived_from",u"device",b"device",u"dna_region_name",b"dna_region_name",u"effective",b"effective",u"encounter",b"encounter",u"extension",b"extension",u"focus",b"focus",u"gene",b"gene",u"genomic_source_class",b"genomic_source_class",u"has_member",b"has_member",u"id",b"id",u"identifier",b"identifier",u"implicit_rules",b"implicit_rules",u"interpretation",b"interpretation",u"interpretation_slice",b"interpretation_slice",u"issued",b"issued",u"language",b"language",u"meta",b"meta",u"method",b"method",u"modifier_extension",b"modifier_extension",u"note",b"note",u"part_of",b"part_of",u"performer",b"performer",u"phase_set",b"phase_set",u"reference_range",b"reference_range",u"specimen",b"specimen",u"status",b"status",u"subject",b"subject",u"text",b"text",u"value",b"value",u"variant",b"variant"]) -> None: ...
