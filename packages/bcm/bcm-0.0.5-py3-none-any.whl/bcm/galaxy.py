...
class star():
    def __init__(self, name=None, distance=0
                 , size=250, speed=0, round=0, angle=0, rotation=0.01,opacity=1,emissive=False,revolve=[0,0,0]):
        self.name = name
    ...
    def setup(self):
        ...
        if not image_name:
            ...
            sys.exit(0)
        self.sphere=sphere(texture=image_name, radius=self.size, pos=vec(self.distance, 0, 0),shininess=0,opacity=self.opacity,emissive=self.emissive)
