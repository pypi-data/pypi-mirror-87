import{_ as s,H as t,p as e,w as i,a3 as a,h as o,l as r,d as n,V as l,W as c,s as d,g as h,c as p}from"./e.1b8d9b76.js";import{m as u}from"./c.c4c0026c.js";import"./c.b9a5584e.js";import"./c.9c6740fb.js";import"./c.abfb169a.js";import{u as m}from"./c.cac26bda.js";let _=s([p("hacs-update-dialog")],(function(s,t){return{F:class extends t{constructor(...t){super(...t),s(this)}},d:[{kind:"field",decorators:[e()],key:"repository",value:void 0},{kind:"field",decorators:[e()],key:"_updating",value:()=>!1},{kind:"field",decorators:[e()],key:"_error",value:void 0},{kind:"field",decorators:[e()],key:"_releaseNotes",value:()=>[]},{kind:"field",key:"_getRepository",value:()=>i((s,t)=>null==s?void 0:s.find(s=>s.id===t))},{kind:"method",key:"firstUpdated",value:async function(){const s=this._getRepository(this.repositories,this.repository);"commit"!==s.version_or_commit&&(this._releaseNotes=await a(this.hass,s.id),this._releaseNotes=this._releaseNotes.filter(t=>t.tag>s.installed_version)),this.hass.connection.subscribeEvents(s=>this._error=s.data,"hacs/error")}},{kind:"method",key:"render",value:function(){if(!this.active)return o``;const s=this._getRepository(this.repositories,this.repository);return o`
      <hacs-dialog
        .active=${this.active}
      ...
      >
        <div class=${n({content:!0,narrow:this.narrow})}>
          ...
          ${"integration"===s.category?o`<p>${r("dialog_install.restart")}</p>`:""}
        ...
        <mwc-button
          ...
          >${this._updating?o`<ha-circular-progress active></ha-circular-progress>`:r("common.update")}</mwc-button
        >
