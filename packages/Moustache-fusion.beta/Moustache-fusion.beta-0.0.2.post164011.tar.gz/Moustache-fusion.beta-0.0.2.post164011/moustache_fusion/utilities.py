...
def validate_pdf(path: str, alias: str):
    ...
    elif process.returncode == 1 and stderr_content == "Command Line Error: Incorrect password\n":
        msgstr = 'Cannot open encrypted %s'
        raise EncryptedPdfException(msgstr % (alias))
