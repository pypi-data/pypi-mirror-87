...
def get_datasets_json(training_data=None,
                      validation_data=None):
    """Get dataprep json.

    :param training_data: Training data.
    :type training_data: azureml.dataprep.DataSet
    :param validation_data: Validation data
    :type validation_data: azureml.dataprep.Dataset
...
def _save_datasets_to_json(dataset_dict):
