...
class ANN(object):
    ...
    def __init__(self,row,col):
        ...
        self.x=tf.compat.v1.placeholder(tf.float32,[None,col],name='1')
        
        # hidden layer 1
        self.weights_hidden1 = tf.Variable(tf.compat.v1.random_normal([col, 64]),name='2')
        self.bias_hidden1 = tf.Variable(tf.compat.v1.random_normal([64]),name='3')
        ...
        # hidden layer 2                          
        self.weights_hidden2 = tf.Variable(tf.compat.v1.random_normal([64, 128]),name='4')
        self.bias_hidden2 = tf.Variable(tf.compat.v1.random_normal([128]),name='5')
        ...
        # hidden layer 3                          
        self.weights_hidden3 = tf.Variable(tf.compat.v1.random_normal([128, 64]),name='6')
        self.bias_hidden3 = tf.Variable(tf.compat.v1.random_normal([64]),name='7')
        ...
        # output layer
        self.weights_output = tf.Variable(tf.compat.v1.random_normal([64, 2]),name='8')
        self.bias_output = tf.Variable(tf.compat.v1.random_normal([2]),name='9') 
        ...
        self.y_=tf.compat.v1.placeholder(tf.float32,[None,2],name='10')
