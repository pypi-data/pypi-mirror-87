...
class test1element(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, test1attribute=None, test1member=None, gds_collector_=None, **kwargs_):
        ...
        self.test1attribute_nsprefix_ = None
        self.test1member = test1member
        self.test1member_nsprefix_ = None
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.vmware.com/vcloud/v0.8" ', name_='test1element', pretty_print=True):
        ...
        if pretty_print:
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'test1element':
        ...
        if self.hasContent_():
            ...
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='test1element'):
    ...
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.vmware.com/vcloud/v0.8" ', name_='test1element', fromsubclass_=False, pretty_print=True):
        ...
        if self.test1member is not None:
            namespaceprefix_ = self.test1member_nsprefix_ + ':' if (UseCapturedNS_ and self.test1member_nsprefix_) else ''
...
class cimAnySimpleType(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='cimAnySimpleType', pretty_print=True):
        ...
        if pretty_print:
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'cimAnySimpleType':
            name_ = self.original_tagname_
        if UseCapturedNS_ and self.ns_prefix_:
            namespaceprefix_ = self.ns_prefix_ + ':'
        showIndent(outfile, level, pretty_print)
        ...
        if self.hasContent_():
            ...
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='cimAnySimpleType'):
        unique_counter = 0
...
NamespaceToDefMappings_ = {'http://www.vmware.com/vcloud/v0.8': [('test1element',
                                        'tests/anysimpletype.xsd',
                                        'CT'),
                                       ('cimAnySimpleType',
                                        'tests/anysimpletype.xsd',
