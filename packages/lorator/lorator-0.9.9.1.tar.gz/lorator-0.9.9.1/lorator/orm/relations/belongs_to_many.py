...
class BelongsToMany(Relation):
    ...
    def get_relation_count_query(self, query, parent):
        ...
        :type query: lorator.orm.Builder
        :type parent: lorator.orm.Builder

        :rtype: lorator.orm.Builder
        """
    ...
    def attach(self, id, attributes=None, touch=True):
        ...
        """
        if isinstance(id, lorator.orm.Model):
            id = id.get_key()
    ...
    def detach(self, ids=None, touch=True):
        ...
        """
        if isinstance(ids, lorator.orm.model.Model):
            ids = ids.get_key()
