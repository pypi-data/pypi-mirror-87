...
from symbol_openapi_client.models.server_info_dto import ServerInfoDTO  # noqa: E501
...
class TestServerInfoDTO(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = symbol_openapi_client.models.server_info_dto.ServerInfoDTO()  # noqa: E501
        if include_optional :
            return ServerInfoDTO(
                server_info = symbol_openapi_client.models.server_dto.ServerDTO(
                    rest_version = '1.0.14', 
                    sdk_version = '0.7.14', )
            )
        else :
