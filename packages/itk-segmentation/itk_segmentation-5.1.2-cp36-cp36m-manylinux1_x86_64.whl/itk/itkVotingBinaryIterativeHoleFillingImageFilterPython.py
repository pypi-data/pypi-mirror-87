...
def voting_binary_iterative_hole_filling_image_filter_init_docstring():
    ...
    import itkTemplate
    import itkHelpers
    if isinstance(itk.VotingBinaryIterativeHoleFillingImageFilter, itkTemplate.itkTemplate):
        filter_object = itk.VotingBinaryIterativeHoleFillingImageFilter.values()[0]
    else:
        filter_object = itk.VotingBinaryIterativeHoleFillingImageFilter
