...
execute_process(
  COMMAND "D:/Git/cmd/git.exe" show-ref 3.3.7
  WORKING_DIRECTORY "D:/code_ws/pb_ws/conmech/cmake/../ext/eigen"
...
if("${show_ref_output}" MATCHES "refs/remotes/3.3.7")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "3.3.7")
...
# yet).
execute_process(
  COMMAND "D:/Git/cmd/git.exe" rev-list --max-count=1 3.3.7
  WORKING_DIRECTORY "D:/code_ws/pb_ws/conmech/cmake/../ext/eigen"
  RESULT_VARIABLE error_code
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(is_remote_ref)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'D:/code_ws/pb_ws/conmech/cmake/../ext/eigen/'.\nYou will have to resolve the conflicts manually")
    endif()
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: 'D:/code_ws/pb_ws/conmech/cmake/../ext/eigen/'.\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
  else()
