...
def pn_connection_set_authorization(connection, authzid):
    return _cproton.pn_connection_set_authorization(connection, authzid)
...
def pn_connection_get_authorization(connection):
    return _cproton.pn_connection_get_authorization(connection)
...
def pn_link_properties(link):
    return _cproton.pn_link_properties(link)

def pn_link_remote_properties(link):
    return _cproton.pn_link_remote_properties(link)
...
PN_RAW_CONNECTION_CONNECTED = _cproton.PN_RAW_CONNECTION_CONNECTED
PN_RAW_CONNECTION_CLOSED_READ = _cproton.PN_RAW_CONNECTION_CLOSED_READ
PN_RAW_CONNECTION_CLOSED_WRITE = _cproton.PN_RAW_CONNECTION_CLOSED_WRITE
PN_RAW_CONNECTION_DISCONNECTED = _cproton.PN_RAW_CONNECTION_DISCONNECTED
PN_RAW_CONNECTION_NEED_READ_BUFFERS = _cproton.PN_RAW_CONNECTION_NEED_READ_BUFFERS
PN_RAW_CONNECTION_NEED_WRITE_BUFFERS = _cproton.PN_RAW_CONNECTION_NEED_WRITE_BUFFERS
PN_RAW_CONNECTION_READ = _cproton.PN_RAW_CONNECTION_READ
PN_RAW_CONNECTION_WRITTEN = _cproton.PN_RAW_CONNECTION_WRITTEN
PN_RAW_CONNECTION_WAKE = _cproton.PN_RAW_CONNECTION_WAKE
...
def pn_sasl_get_authorization(sasl):
    return _cproton.pn_sasl_get_authorization(sasl)
...
CID_pn_raw_connection = _cproton.CID_pn_raw_connection
