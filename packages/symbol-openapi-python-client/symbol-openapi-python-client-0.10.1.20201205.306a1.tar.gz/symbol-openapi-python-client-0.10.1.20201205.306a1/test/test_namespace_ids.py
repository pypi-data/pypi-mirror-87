...
from symbol_openapi_client.models.namespace_ids import NamespaceIds  # noqa: E501
from symbol_openapi_client.rest import ApiException

class TestNamespaceIds(unittest.TestCase):
    """NamespaceIds unit test stubs"""
    ...
    def make_instance(self, include_optional):
        ...
        # model = symbol_openapi_client.models.namespace_ids.NamespaceIds()  # noqa: E501
        if include_optional :
            return NamespaceIds(
                namespace_ids = [
                    '85BBEA6CC462B244'
