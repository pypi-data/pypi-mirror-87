...
class EnrollmentRequest(google___protobuf___message___Message):
    ...
    @property
    def status(self) -> type___EnrollmentRequest.StatusCode: ...
    ...
    @property
    def candidate(self) -> proto___google___fhir___proto___r4___core___datatypes_pb2___Reference: ...
    ...
    def __init__(self,
        *,
        ...
        status : typing___Optional[type___EnrollmentRequest.StatusCode] = None,
        ...
        candidate : typing___Optional[proto___google___fhir___proto___r4___core___datatypes_pb2___Reference] = None,
        coverage : typing___Optional[proto___google___fhir___proto___r4___core___datatypes_pb2___Reference] = None,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions___Literal[u"candidate",b"candidate",u"coverage",b"coverage",u"created",b"created",u"id",b"id",u"implicit_rules",b"implicit_rules",u"insurer",b"insurer",u"language",b"language",u"meta",b"meta",u"provider",b"provider",u"status",b"status",u"text",b"text"]) -> builtin___bool: ...
    def ClearField(self, field_name: typing_extensions___Literal[u"candidate",b"candidate",u"contained",b"contained",u"coverage",b"coverage",u"created",b"created",u"extension",b"extension",u"id",b"id",u"identifier",b"identifier",u"implicit_rules",b"implicit_rules",u"insurer",b"insurer",u"language",b"language",u"meta",b"meta",u"modifier_extension",b"modifier_extension",u"provider",b"provider",u"status",b"status",u"text",b"text"]) -> None: ...
type___EnrollmentRequest = EnrollmentRequest
