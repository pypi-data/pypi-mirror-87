...
from pyrobot import exceptions as err
...
def init_logger(logfile='debug.log', logger_name='tests-test', log_level=FILE_LEVEL,
...
def get_logger(logfile='debug.log', logger_name='test', output_logfile=True,
