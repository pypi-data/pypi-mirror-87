...
#   `tensorflow_probability/substrates/jax/distributions/gumbel.py`
...
from tensorflow_probability.substrates.jax.bijectors import gumbel_cdf as gumbel_cdf_bijector
