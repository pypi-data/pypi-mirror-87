...
__all__ = ['say_hello', 'HelloSayer', 'dummy', 'Recommender', 'Ranking', 'sigmoid']
...
class Recommender:
    ...
    def recommend(self, pid):
        ...
        similar_artists = self.__get_similar_artists(artists) #list
        pids = self.__get_similar_playlists(pid)
        ...
        top_track_uris = self.__limit_artists(filtered_rankings)
    ...
    def __get_similar_artists(self, artists):
        similar_artists = []
    ...
    def __get_similar_playlists(self, pid):
    ...
    def __limit_artists(self, rankings):
        top_track_uris = []
        for ranking in rankings:
