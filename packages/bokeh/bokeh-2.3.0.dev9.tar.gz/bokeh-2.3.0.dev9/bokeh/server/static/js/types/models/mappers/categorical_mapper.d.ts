...
export declare function cat_v_compute<T>(data: ArrayableOf<Factor>, factors: ArrayableOf<Factor>, targets: Arrayable<T>, values: Arrayable<T>, start: number, end: number | null, extra_value: T): void;
