...
{'': ['*'],
 'et_micc': ['templates/app-simple/{{cookiecutter.project_name}}/tests/test_{{cookiecutter.cli_app_name}}.{{cookiecutter.py}}',
             ...
             'templates/module-f2py/{{cookiecutter.project_name}}/{{cookiecutter.package_name}}/f2py_{{cookiecutter.module_name}}/CMakeLists.txt',
             'templates/module-f2py/{{cookiecutter.project_name}}/{{cookiecutter.package_name}}/f2py_{{cookiecutter.module_name}}/CMakeLists.txt',
             'templates/module-f2py/{{cookiecutter.project_name}}/{{cookiecutter.package_name}}/f2py_{{cookiecutter.module_name}}/CMakeLists.txt',
             ...
             'templates/package-simple-docs/{{cookiecutter.project_name}}/.readthedocs.yml',
             'templates/package-simple-docs/{{cookiecutter.project_name}}/.readthedocs.yml',
             'templates/package-simple-docs/{{cookiecutter.project_name}}/.readthedocs.yml',
