...
from polyaxon.exceptions import PolyaxonSchemaError, PolyaxonClientException
from polyaxon.utils.formatting import Printer


def get_versioned_entity_full_name(component: str, owner: str = None, tag: str = None) -> str:
    if tag:
...
def get_versioned_entity_info(entity: str, entity_name: str, default_owner: str) -> Tuple[str, str, str]:
    if not entity:
        raise PolyaxonSchemaError("Received an invalid {} reference: `{}`".format(entity_name, entity))
...
def get_component_info(hub: str) -> Tuple[str, str, str]:
    return get_versioned_entity_info(entity=hub, entity_name="component", default_owner=DEFAULT_HUB)
