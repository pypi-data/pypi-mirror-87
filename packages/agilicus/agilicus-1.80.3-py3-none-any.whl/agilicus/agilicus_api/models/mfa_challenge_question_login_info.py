...
class MFAChallengeQuestionLoginInfo(object):
    ...
    def __init__(self, user_preference='organisation_policy', client_id=None, client_guid=None, issuer_org_id=None, issuer_guid=None, org_id=None, user_id=None, user_object=None, upstream_idp=None, ip_address=None, amr_claim_present=False, last_mfa_login=None, local_vars_configuration=None):  # noqa: E501
