...
class MLogger(object):
    ...
    @staticmethod
    def timeRotatingFileLogger(filepath, fileter):
        # 获取all代表不管输出和文件都会有流产生
    ...
    @staticmethod
    def RotatingFileLogger(filepath, fileter, maxBytes=1024 * 1024 * 1024, backupCount=10):
        # 获取all代表不管输出和文件都会有流产生
