...
class MediaType(object):
    ...
    def __init__(self, archive_config=None, attribute_types=None, default_volume=None, description='', dtype=None, file_format=None, id=None, keep_original=True, name=None, overlay_config=None, project=None, streaming_config=None, local_vars_configuration=None):  # noqa: E501
