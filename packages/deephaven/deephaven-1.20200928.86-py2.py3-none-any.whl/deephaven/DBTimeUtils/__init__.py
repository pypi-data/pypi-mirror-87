...
DBTimeZone = None  #: Deephaven timezone class (com.illumon.iris.db.tables.utils.DBTimeZone).
DBDateTime = None  #: Deephaven date-time class (com.illumon.iris.db.tables.utils.DBDateTime).
...
def autoEpochToTime(epoch):
    ...
    :return: (com.illumon.iris.db.tables.utils.DBDateTime) null, if the input is equal to QueryConstants.NULL_LONG, otherwise a DBDateTime based
...
def cappedTimeOffset(original, period, cap):
    ...
    :param original: (com.illumon.iris.db.tables.utils.DBDateTime) - The starting DBDateTime value.
    :param period: (com.illumon.iris.db.tables.utils.DBPeriod) - The DBPeriod to add to dateTime.
    :param cap: (com.illumon.iris.db.tables.utils.DBDateTime) - A DBDateTime value to use as the maximum return value.
    :return: (com.illumon.iris.db.tables.utils.DBDateTime) a null DBDateTime if either original or period are null;
...
def convertDateQuiet(*args):
    ...
    *Overload 2*  
      ...
      :param dateStyle: (com.illumon.iris.db.tables.utils.DBTimeUtils.DateStyle) - indicates how to interpret slash-delimited dates
...
def convertDateTimeQuiet(s):
    ...
    :param s: (java.lang.String) - String to be converted, usually in the form yyyy-MM-ddThh:mm:ss and with optional sub-seconds
              after an optional decimal point, followed by a mandatory time zone character code
    :return: (com.illumon.iris.db.tables.utils.DBDateTime) A DBDateTime from the parsed String, or null if the format is not recognized or an exception occurs
    """
...
def convertExpression(formula):
    ...
    :return: (com.illumon.iris.db.tables.utils.DBTimeUtils.Result) A DBTimeUtils.Result object, which includes the converted formula string,
...
def convertPeriod(s):
    ...
    :param s: (java.lang.String) - The String to convert in the form of numbertype, e.g. 1W for one week, and Tnumbertype for times, e.g.
     T1M for one minute.
    :return: com.illumon.iris.db.tables.utils.DBPeriod
    """
...
def convertPeriodQuiet(s):
    ...
    :param s: (java.lang.String) - The String to convert in the form of numbertype, e.g. 1W for one week, and Tnumbertype for times, e.g.
     T1M for one minute.
    :return: (com.illumon.iris.db.tables.utils.DBPeriod) null if the String cannot be parsed, otherwise a DBPeriod object.
    """
...
def currentDate(timeZone):
    ...
    :param timeZone: (com.illumon.iris.db.tables.utils.DBTimeZone) - The DBTimeZone to reference when evaluating the current date for "now".
...
def currentTime():
    ...
    :return: (com.illumon.iris.db.tables.utils.DBDateTime) A DBDateTime of the current date and time from the system or from the configured alternate
     time provider.
    """
...
def dateAtMidnight(dateTime, timeZone):
    ...
    :param dateTime: (com.illumon.iris.db.tables.utils.DBDateTime) - DBDateTime for which the new value at midnight should be calculated.
    :param timeZone: (com.illumon.iris.db.tables.utils.DBTimeZone) - DBTimeZone for which the new value at midnight should be calculated.
    :return: (com.illumon.iris.db.tables.utils.DBDateTime) A null DBDateTime if either input is null, otherwise a DBDateTime representing
...
def dayOfMonth(dateTime, timeZone):
    ...
    :param dateTime: (com.illumon.iris.db.tables.utils.DBDateTime) - The DBDateTime for which to find the day of the month.
    :param timeZone: (com.illumon.iris.db.tables.utils.DBTimeZone) - The DBTimeZone to use when interpreting the date/time.
...
def dayOfWeek(dateTime, timeZone):
    ...
    :param dateTime: (com.illumon.iris.db.tables.utils.DBDateTime) - The DBDateTime for which to find the day of the week.
    :param timeZone: (com.illumon.iris.db.tables.utils.DBTimeZone) - The DBTimeZone to use when interpreting the date/time.
    :return: (int) A QueryConstants.NULL_INT if either input is null, otherwise, an int value
...
def dayOfYear(dateTime, timeZone):
    ...
    :param dateTime: (com.illumon.iris.db.tables.utils.DBDateTime) - The DBDateTime for which to find the day of the year.
    :param timeZone: (com.illumon.iris.db.tables.utils.DBTimeZone) - The DBTimeZone to use when interpreting the date/time.
    :return: (int) A QueryConstants.NULL_INT if either input is null, otherwise, an int value
...
def diffDay(start, end):
    ...
    :param start: (com.illumon.iris.db.tables.utils.DBDateTime) - The first DBDateTime.
    :param end: (com.illumon.iris.db.tables.utils.DBDateTime) - The second DBDateTime.
...
def diffNanos(d1, d2):
    ...
    :param d1: (com.illumon.iris.db.tables.utils.DBDateTime) - The first DBDateTime.
    :param d2: (com.illumon.iris.db.tables.utils.DBDateTime) - The second DBDateTime.
...
def format(*args):
    ...
    *Overload 1*  
      :param dateTime: (com.illumon.iris.db.tables.utils.DBDateTime) - The DBDateTime to format as a String.
      :param timeZone: (com.illumon.iris.db.tables.utils.DBTimeZone) - The DBTimeZone to use when formatting the String.
...
def getExcelDateTime(*args):
    ...
    *Overload 1*  
      :param dateTime: (com.illumon.iris.db.tables.utils.DBDateTime) - The DBDateTime to convert.
      :param timeZone: (com.illumon.iris.db.tables.utils.DBTimeZone) - The DBTimeZone to use when interpreting the date/time.
...
def getZonedDateTime(*args):
    ...
    *Overload 1*  
      :param dateTime: (com.illumon.iris.db.tables.utils.DBDateTime) - The a DBDateTime to convert.
    ...
    *Overload 2*  
      :param dateTime: (com.illumon.iris.db.tables.utils.DBDateTime) - The a DBDateTime to convert.
      :param timeZone: (com.illumon.iris.db.tables.utils.DBTimeZone) - The DBTimeZone to use for the conversion.
...
def hourOfDay(dateTime, timeZone):
    ...
    :param dateTime: (com.illumon.iris.db.tables.utils.DBDateTime) - The DBDateTime for which to find the hour of the day.
    :param timeZone: (com.illumon.iris.db.tables.utils.DBTimeZone) - The DBTimeZone to use when interpreting the date/time.
    :return: (int) A QueryConstants.NULL_INT if either input is null, otherwise, an int value
...
def isAfter(d1, d2):
    ...
    :param d1: (com.illumon.iris.db.tables.utils.DBDateTime) - The first DBDateTime value to compare.
    :param d2: (com.illumon.iris.db.tables.utils.DBDateTime) - The second DBDateTime value to compare.
...
def lowerBin(dateTime, intervalNanos):
    ...
    Returns a DBDateTime value which is at the starting (lower) end of a time range defined
     by the second parameter. E.g. lowerBin(someDateTime, 5*MINUTE) would return the date/time value
     for the start of the five minute window that contains someDateTime.
    
    :param dateTime: (com.illumon.iris.db.tables.utils.DBDateTime) - The DBDateTime for which to evaluate the start of the containing window.
    :param intervalNanos: (long) - The long size of the window in nanoseconds.
    :return: (com.illumon.iris.db.tables.utils.DBDateTime) Null if either input is null, otherwise a DBDateTime representing the start of the
     window.
    """
...
def microsOfMilli(dateTime, timeZone):
    ...
    :param dateTime: (com.illumon.iris.db.tables.utils.DBDateTime) - The DBDateTime for which to find the microseconds.
    :param timeZone: (com.illumon.iris.db.tables.utils.DBTimeZone) - The DBTimeZone to use when interpreting the date/time.
    :return: (int) A QueryConstants.NULL_INT if either input is null, otherwise, an int value
...
def microsToTime(micros):
    ...
    :return: (com.illumon.iris.db.tables.utils.DBDateTime) QueryConstants.NULL_LONG if the input is null, otherwise, a DBDateTime
...
def millis(dateTime):
    ...
    :param dateTime: (com.illumon.iris.db.tables.utils.DBDateTime) - The DBDateTime for which the milliseconds offset should be returned.
...
def millisOfDay(dateTime, timeZone):
    ...
    :param dateTime: (com.illumon.iris.db.tables.utils.DBDateTime) - The DBDateTime for which to find the milliseconds since midnight.
    :param timeZone: (com.illumon.iris.db.tables.utils.DBTimeZone) - The DBTimeZone to use when interpreting the date/time.
    :return: (int) A QueryConstants.NULL_INT if either input is null, otherwise, an int value
...
def millisOfSecond(dateTime, timeZone):
    ...
    :param dateTime: (com.illumon.iris.db.tables.utils.DBDateTime) - The DBDateTime for which to find the milliseconds.
    :param timeZone: (com.illumon.iris.db.tables.utils.DBTimeZone) - The DBTimeZone to use when interpreting the date/time.
    :return: (int) A QueryConstants.NULL_INT if either input is null, otherwise, an int value
...
def millisToDateAtMidnight(millis, timeZone):
    ...
    :param timeZone: (com.illumon.iris.db.tables.utils.DBTimeZone) - DBTimeZone for which the new value at midnight should be calculated.
    :return: (com.illumon.iris.db.tables.utils.DBDateTime) A DBDateTime rounded down to midnight in the selected time zone for the specified number of milliseconds
     from Epoch.
    """
...
def millisToDateAtMidnightNy(millis):
    ...
    :param millis: (long) - A long value of the number of milliseconds from Epoch for which the DBDateTime is to be calculated.
    :return: (com.illumon.iris.db.tables.utils.DBDateTime) A DBDateTime rounded down to midnight in the New York time zone for the specified number of milliseconds
     from Epoch.
    """
...
def minus(*args):
    ...
    *Overload 1*  
      :param dateTime: (com.illumon.iris.db.tables.utils.DBDateTime) - The starting DBDateTime value.
      :param nanos: (long) - The long number of nanoseconds to subtract from dateTime.
      :return: (com.illumon.iris.db.tables.utils.DBDateTime) a null DBDateTime if either input is null;
    ...
    *Overload 2*  
      :param dateTime: (com.illumon.iris.db.tables.utils.DBDateTime) - The starting DBDateTime value.
      :param period: (com.illumon.iris.db.tables.utils.DBPeriod) - The DBPeriod to subtract from dateTime.
      :return: (com.illumon.iris.db.tables.utils.DBDateTime) a null DBDateTime if either input is null;
    ...
    *Overload 3*  
      :param d1: (com.illumon.iris.db.tables.utils.DBDateTime) - The first DBDateTime.
      :param d2: (com.illumon.iris.db.tables.utils.DBDateTime) - The DBDateTime to subtract from d1.
      :return: (long) QueryConstants.NULL_LONG if either input is null;
       the long nanoseconds from Epoch value of the first DBDateTime minus d2, if the result is not out of range
       for a long value; or throws a DBDateTimeOverflowException if the
       resultant value would be more than min long or max long nanoseconds from Epoch. 
...
def minuteOfDay(dateTime, timeZone):
    ...
    :param dateTime: (com.illumon.iris.db.tables.utils.DBDateTime) - The DBDateTime for which to find the minutes.
    :param timeZone: (com.illumon.iris.db.tables.utils.DBTimeZone) - The DBTimeZone to use when interpreting the date/time.
    :return: (int) A QueryConstants.NULL_INT if either input is null, otherwise, an int value
...
def monthOfYear(dateTime, timeZone):
    ...
    :param dateTime: (com.illumon.iris.db.tables.utils.DBDateTime) - The DBDateTime for which to find the month.
    :param timeZone: (com.illumon.iris.db.tables.utils.DBTimeZone) - The DBTimeZone to use when interpreting the date/time.
    :return: (int) A QueryConstants.NULL_INT if either input is null, otherwise, an int value
...
def nanos(dateTime):
    ...
    :param dateTime: (com.illumon.iris.db.tables.utils.DBDateTime) - The DBDateTime for which the nanoseconds offset should be returned.
...
def nanosOfDay(dateTime, timeZone):
    ...
    :param dateTime: (com.illumon.iris.db.tables.utils.DBDateTime) - The DBDateTime for which to find the nanoseconds since midnight.
    :param timeZone: (com.illumon.iris.db.tables.utils.DBTimeZone) - The DBTimeZone to use when interpreting the date/time.
...
def nanosOfSecond(dateTime, timeZone):
    ...
    :param dateTime: (com.illumon.iris.db.tables.utils.DBDateTime) - The DBDateTime for which to find the nanoseconds.
    :param timeZone: (com.illumon.iris.db.tables.utils.DBTimeZone) - The DBTimeZone to use when interpreting the date/time.
    :return: (long) A QueryConstants.NULL_LONG if either input is null, otherwise, a long value
...
def nanosToTime(nanos):
    ...
    :return: (com.illumon.iris.db.tables.utils.DBDateTime) A DBDateTime for nanos, or null if nanos
...
def secondOfDay(dateTime, timeZone):
    ...
    :param dateTime: (com.illumon.iris.db.tables.utils.DBDateTime) - The DBDateTime for which to find the seconds.
    :param timeZone: (com.illumon.iris.db.tables.utils.DBTimeZone) - The DBTimeZone to use when interpreting the date/time.
    :return: (int) A QueryConstants.NULL_INT if either input is null, otherwise, an int value
...
def upperBin(*args):
    ...
    *Overload 1*  
      :param dateTime: (com.illumon.iris.db.tables.utils.DBDateTime) - The DBDateTime for which to evaluate the end of the containing window.
      :param intervalNanos: (long) - The size of the window in nanoseconds.
      :return: (com.illumon.iris.db.tables.utils.DBDateTime) Null if either input is null, otherwise a DBDateTime representing the end of the
       window.
...
def year(dateTime, timeZone):
    ...
    :param dateTime: (com.illumon.iris.db.tables.utils.DBDateTime) - The DBDateTime for which to find the year.
    :param timeZone: (com.illumon.iris.db.tables.utils.DBTimeZone) - The DBTimeZone to use when interpreting the date/time.
    :return: (int) A QueryConstants.NULL_INT if either input is null, otherwise, an int value
