...
from openapi_client.models.enumerate_snapshot_model import EnumerateSnapshotModel  # noqa: E501
...
class TestEnumerateSnapshotModel(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = openapi_client.models.enumerate_snapshot_model.EnumerateSnapshotModel()  # noqa: E501
        if include_optional :
            return EnumerateSnapshotModel(
                total = 56, 
                items = [
                    openapi_client.models.snapshot_summary_model.SnapshotSummaryModel(
                        id = 'a', 
                        name = 'a', 
                        description = '0', 
                        created_date = '0', 
