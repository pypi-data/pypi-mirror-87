...
from openapi_client.models.enumerate_dataset_model import EnumerateDatasetModel  # noqa: E501
...
class TestEnumerateDatasetModel(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = openapi_client.models.enumerate_dataset_model.EnumerateDatasetModel()  # noqa: E501
        if include_optional :
            return EnumerateDatasetModel(
                total = 56, 
                items = [
                    openapi_client.models.dataset_summary_model.DatasetSummaryModel(
                        id = 'a', 
                        name = 'a', 
                        description = '0', 
