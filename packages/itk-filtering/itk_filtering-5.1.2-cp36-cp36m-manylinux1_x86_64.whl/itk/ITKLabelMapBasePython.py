...
class itkLabelMap2(itk.itkImagePython.itkImageBase2):
    ...
    However the methods don't have the same complexity in the 2 classes,
    because of the different way to store the data. GetPixel() is run in
    constant time L is the number of lines in the image (imageSize[1] *
    imageSize[2] for a 3D image).
