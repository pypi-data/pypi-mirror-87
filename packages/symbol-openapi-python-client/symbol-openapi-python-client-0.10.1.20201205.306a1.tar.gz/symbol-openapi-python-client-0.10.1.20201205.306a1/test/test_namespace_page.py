...
from symbol_openapi_client.models.namespace_page import NamespacePage  # noqa: E501
...
class TestNamespacePage(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = symbol_openapi_client.models.namespace_page.NamespacePage()  # noqa: E501
        if include_optional :
            return NamespacePage(
                data = [
                    symbol_openapi_client.models.namespace_info_dto.NamespaceInfoDTO(
                        id = '0', 
