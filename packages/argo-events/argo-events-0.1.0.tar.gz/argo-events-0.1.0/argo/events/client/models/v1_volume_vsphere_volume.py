...
class V1VolumeVsphereVolume(object):
    ...
    def __init__(self, fs_type=None, storage_policy_id=None, storage_policy_name=None, volume_path=None, local_vars_configuration=None):  # noqa: E501
        """V1VolumeVsphereVolume - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def fs_type(self):
        """Gets the fs_type of this V1VolumeVsphereVolume.  # noqa: E501
        ...
        :return: The fs_type of this V1VolumeVsphereVolume.  # noqa: E501
        :rtype: str
        """
    ...
    def fs_type(self, fs_type):
        """Sets the fs_type of this V1VolumeVsphereVolume.

        Filesystem type to mount. Must be a filesystem type supported by the host operating system. Ex. \"ext4\", \"xfs\", \"ntfs\". Implicitly inferred to be \"ext4\" if unspecified.  # noqa: E501

        :param fs_type: The fs_type of this V1VolumeVsphereVolume.  # noqa: E501
        :type: str
        """
    ...
    def storage_policy_id(self):
        """Gets the storage_policy_id of this V1VolumeVsphereVolume.  # noqa: E501

        Storage Policy Based Management (SPBM) profile ID associated with the StoragePolicyName.  # noqa: E501

        :return: The storage_policy_id of this V1VolumeVsphereVolume.  # noqa: E501
        :rtype: str
        """
    ...
    def storage_policy_id(self, storage_policy_id):
        """Sets the storage_policy_id of this V1VolumeVsphereVolume.

        Storage Policy Based Management (SPBM) profile ID associated with the StoragePolicyName.  # noqa: E501

        :param storage_policy_id: The storage_policy_id of this V1VolumeVsphereVolume.  # noqa: E501
        :type: str
        """
    ...
    def storage_policy_name(self):
        """Gets the storage_policy_name of this V1VolumeVsphereVolume.  # noqa: E501

        Storage Policy Based Management (SPBM) profile name.  # noqa: E501

        :return: The storage_policy_name of this V1VolumeVsphereVolume.  # noqa: E501
        :rtype: str
        """
    ...
    def storage_policy_name(self, storage_policy_name):
        """Sets the storage_policy_name of this V1VolumeVsphereVolume.

        Storage Policy Based Management (SPBM) profile name.  # noqa: E501

        :param storage_policy_name: The storage_policy_name of this V1VolumeVsphereVolume.  # noqa: E501
        :type: str
        """
    ...
    def volume_path(self):
        """Gets the volume_path of this V1VolumeVsphereVolume.  # noqa: E501

        Path that identifies vSphere volume vmdk  # noqa: E501

        :return: The volume_path of this V1VolumeVsphereVolume.  # noqa: E501
        :rtype: str
        """
    ...
    def volume_path(self, volume_path):
        """Sets the volume_path of this V1VolumeVsphereVolume.

        Path that identifies vSphere volume vmdk  # noqa: E501

        :param volume_path: The volume_path of this V1VolumeVsphereVolume.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, V1VolumeVsphereVolume):
            return False
