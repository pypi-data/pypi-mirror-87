...
setup(
  ...
  url = 'https://github.com/CrackAndDie/robocadSim',   # Provide either the link to your github or to your website
  download_url = 'https://github.com/CrackAndDie/robocadSim',    # I explain this later on
