...
def add_customer_network(
    ...
    :param bool verified: Whether to create the network already Verified. (default false):param json:
...
def add_customer_network_comment(
    ...
    :param str comment: Comment to add to the network  => [\s\w\{\}\$\-\(\)\.\[\]"\'_/\\,\*\+\#:@!?;=]*:param json:
    :param verify: path to a certificate bundle or boolean indicating whether SSL
    verification should be performed.
    :param apiKey: Argus API key.
    :param authentication: authentication override
...
def bulk_add_customer_networks(
    ...
    :param bool verifyNetwork: Whether to create the networks already Verified. (default false):param json:
    :param verify: path to a certificate bundle or boolean indicating whether SSL
    verification should be performed.
    :param apiKey: Argus API key.
    :param authentication: authentication override
    ...
    # Only send verify if the argument was provided, dont send null values
    if verify is not None:
        body.update({"verify": verify})
...
def delete_customer_network(
    ...
    :param int networkID: ID of network to delete:param json:
    :param verify: path to a certificate bundle or boolean indicating whether SSL
    verification should be performed.
    :param apiKey: Argus API key.
    :param authentication: authentication override
...
def delete_customer_network_comment(
    ...
    :param str commentID: ID of comment to delete:param json:
    :param verify: path to a certificate bundle or boolean indicating whether SSL
    verification should be performed.
    :param apiKey: Argus API key.
    :param authentication: authentication override
...
def get_customer_network(
    ...
    :param int networkID: ID of network to get:param json:
    :param verify: path to a certificate bundle or boolean indicating whether SSL
    verification should be performed.
    :param apiKey: Argus API key.
    :param authentication: authentication override
...
def get_customer_network_comments(
    ...
    :param int offset: Skip a number of comments:param json:
    :param verify: path to a certificate bundle or boolean indicating whether SSL
    verification should be performed.
    :param apiKey: Argus API key.
    :param authentication: authentication override
...
def get_customer_networks(
    ...
    :param int offset: Skip a number of networks:param json:
    :param verify: path to a certificate bundle or boolean indicating whether SSL
    verification should be performed.
    :param apiKey: Argus API key.
    :param authentication: authentication override
...
def search_customer_network(
    ...
    :param bool includeSubnet: Network in search criteria will be searched for matching subnets (default true):param json:
    :param verify: path to a certificate bundle or boolean indicating whether SSL
    verification should be performed.
    :param apiKey: Argus API key.
    :param authentication: authentication override
...
def update_customer_network(
    ...
    :param str zone: Zone of the network :param json:
    :param verify: path to a certificate bundle or boolean indicating whether SSL
    verification should be performed.
    :param apiKey: Argus API key.
    :param authentication: authentication override
...
def verify_customer_network(
    ...
    :param int networkID: ID of network to verify:param json:
    :param verify: path to a certificate bundle or boolean indicating whether SSL
    verification should be performed.
    :param apiKey: Argus API key.
    :param authentication: authentication override
