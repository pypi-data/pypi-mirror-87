...
class DocumentFileCreateStatements(ModelNormal):
    ...
    validations = {
        ('tax_year',): {
            'inclusive_maximum': 2020,
            'inclusive_minimum': 1901,
        },
    }
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        """DocumentFileCreateStatements - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            form_type (str): [optional] if omitted the server will use the default value of "INCOME_STATEMENT"  # noqa: E501
            start_date (date): [optional]  # noqa: E501
            end_date (date): [optional]  # noqa: E501
            tax_year (int): Required for tax forms. [optional]  # noqa: E501
        """
