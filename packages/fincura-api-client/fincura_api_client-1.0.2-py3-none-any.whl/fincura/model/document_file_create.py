...
def lazy_import():
    ...
    globals()['DocumentFileCreateStatements'] = DocumentFileCreateStatements


class DocumentFileCreate(ModelNormal):
    ...
    validations = {
        ...
        ('upload_url',): {
            'max_length': 2500,
            'regex': {
                'pattern': r'^(?:[a-z0-9\.\-\+]*):\/\/(?:[^\s:@\/]+(?::[^\s:@\/]*)?@)?(?:(?:25[0-5]|2[0-4]\d|[0-1]?\d?\d)(?:\.(?:25[0-5]|2[0-4]\d|[0-1]?\d?\d)){3}|\[[0-9a-f:\.]+\]|([a-z¡-￿0-9](?:[a-z¡-￿0-9-]{0,61}[a-z¡-￿0-9])?(?:\.(?!-)[a-z¡-￿0-9-]{1,63}(?<!-))*\.(?!-)(?:[a-z¡-￿-]{2,63}|xn--[a-z0-9]{1,59})(?<!-)\.?|localhost))(?::\d{2,5})?(?:[\/?#][^\s]*)?\Z',  # noqa: E501
            },
        },
        ('external_id',): {
            'max_length': 255,
    ...
    def openapi_types():
        ...
        return {
            ...
            'statements': ([DocumentFileCreateStatements],),  # noqa: E501
    ...
    attribute_map = {
        ...
        'upload_url': 'upload_url',  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, borrower_uuid, media_type, *args, **kwargs):  # noqa: E501
        """DocumentFileCreate - a model defined in OpenAPI

        Args:
            borrower_uuid (str): UUID of the borrower for this file. (see [Borrowers](#tag/Borrowers))
            media_type (str): [MIME type](https://developer.mozilla.org/en-US/docs/Glossary/MIME_type) of the file
        ...
        Keyword Args:
            ...
            filename (str): Used to reference the original filename. Defaults to &#x60;document.{MEDIA TYPE FILE EXTENSION}&#x60; e.g. fye_2020.pdf. [optional]  # noqa: E501
            statements ([DocumentFileCreateStatements]):  By default, any document submitted to Fincura will be scanned for Income Statement and Balance Sheet information.  The engine can also be pointed at Tax Returns by setting a statement object with a &#x60;form_type&#x60; and &#x60;tax_year&#x60;. Supported tax form types: &#x60;1065&#x60;, &#x60;1040&#x60;, &#x60;1120&#x60;, &#x60;1120S&#x60;  &#x60;&#x60;&#x60; {     \&quot;borrower_uuid\&quot;: \&quot;6e...845ab1d\&quot;,     \&quot;media_type\&quot;: \&quot;application/pdf\&quot;,     \&quot;statements\&quot;: [         {           \&quot;form_type\&quot;: \&quot;1065\&quot;           \&quot;tax_year\&quot;: 2019         }       ] } &#x60;&#x60;&#x60;       . [optional]  # noqa: E501
            upload_url (str): [optional]  # noqa: E501
            external_id (str): External ID is used to uniquely identify a record from your system in our system. Must be unique across records.. [optional]  # noqa: E501
