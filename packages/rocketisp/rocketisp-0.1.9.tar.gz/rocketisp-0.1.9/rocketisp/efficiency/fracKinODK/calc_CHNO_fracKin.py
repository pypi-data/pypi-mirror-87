...
speciesL = ['*CO', '*CO2', '*H', '*H2', '*N', '*N2', '*NH', '*NO', '*O', '*O2', '*OH', 'C(gr)', 'CH4', 'COOH', 'H2O', 'H2O2', 'HCHO,formaldehy', 'HCN', 'HCO', 'HCOOH', 'HNC', 'HNCO', 'HNO', 'HNO2', 'HO2', 'N2O', 'NH2', 'NH3', 'NO2']
...
npz_filename =  os.path.join( here, 'calc_CHNO_fracKin.npz')
