...
class ContractOneShotRequestWizard(models.TransientModel):
    ...
    def _get_last_day_of_month(self, start_date):
        # touple with two numbers: first and last day of the given month
        month_range = monthrange(start_date.year, start_date.month)

        return date(start_date.year, start_date.month, month_range[1])
