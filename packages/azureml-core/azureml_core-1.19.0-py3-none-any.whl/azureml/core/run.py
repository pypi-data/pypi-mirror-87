    ...
    * `How to manage runs <https://docs.microsoft.com/azure/machine-learning/how-to-manage-runs>`_
    ...
    def _load_scope(cls):
        ...
        try:
            ...
            workspace_discovery_url = os.environ.get(DISCOVERY_END_POINT, url + "/discovery")
    ...
    def _create(experiment, name=None, run_id=None,
                outputs=None, properties=None, tags=None, **kwargs):
    ...
    def _get_outputs_datapath(self):
        ...
        """
        blob_azureml_datastore = self._get_blob_azureml_datastore()

        outputs_dir = self._outputs if self._outputs else "outputs"
        return DataPath(datastore=blob_azureml_datastore,
                        path_on_datastore="{}/{}/{}".format(RUN_ORIGIN, self._container, outputs_dir))

    def _get_blob_azureml_datastore(self):
        """Get a AzureBlobDataStore pointing to azureml container.

        :return AzureBlobDataStore pointing to azureml container in default datastore.
        ...
        return Datastore.register_azure_blob_container(
            ...
            account_name=default_datastore.account_name, account_key=default_datastore.account_key,
...
class _SubmittedRun(Run):
    ...
    def output_datasets(self):
        ...
        if self._output_datasets is None:
            self._output_datasets = OutputDatasets()
...
class _OfflineRun(ChainedIdentity):
    ...
    def upload_files(self, name, paths, return_artifacts=False):
