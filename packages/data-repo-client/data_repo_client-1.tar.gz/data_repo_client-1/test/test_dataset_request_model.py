...
from openapi_client.models.dataset_request_model import DatasetRequestModel  # noqa: E501
...
class TestDatasetRequestModel(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = openapi_client.models.dataset_request_model.DatasetRequestModel()  # noqa: E501
        if include_optional :
            return DatasetRequestModel(
                name = 'a', 
                description = '0', 
                default_profile_id = 'a', 
                schema = openapi_client.models.dataset_specification_model.DatasetSpecificationModel(
                    tables = [
                        openapi_client.models.table_model.TableModel(
                            name = 'a', 
                            columns = [
                                openapi_client.models.column_model.ColumnModel(
                                    name = 'a', 
                                    datatype = '0', 
                                    array_of = True, )
                                ], 
                            ...
                            partition_mode = 'none', 
                            date_partition_options = openapi_client.models.date_partition_options_model.DatePartitionOptionsModel(
                                column = 'a', ), 
                            int_partition_options = openapi_client.models.int_partition_options_model.IntPartitionOptionsModel(
                                column = 'a', 
                                min = 56, 
                                max = 56, 
                                interval = 56, ), 
                    ...
                    relationships = [
                        openapi_client.models.relationship_model.RelationshipModel(
                            name = '0', 
                            from = openapi_client.models.relationship_term_model.RelationshipTermModel(
                                table = 'a', 
                                column = 'a', ), 
                            to = openapi_client.models.relationship_term_model.RelationshipTermModel(
                                table = 'a', 
                                column = 'a', ), )
                        ], 
                    assets = [
                        openapi_client.models.asset_model.AssetModel(
                            name = '0', 
                            tables = [
                                openapi_client.models.asset_table_model.AssetTableModel(
                                    name = 'a', 
                                    columns = [
                                        'a'
                                        ], )
