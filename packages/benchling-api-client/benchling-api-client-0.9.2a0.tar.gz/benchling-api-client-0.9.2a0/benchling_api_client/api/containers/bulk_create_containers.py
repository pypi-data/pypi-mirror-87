...
from ...models.container_bulk_create_request_body import ContainerBulkCreateRequestBody
...
def _get_kwargs(
    *,
    client: Client,
    json_body: ContainerBulkCreateRequestBody,
) -> Dict[str, Any]:
    url = "{}/containers:bulk-create".format(client.base_url)
