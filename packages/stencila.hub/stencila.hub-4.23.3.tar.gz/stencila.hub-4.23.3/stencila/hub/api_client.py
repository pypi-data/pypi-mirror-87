...
from stencila.hub import rest
from stencila.hub.configuration import Configuration
from stencila.hub.exceptions import ApiTypeError, ApiValueError, ApiException
from stencila.hub.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = 'OpenAPI-Generator/4.23.3/python'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.accounts_broker_list  # this is an instance of the class Endpoint
        api_instance.accounts_broker_list()  # this invokes api_instance.accounts_broker_list.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.accounts_broker_list.callable or self.callable in this class
