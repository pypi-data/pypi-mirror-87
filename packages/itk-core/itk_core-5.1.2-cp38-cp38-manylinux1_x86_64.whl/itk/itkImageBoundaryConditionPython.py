...
class itkZeroFluxNeumannBoundaryConditionICF2(itkImageBoundaryConditionICF2):
    ...
    a region at an image corner (iterator is centered on the 2): returns
    the following neighborhood of values: The input to this function
    object is a neighborhood iterator. This boundary condition object is
    designed to be given as a template argument to a NeighborhoodIterator
    or any of the NeighborhoodIterator subclasses. 
    """
...
class itkConstantBoundaryConditionICF2(itkImageBoundaryConditionICF2):
    ...
    (the default) on each out-of-bounds element of a 7x5 iterator that
    masks a region at an image corner (iterator is centered on the 2):
    * * * * * * *           * * * * * * *           * * 1 2 3 4 5  (where
    * denotes pixels that lie           * * 3 3 5 5 6 outside of the image
    boundary)           * * 4 4 6 7 8
