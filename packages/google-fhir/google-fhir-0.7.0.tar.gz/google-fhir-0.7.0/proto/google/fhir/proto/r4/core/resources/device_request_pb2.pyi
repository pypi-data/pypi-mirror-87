...
class DeviceRequest(google___protobuf___message___Message):
    ...
    class Parameter(google___protobuf___message___Message):
        ...
        @property
        def value(self) -> type___DeviceRequest.Parameter.ValueX: ...
        ...
        def __init__(self,
            *,
            ...
            value : typing___Optional[type___DeviceRequest.Parameter.ValueX] = None,
            ) -> None: ...
    ...
    @property
    def status(self) -> type___DeviceRequest.StatusCode: ...

    @property
    def intent(self) -> type___DeviceRequest.IntentCode: ...

    @property
    def priority(self) -> type___DeviceRequest.PriorityCode: ...

    @property
    def code(self) -> type___DeviceRequest.CodeX: ...

    @property
    def parameter(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[type___DeviceRequest.Parameter]: ...
    ...
    @property
    def occurrence(self) -> type___DeviceRequest.OccurrenceX: ...
    ...
    def __init__(self,
        *,
        ...
        status : typing___Optional[type___DeviceRequest.StatusCode] = None,
        intent : typing___Optional[type___DeviceRequest.IntentCode] = None,
        priority : typing___Optional[type___DeviceRequest.PriorityCode] = None,
        code : typing___Optional[type___DeviceRequest.CodeX] = None,
        parameter : typing___Optional[typing___Iterable[type___DeviceRequest.Parameter]] = None,
        ...
        occurrence : typing___Optional[type___DeviceRequest.OccurrenceX] = None,
...
type___DeviceRequest = DeviceRequest
