...
class itkComposeImageFilterID2VID2(itk.itkImageToImageFilterBPython.itkImageToImageFilterID2VID2):
    ...
    {Filtering/ImageCompose/CreateVectorImageFromScalarImages,Create
    Vector Image From Scalar Images}
    {Filtering/ImageCompose/ComposeVectorFromThreeScalarImages,Compose
    Vector From Three Scalar Images}
    {Filtering/ImageCompose/ConvertRealAndImaginaryToComplexImage,Convert
    Real And Imaginary Images To Complex Image} 
    """
