...
class decimal_enumeration_st(str, Enum):
    _5='5'
    _1_0='10'
    _1_5='15'
...
class simpleOneType(GeneratedsSuper):
    ...
    member_data_items_ = [
        ...
        MemberSpec_('hexbinary_simple_value1', ['hexbinary_st', 'xs:hexBinary'], 0, 0, {'name': 'hexbinary_simple_value1', 'type': 'xs:hexBinary'}, None),
        MemberSpec_('hexbinary_simple_value2', ['hexbinary_st', 'xs:hexBinary'], 0, 0, {'name': 'hexbinary_simple_value2', 'type': 'xs:hexBinary'}, None),
        MemberSpec_('decimal_enumeration_simple_value1', ['decimal_enumeration_st', 'xs:decimal'], 0, 0, {'name': 'decimal_enumeration_simple_value1', 'type': 'xs:decimal'}, None),
        MemberSpec_('decimal_enumeration_simple_value2', ['decimal_enumeration_st', 'xs:decimal'], 0, 0, {'name': 'decimal_enumeration_simple_value2', 'type': 'xs:decimal'}, None),
    ...
    def __init__(self, integer_range_1_value_with_default='6', integer_range_1_value=5, pattern_value=None, token_enum_value=None, integer_range_incl_value=None, integer_range_excl_value=None, min_max_length_value=None, length_value=None, totalDigits_value=None, date_minincl_value=None, date_maxincl_value=None, date_minexcl_value=None, date_maxexcl_value=None, time_minincl_value=None, time_maxincl_value=None, time_minexcl_value=None, time_maxexcl_value=None, datetime_minincl_value=None, datetime_maxincl_value=None, datetime_minexcl_value=None, datetime_maxexcl_value=None, vbar_pattern_value=None, unicode_pattern_value=None, gyear_minincl_value=None, gyearmonth_minincl_value=None, simpletype0=None, simpletype1=None, simpletype2=None, simpletype0a=None, simpletype1a=None, simpletype2a=None, hexbinary_simple_value1=None, hexbinary_simple_value2=None, decimal_enumeration_simple_value1=None, decimal_enumeration_simple_value2=None, anonymous_float_value=None, primative_integer=None, primative_float=None, gds_collector_=None, **kwargs_):
        ...
        self.hexbinary_simple_value1 = hexbinary_simple_value1
        self.validate_hexbinary_st(self.hexbinary_simple_value1)
        self.hexbinary_simple_value1_nsprefix_ = None
        self.hexbinary_simple_value2 = hexbinary_simple_value2
        self.validate_hexbinary_st(self.hexbinary_simple_value2)
        self.hexbinary_simple_value2_nsprefix_ = None
        self.decimal_enumeration_simple_value1 = decimal_enumeration_simple_value1
        self.validate_decimal_enumeration_st(self.decimal_enumeration_simple_value1)
        self.decimal_enumeration_simple_value1_nsprefix_ = None
        self.decimal_enumeration_simple_value2 = decimal_enumeration_simple_value2
        self.validate_decimal_enumeration_st(self.decimal_enumeration_simple_value2)
        self.decimal_enumeration_simple_value2_nsprefix_ = None
    ...
    def set_simpletype2a(self, simpletype2a):
        self.simpletype2a = simpletype2a
    def get_hexbinary_simple_value1(self):
        return self.hexbinary_simple_value1
    def set_hexbinary_simple_value1(self, hexbinary_simple_value1):
        self.hexbinary_simple_value1 = hexbinary_simple_value1
    def get_hexbinary_simple_value2(self):
        return self.hexbinary_simple_value2
    def set_hexbinary_simple_value2(self, hexbinary_simple_value2):
        self.hexbinary_simple_value2 = hexbinary_simple_value2
    def get_decimal_enumeration_simple_value1(self):
        return self.decimal_enumeration_simple_value1
    def set_decimal_enumeration_simple_value1(self, decimal_enumeration_simple_value1):
        self.decimal_enumeration_simple_value1 = decimal_enumeration_simple_value1
    def get_decimal_enumeration_simple_value2(self):
        return self.decimal_enumeration_simple_value2
    def set_decimal_enumeration_simple_value2(self, decimal_enumeration_simple_value2):
        self.decimal_enumeration_simple_value2 = decimal_enumeration_simple_value2
    ...
    def validate_integer_range_A_2_st(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            ...
            if value > 10:
                ...
                result = False
        return result
    def validate_hexbinary_st(self, value):
        result = True
        # Validate type hexbinary_st, a restriction on xs:hexBinary.
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, str):
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s"%(lineno)s is not of the correct base simple type (str)' % {"value": value, "lineno": lineno, })
            ...
            if len(value) > 20:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s"%(lineno)s does not match xsd maxLength restriction on hexbinary_st' % {"value": value, "lineno": lineno} )
                result = False
            if len(value) < 8:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s"%(lineno)s does not match xsd minLength restriction on hexbinary_st' % {"value" : value, "lineno": lineno} )
                result = False
        return result
    def validate_decimal_enumeration_st(self, value):
        result = True
        # Validate type decimal_enumeration_st, a restriction on xs:decimal.
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, decimal_.Decimal):
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s"%(lineno)s is not of the correct base simple type (decimal_.Decimal)' % {"value": value, "lineno": lineno, })
                return False
            value = value
            enumerations = [decimal_.Decimal(5), decimal_.Decimal(10), decimal_.Decimal(15)]
            if value not in enumerations:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s"%(lineno)s does not match xsd enumeration restriction on decimal_enumeration_st' % {"value" : encode_str_2_3(value), "lineno": lineno} )
                result = False
        return result
    ...
    def hasContent_(self):
        if (
            ...
            self.hexbinary_simple_value1 is not None or
            self.hexbinary_simple_value2 is not None or
            self.decimal_enumeration_simple_value1 is not None or
            self.decimal_enumeration_simple_value2 is not None or
    ...
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:namespaceA="http://www.someplace.org/namespaceA" ', name_='simpleOneType', fromsubclass_=False, pretty_print=True):
        ...
        if self.hexbinary_simple_value1 is not None:
            namespaceprefix_ = self.hexbinary_simple_value1_nsprefix_ + ':' if (UseCapturedNS_ and self.hexbinary_simple_value1_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%shexbinary_simple_value1>%s</%shexbinary_simple_value1>%s' % (namespaceprefix_ , self.gds_encode(self.gds_format_string(quote_xml(self.hexbinary_simple_value1), input_name='hexbinary_simple_value1')), namespaceprefix_ , eol_))
        if self.hexbinary_simple_value2 is not None:
            namespaceprefix_ = self.hexbinary_simple_value2_nsprefix_ + ':' if (UseCapturedNS_ and self.hexbinary_simple_value2_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%shexbinary_simple_value2>%s</%shexbinary_simple_value2>%s' % (namespaceprefix_ , self.gds_encode(self.gds_format_string(quote_xml(self.hexbinary_simple_value2), input_name='hexbinary_simple_value2')), namespaceprefix_ , eol_))
        if self.decimal_enumeration_simple_value1 is not None:
            namespaceprefix_ = self.decimal_enumeration_simple_value1_nsprefix_ + ':' if (UseCapturedNS_ and self.decimal_enumeration_simple_value1_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sdecimal_enumeration_simple_value1>%s</%sdecimal_enumeration_simple_value1>%s' % (namespaceprefix_ , self.gds_format_decimal(self.decimal_enumeration_simple_value1, input_name='decimal_enumeration_simple_value1'), namespaceprefix_ , eol_))
        if self.decimal_enumeration_simple_value2 is not None:
            namespaceprefix_ = self.decimal_enumeration_simple_value2_nsprefix_ + ':' if (UseCapturedNS_ and self.decimal_enumeration_simple_value2_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sdecimal_enumeration_simple_value2>%s</%sdecimal_enumeration_simple_value2>%s' % (namespaceprefix_ , self.gds_format_decimal(self.decimal_enumeration_simple_value2, input_name='decimal_enumeration_simple_value2'), namespaceprefix_ , eol_))
    ...
    def validate_(self, gds_collector, recursive=False):
        ...
        self.gds_validate_defined_ST_(self.validate_hexbinary_st, self.hexbinary_simple_value1, 'hexbinary_simple_value1')
        self.gds_check_cardinality_(self.hexbinary_simple_value1, 'hexbinary_simple_value1', min_occurs=1, max_occurs=1)
        self.gds_validate_defined_ST_(self.validate_hexbinary_st, self.hexbinary_simple_value2, 'hexbinary_simple_value2')
        self.gds_check_cardinality_(self.hexbinary_simple_value2, 'hexbinary_simple_value2', min_occurs=1, max_occurs=1)
        self.gds_validate_defined_ST_(self.validate_decimal_enumeration_st, self.decimal_enumeration_simple_value1, 'decimal_enumeration_simple_value1')
        self.gds_check_cardinality_(self.decimal_enumeration_simple_value1, 'decimal_enumeration_simple_value1', min_occurs=1, max_occurs=1)
        self.gds_validate_defined_ST_(self.validate_decimal_enumeration_st, self.decimal_enumeration_simple_value2, 'decimal_enumeration_simple_value2')
        self.gds_check_cardinality_(self.decimal_enumeration_simple_value2, 'decimal_enumeration_simple_value2', min_occurs=1, max_occurs=1)
    ...
    def buildAttributes(self, node, attrs, already_processed):
        ...
        if value is not None and 'integer_range_1_value_with_default' not in already_processed:
            already_processed.add('integer_range_1_value_with_default')
            self.integer_range_1_value_with_default = self.gds_parse_integer(value, node, 'integer_range_1_value_with_default')
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'integer_range_1_value' and child_.text:
            ...
            # validate type integer_range_A_2_st
            self.validate_integer_range_A_2_st(self.simpletype2a)
        elif nodeName_ == 'hexbinary_simple_value1':
            value_ = child_.text
            value_ = self.gds_parse_string(value_, node, 'hexbinary_simple_value1')
            value_ = self.gds_validate_string(value_, node, 'hexbinary_simple_value1')
            self.hexbinary_simple_value1 = value_
            self.hexbinary_simple_value1_nsprefix_ = child_.prefix
            # validate type hexbinary_st
            self.validate_hexbinary_st(self.hexbinary_simple_value1)
        elif nodeName_ == 'hexbinary_simple_value2':
            value_ = child_.text
            value_ = self.gds_parse_string(value_, node, 'hexbinary_simple_value2')
            value_ = self.gds_validate_string(value_, node, 'hexbinary_simple_value2')
            self.hexbinary_simple_value2 = value_
            self.hexbinary_simple_value2_nsprefix_ = child_.prefix
            # validate type hexbinary_st
            self.validate_hexbinary_st(self.hexbinary_simple_value2)
        elif nodeName_ == 'decimal_enumeration_simple_value1' and child_.text:
            sval_ = child_.text
            fval_ = self.gds_parse_decimal(sval_, node, 'decimal_enumeration_simple_value1')
            fval_ = self.gds_validate_decimal(fval_, node, 'decimal_enumeration_simple_value1')
            self.decimal_enumeration_simple_value1 = fval_
            self.decimal_enumeration_simple_value1_nsprefix_ = child_.prefix
            # validate type decimal_enumeration_st
            self.validate_decimal_enumeration_st(self.decimal_enumeration_simple_value1)
        elif nodeName_ == 'decimal_enumeration_simple_value2' and child_.text:
            sval_ = child_.text
            fval_ = self.gds_parse_decimal(sval_, node, 'decimal_enumeration_simple_value2')
            fval_ = self.gds_validate_decimal(fval_, node, 'decimal_enumeration_simple_value2')
            self.decimal_enumeration_simple_value2 = fval_
            self.decimal_enumeration_simple_value2_nsprefix_ = child_.prefix
            # validate type decimal_enumeration_st
            self.validate_decimal_enumeration_st(self.decimal_enumeration_simple_value2)
