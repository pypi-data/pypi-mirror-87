 ...
 *        the Mean squared error objective function in the batch processing mode    \DAAL_DEPRECATED
 *
 ...
 * \brief Computes the Mean squared error objective function in the batch processing mode.     \DAAL_DEPRECATED
...
public:
    ...
    typedef algorithms::optimization_solver::mse::interface1::Input InputType;
    typedef algorithms::optimization_solver::mse::interface1::Parameter ParameterType;
