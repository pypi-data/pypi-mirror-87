...
class itkBinaryContourImageFilterID2ID2(itk.itkInPlaceImageFilterAPython.itkInPlaceImageFilterID2ID2):
    ...
    {Filtering/ImageLabel/ExtractBoundariesOfConnectedRegionsInBinaryImag
    e,Extract Boundaries Of Connected Regions In Binary Image}
    {Filtering/ImageLabel/ExtractBoundariesOfBlobsInBinaryImage,Extract
    Inner And Outer Boundaries Of Blobs In Binary Image} 
    """
