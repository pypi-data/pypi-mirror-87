...
class V1alpha1TriggerParameterSource(object):
    ...
    def context_key(self):
        """Gets the context_key of this V1alpha1TriggerParameterSource.  # noqa: E501
        ...
        :return: The context_key of this V1alpha1TriggerParameterSource.  # noqa: E501
        :rtype: str
        """
    ...
    def context_key(self, context_key):
        """Sets the context_key of this V1alpha1TriggerParameterSource.

        ContextKey is the JSONPath of the event's (JSON decoded) context key ContextKey is a series of keys separated by a dot. A key may contain wildcard characters '*' and '?'. To access an array value use the index as the key. The dot and wildcard characters can be escaped with '\\'. See https://github.com/tidwall/gjson#path-syntax for more information on how to use this.  # noqa: E501

        :param context_key: The context_key of this V1alpha1TriggerParameterSource.  # noqa: E501
        :type: str
        """
    ...
    def context_template(self):
        """Gets the context_template of this V1alpha1TriggerParameterSource.  # noqa: E501
        ...
        :return: The context_template of this V1alpha1TriggerParameterSource.  # noqa: E501
        :rtype: str
        """
    ...
    def context_template(self, context_template):
        """Sets the context_template of this V1alpha1TriggerParameterSource.

        ContextTemplate is a go-template for extracting a string from the event's context. If a ContextTemplate is provided with a ContextKey, the template will be evaluated first and fallback to the ContextKey. The templating follows the standard go-template syntax as well as sprig's extra functions. See https://pkg.go.dev/text/template and https://masterminds.github.io/sprig/  # noqa: E501

        :param context_template: The context_template of this V1alpha1TriggerParameterSource.  # noqa: E501
        :type: str
        """
    ...
    @property
    def data_key(self):
        """Gets the data_key of this V1alpha1TriggerParameterSource.  # noqa: E501
        ...
        :return: The data_key of this V1alpha1TriggerParameterSource.  # noqa: E501
        :rtype: str
        """
    ...
    def data_key(self, data_key):
        """Sets the data_key of this V1alpha1TriggerParameterSource.

        DataKey is the JSONPath of the event's (JSON decoded) data key DataKey is a series of keys separated by a dot. A key may contain wildcard characters '*' and '?'. To access an array value use the index as the key. The dot and wildcard characters can be escaped with '\\'. See https://github.com/tidwall/gjson#path-syntax for more information on how to use this.  # noqa: E501

        :param data_key: The data_key of this V1alpha1TriggerParameterSource.  # noqa: E501
        :type: str
        """
    ...
    def data_template(self):
        """Gets the data_template of this V1alpha1TriggerParameterSource.  # noqa: E501
        ...
        :return: The data_template of this V1alpha1TriggerParameterSource.  # noqa: E501
        :rtype: str
        """
    ...
    def data_template(self, data_template):
        """Sets the data_template of this V1alpha1TriggerParameterSource.

        DataTemplate is a go-template for extracting a string from the event's data. If a DataTemplate is provided with a DataKey, the template will be evaluated first and fallback to the DataKey. The templating follows the standard go-template syntax as well as sprig's extra functions. See https://pkg.go.dev/text/template and https://masterminds.github.io/sprig/  # noqa: E501

        :param data_template: The data_template of this V1alpha1TriggerParameterSource.  # noqa: E501
        :type: str
        """
    ...
    def dependency_name(self):
        """Gets the dependency_name of this V1alpha1TriggerParameterSource.  # noqa: E501
        ...
        :return: The dependency_name of this V1alpha1TriggerParameterSource.  # noqa: E501
        :rtype: str
        """
    ...
    def dependency_name(self, dependency_name):
        """Sets the dependency_name of this V1alpha1TriggerParameterSource.

        DependencyName refers to the name of the dependency. The event which is stored for this dependency is used as payload for the parameterization. Make sure to refer to one of the dependencies you have defined under Dependencies list.  # noqa: E501

        :param dependency_name: The dependency_name of this V1alpha1TriggerParameterSource.  # noqa: E501
        :type: str
        """
        if self.local_vars_configuration.client_side_validation and dependency_name is None:  # noqa: E501
            raise ValueError("Invalid value for `dependency_name`, must not be `None`")  # noqa: E501

        self._dependency_name = dependency_name

    @property
    def value(self):
        """Gets the value of this V1alpha1TriggerParameterSource.  # noqa: E501
        ...
        :return: The value of this V1alpha1TriggerParameterSource.  # noqa: E501
        :rtype: str
        """
        return self._value
    ...
    def value(self, value):
        """Sets the value of this V1alpha1TriggerParameterSource.

        Value is the default literal value to use for this parameter source This is only used if the DataKey is invalid. If the DataKey is invalid and this is not defined, this param source will produce an error.  # noqa: E501

        :param value: The value of this V1alpha1TriggerParameterSource.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, V1alpha1TriggerParameterSource):
            return False
