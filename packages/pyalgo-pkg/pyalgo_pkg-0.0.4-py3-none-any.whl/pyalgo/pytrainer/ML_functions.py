...
class Basic_ML_functions:
    ...
    def Tanh(cls, X, Scaler=2):
        floatType = basic_modules.default_values.FloatType
        intType = basic_modules.default_values.IntType
...
class ML_functions_Training(Basic_ML_functions):
    ...
    @staticmethod
    def cost_function(X, Y, Theta, NonLinearityFunction=default_functions.LinearNonLinearity, Method='MSE', AddBias=True, Lambda=None):
