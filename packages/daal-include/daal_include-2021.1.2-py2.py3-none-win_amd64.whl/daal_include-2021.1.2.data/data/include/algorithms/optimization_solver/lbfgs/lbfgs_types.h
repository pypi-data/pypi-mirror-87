 ...
 *
 * \snippet optimization_solver/lbfgs/lbfgs_types.h interface1::Parameter source code
 */
...
* \brief %Input class for LBFGS algorithm         \DAAL_DEPRECATED
*
* \snippet optimization_solver/lbfgs/lbfgs_types.h interface1::Input source code
*/
...
* \brief Results obtained with the compute() method of the LBFGS algorithm in the batch processing mode    \DAAL_DEPRECATED
*/
