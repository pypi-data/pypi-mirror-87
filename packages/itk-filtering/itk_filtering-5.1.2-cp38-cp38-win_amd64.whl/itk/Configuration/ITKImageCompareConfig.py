...
snake_case_functions = ('staple_image_filter', 'absolute_value_difference_image_filter', 'similarity_index_image_filter', 'squared_difference_image_filter', 'checker_board_image_filter', )
