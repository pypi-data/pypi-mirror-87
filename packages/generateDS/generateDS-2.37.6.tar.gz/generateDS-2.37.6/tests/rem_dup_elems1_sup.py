...
class authorsType(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, author=None, cooperation=None, gds_collector_=None, **kwargs_):
        ...
        self.cooperation_nsprefix_ = None
    ...
    def insert_cooperation_at(self, index, value):
        self.cooperation.insert(index, value)
    def replace_cooperation_at(self, index, value):
        self.cooperation[index] = value
    ...
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='authorsType', fromsubclass_=False, pretty_print=True):
        ...
        for cooperation_ in self.cooperation:
            namespaceprefix_ = self.cooperation_nsprefix_ + ':' if (UseCapturedNS_ and self.cooperation_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'author':
            ...
            value_ = child_.text
            value_ = self.gds_parse_string(value_, node, 'cooperation')
            value_ = self.gds_validate_string(value_, node, 'cooperation')
            self.cooperation.append(value_)
            self.cooperation_nsprefix_ = child_.prefix
...
class author(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='author', pretty_print=True):
    ...
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='author'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='author', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
