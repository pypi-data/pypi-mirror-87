...
class itkImageSourceLM2(itk.ITKCommonBasePython.itkProcessObject):
    ...
    example{Core/Common/ProduceImageProgrammatically,Produce Image
    Programmatically} 
    """
...
class itkImageToImageFilterID2LM2(itkImageSourceLM2):
    ...
    example{Core/Common/FilterImage,Filter Image}
    example{Core/Common/MultipleInputsOfSameType,Multiple Inputs Of Same
    Type}  example{Core/Common/MultipleInputsOfDifferentType,Multiple
    Inputs Of Different Type}
    example{Core/Common/MultipleOutputsOfSameType,Multiple Outputs Of Same
    Type}  example{Core/Common/MultThreadOilPainting,Mult-thread Oil
    Painting}  example{Core/Common/MultipleOutputsOfDifferentType,Multiple
    Outputs Of Different Type}
    example{Core/Common/FilterImageUsingMultipleThreads,Filter Image Using
    Multiple Threads} 
    """
...
class itkLabelMap2(itk.itkImagePython.itkImageBase2):
    ...
    example{Filtering/LabelMap/RemoveLabelsFromLabelMa,Remove Labels From
    Label Map} 
    """
