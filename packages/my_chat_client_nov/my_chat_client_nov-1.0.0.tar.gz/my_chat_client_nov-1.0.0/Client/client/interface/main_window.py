...
from client.interface.del_contact import DelContactDialog
from client.interface.add_contact import AddContactDialog
from client.interface.main_window_conv import Ui_MainClientWindow
