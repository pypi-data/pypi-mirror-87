...
from openapi_client.models.policy_response import PolicyResponse  # noqa: E501
...
class TestPolicyResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = openapi_client.models.policy_response.PolicyResponse()  # noqa: E501
        if include_optional :
            return PolicyResponse(
                policies = [
                    openapi_client.models.policy_model.PolicyModel(
                        name = '0', 
                        members = [
                            '0'
                            ], )
