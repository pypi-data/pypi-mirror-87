...
class AnnotationInputV1(object):
    ...
    def created_by_id(self):
        ...
        The ID of the User that created this annotation. If omitted when creating a new annotation, the authenticated user is used by default. Only administrators can set this value.
