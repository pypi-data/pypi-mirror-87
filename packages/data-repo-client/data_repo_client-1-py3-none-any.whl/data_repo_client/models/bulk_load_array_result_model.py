...
class BulkLoadArrayResultModel(object):
    ...
    """
    openapi_types = {
        'load_summary': 'BulkLoadResultModel',
        'load_file_results': 'list[BulkLoadFileResultModel]'
    }

    attribute_map = {
        'load_summary': 'loadSummary',
        'load_file_results': 'loadFileResults'
    }

    def __init__(self, load_summary=None, load_file_results=None, local_vars_configuration=None):  # noqa: E501
        """BulkLoadArrayResultModel - a model defined in OpenAPI"""  # noqa: E501
        if local_vars_configuration is None:
            local_vars_configuration = Configuration()
        self.local_vars_configuration = local_vars_configuration

        self._load_summary = None
        self._load_file_results = None
        self.discriminator = None

        if load_summary is not None:
            self.load_summary = load_summary
        if load_file_results is not None:
            self.load_file_results = load_file_results

    @property
    def load_summary(self):
        """Gets the load_summary of this BulkLoadArrayResultModel.  # noqa: E501


        :return: The load_summary of this BulkLoadArrayResultModel.  # noqa: E501
        :rtype: BulkLoadResultModel
        """
        return self._load_summary

    @load_summary.setter
    def load_summary(self, load_summary):
        """Sets the load_summary of this BulkLoadArrayResultModel.


        :param load_summary: The load_summary of this BulkLoadArrayResultModel.  # noqa: E501
        :type: BulkLoadResultModel
        """

        self._load_summary = load_summary

    @property
    def load_file_results(self):
        """Gets the load_file_results of this BulkLoadArrayResultModel.  # noqa: E501


        :return: The load_file_results of this BulkLoadArrayResultModel.  # noqa: E501
        :rtype: list[BulkLoadFileResultModel]
        """
        return self._load_file_results

    @load_file_results.setter
    def load_file_results(self, load_file_results):
        """Sets the load_file_results of this BulkLoadArrayResultModel.


        :param load_file_results: The load_file_results of this BulkLoadArrayResultModel.  # noqa: E501
        :type: list[BulkLoadFileResultModel]
        """

        self._load_file_results = load_file_results
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BulkLoadArrayResultModel):
            return False
