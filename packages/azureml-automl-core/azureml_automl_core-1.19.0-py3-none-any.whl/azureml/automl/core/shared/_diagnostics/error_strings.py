...
class AutoMLErrorStrings:
    ...
    TIMESERIES_ONE_POINT_PER_GRAIN = "Could not determine the dataset time frequency. "\
                                     "All series in the dataset have one row and no freq parameter was provided. " \
