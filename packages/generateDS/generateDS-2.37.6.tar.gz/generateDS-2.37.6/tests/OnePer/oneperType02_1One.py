...
class oneperEnumType00_1(str, Enum):
    FLOAT='float'
    INT='int'
    NAME='Name'
    TOKEN='token'
...
class oneperEnumType01_1(str, Enum):
    FLOAT='float'
    INT='int'
    NAME='Name'
    TOKEN='token'
...
class oneperType02_1(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, clientname=None, inner01=None, gds_collector_=None, **kwargs_):
        ...
        self.clientname_nsprefix_ = None
        self.inner01 = inner01
        self.inner01_nsprefix_ = None
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='oneperType02_1', pretty_print=True):
        ...
        if pretty_print:
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'oneperType02_1':
        ...
        if self.hasContent_():
            ...
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='oneperType02_1', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
    ...
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='oneperType02_1'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='oneperType02_1', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.clientname is not None:
            namespaceprefix_ = self.clientname_nsprefix_ + ':' if (UseCapturedNS_ and self.clientname_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
        ...
        if self.inner01 is not None:
            namespaceprefix_ = self.inner01_nsprefix_ + ':' if (UseCapturedNS_ and self.inner01_nsprefix_) else ''
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'clientname':
            value_ = child_.text
            value_ = self.gds_parse_string(value_, node, 'clientname')
            value_ = self.gds_validate_string(value_, node, 'clientname')
            self.clientname = value_
            self.clientname_nsprefix_ = child_.prefix
        elif nodeName_ == 'inner01':
            obj_ = oneperType02_2.factory(parent_object_=self)
...
class oneperType02_2(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, clientdescription=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
        ...
        self.clientdescription_nsprefix_ = None
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
    ...
    def set_ns_prefix_(self, ns_prefix):
        self.ns_prefix_ = ns_prefix
    def get_clientdescription(self):
        return self.clientdescription
    def set_clientdescription(self, clientdescription):
        self.clientdescription = clientdescription
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='oneperType02_2', pretty_print=True):
        ...
        if pretty_print:
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'oneperType02_2':
            name_ = self.original_tagname_
        if UseCapturedNS_ and self.ns_prefix_:
            namespaceprefix_ = self.ns_prefix_ + ':'
        showIndent(outfile, level, pretty_print)
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='oneperType02_2', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='oneperType02_2'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='oneperType02_2', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.clientdescription is not None:
            namespaceprefix_ = self.clientdescription_nsprefix_ + ':' if (UseCapturedNS_ and self.clientdescription_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sclientdescription>%s</%sclientdescription>%s' % (namespaceprefix_ , self.gds_encode(self.gds_format_string(quote_xml(self.clientdescription), input_name='clientdescription')), namespaceprefix_ , eol_))
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
            self.gds_elementtree_node_ = node
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'clientdescription':
            value_ = child_.text
            value_ = self.gds_parse_string(value_, node, 'clientdescription')
            value_ = self.gds_validate_string(value_, node, 'clientdescription')
            self.clientdescription = value_
            self.clientdescription_nsprefix_ = child_.prefix
