...
class BasicThruster:
    ...
    def __init__(self, oxName='N2O4', fuelName='MMH',  MR=1.5,
                 ...
                 effMix=1.0, effVap=1.0, effHL=1.0, elemEm=0.8,
        ...
        :param elemEm: intra-element Rupe mixing factor
    ...
    def calc_effEm(self, call_calc_overall=True):
        ...
        mrLow = self.MR * self.elemEm
        mrHi = self.MR / self.elemEm
        ...
        xm1=(1.+mrLow)/(1.+self.elemEm)/(1.+self.MR)
        xm2=1.0-xm1
        self.effEm = (xm1*odkLowIsp + xm2*odkHiIsp) / IspODK
        self.effEm_method = 'RocketIsp (elemEm=%g)'%self.elemEm
