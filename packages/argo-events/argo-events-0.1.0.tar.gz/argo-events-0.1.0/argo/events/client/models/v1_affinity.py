...
class V1Affinity(object):
    ...
    """
    openapi_types = {
        'node_affinity': 'V1AffinityNodeAffinity',
        'pod_affinity': 'V1AffinityPodAffinity',
        'pod_anti_affinity': 'V1AffinityPodAntiAffinity'
    }
    ...
    def pod_anti_affinity(self):
        ...
        :rtype: V1AffinityPodAntiAffinity
        """
