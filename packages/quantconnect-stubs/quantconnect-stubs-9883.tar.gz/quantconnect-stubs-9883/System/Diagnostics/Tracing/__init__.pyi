...
System_Diagnostics_Tracing_EventSource_T = typing.TypeVar('System_Diagnostics_Tracing_EventSource_T')
...
class EventCommandEventArgs(System.EventArgs):
    ...
    @Command.setter
    def Command(self, value: System.Diagnostics.Tracing.EventCommand):
        """Gets the command for the callback."""
        ...
...
class EventSourceOptions:
    ...
    @Opcode.setter
    def Opcode(self, value: System.Diagnostics.Tracing.EventOpcode):
        """
        Gets or sets the opcode to use for the specified event. If this property
        is unset, the event's opcode will 0 (Info).
        """
...
class EventSource(System.Object, System.IDisposable):
    ...
    call one of the EventSource.WriteEvent overloads, EventSource.WriteEventCore,
    or EventSource.WriteEventWithRelatedActivityIdCore to log them. This functionality
    ...
    @typing.overload
    def WriteEvent(self, eventId: int, *args: System.Object) -> None:
        """This method is protected."""
        ...

    def WriteEventWithRelatedActivityId(self, eventId: int, relatedActivityId: System.Guid, *args: System.Object) -> None:
        """
    ...
    @typing.overload
    def Write(self, eventName: str, data: System_Diagnostics_Tracing_EventSource_T) -> None:
        """
        Writes an event.
        (Native API: EventWriteTransfer)
    ...
    @typing.overload
    def Write(self, eventName: str, options: System.Diagnostics.Tracing.EventSourceOptions, data: System_Diagnostics_Tracing_EventSource_T) -> None:
        """
        Writes an event.
        (Native API: EventWriteTransfer)
    ...
    @typing.overload
    def Write(self, eventName: str, options: System.Diagnostics.Tracing.EventSourceOptions, activityId: System.Guid, relatedActivityId: System.Guid, data: System_Diagnostics_Tracing_EventSource_T) -> None:
        """
        Writes an event.
...
class EventAttribute(System.Attribute):
    ...
    @Task.setter
    def Task(self, value: System.Diagnostics.Tracing.EventTask):
        """Event's task: allows logical grouping of events"""
        ...
...
class EventFieldAttribute(System.Attribute):
    ...
    @Tags.setter
    def Tags(self, value: System.Diagnostics.Tracing.EventFieldTags):
        """
        User defined options for the field. These are not interpreted by the EventSource
        but are available to the Listener. See EventFieldSettings for details
        """
    ...
    @Format.setter
    def Format(self, value: System.Diagnostics.Tracing.EventFieldFormat):
        """Gets or sets a field formatting hint."""
        ...
