...
</dom-module>`;document.head.appendChild(n.content)},22726:(e,t,o)=>{"use strict";class n extends HTMLElement{static get version(){return"1.2.3"}}customElements.define("vaadin-material-styles",n)},1335:(e,t,o)=>{"use strict";o.d(t,{G:()=>b});var n=o(28426),r=o(52521),a=o(87529),i=o(20723),s=o(15520);const l=Element.prototype,d=l.matches||l.matchesSelector||l.mozMatchesSelector||l.msMatchesSelector||l.oMatchesSelector||l.webkitMatchesSelector,c={getTabbableNodes:function(e){const t=[];return this._collectTabbableNodes(e,t)?this._sortByTabIndex(t):t},isFocusable:function(e){return d.call(e,"input, select, textarea, button, object")?d.call(e,":not([disabled])"):d.call(e,"a[href], area[href], iframe, [tabindex], [contentEditable]")},isTabbable:function(e){return this.isFocusable(e)&&d.call(e,':not([tabindex="-1"])')&&this._isVisible(e)},_normalizedTabIndex:function(e){if(this.isFocusable(e)){const t=e.getAttribute("tabindex")||0;return Number(t)}return-1},_collectTabbableNodes:function(e,t){if(e.nodeType!==Node.ELEMENT_NODE||!this._isVisible(e))return!1;const o=e,n=this._normalizedTabIndex(o);let r,a=n>0;if(n>=0&&t.push(o),r="slot"===o.localName?o.assignedNodes({flatten:!0}):(o.shadowRoot||o).children,r)for(let i=0;i<r.length;i++)a=this._collectTabbableNodes(r[i],t)||a;return a},_isVisible:function(e){let t=e.style;return"hidden"!==t.visibility&&"none"!==t.display&&(t=window.getComputedStyle(e),"hidden"!==t.visibility&&"none"!==t.display)},_sortByTabIndex:function(e){const t=e.length;if(t<2)return e;const o=Math.ceil(t/2),n=this._sortByTabIndex(e.slice(0,o)),r=this._sortByTabIndex(e.slice(o));return this._mergeSortByTabIndex(n,r)},_mergeSortByTabIndex:function(e,t){const o=[];for(;e.length>0&&t.length>0;)this._hasLowerTabOrder(e[0],t[0])?o.push(t.shift()):o.push(e.shift());return o.concat(e,t)},_hasLowerTabOrder:function(e,t){const o=Math.max(e.tabIndex,0),n=Math.max(t.tabIndex,0);return 0===o||0===n?n>o:o>n}};var h=o(50856);let m=0;const p={},u=e=>{m++;const t="vaadin-overlay-content-"+m,o=document.createElement("template"),n=document.createElement("style");n.textContent=":host { display: block; }"+e,o.content.appendChild(n),window.ShadyCSS&&window.ShadyCSS.prepareTemplate(o,t);const r=class extends HTMLElement{static get is(){return t}constructor(){super(),this.shadowRoot||(this.attachShadow({mode:"open"}),this.shadowRoot.appendChild(document.importNode(o.content,!0)))}connectedCallback(){window.ShadyCSS&&window.ShadyCSS.styleElement(this)}};return customElements.define(r.is,r),p[e]=t,t};class b extends((0,s.T)(n.H3)){static get template(){return h.d`
    <style>
      :host {
        z-index: 200;
        position: fixed;
