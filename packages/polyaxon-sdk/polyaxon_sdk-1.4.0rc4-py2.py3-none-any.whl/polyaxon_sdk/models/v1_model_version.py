...
class V1ModelVersion(object):
    ...
    def __init__(self, uuid=None, name=None, description=None, tags=None, live_state=None, created_at=None, updated_at=None, stage=None, stage_conditions=None, framework=None, metadata=None, local_vars_configuration=None):  # noqa: E501
