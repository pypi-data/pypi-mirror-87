...
m.Simulator(dim=[25., 25., 25.], cutoff=3, dt=0.005, periodic=m.PERIODIC_NONE)
...
h = m.Potential.harmonic(k=50, r0=0.001, max = 5)

#h = m.Potential.linear(k=0.5,  max = 5)

#pb= m.Potential.glj(e=0.00001, r0=0.1, m=3, min=0.01, max=Blue.radius*3)
pb = m.Potential.glj(e=0.00001, r0=0.1, m=3, min=0.001, max=Blue.radius*2)
...
parts, bonds = m.bind_sphere(h, type=Blue, n=5, phi=(0.55 * np.pi, 0.6 * np.pi), radius = Big.radius + Blue.radius)
