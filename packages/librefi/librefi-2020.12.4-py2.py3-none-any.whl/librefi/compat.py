...
# based on https://github.com/ytdl-org/youtube-dl/blob/master/youtube_dl/compat.py
...
try:
    ...
    from urllib import quote as compat_urllib_parse_quote
    from urllib import quote_plus as compat_urllib_parse_quote_plus
...
if compat_sys_platform.startswith('linux'):
    compat_sys_platform = 'linux'
elif compat_sys_platform.startswith('aix'):
    compat_sys_platform = 'aix'
