...
class ShareableLibrary(google___protobuf___message___Message):
    ...
    @property
    def status(self) -> type___ShareableLibrary.StatusCode: ...
    ...
    @property
    def subject(self) -> type___ShareableLibrary.SubjectX: ...
    ...
    @property
    def parameter(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[proto___google___fhir___proto___r4___core___datatypes_pb2___ParameterDefinition]: ...
    ...
    @property
    def content(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[proto___google___fhir___proto___r4___core___datatypes_pb2___Attachment]: ...
    ...
    def __init__(self,
        *,
        ...
        status : typing___Optional[type___ShareableLibrary.StatusCode] = None,
        ...
        subject : typing___Optional[type___ShareableLibrary.SubjectX] = None,
        ...
        parameter : typing___Optional[typing___Iterable[proto___google___fhir___proto___r4___core___datatypes_pb2___ParameterDefinition]] = None,
        ...
        content : typing___Optional[typing___Iterable[proto___google___fhir___proto___r4___core___datatypes_pb2___Attachment]] = None,
        ) -> None: ...
    ...
    def ClearField(self, field_name: typing_extensions___Literal[u"approval_date",b"approval_date",u"author",b"author",u"contact",b"contact",u"contained",b"contained",u"content",b"content",u"copyright",b"copyright",u"data_requirement",b"data_requirement",u"date",b"date",u"description",b"description",u"editor",b"editor",u"effective_period",b"effective_period",u"endorser",b"endorser",u"experimental",b"experimental",u"extension",b"extension",u"id",b"id",u"identifier",b"identifier",u"implicit_rules",b"implicit_rules",u"jurisdiction",b"jurisdiction",u"language",b"language",u"last_review_date",b"last_review_date",u"meta",b"meta",u"modifier_extension",b"modifier_extension",u"name",b"name",u"parameter",b"parameter",u"publisher",b"publisher",u"purpose",b"purpose",u"related_artifact",b"related_artifact",u"reviewer",b"reviewer",u"status",b"status",u"subject",b"subject",u"subtitle",b"subtitle",u"text",b"text",u"title",b"title",u"topic",b"topic",u"type",b"type",u"url",b"url",u"usage",b"usage",u"use_context",b"use_context",u"version",b"version"]) -> None: ...
type___ShareableLibrary = ShareableLibrary
