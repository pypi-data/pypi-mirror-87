...
class DroneClient(Client):
    ...
    def list_extensions(self, share_id: int) -> models_pb2.Filter:
        return self.perform_request(
            self.scanner_stub.ListExtensions,
            models_pb2.Share(id=share_id)
        )
    ...
    def download_multiple_files(self, share_id: int, parse_credentials: bool, credential_id: int, extension: str = '',
                                ...
                                share_file_ids: Optional[List[int]] = None) -> models_pb2.CountMessage:
        return self.perform_request(
    ...
    def parse_files(self, scan_id: int, extension: str = '', max_count: int = 0, skip_parsed: bool = False, keyword: str = '',
