...
class PersonType(GeneratedsSuper):
    ...
    member_data_items_ = [
        MemberSpec_('personId', 'PersonIdType', 0, 0, {'maxOccurs': '1', 'minOccurs': '1', 'name': 'personId', 'ref': 'personId', 'type': 'personId'}, None),
    ...
    subclass = None
    superclass = None
    def __init__(self, personId=None, fname=None, lname=None, gds_collector_=None, **kwargs_):
        ...
        self.fname = fname
        self.fname_nsprefix_ = None
        self.lname = lname
        self.lname_nsprefix_ = None
    ...
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='PersonType'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='PersonType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.personId is not None:
            ...
            self.personId.export(outfile, level, namespaceprefix_, namespacedef_='', name_='personId', pretty_print=pretty_print)
        if self.fname is not None:
            namespaceprefix_ = self.fname_nsprefix_ + ':' if (UseCapturedNS_ and self.fname_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
        ...
        if self.lname is not None:
            namespaceprefix_ = self.lname_nsprefix_ + ':' if (UseCapturedNS_ and self.lname_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'personId':
            obj_ = PersonIdType.factory(parent_object_=self)
            obj_.build(child_, gds_collector_=gds_collector_)
            self.personId = obj_
            obj_.original_tagname_ = 'personId'
        elif nodeName_ == 'fname':
            value_ = child_.text
            value_ = self.gds_parse_string(value_, node, 'fname')
            value_ = self.gds_validate_string(value_, node, 'fname')
            self.fname = value_
            self.fname_nsprefix_ = child_.prefix
        elif nodeName_ == 'lname':
            value_ = child_.text
            value_ = self.gds_parse_string(value_, node, 'lname')
            value_ = self.gds_validate_string(value_, node, 'lname')
            self.lname = value_
            self.lname_nsprefix_ = child_.prefix
# end class PersonType


class PersonIdType(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    member_data_items_ = [
        MemberSpec_('valueOf_', ['PersonIdType_impl', 'IdType', 'xs:integer'], 0),
    ]
    subclass = None
    superclass = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, PersonIdType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if PersonIdType.subclass:
            return PersonIdType.subclass(*args_, **kwargs_)
        else:
            return PersonIdType(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_ns_prefix_(self):
        return self.ns_prefix_
    def set_ns_prefix_(self, ns_prefix):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='PersonIdType', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('PersonIdType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'PersonIdType':
            name_ = self.original_tagname_
        if UseCapturedNS_ and self.ns_prefix_:
            namespaceprefix_ = self.ns_prefix_ + ':'
        showIndent(outfile, level, pretty_print)
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='PersonIdType')
        if self.hasContent_():
            outfile.write('>')
            outfile.write(self.convert_unicode(self.valueOf_))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='PersonIdType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='PersonIdType'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='PersonIdType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
