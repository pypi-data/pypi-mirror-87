...
class AnnotationOutputV1(object):
    ...
    def __init__(self, background=False, backups=None, content_ids=None, created_at=None, created_by=None, cron_schedule=None, date_range_ids=None, description=None, discoverable=False, document=None, effective_permissions=None, enabled=False, href=None, id=None, interests=None, is_archived=False, is_redacted=False, name=None, next_run_time=None, published_at=None, replies=None, replies_to=None, status_message=None, type=None, updated_at=None):
        """
