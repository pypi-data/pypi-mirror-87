...
import os
import traceback
import CapiPy.src.BMOD as BMOD
import CapiPy.src.QUAT as QUAT 
import CapiPy.src.AS_ID as AS_ID 
import CapiPy.src.S2_analysis as S2_analysis 
import CapiPy.src.ClusterDistance as ClusterDistance
import CapiPy.src.Ref_retrieval as Ref_retrieval
import webbrowser
import json
import subprocess
import time
...
def main():
    ...
    sg.theme(default_settings['theme'])
                ...
                if len(checks) == 0:
                    ...
                    try:
                        ...
                        if output_programs == "YES":
                            ...
                            elif not os.path.isfile(workdir + '/' + folder_name + '/Blast&Modeller/query_multimeric.pdb'):
