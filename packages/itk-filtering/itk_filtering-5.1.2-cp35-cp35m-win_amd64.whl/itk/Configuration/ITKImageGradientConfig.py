...
templates = (
  ...
  ('DifferenceOfGaussiansGradientImageFilter', 'itk::DifferenceOfGaussiansGradientImageFilter', 'itkDifferenceOfGaussiansGradientImageFilterIUS2F', True, 'itk::Image< unsigned short,2 >, float'),
  ...
  ('DifferenceOfGaussiansGradientImageFilter', 'itk::DifferenceOfGaussiansGradientImageFilter', 'itkDifferenceOfGaussiansGradientImageFilterID2F', True, 'itk::Image< double,2 >, float'),
  ...
  ('DifferenceOfGaussiansGradientImageFilter', 'itk::DifferenceOfGaussiansGradientImageFilter', 'itkDifferenceOfGaussiansGradientImageFilterIUS3F', True, 'itk::Image< unsigned short,3 >, float'),
  ...
  ('DifferenceOfGaussiansGradientImageFilter', 'itk::DifferenceOfGaussiansGradientImageFilter', 'itkDifferenceOfGaussiansGradientImageFilterID3F', True, 'itk::Image< double,3 >, float'),
  ...
  ('GradientImageFilter', 'itk::GradientImageFilter', 'itkGradientImageFilterIUS2FF', True, 'itk::Image< unsigned short,2 >,float,float'),
  ('GradientImageFilter', 'itk::GradientImageFilter', 'itkGradientImageFilterIF2FF', True, 'itk::Image< float,2 >,float,float'),
  ('GradientImageFilter', 'itk::GradientImageFilter', 'itkGradientImageFilterID2FF', True, 'itk::Image< double,2 >,float,float'),
  ...
  ('GradientImageFilter', 'itk::GradientImageFilter', 'itkGradientImageFilterIUS3FF', True, 'itk::Image< unsigned short,3 >,float,float'),
  ('GradientImageFilter', 'itk::GradientImageFilter', 'itkGradientImageFilterIF3FF', True, 'itk::Image< float,3 >,float,float'),
  ('GradientImageFilter', 'itk::GradientImageFilter', 'itkGradientImageFilterID3FF', True, 'itk::Image< double,3 >,float,float'),
  ...
  ('GradientMagnitudeImageFilter', 'itk::GradientMagnitudeImageFilter', 'itkGradientMagnitudeImageFilterIUS2IUS2', True, 'itk::Image< unsigned short,2 >, itk::Image< unsigned short,2 >'),
  ('GradientMagnitudeImageFilter', 'itk::GradientMagnitudeImageFilter', 'itkGradientMagnitudeImageFilterIUS3IUS3', True, 'itk::Image< unsigned short,3 >, itk::Image< unsigned short,3 >'),
  ...
  ('GradientMagnitudeImageFilter', 'itk::GradientMagnitudeImageFilter', 'itkGradientMagnitudeImageFilterID2ID2', True, 'itk::Image< double,2 >, itk::Image< double,2 >'),
  ('GradientMagnitudeImageFilter', 'itk::GradientMagnitudeImageFilter', 'itkGradientMagnitudeImageFilterID3ID3', True, 'itk::Image< double,3 >, itk::Image< double,3 >'),
  ...
  ('GradientMagnitudeRecursiveGaussianImageFilter', 'itk::GradientMagnitudeRecursiveGaussianImageFilter', 'itkGradientMagnitudeRecursiveGaussianImageFilterIUS2IUS2', True, 'itk::Image< unsigned short,2 >, itk::Image< unsigned short,2 >'),
  ('GradientMagnitudeRecursiveGaussianImageFilter', 'itk::GradientMagnitudeRecursiveGaussianImageFilter', 'itkGradientMagnitudeRecursiveGaussianImageFilterIUS3IUS3', True, 'itk::Image< unsigned short,3 >, itk::Image< unsigned short,3 >'),
  ...
  ('GradientMagnitudeRecursiveGaussianImageFilter', 'itk::GradientMagnitudeRecursiveGaussianImageFilter', 'itkGradientMagnitudeRecursiveGaussianImageFilterID2ID2', True, 'itk::Image< double,2 >, itk::Image< double,2 >'),
  ('GradientMagnitudeRecursiveGaussianImageFilter', 'itk::GradientMagnitudeRecursiveGaussianImageFilter', 'itkGradientMagnitudeRecursiveGaussianImageFilterID3ID3', True, 'itk::Image< double,3 >, itk::Image< double,3 >'),
  ...
  ('GradientRecursiveGaussianImageFilter', 'itk::GradientRecursiveGaussianImageFilter', 'itkGradientRecursiveGaussianImageFilterIUS2ICVF22', True, 'itk::Image< unsigned short,2 >,itk::Image< itk::CovariantVector< float,2 >,2 >'),
  ...
  ('GradientRecursiveGaussianImageFilter', 'itk::GradientRecursiveGaussianImageFilter', 'itkGradientRecursiveGaussianImageFilterID2ICVF22', True, 'itk::Image< double,2 >,itk::Image< itk::CovariantVector< float,2 >,2 >'),
  ...
  ('GradientRecursiveGaussianImageFilter', 'itk::GradientRecursiveGaussianImageFilter', 'itkGradientRecursiveGaussianImageFilterIUS3ICVF23', True, 'itk::Image< unsigned short,3 >,itk::Image< itk::CovariantVector< float,2 >,3 >'),
  ...
  ('GradientRecursiveGaussianImageFilter', 'itk::GradientRecursiveGaussianImageFilter', 'itkGradientRecursiveGaussianImageFilterID3ICVF23', True, 'itk::Image< double,3 >,itk::Image< itk::CovariantVector< float,2 >,3 >'),
  ...
  ('VectorGradientMagnitudeImageFilter', 'itk::VectorGradientMagnitudeImageFilter', 'itkVectorGradientMagnitudeImageFilterIVF22D', True, 'itk::Image< itk::Vector< float,2 >,2 >, double'),
  ...
  ('VectorGradientMagnitudeImageFilter', 'itk::VectorGradientMagnitudeImageFilter', 'itkVectorGradientMagnitudeImageFilterIVF33D', True, 'itk::Image< itk::Vector< float,3 >,3 >, double'),
)
snake_case_functions = ('gradient_magnitude_image_filter', 'gradient_image_filter', 'gradient_magnitude_recursive_gaussian_image_filter', 'vector_gradient_magnitude_image_filter', 'difference_of_gaussians_gradient_image_filter', 'gradient_recursive_gaussian_image_filter', )
