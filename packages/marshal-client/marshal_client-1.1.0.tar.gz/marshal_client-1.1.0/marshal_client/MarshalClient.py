...
class MarshalClient(object):
    ...
    def __response_to_job(self, data):
        ...
        submit_time = datetime.fromisoformat(data['submitTime'][0:-1])
        scheduled_time = datetime.fromisoformat(data['scheduledTime'][0:-1]) if data['scheduledTime'] is not None else None
