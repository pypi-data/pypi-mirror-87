...
class itkForwardFFTImageFilterIF2ICF2(itk.itkImageToImageFilterBPython.itkImageToImageFilterIF2ICF2):
    ...
    example{Filtering/FFT/ComputeForwardFFT,Compute Forward FFT} 
    """
...
def forward_fft_image_filter_init_docstring():
    ...
    if isinstance(itk.ForwardFFTImageFilter, itkTemplate.itkTemplate):
        forward_fft_image_filter.__doc__ += itkHelpers.filter_args(filter_object)[0]
        forward_fft_image_filter.__doc__ += "\n"
        forward_fft_image_filter.__doc__ += itkHelpers.filter_args(filter_object)[1]
    else:
