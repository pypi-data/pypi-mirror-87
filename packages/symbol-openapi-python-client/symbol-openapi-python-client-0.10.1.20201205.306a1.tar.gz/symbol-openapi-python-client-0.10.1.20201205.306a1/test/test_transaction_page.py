...
from symbol_openapi_client.models.transaction_page import TransactionPage  # noqa: E501
...
class TestTransactionPage(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = symbol_openapi_client.models.transaction_page.TransactionPage()  # noqa: E501
        if include_optional :
            return TransactionPage(
                data = [
                    symbol_openapi_client.models.transaction_info_dto.TransactionInfoDTO(
                        id = '0', 
                        meta = null, 
                        transaction = null, )
                    ], 
