...
class MetricsClient(RunClient):
    ...
    def get_metric_dto_for_run_v2(self, name, start_time=None, end_time=None, custom_headers=None):
        request_dto = RetrieveFullFidelityMetricRequestDto(metric_name=name, start_time=start_time, end_time=end_time)
    ...
    def get_metric_for_run_v2(self, name, start_time=None, end_time=None, artifact_client=None,
                              populate=False, custom_headers=None):
        metric_dto = self.get_metric_dto_for_run_v2(name, start_time=start_time, end_time=end_time,
                                                    custom_headers=custom_headers)
        if metric_dto is None:
            return None
        return MetricsClient.dto_v2_to_metric_cells(metric_dto, artifact_client, populate)

    def get_v2_metric_for_run(self, name, start_time=None, end_time=None, artifact_client=None,
                              populate=False, custom_headers=None):
        return_value = {}
        metric = self.get_metric_for_run_v2(name=name, start_time=start_time, end_time=end_time,
                                            artifact_client=artifact_client, populate=populate,
                                            custom_headers=custom_headers)
        if metric is not None:
            return_value[name] = metric
        return return_value
