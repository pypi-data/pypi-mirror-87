...
#                 pass
        ...
        path_list = [json_path_model, csv_path_visual, json_path_visual]   # DL
        ...
        path_list = [json_path_model, json_path_visual]                       # ML & Classification

    else:
        path_list = [json_path_model]                                         # DL & Regression
    ...
    ## 최종 path
    if len(path_list) == 1:     # ML & Regression
