...
class itkCurvatureFlowImageFilterID2ID2(itk.itkDenseFiniteDifferenceImageFilterPython.itkDenseFiniteDifferenceImageFilterID2ID2):
    ...
    {Filtering/CurvatureFlow/SmoothImageUsingCurvatureFlow,Smooth Image
    Using Curvature Flow}
    {Filtering/CurvatureFlow/SmoothRGBImageUsingCurvatureFlow,Smooth RGB
    Image Using Curvature Flow} 
    """
