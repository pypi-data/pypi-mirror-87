...
class ScheduledEvent(System.Object, System.IDisposable):
    ...
    @property
    def EventFired(self) -> typing.List[typing.Callable[[str], datetime.datetime]]:
        """Event that fires each time this scheduled event happens"""
        ...

    @EventFired.setter
    def EventFired(self, value: typing.List[typing.Callable[[str], datetime.datetime]]):
        """Event that fires each time this scheduled event happens"""
        ...
    ...
    @typing.overload
    def __init__(self, name: str, eventUtcTime: datetime.datetime, callback: typing.Callable[[str], datetime.datetime] = None) -> None:
        """
    ...
    @typing.overload
    def __init__(self, name: str, orderedEventUtcTimes: System.Collections.Generic.IEnumerable[datetime.datetime], callback: typing.Callable[[str], datetime.datetime] = None) -> None:
        """
        Initializes a new instance of the ScheduledEvent class
    ...
    @typing.overload
    def __init__(self, name: str, orderedEventUtcTimes: System.Collections.Generic.IEnumerator[datetime.datetime], callback: typing.Callable[[str], datetime.datetime] = None) -> None:
        """
        Initializes a new instance of the ScheduledEvent class
...
class IFluentSchedulingRunnable(QuantConnect.Scheduling.IFluentSchedulingTimeSpecifier, metaclass=abc.ABCMeta):
    ...
    @typing.overload
    def Run(self, callback: typing.Callable[[], datetime.datetime]) -> QuantConnect.Scheduling.ScheduledEvent:
        """Register the defined event with the callback"""
        ...

    @typing.overload
    def Run(self, callback: typing.Callable[[str], datetime.datetime]) -> QuantConnect.Scheduling.ScheduledEvent:
        """Register the defined event with the callback"""
        ...
...
class ScheduleManager(System.Object, QuantConnect.Scheduling.IEventSchedule):
    ...
    @typing.overload
    def On(self, dateRule: QuantConnect.Scheduling.IDateRule, timeRule: QuantConnect.Scheduling.ITimeRule, callback: typing.Callable[[str], datetime.datetime]) -> QuantConnect.Scheduling.ScheduledEvent:
        """
        Schedules the callback to run using the specified date and time rules
    ...
    @typing.overload
    def On(self, name: str, dateRule: QuantConnect.Scheduling.IDateRule, timeRule: QuantConnect.Scheduling.ITimeRule, callback: typing.Callable[[str], datetime.datetime]) -> QuantConnect.Scheduling.ScheduledEvent:
        """
        Schedules the callback to run using the specified date and time rules
    ...
    @typing.overload
    def Training(self, dateRule: QuantConnect.Scheduling.IDateRule, timeRule: QuantConnect.Scheduling.ITimeRule, trainingCode: typing.Callable[[], datetime.datetime]) -> QuantConnect.Scheduling.ScheduledEvent:
        """
        Schedules the training code to run using the specified date and time rules
