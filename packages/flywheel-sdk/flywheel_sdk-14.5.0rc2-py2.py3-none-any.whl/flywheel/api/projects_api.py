...
class ProjectsApi(object):
    ...
    def end_project_packfile_upload(self, project_id, token, metadata, **kwargs):  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_'):
            return self.end_project_packfile_upload_with_http_info(project_id, token, metadata, **kwargs)  # noqa: E501
        else:
            (data) = self.end_project_packfile_upload_with_http_info(project_id, token, metadata, **kwargs)  # noqa: E501
            if data and hasattr(data, 'return_value'):
                return data.return_value()
            return data


    def end_project_packfile_upload_with_http_info(self, project_id, token, metadata, **kwargs):  # noqa: E501
        """End a packfile upload
        ...
        all_params = ['project_id', 'token', 'metadata']  # noqa: E501
        all_params.append('async_')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
