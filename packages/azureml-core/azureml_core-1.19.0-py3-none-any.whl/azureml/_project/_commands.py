...
def create_workspace(auth, resource_group_name, workspace_name, subscription_id,
                     ...
                     cmk_keyvault=None, resource_cmk_uri=None, hbi_workspace=False,
...
def list_workspace_keys(auth, subscription_id, resource_group_name, workspace_name):
...
def _validate_private_endpoint(auth, private_endpoint_config, location):
    ...
    if private_endpoint_config:
        ...
        try:
            network_client = NetworkManagementClient(auth, private_endpoint_config.vnet_subscription_id)
