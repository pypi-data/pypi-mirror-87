...
setup(
  ...
  version = '2.1.7',      # Start with a small number and increase it with every change you make
  ...
  download_url = 'https://github.com/wickerdevs/py-instaclient/archive/v2.1.7.tar.gz',    # I explain this later on
