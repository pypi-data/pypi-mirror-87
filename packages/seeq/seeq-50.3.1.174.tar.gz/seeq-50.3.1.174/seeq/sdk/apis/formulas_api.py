...
class FormulasApi(object):
    ...
    def get_package_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api('/formulas/packages/{packageName}', 'GET',
                                        ...
                                        post_params=form_params,
                                        files=local_var_files,
                                        response_type='FormulaPackageOutputV1',
                                        auth_settings=auth_settings,
                                        callback=params.get('callback'),
                                        _return_http_data_only=params.get('_return_http_data_only'),
                                        _preload_content=params.get('_preload_content', True),
    ...
    def put_formula_doc(self, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.put_formula_doc(package_name=package_name_value, doc_name=doc_name_value, body=body_value, callback=callback_function)
    ...
    def put_formula_doc_with_http_info(self, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.put_formula_doc_with_http_info(package_name=package_name_value, doc_name=doc_name_value, body=body_value, callback=callback_function)
        ...
        all_params = ['package_name', 'doc_name', 'body']
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def put_package(self, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.put_package(package_name=package_name_value, body=body_value, callback=callback_function)
    ...
    def put_package_with_http_info(self, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.put_package_with_http_info(package_name=package_name_value, body=body_value, callback=callback_function)
