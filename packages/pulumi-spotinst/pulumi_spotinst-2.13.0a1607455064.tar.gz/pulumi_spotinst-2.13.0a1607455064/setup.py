...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'spotinst', '2.13.0-alpha.1607455064+fd7dc16c'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource spotinst 2.13.0-alpha.1607455064+fd7dc16c`
                """)
            else:
                raise
