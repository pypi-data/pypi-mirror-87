...
class SignalsApi(object):
    ...
    def archive_signal(self, **kwargs):
        ...
        :return: ArchiveSignalOutputV1
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: ArchiveSignalOutputV1
        """
    ...
    def archive_signal_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api('/signals/{id}', 'DELETE',
                                        ...
                                        response_type='ArchiveSignalOutputV1',
    ...
    def get_sample_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api('/signals/{id}/sample/{key}', 'GET',
                                        ...
                                        post_params=form_params,
                                        files=local_var_files,
                                        response_type='GetSampleOutputV1',
                                        auth_settings=auth_settings,
                                        callback=params.get('callback'),
                                        _return_http_data_only=params.get('_return_http_data_only'),
                                        _preload_content=params.get('_preload_content', True),
    ...
    def get_samples_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api('/signals/{id}/samples', 'GET',
                                        ...
                                        post_params=form_params,
                                        files=local_var_files,
                                        response_type='GetSamplesOutputV1',
                                        auth_settings=auth_settings,
                                        callback=params.get('callback'),
                                        _return_http_data_only=params.get('_return_http_data_only'),
                                        _preload_content=params.get('_preload_content', True),
    ...
    def get_signals_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api('/signals', 'GET',
                                        ...
                                        post_params=form_params,
                                        files=local_var_files,
                                        response_type='GetSignalsOutputV1',
                                        auth_settings=auth_settings,
                                        callback=params.get('callback'),
                                        _return_http_data_only=params.get('_return_http_data_only'),
                                        _preload_content=params.get('_preload_content', True),
    ...
    def put_samples(self, **kwargs):
        ...
        If samples are in the past, the cache should be invalidated via the Items API
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        to be invoked when receiving the response.
        >>> def callback_function(response):
        ...
        :param callback function: The callback function
            for asynchronous request. (optional)
        :param str id: The Seeq ID for the signal (required)
        :param PutSamplesInputV1 body: Data to be added to the series (required)
        :return: PutSamplesOutputV1
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: PutSamplesOutputV1
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
    ...
    def put_samples_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api('/signals/{id}/samples', 'POST',
                                        ...
                                        post_params=form_params,
                                        files=local_var_files,
                                        response_type='PutSamplesOutputV1',
                                        auth_settings=auth_settings,
                                        callback=params.get('callback'),
                                        _return_http_data_only=params.get('_return_http_data_only'),
                                        _preload_content=params.get('_preload_content', True),
    ...
    def put_samples_by_data_id(self, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.put_samples_by_data_id(datasource_class=datasource_class_value, datasource_id=datasource_id_value, data_id=data_id_value, body=body_value, callback=callback_function)
    ...
    def put_samples_by_data_id_with_http_info(self, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.put_samples_by_data_id_with_http_info(datasource_class=datasource_class_value, datasource_id=datasource_id_value, data_id=data_id_value, body=body_value, callback=callback_function)
        ...
        all_params = ['datasource_class', 'datasource_id', 'data_id', 'body']
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def put_signal(self, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.put_signal(id=id_value, body=body_value, callback=callback_function)
    ...
    def put_signal_with_http_info(self, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.put_signal_with_http_info(id=id_value, body=body_value, callback=callback_function)
    ...
    def put_signal_by_data_id(self, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.put_signal_by_data_id(datasource_class=datasource_class_value, datasource_id=datasource_id_value, data_id=data_id_value, body=body_value, callback=callback_function)
    ...
    def put_signal_by_data_id_with_http_info(self, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.put_signal_by_data_id_with_http_info(datasource_class=datasource_class_value, datasource_id=datasource_id_value, data_id=data_id_value, body=body_value, callback=callback_function)
