...
from azureml.automl.core.automl_utils import service_exception_handler
...
from azureml.automl.core.shared.constants import TIMEOUT_TAG
...
from . import feature_skus_utilities
...
class FitOutput:
    ...
    @property
    def feature_skus(self) -> Set[str]:
        return feature_skus_utilities.get_feature_skus_from_settings(self._settings)
    ...
    def get_output_dict(self, exclude_keys: Optional[List[str]] = None) -> Dict[str, Any]:
        ...
        output = {
            ...
            'feature_skus': feature_skus_utilities.serialize_skus(self.feature_skus)
        }
...
class _FitOutputUtils:
    ...
    @staticmethod
    @service_exception_handler(raise_exception=False)
