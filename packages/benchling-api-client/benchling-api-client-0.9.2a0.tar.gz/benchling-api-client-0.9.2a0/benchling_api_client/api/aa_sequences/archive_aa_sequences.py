...
from ...models.aa_sequence_archive_request import AaSequenceArchiveRequest
...
def _get_kwargs(
    *,
    client: Client,
    json_body: AaSequenceArchiveRequest,
) -> Dict[str, Any]:
    url = "{}/aa-sequences:archive".format(client.base_url)
