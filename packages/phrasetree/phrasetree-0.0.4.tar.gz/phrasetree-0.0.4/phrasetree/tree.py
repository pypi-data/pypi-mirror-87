...
from phrasetree.grammar import Production, Nonterminal
from phrasetree.util import slice_bounds
...
class Tree(list):
    ...
    def chomsky_normal_form(
        ...
        :type  parentChar: str
        """
        from phrasetree.treetransforms import chomsky_normal_form
    ...
    def un_chomsky_normal_form(
        ...
        :type  unaryChar: str
        """
        from phrasetree.treetransforms import un_chomsky_normal_form
    ...
    def collapse_unary(self, collapsePOS=False, collapseRoot=False, joinChar="+"):
        ...
        :type  joinChar: str
        """
        from phrasetree.treetransforms import collapse_unary
    ...
    def pretty_print(self, sentence=None, highlight=(), stream=None, **kwargs):
        ...
        """
        from phrasetree.treeprettyprinter import TreePrettyPrinter

        print(TreePrettyPrinter(self, sentence, highlight).text(**kwargs), file=stream)

    def to_list(self):
        return [self.label(), [t.to_list() if isinstance(t, Tree) else t for t in self]]

    @staticmethod
    def from_list(L):
        if isinstance(L, str):
            return L
        return Tree(L[0], [Tree.from_list(child) for child in L[1]])
...
def demo():
    ...
    print(t)
    print(t.__repr__())
    print(Tree.from_list(['S', [['NP', [['DT', ['the']], ['NN', ['cat']]]], ['VP', [['VBD', ['ate']], ['NP', [['DT', ['a']], ['NN', ['cookie']]]]]]]]))
