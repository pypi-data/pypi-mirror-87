...
from openapi_client.models.snapshot_request_model import SnapshotRequestModel  # noqa: E501
...
class TestSnapshotRequestModel(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = openapi_client.models.snapshot_request_model.SnapshotRequestModel()  # noqa: E501
        if include_optional :
            return SnapshotRequestModel(
                name = 'a', 
                description = '0', 
                contents = [
                    openapi_client.models.snapshot_request_contents_model.SnapshotRequestContentsModel(
                        dataset_name = 'a', 
                        mode = 'byAsset', 
                        asset_spec = openapi_client.models.snapshot_request_asset_model.SnapshotRequestAssetModel(
                            asset_name = 'a', 
                            root_values = [
                                '0'
                                ], ), 
                        query_spec = openapi_client.models.snapshot_request_query_model.SnapshotRequestQueryModel(
                            asset_name = 'a', 
                            query = '0', ), 
                        row_id_spec = openapi_client.models.snapshot_request_row_id_model.SnapshotRequestRowIdModel(
                            tables = [
                                openapi_client.models.snapshot_request_row_id_table_model.SnapshotRequestRowIdTableModel(
                                    table_name = 'a', 
                                    columns = [
                                        'a'
                                        ], 
