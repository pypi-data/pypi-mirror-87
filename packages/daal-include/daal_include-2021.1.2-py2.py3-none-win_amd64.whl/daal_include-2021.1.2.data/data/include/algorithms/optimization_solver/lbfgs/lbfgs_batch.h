 ...
 *        This class is associated with daal::algorithms::optimization_solver::lbfgs::Batch class.     \DAAL_DEPRECATED
 *
 ...
 * \brief Computes LBFGS in the batch processing mode.     \DAAL_DEPRECATED
