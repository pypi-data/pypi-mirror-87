...
#   `tensorflow_probability/substrates/numpy/distributions/joint_distribution.py`
...
class JointDistribution(distribution_lib.Distribution):
  ...
  **Note**: unlike other non-`JointDistribution` distributions in
  ...
  def experimental_pin(self, *args, **kwargs):  # pylint: disable=g-doc-args
    ...
    from tensorflow_probability.substrates.numpy.experimental.distributions import joint_distribution_pinned as jd_pinned  # pylint: disable=g-import-not-at-top
