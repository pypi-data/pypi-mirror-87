...
def combine_curves(curve_1: ArcSpline, curve_2: ArcSpline, mode: str) -> List[ArcSpline]:
    ...
    """
    combined_curves = _libfibomat.combine_curves(curve_1.arc_spline_impl, curve_2.arc_spline_impl, mode)

    return [ArcSpline(raw) for raw in combined_curves]
