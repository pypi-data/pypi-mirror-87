...
class DescribeGlobalNetworksPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [DescribeGlobalNetworks.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.16.28/reference/services/networkmanager.html#NetworkManager.Paginator.DescribeGlobalNetworks.paginate)
        """
...
class GetCustomerGatewayAssociationsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [GetCustomerGatewayAssociations.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.16.28/reference/services/networkmanager.html#NetworkManager.Paginator.GetCustomerGatewayAssociations.paginate)
        """
...
class GetDevicesPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [GetDevices.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.16.28/reference/services/networkmanager.html#NetworkManager.Paginator.GetDevices.paginate)
        """
...
class GetLinkAssociationsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [GetLinkAssociations.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.16.28/reference/services/networkmanager.html#NetworkManager.Paginator.GetLinkAssociations.paginate)
        """
...
class GetLinksPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [GetLinks.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.16.28/reference/services/networkmanager.html#NetworkManager.Paginator.GetLinks.paginate)
        """
...
class GetSitesPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [GetSites.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.16.28/reference/services/networkmanager.html#NetworkManager.Paginator.GetSites.paginate)
        """
...
class GetTransitGatewayRegistrationsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [GetTransitGatewayRegistrations.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.16.28/reference/services/networkmanager.html#NetworkManager.Paginator.GetTransitGatewayRegistrations.paginate)
        """
