/*! For license information please see chunk.06a2abf3277a87471d3a.js.LICENSE.txt */
(self.webpackChunkhome_assistant_frontend=self.webpackChunkhome_assistant_frontend||[]).push([[2772],{39841:(e,t,i)=>{"use strict";i(43437),i(65660);var r=i(9672),o=i(87156),n=i(50856),a=i(44181);(0,r.k)({_template:n.d`
    <style>
      :host {
        display: block;
        /**
...
`,is:"app-header-layout",behaviors:[a.Y],properties:{hasScrollingRegion:{type:Boolean,value:!1,reflectToAttribute:!0}},observers:["resetLayout(isAttached, hasScrollingRegion)"],get header(){return(0,o.vz)(this.$.headerSlot).getDistributedNodes()[0]},_updateLayoutStates:function(){var e=this.header;if(this.isAttached&&e){this.$.wrapper.classList.remove("initializing"),e.scrollTarget=this.hasScrollingRegion?this.$.contentContainer:this.ownerDocument.documentElement;var t=e.offsetHeight;this.hasScrollingRegion?(e.style.left="",e.style.right=""):requestAnimationFrame(function(){var t=this.getBoundingClientRect(),i=document.documentElement.clientWidth-t.right;e.style.left=t.left+"px",e.style.right=i+"px"}.bind(this));var i=this.$.contentContainer.style;e.fixed&&!e.condenses&&this.hasScrollingRegion?(i.marginTop=t+"px",i.paddingTop=""):(i.paddingTop=t+"px",i.marginTop="")}}})},25782:(e,t,i)=>{"use strict";i(43437),i(65660),i(70019),i(97968);var r=i(9672),o=i(50856),n=i(33760);(0,r.k)({_template:o.d`
    ...
    <slot></slot>
`,is:"paper-icon-item",behaviors:[n.U]})},26765:(e,t,i)=>{"use strict";i.d(t,{Ys:()=>a,g7:()=>s,D9:()=>l});var r=i(47181);const o=()=>Promise.all([i.e(8200),i.e(879),i.e(1458),i.e(2034),i.e(6509),i.e(7230)]).then(i.bind(i,1281)),n=(e,t,i)=>new Promise((n=>{const a=t.cancel,s=t.confirm;(0,r.B)(e,"show-dialog",{dialogTag:"dialog-box",dialogImport:o,dialogParams:{...t,...i,cancel:()=>{n(!!(null==i?void 0:i.prompt)&&null),a&&a()},confirm:e=>{n(!(null==i?void 0:i.prompt)||e),s&&s(e)}}})})),a=(e,t)=>n(e,t),s=(e,t)=>n(e,t,{confirmation:!0}),l=(e,t)=>n(e,t,{prompt:!0})},27849:(e,t,i)=>{"use strict";i(39841);var r=i(50856);i(28426);class o extends(customElements.get("app-header-layout")){static get template(){return r.d`
      <style>
        :host {
          display: block;
          /**
    ...
    >
      ...
      ${Object.values(a.aisConfigSections).map((e=>r.dy`
          <ha-card>
        ...
        `))}
      ${this.cloudStatus&&(0,o.p)(this.hass,"cloud")?r.dy`
            <ha-card>
              <ha-config-navigation
                .hass=${this.hass}
                .showAdvanced=${this.showAdvanced}
                .pages=${[{component:"cloud",path:"/config/cloud",name:"Home Assistant Cloud",info:this.cloudStatus,iconPath:s.UoA}]}
              ></ha-config-navigation>
            </ha-card>
          `:""}
      ${Object.values(a.configSections).map((e=>r.dy`
          <ha-card>
            <ha-config-navigation
              .hass=${this.hass}
              .showAdvanced=${this.showAdvanced}
        ...
        `))}
      ${(0,o.p)(this.hass,"zha")?r.dy`
            <div class="promo-advanced">
              ${this.hass.localize("ui.panel.config.integration_panel_move.missing_zha","integrations_page",r.dy`<a href="/config/integrations">
                  ${this.hass.localize("ui.panel.config.integration_panel_move.link_integration_page")}
                </a>`)}
            </div>
          `:""}
      ${(0,o.p)(this.hass,"zwave")?r.dy`
            <div class="promo-advanced">
              ${this.hass.localize("ui.panel.config.integration_panel_move.missing_zwave","integrations_page",r.dy`<a href="/config/integrations">
                  ${this.hass.localize("ui.panel.config.integration_panel_move.link_integration_page")}
                </a>`)}
            </div>
          `:""}
      ${this.showAdvanced?"":r.dy`
          ...
          `}
    </ha-config-section>`;return this.narrow||"always_hidden"===this.hass.dockedSidebar?r.dy`
      <ha-app-layout>
    ...
    `:e}},{kind:"method",key:"_dismissConference",value:async function(){await(0,l.g7)(this,{title:"Home Assistant Conference",text:r.dy`
          If you've
          <a
            target="_blank"
        ...
        `})&&(localStorage.dismissConf2020="1",this.requestUpdate())}},{kind:"get",static:!0,key:"styles",value:function(){return[n.Qx,r.iv`
        app-header {
      ...
      `]}}]}}),r.oi)}}]);
//# sourceMappingURL=chunk.06a2abf3277a87471d3a.js.map