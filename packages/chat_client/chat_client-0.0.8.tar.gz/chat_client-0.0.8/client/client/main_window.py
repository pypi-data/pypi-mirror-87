...
class ClientMainWindow(QMainWindow):
    ...
    def __init__(self, database, transport, keys):
        ...
        # Объект - дешифровщик сообщений с предзагруженным ключём
        ...
        # Двойное нажатие по листу контактов отправляет выбранное в обработчик
    ...
    def history_list_update(self):
        ...
        """
        # Получение истории, сортированную по дате
        list = sorted(
        ...
        # Заполнение модели записями, также стоит разделить входящие
        # и исходящие выравниванием и разным фоном.
        # Отображение только последих 20 сообщений
        for i in range(start_index, length):
            ...
            if item[1] == 'in':
                ...
                mess.setBackground(QBrush(QColor(214, 230, 207)))
                ...
                mess.setBackground(QBrush(QColor(249, 202, 203)))
                self.history_model.appendRow(mess)
        self.ui.list_messages.scrollToBottom()

    def select_active_user(self):
        """Метод - обработчик события двойного клика по списку контактов."""
        # Выбранный пользователем (двойным нажатием) находится в выделеном элементе в QListView
        self.current_chat = self.ui.list_contacts.currentIndex().data()
        # Вызов основной функции
        self.set_active_user()

    def set_active_user(self):
        """Метод - активатор чата с собеседником."""
        ...
        # Установка надписи и активация кнопки
        self.ui.label_new_message.setText(
        ...
        # Заполнение окна истории сообщений по требуемому пользователю
    ...
    def add_contact(self, new_contact):
        ...
        После обновления база данных обновляет и содержимое окна.
        """
        try:
    ...
    def send_message(self):
        ...
        """
        # Проверка поля, пустое или нет, затем забирается сообщение
        # и поле очищается
    ...
    def message(self, message):
        ...
        # Декодировка строки, при ошибке выдача сообщения и завершение функции
        try:
            ...
            return
        # Сохранение сообщения в базу и обновление истории сообщений, иначе
        ...
        if sender == self.current_chat:
            ...
            # Проверка на наличие пользователя у нас в контактах
            if self.database.check_contact(sender):
                # При наличии, спрашиваем о желании открыть с ним чат,
                # при согласии, открываем
                ...
                print('Нет')
                # При отсутствии, спрашиваем, хотим ли добавить пользователя в контакты
                if self.messages.question(
                        self,
                        'Новое сообщение',
    ...
    def connection_lost(self):
        """
            Слот - обработчик потери соединнения с сервером.
            Выдаёт окно предупреждения и завершает работу приложения.
        """
        self.messages.warning(
            self,
            'Сбой соединения',
