...
class VolcanoJobDescRender:
    ...
    def _create_worker_pod(self, role):
        ...
        return {
            ...
            "spec": {
                ...
                "imagePullSecrets": [{"name": self._image_secret,},],
    ...
    def spec(self):
        min_avaliable = self._runtime_configs["resources"]["worker"]["instances"].as_number()
        if self._need_ps:
            min_avaliable += self._runtime_configs["resources"]["ps"]["instances"].as_number() + 1
