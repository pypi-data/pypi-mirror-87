...
def complex_to_imaginary_image_filter(*args, **kwargs):
    """Procedural interface for ComplexToImaginaryImageFilter"""
    import itk
...
def complex_to_imaginary_image_filter_init_docstring():
    ...
    import itkTemplate
    import itkHelpers
    if isinstance(itk.ComplexToImaginaryImageFilter, itkTemplate.itkTemplate):
        filter_object = itk.ComplexToImaginaryImageFilter.values()[0]
    else:
        filter_object = itk.ComplexToImaginaryImageFilter

    complex_to_imaginary_image_filter.__doc__ = filter_object.__doc__
    complex_to_imaginary_image_filter.__doc__ += "\n Args are Input(s) to the filter.\n"
    complex_to_imaginary_image_filter.__doc__ += "\n Available Keyword Arguments:\n"
    if isinstance(itk.ComplexToImaginaryImageFilter, itkTemplate.itkTemplate):
        complex_to_imaginary_image_filter.__doc__ += itkHelpers.filter_args(filter_object)[0]
        complex_to_imaginary_image_filter.__doc__ += "\n"
        complex_to_imaginary_image_filter.__doc__ += itkHelpers.filter_args(filter_object)[1]
    else:
        complex_to_imaginary_image_filter.__doc__ += "".join([
