    ...
    """
{
    ...
    "package_data": {
        "cloudcomponents.cdk_codepipeline_slack._jsii": [
            "cdk-codepipeline-slack@1.12.0.jsii.tgz"
        ],
        "cloudcomponents.cdk_codepipeline_slack": [
            "py.typed"
        ]
    ...
    "python_requires": ">=3.6",
    "install_requires": [
        "aws-cdk.aws-apigateway>=1.77.0, <2.0.0",
        "aws-cdk.aws-codebuild>=1.77.0, <2.0.0",
        "aws-cdk.aws-codepipeline-actions>=1.77.0, <2.0.0",
        "aws-cdk.aws-codepipeline>=1.77.0, <2.0.0",
        "aws-cdk.aws-events-targets>=1.77.0, <2.0.0",
        "aws-cdk.aws-events>=1.77.0, <2.0.0",
        "aws-cdk.aws-iam>=1.77.0, <2.0.0",
        "aws-cdk.aws-lambda>=1.77.0, <2.0.0",
        "aws-cdk.aws-s3>=1.77.0, <2.0.0",
        "aws-cdk.aws-sns-subscriptions>=1.77.0, <2.0.0",
