...
class TMC4671_fields(object):
    ...
    BLANKING_A                             = ( 0x04, 0x000000FF00,  8 ) # DSADC_MCFG_B_MCFG_A
    ...
    # PWM_POLARITIES
    PWM_POLARITIES__                       = ( 0x17, 0x00000001,  0 ) # PWM_POLARITIES
    PWM_POLARITIES__                       = ( 0x17, 0x00000002,  1 ) # PWM_POLARITIES
    ...
    # ABN_DECODER_MODE
    APOL                                   = ( 0x25, 0x00000001,  0 ) # ABN_DECODER_MODE
    BPOL                                   = ( 0x25, 0x00000002,  1 ) # ABN_DECODER_MODE
    NPOL                                   = ( 0x25, 0x00000004,  2 ) # ABN_DECODER_MODE
    USE_ABN_AS_N                           = ( 0x25, 0x00000008,  3 ) # ABN_DECODER_MODE
    CLN                                    = ( 0x25, 0x00000100,  8 ) # ABN_DECODER_MODE
    DIRECTION                              = ( 0x25, 0x00001000, 12 ) # ABN_DECODER_MODE
    ...
    # ABN_2_DECODER_MODE
    APOL                                   = ( 0x2c, 0x00000001,  0 ) # ABN_2_DECODER_MODE
    BPOL                                   = ( 0x2c, 0x00000002,  1 ) # ABN_2_DECODER_MODE
    NPOL                                   = ( 0x2c, 0x00000004,  2 ) # ABN_2_DECODER_MODE
    USE_ABN_AS_N                           = ( 0x2c, 0x00000008,  3 ) # ABN_2_DECODER_MODE
    CLN                                    = ( 0x2c, 0x00000100,  8 ) # ABN_2_DECODER_MODE
    DIRECTION                              = ( 0x2c, 0x00001000, 12 ) # ABN_2_DECODER_MODE
    ...
    # HALL_MODE
    POLARITY                               = ( 0x33, 0x00000001,  0 ) # HALL_MODE
    INTERPOLATION                          = ( 0x33, 0x00000100,  8 ) # HALL_MODE
    DIRECTION                              = ( 0x33, 0x00001000, 12 ) # HALL_MODE
    HALL_BLANK                             = ( 0x33, 0x0FFF0000, 16 ) # HALL_MODE
    ...
    # AENC_DECODER_MODE
    AENC_DECODER_MODE__                    = ( 0x3b, 0x00000001,  0 ) # AENC_DECODER_MODE
    AENC_DECODER_MODE__                    = ( 0x3b, 0x00001000, 12 ) # AENC_DECODER_MODE
    ...
    PID_TORQUE_ACTUAL                      = ( 0x6e, 0x0000FFFF,  0 ) # INTERIM_DATA
    PID_TORQUE_TARGET                      = ( 0x6e, 0xFFFF0000, 16 ) # INTERIM_DATA
    PID_FLUX_ACTUAL                        = ( 0x6e, 0x0000FFFF,  0 ) # INTERIM_DATA
    PID_FLUX_TARGET                        = ( 0x6e, 0xFFFF0000, 16 ) # INTERIM_DATA
    ...
    _                                      = ( 0x76, 0x00000008,  3 ) # TMC4671_INPUTS_RAW
    ...
    _                                      = ( 0x76, 0x00000080,  7 ) # TMC4671_INPUTS_RAW
    ...
    _                                      = ( 0x76, 0x00000800, 11 ) # TMC4671_INPUTS_RAW
    ...
    _                                      = ( 0x76, 0x00080000, 19 ) # TMC4671_INPUTS_RAW
    ...
    _                                      = ( 0x76, 0x00800000, 23 ) # TMC4671_INPUTS_RAW
    _                                      = ( 0x76, 0x01000000, 24 ) # TMC4671_INPUTS_RAW
    _                                      = ( 0x76, 0x02000000, 25 ) # TMC4671_INPUTS_RAW
    _                                      = ( 0x76, 0x04000000, 26 ) # TMC4671_INPUTS_RAW
    _                                      = ( 0x76, 0x08000000, 27 ) # TMC4671_INPUTS_RAW
    PWM_IDLE_L_RAW                         = ( 0x76, 0x10000000, 28 ) # TMC4671_INPUTS_RAW
    PWM_IDLE_H_RAW                         = ( 0x76, 0x20000000, 29 ) # TMC4671_INPUTS_RAW
    _                                      = ( 0x76, 0x40000000, 30 ) # TMC4671_INPUTS_RAW
    _                                      = ( 0x76, 0x80000000, 31 ) # TMC4671_INPUTS_RAW

    # TMC4671_OUTPUTS_RAW
    TMC4671_OUTPUTS_RAW__                  = ( 0x77, 0x00000001,  0 ) # TMC4671_OUTPUTS_RAW
    TMC4671_OUTPUTS_RAW__                  = ( 0x77, 0x00000002,  1 ) # TMC4671_OUTPUTS_RAW
    TMC4671_OUTPUTS_RAW__                  = ( 0x77, 0x00000004,  2 ) # TMC4671_OUTPUTS_RAW
    TMC4671_OUTPUTS_RAW__                  = ( 0x77, 0x00000008,  3 ) # TMC4671_OUTPUTS_RAW
    TMC4671_OUTPUTS_RAW__                  = ( 0x77, 0x00000010,  4 ) # TMC4671_OUTPUTS_RAW
    TMC4671_OUTPUTS_RAW__                  = ( 0x77, 0x00000020,  5 ) # TMC4671_OUTPUTS_RAW
    TMC4671_OUTPUTS_RAW__                  = ( 0x77, 0x00000040,  6 ) # TMC4671_OUTPUTS_RAW
    TMC4671_OUTPUTS_RAW__                  = ( 0x77, 0x00000080,  7 ) # TMC4671_OUTPUTS_RAW
    ...
    # GPIO_dsADCI_CONFIG
    GPIO_DSADCI_CONFIG__                   = ( 0x7B, 0x00000001,  0 ) # GPIO_DSADCI_CONFIG
    GPIO_DSADCI_CONFIG__                   = ( 0x7B, 0x00000002,  1 ) # GPIO_DSADCI_CONFIG
    GPIO_DSADCI_CONFIG__                   = ( 0x7B, 0x00000004,  2 ) # GPIO_DSADCI_CONFIG
    GPIO_DSADCI_CONFIG__                   = ( 0x7B, 0x00000008,  3 ) # GPIO_DSADCI_CONFIG
    GPIO_DSADCI_CONFIG__                   = ( 0x7B, 0x00000010,  4 ) # GPIO_DSADCI_CONFIG
    GPIO_DSADCI_CONFIG__                   = ( 0x7B, 0x00000020,  5 ) # GPIO_DSADCI_CONFIG
    GPIO_DSADCI_CONFIG__                   = ( 0x7B, 0x00000040,  6 ) # GPIO_DSADCI_CONFIG
    GPO                                    = ( 0x7B, 0x00FF0000, 16 ) # GPIO_DSADCI_CONFIG
    GPI                                    = ( 0x7B, 0xFF000000, 24 ) # GPIO_DSADCI_CONFIG

    # STATUS_FLAGS
    STATUS_FLAGS__                         = ( 0x7c, 0x00000001,  0 ) # STATUS_FLAGS
    STATUS_FLAGS__                         = ( 0x7c, 0x00000002,  1 ) # STATUS_FLAGS
    STATUS_FLAGS__                         = ( 0x7c, 0x00000004,  2 ) # STATUS_FLAGS
    STATUS_FLAGS__                         = ( 0x7c, 0x00000008,  3 ) # STATUS_FLAGS
    STATUS_FLAGS__                         = ( 0x7c, 0x00000010,  4 ) # STATUS_FLAGS
    STATUS_FLAGS__                         = ( 0x7c, 0x00000020,  5 ) # STATUS_FLAGS
    STATUS_FLAGS__                         = ( 0x7c, 0x00000040,  6 ) # STATUS_FLAGS
    STATUS_FLAGS__                         = ( 0x7c, 0x00000080,  7 ) # STATUS_FLAGS
    STATUS_FLAGS__                         = ( 0x7c, 0x00000100,  8 ) # STATUS_FLAGS
    STATUS_FLAGS__                         = ( 0x7c, 0x00000200,  9 ) # STATUS_FLAGS
    STATUS_FLAGS__                         = ( 0x7c, 0x00000400, 10 ) # STATUS_FLAGS
    STATUS_FLAGS__                         = ( 0x7c, 0x00000800, 11 ) # STATUS_FLAGS
    STATUS_FLAGS__                         = ( 0x7c, 0x00001000, 12 ) # STATUS_FLAGS
    STATUS_FLAGS__                         = ( 0x7c, 0x00002000, 13 ) # STATUS_FLAGS
    STATUS_FLAGS__                         = ( 0x7c, 0x00004000, 14 ) # STATUS_FLAGS
    STATUS_FLAGS__                         = ( 0x7c, 0x00008000, 15 ) # STATUS_FLAGS
    STATUS_FLAGS__                         = ( 0x7c, 0x00010000, 16 ) # STATUS_FLAGS
    STATUS_FLAGS__                         = ( 0x7c, 0x00020000, 17 ) # STATUS_FLAGS
    STATUS_FLAGS__                         = ( 0x7c, 0x00040000, 18 ) # STATUS_FLAGS
    STATUS_FLAGS__                         = ( 0x7c, 0x00080000, 19 ) # STATUS_FLAGS
    STATUS_FLAGS__                         = ( 0x7c, 0x00100000, 20 ) # STATUS_FLAGS
    STATUS_FLAGS__                         = ( 0x7c, 0x00200000, 21 ) # STATUS_FLAGS
    STATUS_FLAGS__                         = ( 0x7c, 0x00400000, 22 ) # STATUS_FLAGS
    STATUS_FLAGS__                         = ( 0x7c, 0x00800000, 23 ) # STATUS_FLAGS
    STATUS_FLAGS__                         = ( 0x7c, 0x01000000, 24 ) # STATUS_FLAGS
    STATUS_FLAGS__                         = ( 0x7c, 0x02000000, 25 ) # STATUS_FLAGS
    STATUS_FLAGS__                         = ( 0x7c, 0x04000000, 26 ) # STATUS_FLAGS
    STATUS_FLAGS__                         = ( 0x7c, 0x08000000, 27 ) # STATUS_FLAGS
    STATUS_FLAGS__                         = ( 0x7c, 0x10000000, 28 ) # STATUS_FLAGS
    STATUS_FLAGS__                         = ( 0x7c, 0x20000000, 29 ) # STATUS_FLAGS
    STATUS_FLAGS__                         = ( 0x7c, 0x40000000, 30 ) # STATUS_FLAGS
    STATUS_FLAGS__                         = ( 0x7c, 0x80000000, 31 ) # STATUS_FLAGS
