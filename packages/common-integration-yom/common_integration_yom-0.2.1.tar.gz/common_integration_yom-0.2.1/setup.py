...
requirements = ["requests==2.25.0", "bunyan==0.1.3", "pandas==1.0.5", "sqlalchemy==1.3.18"]
...
setuptools.setup(
	...
	url="https://github.com/kaizen-group/yom-integration-package",
