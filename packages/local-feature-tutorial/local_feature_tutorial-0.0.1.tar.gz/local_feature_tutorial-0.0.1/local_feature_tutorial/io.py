...
__all__ = ['DOWNLOAD_DIR', 'download_file', 'clone_gitrepo_and_return_path']
...
# Cell
def download_file(url, fname=None, md5sum=None, with_progress=False):
...
# Cell
import subprocess
def clone_gitrepo_and_return_path(url, reponame):
