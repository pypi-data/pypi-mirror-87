...
class Type02_1(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    member_data_items_ = {
        'userdescription': MemberSpec_('userdescription', 'xs:string', 0, 0, {'name': 'userdescription', 'type': 'xs:string'}, None),
    }
    subclass = None
    superclass = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, Type02_1)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if Type02_1.subclass:
            return Type02_1.subclass(*args_, **kwargs_)
        else:
            return Type02_1(*args_, **kwargs_)
