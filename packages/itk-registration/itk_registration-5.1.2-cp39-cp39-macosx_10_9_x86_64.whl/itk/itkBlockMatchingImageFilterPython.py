...
class itkPointSetVF33(itk.ITKCommonBasePython.itkDataObject):
    ...
    example{Core/Common/CreateAPointSet,Create a PointSet}
    example{Core/Common/ReadAPointSet,Read a PointSet}
    example{Core/Common/WriteAPointSet,Write a PointSet}
    example{Core/Common/BoundingBoxOfAPointSet,Bounding Box Of A Point
    Set} 
    """
...
class itkBlockMatchingImageFilterID3(itkBlockMatchingImageFilterIF3_Superclass):
    ...
    example{Registration/Common/MatchFeaturePoints,Match Feature Points}
