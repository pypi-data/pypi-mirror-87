...
#   `tensorflow_probability/substrates/jax/distributions/kumaraswamy.py`
...
from tensorflow_probability.substrates.jax.bijectors import kumaraswamy_cdf as kumaraswamy_cdf
