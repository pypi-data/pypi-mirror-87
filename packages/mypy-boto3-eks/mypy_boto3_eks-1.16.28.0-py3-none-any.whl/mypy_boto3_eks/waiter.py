...
class AddonActiveWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [AddonActive.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.16.28/reference/services/eks.html#EKS.Waiter.AddonActive.wait)
        """
...
class AddonDeletedWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [AddonDeleted.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.16.28/reference/services/eks.html#EKS.Waiter.AddonDeleted.wait)
        """
...
class ClusterActiveWaiter(Boto3Waiter):
    ...
    def wait(self, name: str, WaiterConfig: WaiterConfigTypeDef = None) -> None:
        """
        [ClusterActive.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.16.28/reference/services/eks.html#EKS.Waiter.ClusterActive.wait)
        """
...
class ClusterDeletedWaiter(Boto3Waiter):
    ...
    def wait(self, name: str, WaiterConfig: WaiterConfigTypeDef = None) -> None:
        """
        [ClusterDeleted.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.16.28/reference/services/eks.html#EKS.Waiter.ClusterDeleted.wait)
        """
...
class NodegroupActiveWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [NodegroupActive.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.16.28/reference/services/eks.html#EKS.Waiter.NodegroupActive.wait)
        """
...
class NodegroupDeletedWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [NodegroupDeleted.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.16.28/reference/services/eks.html#EKS.Waiter.NodegroupDeleted.wait)
        """
