...
class V1VolumeFc(object):
    ...
    @property
    def fs_type(self):
        """Gets the fs_type of this V1VolumeFc.  # noqa: E501
        ...
        :return: The fs_type of this V1VolumeFc.  # noqa: E501
        :rtype: str
        """
    ...
    def fs_type(self, fs_type):
        """Sets the fs_type of this V1VolumeFc.

        Filesystem type to mount. Must be a filesystem type supported by the host operating system. Ex. \"ext4\", \"xfs\", \"ntfs\". Implicitly inferred to be \"ext4\" if unspecified.  # noqa: E501

        :param fs_type: The fs_type of this V1VolumeFc.  # noqa: E501
        :type: str
        """
    ...
    @property
    def lun(self):
        """Gets the lun of this V1VolumeFc.  # noqa: E501

        Optional: FC target lun number  # noqa: E501

        :return: The lun of this V1VolumeFc.  # noqa: E501
        :rtype: int
        """
        return self._lun
    ...
    @lun.setter
    def lun(self, lun):
        """Sets the lun of this V1VolumeFc.

        Optional: FC target lun number  # noqa: E501

        :param lun: The lun of this V1VolumeFc.  # noqa: E501
        :type: int
        """
    ...
    def read_only(self, read_only):
        """Sets the read_only of this V1VolumeFc.

        Optional: Defaults to false (read/write). ReadOnly here will force the ReadOnly setting in VolumeMounts.  # noqa: E501

        :param read_only: The read_only of this V1VolumeFc.  # noqa: E501
        :type: bool
        """
    ...
    def target_ww_ns(self):
        """Gets the target_ww_ns of this V1VolumeFc.  # noqa: E501

        Optional: FC target worldwide names (WWNs)  # noqa: E501

        :return: The target_ww_ns of this V1VolumeFc.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def target_ww_ns(self, target_ww_ns):
        """Sets the target_ww_ns of this V1VolumeFc.

        Optional: FC target worldwide names (WWNs)  # noqa: E501

        :param target_ww_ns: The target_ww_ns of this V1VolumeFc.  # noqa: E501
        :type: list[str]
        """
    ...
    @property
    def wwids(self):
        """Gets the wwids of this V1VolumeFc.  # noqa: E501
        ...
        :return: The wwids of this V1VolumeFc.  # noqa: E501
        :rtype: list[str]
        """
        return self._wwids
    ...
    def wwids(self, wwids):
        """Sets the wwids of this V1VolumeFc.

        Optional: FC volume world wide identifiers (wwids) Either wwids or combination of targetWWNs and lun must be set, but not both simultaneously.  # noqa: E501

        :param wwids: The wwids of this V1VolumeFc.  # noqa: E501
        :type: list[str]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, V1VolumeFc):
            return False
