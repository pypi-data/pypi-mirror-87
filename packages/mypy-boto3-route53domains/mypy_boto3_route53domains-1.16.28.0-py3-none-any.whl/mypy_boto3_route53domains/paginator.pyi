...
class ListDomainsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListDomains.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.16.28/reference/services/route53domains.html#Route53Domains.Paginator.ListDomains.paginate)
        """
...
class ListOperationsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListOperations.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.16.28/reference/services/route53domains.html#Route53Domains.Paginator.ListOperations.paginate)
        """
...
class ViewBillingPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ViewBilling.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.16.28/reference/services/route53domains.html#Route53Domains.Paginator.ViewBilling.paginate)
        """
