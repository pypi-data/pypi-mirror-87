...
def _defineSymbols():
    ...
    if _java_type_ is None:
        ...
        _java_type_ = jpy.get_type("com.illumon.iris.db.tables.utils.WindowCheck")
...
def addTimeWindow(table, timestampColumn, windowNanos, inWindowColumn):
    ...
    :param table: (com.illumon.iris.db.tables.Table) - the input table
    ...
    :return: (com.illumon.iris.db.tables.Table) a new table that contains an in-window Boolean column
    """
