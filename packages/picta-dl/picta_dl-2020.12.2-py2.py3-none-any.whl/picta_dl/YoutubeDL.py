...
class YoutubeDL(object):
    ...
    postprocessors:    A list of dictionaries, each with an entry
                       * key:  The name of the postprocessor. See
                               picta_dl/postprocessor/__init__.py for a list.
    ...
    call_home:         Boolean, true iff we are allowed to contact the
                       picta-dl servers for debugging.
    ...
    the downloader (see picta_dl/downloader/common.py):
    ...
    def print_debug_header(self):
        ...
        self._write_string('[debug] picta-dl version ' + __version__ + '\n')
        if _LAZY_LOADER:
    ...
    def _setup_opener(self):
        ...
        def file_open(*args, **kwargs):
            raise compat_urllib_error.URLError('file:// scheme is explicitly disabled in picta-dl for security reasons')
