...
QuantConnect_Data_Market_FuturesChain_T = typing.TypeVar('QuantConnect_Data_Market_FuturesChain_T')
QuantConnect_Data_Market_TradeBar_T = typing.TypeVar('QuantConnect_Data_Market_TradeBar_T')
QuantConnect_Data_Market_DataDictionary_T = typing.TypeVar('QuantConnect_Data_Market_DataDictionary_T')
QuantConnect_Data_Market_DataDictionaryExtensions_T = typing.TypeVar('QuantConnect_Data_Market_DataDictionaryExtensions_T')
QuantConnect_Data_Market_OptionChain_T = typing.TypeVar('QuantConnect_Data_Market_OptionChain_T')
...
class TradeBar(QuantConnect.Data.BaseData, QuantConnect.Data.Market.IBaseDataBar):
    ...
    @staticmethod
    @typing.overload
    def ParseEquity(config: QuantConnect.Data.SubscriptionDataConfig, line: str, date: datetime.datetime) -> QuantConnect_Data_Market_TradeBar_T:
        """
    ...
    @staticmethod
    @typing.overload
    def ParseForex(config: QuantConnect.Data.SubscriptionDataConfig, line: str, date: datetime.datetime) -> QuantConnect_Data_Market_TradeBar_T:
        """
    ...
    @staticmethod
    @typing.overload
    def ParseCrypto(config: QuantConnect.Data.SubscriptionDataConfig, line: str, date: datetime.datetime) -> QuantConnect_Data_Market_TradeBar_T:
        """
    ...
    @staticmethod
    @typing.overload
    def ParseCfd(config: QuantConnect.Data.SubscriptionDataConfig, line: str, date: datetime.datetime) -> QuantConnect_Data_Market_TradeBar_T:
        """
    ...
    @staticmethod
    @typing.overload
    def ParseOption(config: QuantConnect.Data.SubscriptionDataConfig, line: str, date: datetime.datetime) -> QuantConnect_Data_Market_TradeBar_T:
        """
    ...
    @staticmethod
    @typing.overload
    def ParseOption(config: QuantConnect.Data.SubscriptionDataConfig, streamReader: System.IO.StreamReader, date: datetime.datetime) -> QuantConnect_Data_Market_TradeBar_T:
        """
        Parses Option trade bar data into the specified tradebar type, useful for custom types with OHLCV data deriving from TradeBar
    ...
    @staticmethod
    @typing.overload
    def ParseFuture(config: QuantConnect.Data.SubscriptionDataConfig, streamReader: System.IO.StreamReader, date: datetime.datetime) -> QuantConnect_Data_Market_TradeBar_T:
        """
    ...
    @staticmethod
    @typing.overload
    def ParseFuture(config: QuantConnect.Data.SubscriptionDataConfig, line: str, date: datetime.datetime) -> QuantConnect_Data_Market_TradeBar_T:
        """
        Parses Future trade bar data into the specified tradebar type, useful for custom types with OHLCV data deriving from TradeBar
...
class OptionChain(QuantConnect.Data.BaseData, System.Collections.Generic.IEnumerable[QuantConnect.Data.Market.OptionContract], typing.Iterable[QuantConnect.Data.Market.OptionContract]):
    ...
    @typing.overload
    def GetAux(self, symbol: typing.Union[QuantConnect.Symbol, str]) -> QuantConnect_Data_Market_OptionChain_T:
        """
    ...
    @typing.overload
    def GetAux(self) -> QuantConnect.Data.Market.DataDictionary[QuantConnect_Data_Market_OptionChain_T]:
        """
    ...
    @typing.overload
    def GetAuxList(self, symbol: typing.Union[QuantConnect.Symbol, str]) -> System.Collections.Generic.List[QuantConnect_Data_Market_OptionChain_T]:
        """
...
class FuturesChain(QuantConnect.Data.BaseData, System.Collections.Generic.IEnumerable[QuantConnect.Data.Market.FuturesContract], typing.Iterable[QuantConnect.Data.Market.FuturesContract]):
    ...
    @typing.overload
    def GetAux(self, symbol: typing.Union[QuantConnect.Symbol, str]) -> QuantConnect_Data_Market_FuturesChain_T:
        """
        Gets the auxiliary data with the specified type and symbol
    ...
    @typing.overload
    def GetAux(self) -> QuantConnect.Data.Market.DataDictionary[QuantConnect_Data_Market_FuturesChain_T]:
        """
        Gets all auxiliary data of the specified type as a dictionary keyed by symbol
    ...
    @typing.overload
    def GetAuxList(self, symbol: typing.Union[QuantConnect.Symbol, str]) -> System.Collections.Generic.List[QuantConnect_Data_Market_FuturesChain_T]:
        """
        Gets a list of auxiliary data with the specified type and symbol
...
class Split(QuantConnect.Data.BaseData):
    ...
    @Type.setter
    def Type(self, value: QuantConnect.SplitType):
        """Gets the type of split event, warning or split."""
        ...
...
class DataDictionaryExtensions(System.Object):
    ...
    @staticmethod
    def Add(dictionary: QuantConnect.Data.Market.DataDictionary[QuantConnect_Data_Market_DataDictionaryExtensions_T], data: QuantConnect_Data_Market_DataDictionaryExtensions_T) -> None:
...
class RenkoBar(QuantConnect.Data.BaseData, QuantConnect.Data.Market.IBaseDataBar):
    ...
    @Type.setter
    def Type(self, value: QuantConnect.Data.Market.RenkoType):
        """Gets the kind of the bar"""
        ...
...
class Delisting(QuantConnect.Data.BaseData):
    ...
    @Type.setter
    def Type(self, value: QuantConnect.DelistingType):
        """
        Gets the type of delisting, warning or delisted
        A DelistingType.Warning is sent
        """
