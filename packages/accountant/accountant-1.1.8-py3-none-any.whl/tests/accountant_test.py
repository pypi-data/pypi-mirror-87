...
class TestCasesOrdersAccountant(unittest.TestCase):
    ...
    def test_block_for_order(self):
        ...
        from_amount = '100'
        to_amount = '10'
        operation = self.accountant.block_for_order(order_id, order_type, from_currency, to_currency, from_amount, to_amount)
    ...
    def test_flow_3(self):
        ...
        from_amount = '100'
        to_amount = '10'
        self.accountant.block_for_order(order_id, order_type, from_currency, to_currency, from_amount, to_amount)
        operation = self.accountant.unblock_for_order(order_id, order_type)
        self.assertIn("status", operation)
        self.assertEqual(operation['status'], 'APPLIED')
