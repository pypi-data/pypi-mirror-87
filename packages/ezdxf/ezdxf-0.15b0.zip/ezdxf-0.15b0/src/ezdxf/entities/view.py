...
class View(DXFEntity):
    ...
    def export_entity(self, tagwriter: 'TagWriter') -> None:
        ...
        self.dxf.export_dxf_attribs(tagwriter, [
            'name', 'flags', 'height', 'width', 'center', 'direction', 'target',
            'focal_length', 'front_clipping', 'back_clipping', 'view_twist',
            'view_mode', 'render_mode', 'ucs', 'ucs_origin', 'ucs_xaxis',
            'ucs_yaxis', 'ucs_ortho_type', 'elevation', 'ucs_handle',
            'base_ucs_handle', 'camera_plottable', 'background_handle',
