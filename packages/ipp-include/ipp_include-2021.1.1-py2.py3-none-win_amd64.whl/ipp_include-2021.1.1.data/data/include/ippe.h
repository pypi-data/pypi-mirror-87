...
//   pSrc               pointer to the source vector
//   len                length of the vector, number of items
//   poly               CRC polinomial with explicit leading 1(indicates CRC length 8/16/24/32 bits)
...
//              ippsCRC_8u has optimization for some fixed polinomials only
...
//                                                        'ippStsNonOptimalPathSelected' functon works slow. see 2.   
