...
class MediaTypeSpec(object):
    ...
    def __init__(self, archive_config=None, attribute_types=None, default_volume=None, description='', dtype=None, file_format=None, keep_original=True, name=None, overlay_config=None, streaming_config=None, local_vars_configuration=None):  # noqa: E501
