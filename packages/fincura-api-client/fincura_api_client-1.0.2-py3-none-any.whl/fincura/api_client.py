...
from fincura import rest
from fincura.configuration import Configuration
from fincura.exceptions import ApiTypeError, ApiValueError, ApiException
from fincura.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.refresh_api_key  # this is an instance of the class Endpoint
        api_instance.refresh_api_key()  # this invokes api_instance.refresh_api_key.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.refresh_api_key.callable or self.callable in this class
