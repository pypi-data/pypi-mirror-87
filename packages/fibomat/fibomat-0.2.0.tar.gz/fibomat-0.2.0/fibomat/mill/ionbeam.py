...
from fibomat.linalg import VectorLike, VectorArrayLike, Vector, VectorArray, VectorValueError, VectorArrayValueError
...
class IonBeam(abc.ABC):
    ...
    def flux_at(
        self,
        position: VectorLike, beam_maxima: VectorArrayLike,
        position_unit: UnitType
    ...
    def flux_at(
        self,
        position: VectorLike, beam_maxima: Union[VectorArrayLike, VectorLike],
        position_unit: UnitType
...
class GaussBeam(IonBeam):
    ...
    def flux_at(
        ...
        try:
            ...
            try:
                beam_maxima = VectorArray(beam_maxima)
            except VectorArrayValueError:
