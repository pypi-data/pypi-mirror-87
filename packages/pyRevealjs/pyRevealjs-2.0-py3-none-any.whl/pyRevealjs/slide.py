...
class Slide:
    ...
    def __init__(self, id: int, title: str, part:float=0.0, version:float=0.0, showLinks=True, isImage=False, display_title=False):
        """builds the object"""
        self.filename = None
        self.content = None
    ...
    def getContent(self):
        ...
        if self.display_title or not content:
    ...
    def _getImageContent(self):
        ...
        imageLink = r'images/'+path.basename(self.filename)
        content = '![{0}]({1})'.format(
