...
class ChannelCreatedWaiter(Boto3Waiter):
    ...
    def wait(self, ChannelId: str, WaiterConfig: WaiterConfigTypeDef = None) -> None:
        """
        [ChannelCreated.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.16.28/reference/services/medialive.html#MediaLive.Waiter.ChannelCreated.wait)
        """
...
class ChannelDeletedWaiter(Boto3Waiter):
    ...
    def wait(self, ChannelId: str, WaiterConfig: WaiterConfigTypeDef = None) -> None:
        """
        [ChannelDeleted.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.16.28/reference/services/medialive.html#MediaLive.Waiter.ChannelDeleted.wait)
        """
...
class ChannelRunningWaiter(Boto3Waiter):
    ...
    def wait(self, ChannelId: str, WaiterConfig: WaiterConfigTypeDef = None) -> None:
        """
        [ChannelRunning.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.16.28/reference/services/medialive.html#MediaLive.Waiter.ChannelRunning.wait)
        """
...
class ChannelStoppedWaiter(Boto3Waiter):
    ...
    def wait(self, ChannelId: str, WaiterConfig: WaiterConfigTypeDef = None) -> None:
        """
        [ChannelStopped.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.16.28/reference/services/medialive.html#MediaLive.Waiter.ChannelStopped.wait)
        """
...
class InputAttachedWaiter(Boto3Waiter):
    ...
    def wait(self, InputId: str, WaiterConfig: WaiterConfigTypeDef = None) -> None:
        """
        [InputAttached.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.16.28/reference/services/medialive.html#MediaLive.Waiter.InputAttached.wait)
        """
...
class InputDeletedWaiter(Boto3Waiter):
    ...
    def wait(self, InputId: str, WaiterConfig: WaiterConfigTypeDef = None) -> None:
        """
        [InputDeleted.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.16.28/reference/services/medialive.html#MediaLive.Waiter.InputDeleted.wait)
        """
...
class InputDetachedWaiter(Boto3Waiter):
    ...
    def wait(self, InputId: str, WaiterConfig: WaiterConfigTypeDef = None) -> None:
        """
        [InputDetached.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.16.28/reference/services/medialive.html#MediaLive.Waiter.InputDetached.wait)
        """
...
class MultiplexCreatedWaiter(Boto3Waiter):
    ...
    def wait(self, MultiplexId: str, WaiterConfig: WaiterConfigTypeDef = None) -> None:
        """
        [MultiplexCreated.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.16.28/reference/services/medialive.html#MediaLive.Waiter.MultiplexCreated.wait)
        """
...
class MultiplexDeletedWaiter(Boto3Waiter):
    ...
    def wait(self, MultiplexId: str, WaiterConfig: WaiterConfigTypeDef = None) -> None:
        """
        [MultiplexDeleted.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.16.28/reference/services/medialive.html#MediaLive.Waiter.MultiplexDeleted.wait)
        """
...
class MultiplexRunningWaiter(Boto3Waiter):
    ...
    def wait(self, MultiplexId: str, WaiterConfig: WaiterConfigTypeDef = None) -> None:
        """
        [MultiplexRunning.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.16.28/reference/services/medialive.html#MediaLive.Waiter.MultiplexRunning.wait)
        """
...
class MultiplexStoppedWaiter(Boto3Waiter):
    ...
    def wait(self, MultiplexId: str, WaiterConfig: WaiterConfigTypeDef = None) -> None:
        """
        [MultiplexStopped.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.16.28/reference/services/medialive.html#MediaLive.Waiter.MultiplexStopped.wait)
        """
