...
class oneperType03_1(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, helpername=None, inner01=None, gds_collector_=None, **kwargs_):
        ...
        self.helpername_nsprefix_ = None
    ...
    def get_helpername(self):
        return self.helpername
    def set_helpername(self, helpername):
        self.helpername = helpername
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='oneperType03_1', pretty_print=True):
        ...
        if pretty_print:
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'oneperType03_1':
        ...
        if self.hasContent_():
            ...
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='oneperType03_1', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
    ...
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='oneperType03_1'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='oneperType03_1', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.helpername is not None:
            namespaceprefix_ = self.helpername_nsprefix_ + ':' if (UseCapturedNS_ and self.helpername_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'helpername':
            value_ = child_.text
            value_ = self.gds_parse_string(value_, node, 'helpername')
            value_ = self.gds_validate_string(value_, node, 'helpername')
            self.helpername = value_
            self.helpername_nsprefix_ = child_.prefix
...
class oneperType03_2(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, helperdescription=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
        ...
        self.helperdescription_nsprefix_ = None
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
    ...
    def set_ns_prefix_(self, ns_prefix):
        self.ns_prefix_ = ns_prefix
    def get_helperdescription(self):
        return self.helperdescription
    def set_helperdescription(self, helperdescription):
        self.helperdescription = helperdescription
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='oneperType03_2', pretty_print=True):
        ...
        if pretty_print:
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'oneperType03_2':
            name_ = self.original_tagname_
        if UseCapturedNS_ and self.ns_prefix_:
            namespaceprefix_ = self.ns_prefix_ + ':'
        showIndent(outfile, level, pretty_print)
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='oneperType03_2', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='oneperType03_2'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='oneperType03_2', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.helperdescription is not None:
            namespaceprefix_ = self.helperdescription_nsprefix_ + ':' if (UseCapturedNS_ and self.helperdescription_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'helperdescription':
            value_ = child_.text
            value_ = self.gds_parse_string(value_, node, 'helperdescription')
            value_ = self.gds_validate_string(value_, node, 'helperdescription')
            self.helperdescription = value_
            self.helperdescription_nsprefix_ = child_.prefix
