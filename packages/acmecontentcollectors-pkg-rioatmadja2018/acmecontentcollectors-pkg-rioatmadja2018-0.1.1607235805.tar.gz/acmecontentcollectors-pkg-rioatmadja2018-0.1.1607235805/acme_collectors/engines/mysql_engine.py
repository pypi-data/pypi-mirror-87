...
class MySQLEngine(object):
    ...
    def __init__(self, credentials_path: str):
        ...
        self.host: str = os.getenv.get('MYSQL_SERVER')
        self.port: str = os.getenv.get('MYSQL_PORT')
        self.user: str = os.getenv.get('MYSQL_USER')
        self.root_user: str = os.getenv.get('MYSQL_ROOT_USER')
        self.passwd: str = os.getenv.get('MYSQL_PASSWD')
        self.db: str = os.getenv.get('MYSQL_DB')

        self.conn = self.mysql_connection()
        self.cursor = self.conn.cursor()

    def mysql_connection(self, user: str = 'root') -> Connection:
        """
        Description
        -----------
