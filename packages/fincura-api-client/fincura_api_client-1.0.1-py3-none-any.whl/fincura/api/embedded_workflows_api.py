...
class EmbeddedWorkflowsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        def __create_embedded_workflow(
            self,
            **kwargs
        ):
            ...
            Keyword Args:
                embedded_workflow (EmbeddedWorkflow): [optional]
        ...
        self.create_embedded_workflow = Endpoint(
            settings={
                'response_type': (EmbeddedWorkflow,),
                'auth': [
                    'API_Key'
                ],
                'endpoint_path': '/v1/embedded-workflow',
                'operation_id': 'create_embedded_workflow',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
            ...
            callable=__create_embedded_workflow
        )

        def __retrieve_embedded_workflow(
            self,
            uuid,
            **kwargs
        ):
        ...
        self.retrieve_embedded_workflow = Endpoint(
            settings={
                'response_type': (EmbeddedWorkflow,),
                'auth': [
                    'API_Key'
                ],
                'endpoint_path': '/v1/embedded-workflow/{uuid}',
                'operation_id': 'retrieve_embedded_workflow',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__retrieve_embedded_workflow
        )
