...
#   `tensorflow_probability/substrates/jax/distributions/moyal.py`
...
from tensorflow_probability.substrates.jax.bijectors import moyal_cdf as moyal_cdf_bijector
