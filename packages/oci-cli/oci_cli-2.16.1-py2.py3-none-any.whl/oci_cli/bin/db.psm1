...
function GetOciCommandsToLongParams_db() {
    $ociCommandsToLongParams = @{
        ...
        'db exadata-infrastructure create' = 'admin-network-cidr cloud-control-plane-server1 cloud-control-plane-server2 compartment-id contacts corporate-proxy defined-tags display-name dns-server freeform-tags from-json gateway help infini-band-network-cidr maintenance-window max-wait-seconds netmask ntp-server shape time-zone wait-for-state wait-interval-seconds'
        ...
        'db exadata-infrastructure update' = 'admin-network-cidr cloud-control-plane-server1 cloud-control-plane-server2 contacts corporate-proxy defined-tags dns-server exadata-infrastructure-id force freeform-tags from-json gateway help if-match infini-band-network-cidr maintenance-window max-wait-seconds netmask ntp-server time-zone wait-for-state wait-interval-seconds'
