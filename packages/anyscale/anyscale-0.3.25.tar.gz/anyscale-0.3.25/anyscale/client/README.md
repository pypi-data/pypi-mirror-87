...
*DefaultApi* | [**create_new_session_api_v2_sessions_create_from_snapshot_post**](docs/DefaultApi.md#create_new_session_api_v2_sessions_create_from_snapshot_post) | **POST** /api/v2/sessions/create_from_snapshot | Create New Session
...
*DefaultApi* | [**execute_command_api_v2_sessions_session_id_execute_command_name_post**](docs/DefaultApi.md#execute_command_api_v2_sessions_session_id_execute_command_name_post) | **POST** /api/v2/sessions/{session_id}/execute/{command_name} | Execute Command
...
*DefaultApi* | [**handle_gateway_interaction_api_v2_cloudgateway_gateway_id_post**](docs/DefaultApi.md#handle_gateway_interaction_api_v2_cloudgateway_gateway_id_post) | **POST** /api/v2/cloudgateway/{gateway_id} | Handle Gateway Interaction
...
*DefaultApi* | [**put_session_cluster_config_api_v2_sessions_session_id_cluster_config_put**](docs/DefaultApi.md#put_session_cluster_config_api_v2_sessions_session_id_cluster_config_put) | **PUT** /api/v2/sessions/{session_id}/cluster_config | Put Session Cluster Config
...
*DefaultApi* | [**rerun_command_api_v2_session_commands_session_command_id_rerun_post**](docs/DefaultApi.md#rerun_command_api_v2_session_commands_session_command_id_rerun_post) | **POST** /api/v2/session_commands/{session_command_id}/rerun | Rerun Command
...
*DefaultApi* | [**session_finish_up_api_v2_sessions_session_id_finish_up_post**](docs/DefaultApi.md#session_finish_up_api_v2_sessions_session_id_finish_up_post) | **POST** /api/v2/sessions/{session_id}/finish_up | Session Finish Up
...
*DefaultApi* | [**session_report_command_api_v2_session_commands_session_command_id_report_command_post**](docs/DefaultApi.md#session_report_command_api_v2_session_commands_session_command_id_report_command_post) | **POST** /api/v2/session_commands/{session_command_id}/report_command | Session Report Command
*DefaultApi* | [**session_up_api_v2_sessions_up_post**](docs/DefaultApi.md#session_up_api_v2_sessions_up_post) | **POST** /api/v2/sessions/up | Session Up
*DefaultApi* | [**set_ray_dashboard_url_api_v2_sessions_session_id_ray_dashboard_url_post**](docs/DefaultApi.md#set_ray_dashboard_url_api_v2_sessions_session_id_ray_dashboard_url_post) | **POST** /api/v2/sessions/{session_id}/ray_dashboard_url | Set Ray Dashboard Url
...
## Documentation For Models
 ...
 - [Error](docs/Error.md)
 - [ExecuteCommandOptions](docs/ExecuteCommandOptions.md)
 ...
 - [GatewayRequest](docs/GatewayRequest.md)
 - [GatewayrequestResponse](docs/GatewayrequestResponse.md)
 ...
 - [JsonDumpedGatewayResponseMessage](docs/JsonDumpedGatewayResponseMessage.md)
 ...
 - [SessionUpResponse](docs/SessionUpResponse.md)
 ...
 - [SessionupresponseResponse](docs/SessionupresponseResponse.md)
