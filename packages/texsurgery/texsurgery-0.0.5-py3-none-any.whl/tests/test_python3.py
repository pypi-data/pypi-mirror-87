...
class TestPython3Surgery(unittest.TestCase):
    ...
    def test_nested_brackets(self):
        ...
        tex_source = r"\usepackage[sagemath]{texsurgery}The first prime number is \eval{sorted({7,3,5,2})[0]}"
    ...
    def test_return_str(self):
        ...
        tex_source = r"\usepackage[sagemath]{texsurgery}My favourite colour is \evalstr{'blue'}"
