# Generated from 'v2_4_0.xml' on 2020-11-30 09:07:58.135707
...
class LaserHead:
    def __init__(self, client: Client, name: str) -> None:
        ...
        self._eom = PiezoDrv2(client, name + ':eom')
...
class ScbPowerOptimization:
    ...
    async def start_optimization_seed_probe(self) -> int:
        return await self.__client.exec(self.__name + ':start-optimization-seed-probe', input_stream=None, output_type=None, return_type=int)
...
class ServoControlServos:
    ...
    async def center_probe_servos(self) -> None:
        await self.__client.exec(self.__name + ':center-probe-servos', input_stream=None, output_type=None, return_type=None)
...
class NloLaserHeadServos:
    def __init__(self, client: Client, name: str) -> None:
        ...
        self._etalon = NloLaserHeadServoPwm2(client, name + ':etalon')
    ...
    @property
    def etalon(self) -> 'NloLaserHeadServoPwm2':
        return self._etalon
...
class NloPhotoDiodes:
    def __init__(self, client: Client, name: str) -> None:
        ...
        self._pump = NloLaserHeadNloPhotodiode2(client, name + ':pump')
        self._pump_dep = NloLaserHeadNloPhotodiode2(client, name + ':pump-dep')
        self._sig = NloLaserHeadNloPhotodiode2(client, name + ':sig')
    ...
    @property
    def pump(self) -> 'NloLaserHeadNloPhotodiode2':
        return self._pump

    @property
    def pump_dep(self) -> 'NloLaserHeadNloPhotodiode2':
        return self._pump_dep

    @property
    def sig(self) -> 'NloLaserHeadNloPhotodiode2':
        return self._sig
...
class NloPowerOptimization:
    def __init__(self, client: Client, name: str) -> None:
        ...
        self._stage1 = NloStage2(client, name + ':stage1')
        self._stage2 = NloStage2(client, name + ':stage2')
        self._stage3 = NloStage2(client, name + ':stage3')
        self._stage4 = NloStage2(client, name + ':stage4')
        self._stage5 = NloStage2(client, name + ':stage5')
        self._progress_data_amp = DecopBinary(client, name + ':progress-data-amp')
    ...
    @property
    def stage1(self) -> 'NloStage2':
        return self._stage1

    @property
    def stage2(self) -> 'NloStage2':
        return self._stage2

    @property
    def stage3(self) -> 'NloStage2':
        return self._stage3

    @property
    def stage4(self) -> 'NloStage2':
        return self._stage4

    @property
    def stage5(self) -> 'NloStage2':
        return self._stage5
...
class Shg:
    def __init__(self, client: Client, name: str) -> None:
        ...
        self.__name = name
        self._tc = TcChannel2(client, name + ':tc')
        self._cavity_tc = TcChannel2(client, name + ':cavity-tc')
        self._pc = PiezoDrv2(client, name + ':pc')
...
class UvShgPowerOptimization:
    def __init__(self, client: Client, name: str) -> None:
        ...
        self._status = DecopInteger(client, name + ':status')
        self._status_string = DecopString(client, name + ':status-string')
        self._cavity = NloStage1(client, name + ':cavity')
...
class LaserDiagnosis:
    ...
    async def generate_to_usb(self) -> None:
        await self.__client.exec(self.__name + ':generate-to-usb', input_stream=None, output_type=None, return_type=None)
...
class ServiceReport:
    ...
    async def save_to_usb(self) -> None:
        await self.__client.exec(self.__name + ':save-to-usb', input_stream=None, output_type=None, return_type=None)
...
class Ipconfig:
    ...
    async def set_ip_gateway(self, ip_addr: str, net_mask: str, gateway: str) -> None:
        assert isinstance(ip_addr, str), "expected type 'str' for parameter 'ip_addr', got '{}'".format(type(ip_addr))
        assert isinstance(net_mask, str), "expected type 'str' for parameter 'net_mask', got '{}'".format(type(net_mask))
        assert isinstance(gateway, str), "expected type 'str' for parameter 'gateway', got '{}'".format(type(gateway))
        await self.__client.exec(self.__name + ':set-ip-gateway', ip_addr, net_mask, gateway, input_stream=None, output_type=None, return_type=None)
...
class DLCpro:
    ...
    async def service_script_from_usb(self) -> None:
        await self.__client.exec('service-script-from-usb', input_stream=None, output_type=None, return_type=None)
