...
def lazy_import():
    ...
    globals()['DataViewCells'] = DataViewCells


class DataViewColumns(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, label, statement_date, reporting_interval, preparation_type, prepared_by, months_in_interval, cells, *args, **kwargs):  # noqa: E501
        """DataViewColumns - a model defined in OpenAPI
