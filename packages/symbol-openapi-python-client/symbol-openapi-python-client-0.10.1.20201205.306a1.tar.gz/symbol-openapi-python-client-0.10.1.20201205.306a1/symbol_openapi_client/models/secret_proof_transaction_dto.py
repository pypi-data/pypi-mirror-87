...
class SecretProofTransactionDTO(object):
    ...
    def __init__(self, size=None, signature=None, signer_public_key=None, version=None, network=None, type=None, max_fee=None, deadline=None, recipient_address=None, secret=None, hash_algorithm=None, proof=None, local_vars_configuration=None):  # noqa: E501
    ...
    @property
    def size(self):
        """Gets the size of this SecretProofTransactionDTO.  # noqa: E501

        A number that allows uint 32 values.  # noqa: E501

        :return: The size of this SecretProofTransactionDTO.  # noqa: E501
        :rtype: int
        """
        return self._size
    ...
    @size.setter
    def size(self, size):
        """Sets the size of this SecretProofTransactionDTO.

        A number that allows uint 32 values.  # noqa: E501

        :param size: The size of this SecretProofTransactionDTO.  # noqa: E501
        :type: int
        """
