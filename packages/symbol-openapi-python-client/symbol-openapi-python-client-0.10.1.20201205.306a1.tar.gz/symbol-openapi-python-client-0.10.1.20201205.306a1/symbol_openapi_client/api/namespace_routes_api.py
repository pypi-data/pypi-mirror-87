...
class NamespaceRoutesApi(object):
    ...
    def get_accounts_names(self, addresses, **kwargs):  # noqa: E501
        ...
        return self.get_accounts_names_with_http_info(addresses, **kwargs)  # noqa: E501

    def get_accounts_names_with_http_info(self, addresses, **kwargs):  # noqa: E501
        """Get readable names for a set of accountIds  # noqa: E501

        Returns friendly names for accounts.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_accounts_names_with_http_info(addresses, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('addresses' not in local_var_params or  # noqa: E501
                                                        local_var_params['addresses'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `addresses` when calling `get_accounts_names`")  # noqa: E501
    ...
    def get_namespace_merkle(self, namespace_id, **kwargs):  # noqa: E501
        """Get namespace merkle information  # noqa: E501

        Gets the namespace merkle for a given namespace identifier.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_namespace_merkle(namespace_id, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.get_namespace_merkle_with_http_info(namespace_id, **kwargs)  # noqa: E501

    def get_namespace_merkle_with_http_info(self, namespace_id, **kwargs):  # noqa: E501
        """Get namespace merkle information  # noqa: E501

        Gets the namespace merkle for a given namespace identifier.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_namespace_merkle_with_http_info(namespace_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_namespace_merkle" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'namespace_id' is set
        if self.api_client.client_side_validation and ('namespace_id' not in local_var_params or  # noqa: E501
                                                        local_var_params['namespace_id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `namespace_id` when calling `get_namespace_merkle`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/namespaces/{namespaceId}/merkle', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def search_namespaces(self, **kwargs):  # noqa: E501
        """Search namespaces  # noqa: E501

        Gets an array of namespaces.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        :param NamespaceRegistrationTypeEnum registration_type: Filter by registration type.
        :param str level0: Filter by root namespace.
        :param AliasTypeEnum alias_type: Filter by alias type.
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.search_namespaces_with_http_info(**kwargs)  # noqa: E501

    def search_namespaces_with_http_info(self, **kwargs):  # noqa: E501
        """Search namespaces  # noqa: E501

        Gets an array of namespaces.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.search_namespaces_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(NamespacePage, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method search_namespaces" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']

        if self.api_client.client_side_validation and 'page_size' in local_var_params and local_var_params['page_size'] > 100:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `page_size` when calling `search_namespaces`, must be a value less than or equal to `100`")  # noqa: E501
        if self.api_client.client_side_validation and 'page_size' in local_var_params and local_var_params['page_size'] < 10:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `page_size` when calling `search_namespaces`, must be a value greater than or equal to `10`")  # noqa: E501
        if self.api_client.client_side_validation and 'page_number' in local_var_params and local_var_params['page_number'] < 1:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `page_number` when calling `search_namespaces`, must be a value greater than or equal to `1`")  # noqa: E501
        collection_formats = {}
        ...
        if 'registration_type' in local_var_params and local_var_params['registration_type'] is not None:  # noqa: E501
            query_params.append(('registrationType', local_var_params['registration_type']))  # noqa: E501
        if 'level0' in local_var_params and local_var_params['level0'] is not None:  # noqa: E501
            query_params.append(('level0', local_var_params['level0']))  # noqa: E501
        if 'alias_type' in local_var_params and local_var_params['alias_type'] is not None:  # noqa: E501
            query_params.append(('aliasType', local_var_params['alias_type']))  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='NamespacePage',  # noqa: E501
            auth_settings=auth_settings,
            async_req=local_var_params.get('async_req'),
            _return_http_data_only=local_var_params.get('_return_http_data_only'),  # noqa: E501
            _preload_content=local_var_params.get('_preload_content', True),
