...
#   `tensorflow_probability/substrates/numpy/distributions/inverse_gamma.py`
...
from tensorflow_probability.substrates.numpy.bijectors import reciprocal as reciprocal_bijector
