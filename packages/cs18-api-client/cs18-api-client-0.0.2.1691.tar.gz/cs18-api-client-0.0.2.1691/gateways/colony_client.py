...
from gateways.common.cs18_api_classes import BlueprintRepositoryDetails, AccessLink, \
    AddBlueprintUsingTokenRepositoryRequest, AddBlueprintGithubRepositoryRequest, AddBlueprintBitbucketRepositoryRequest
...
from gateways.common.cs18_api_requests import (
    ...
    AddK8SComputeServiceToSpaceRequest, UpdateK8SComputeServiceInSpaceRequest)
...
class Colony:
    ...
    def get_k8s_agent_deployment_yaml(self, cloud_account_name: str, compute_service_name: str, sandbox_namespaces: List[str]):
    ...
    def add_repository_to_space(
        ...
        print(f'repository_url: {repository_details.repository_url} access_token: {repository_details.access_token}')
