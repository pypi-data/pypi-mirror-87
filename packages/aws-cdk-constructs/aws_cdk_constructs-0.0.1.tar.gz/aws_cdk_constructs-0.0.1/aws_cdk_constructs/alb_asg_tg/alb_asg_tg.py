...
class AlbAsgTg(core.Construct):
    ...
    - Application Load Balancer, configurable to be 'internal' or 'internet-facing' or to integrate with Cognito
    ...
    def enable_fao_private_access(self, security_group):
        security_group.add_ingress_rule(
            peer=self.pulse_cidr_as_peer(self._aws_cdk_parameters),
            connection=self.tcp_connection_traffic_port,
            description="Pulse Secure",
        )

        security_group.add_ingress_rule(
            peer=self.fao_hq_clients_as_peer(self._aws_cdk_parameters),
            connection=self.tcp_connection_traffic_port,
    ...
    @staticmethod
    def pulse_cidr_as_peer(aws_cdk_parameters):
        fao_networks = aws_cdk_parameters["networking"]
        return _ec2.Peer.ipv4(fao_networks["pulse"])

    @staticmethod
    def fao_hq_clients_as_peer(aws_cdk_parameters):
        """
    ...
    def __init__(
        ...
        **kwargs
        ...
        self._aws_cdk_parameters = aws_cdk_parameters
        aws_account = self._aws_cdk_parameters["accounts"][environment.lower()]
        ...
        # MUST EXIST aws_cdk_parameters, enviroment
        ...
        self._pulse_cidr_as_peer = self.pulse_cidr_as_peer(self._aws_cdk_parameters)
        self._fao_hq_clients_as_peer = self.fao_hq_clients_as_peer(
            self._aws_cdk_parameters
        )
