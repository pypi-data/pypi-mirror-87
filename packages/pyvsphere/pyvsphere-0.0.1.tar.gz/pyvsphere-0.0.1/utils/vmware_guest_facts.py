...
if __name__ == '__main__':
    # r = main(show_attribute=False,datacenter='Datacenter',uuid='564d9a26-f764-1eca-ef50-13733bf6b6df',schema='summary')
    # r = main(show_attribute=False,datacenter='Datacenter',schema='summary',name='vCenter Server')
    r = vmware_guest_facts(show_attribute=False,datacenter='Datacenter',schema='summary',name='maliao-test1') # 172.16.10.6
    r = vmware_guest_facts(show_attribute=False,datacenter='Datacenter',schema='summary',name='rancher-node04') # 192.168.10.40
    print(r)
