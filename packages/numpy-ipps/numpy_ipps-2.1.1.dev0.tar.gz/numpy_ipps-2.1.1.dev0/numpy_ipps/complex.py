...
class _MulCplxCIIPPSImpl(
    metaclass=_binaries.BinaryC_I,
    ipps_backend="MulC_I",
    numpy_backend=_numpy.multiply,
    candidates=(_numpy.complex64,),
):
    """MulC_I Function -- Intel IPPS implementation."""

    pass


class _MulCplxCINumpyImpl(
    metaclass=_binaries.BinaryC_I,
    ipps_backend="MulC_I",
    numpy_backend=_numpy.multiply,
    candidates=(_numpy.complex64,),
    ...
    """MulC_I Function -- Numpy implementation."""
...
class _MulCplxC_I(
    ...
    ipps_class=_MulCplxCIIPPSImpl,
    numpy_class=_MulCplxCINumpyImpl,
