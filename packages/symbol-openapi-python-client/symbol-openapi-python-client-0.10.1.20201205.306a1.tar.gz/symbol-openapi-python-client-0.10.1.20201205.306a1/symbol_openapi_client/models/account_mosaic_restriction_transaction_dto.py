...
class AccountMosaicRestrictionTransactionDTO(object):
    ...
    @property
    def size(self):
        """Gets the size of this AccountMosaicRestrictionTransactionDTO.  # noqa: E501

        A number that allows uint 32 values.  # noqa: E501

        :return: The size of this AccountMosaicRestrictionTransactionDTO.  # noqa: E501
        :rtype: int
        """
        return self._size
    ...
    @size.setter
    def size(self, size):
        """Sets the size of this AccountMosaicRestrictionTransactionDTO.

        A number that allows uint 32 values.  # noqa: E501

        :param size: The size of this AccountMosaicRestrictionTransactionDTO.  # noqa: E501
        :type: int
        """
