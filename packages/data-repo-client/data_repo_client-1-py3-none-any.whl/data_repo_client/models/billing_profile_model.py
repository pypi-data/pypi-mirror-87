...
class BillingProfileModel(object):
    ...
    def __init__(self, id=None, billing_account_id=None, profile_name=None, biller=None, description=None, created_date=None, created_by=None, local_vars_configuration=None):  # noqa: E501
