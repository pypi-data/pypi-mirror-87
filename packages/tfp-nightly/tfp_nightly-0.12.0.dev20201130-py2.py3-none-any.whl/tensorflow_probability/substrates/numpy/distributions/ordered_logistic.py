...
#   `tensorflow_probability/substrates/numpy/distributions/ordered_logistic.py`
...
from tensorflow_probability.substrates.numpy.bijectors import ordered as ordered_bijector
