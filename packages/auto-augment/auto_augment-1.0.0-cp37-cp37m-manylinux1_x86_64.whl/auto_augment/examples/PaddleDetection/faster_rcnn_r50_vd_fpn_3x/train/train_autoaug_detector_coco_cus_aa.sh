...
config="examples/PaddleDetection/faster_rcnn_r50_vd_fpn_3x/train/faster_rcnn_r50_vd_fpn_3x_reduce_coco.yml"

#model_save_dir="work_dirs/pbt_detector/test_autoaug_detector_coco_faster_rcnn_r50_vd_fpn_3x_cus_aa/train"
#model_save_dir="work_dirs/pbt_detector/test_autoaug_detector_coco_faster_rcnn_r50_vd_fpn_3x_cus_aa/reduce_train"
model_save_dir="work_dirs/pbt_detector/test_autoaug_detector_coco_faster_rcnn_r50_vd_fpn_3x_cus_aa/baseline_reduce_train"
#
