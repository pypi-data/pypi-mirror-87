(self.webpackChunkhome_assistant_frontend=self.webpackChunkhome_assistant_frontend||[]).push([[1850],{75692:(e,t,i)=>{"use strict";i.d(t,{rc:()=>l,NF:()=>v,pv:()=>g,k2:()=>w,A$:()=>k,Cq:()=>E});var r=i(55317),n=i(15652),o=i(79865),a=(i(16509),i(52039),i(88027));const s=new Set(["clear-night","cloudy","fog","lightning","lightning-rainy","partlycloudy","pouring","rainy","hail","snowy","snowy-rainy","sunny","windy","windy-variant"]),c={exceptional:"hass:alert-circle-outline"},l={humidity:r.uUi,wind_bearing:r.GOG,wind_speed:r.GOG,pressure:r.mXo,visibility:r.VE8,precipitation:r.yxk},d=new Set(["partlycloudy","cloudy","fog","windy","windy-variant","hail","rainy","snowy","snowy-rainy","pouring","lightning","lightning-rainy"]),u=new Set(["hail","rainy","pouring"]),h=new Set(["windy","windy-variant"]),p=new Set(["snowy","snowy-rainy"]),f=new Set(["lightning","lightning-rainy"]),m=["N","NNE","NE","ENE","E","ESE","SE","SSE","S","SSW","SW","WSW","W","WNW","NW","NNW","N"],y=e=>null!=e?(e=>{const t=parseInt(e,10);return isFinite(t)?m[((t+11.25)/22.5|0)%16]:e})(e):"",v=(e,t,i)=>{if(null!==i){const r=y(i);return`${t} ${g(e,"wind_speed")} (${e.localize("ui.card.weather.cardinal_direction."+r.toLowerCase())||r})`}return`${t} ${g(e,"wind_speed")}`},g=(e,t)=>{const i=e.config.unit_system.length||"";switch(t){case"pressure":return"km"===i?"hPa":"inHg";case"wind_speed":return i+"/h";case"visibility":case"length":return i;case"precipitation":return"km"===i?"mm":"in";case"humidity":case"precipitation_probability":return"%";default:return e.config.unit_system[t]||""}},w=(e,t)=>{var i;const r=b(e,t);if(r)return r;let o,s;if((null===(i=t.attributes.forecast)||void 0===i?void 0:i.length)&&void 0!==t.attributes.forecast[0].precipitation&&null!==t.attributes.forecast[0].precipitation)o=t.attributes.forecast[0].precipitation,s="precipitation";else{if(!("humidity"in t.attributes))return;o=t.attributes.humidity,s="humidity"}const c=l[s];return n.dy`
    ${c?n.dy`
          <ha-svg-icon class="attr-icon" .path=${c}></ha-svg-icon>
        `:e.localize("ui.card.weather.attributes."+s)}
    ${(0,a.IU)(o)} ${g(e,s)}
  `},b=(e,t)=>{var i;if(!(null===(i=t.attributes.forecast)||void 0===i?void 0:i.length))return;let r,o;const a=(new Date).getDate();for(const n of t.attributes.forecast){if(new Date(n.datetime).getDate()!==a)break;(!o||n.temperature>o)&&(o=n.temperature),(!r||n.templow&&n.templow<r)&&(r=n.templow),n.templow||r&&!(n.temperature<r)||(r=n.temperature)}if(!r&&!o)return;const s=g(e,"temperature");return n.dy`
    ${o?`\n            ${o} ${s}\n          `:""}
    ${r&&o?" / ":""}
    ${r?`\n          ${r} ${s}\n        `:""}
  `},k=n.iv`
...
`,E=(e,t,i)=>{const r=getComputedStyle(t).getPropertyValue("--weather-icon-"+e);return r?n.dy`
      <div
        style="background-size: cover;${(0,o.V)({"background-image":r})}"
      ></div>
    `:s.has(e)?n.dy`${((e,t)=>n.YP`
  <svg
  ...
  ${f.has(e)?n.YP`
    ...
    `}},{kind:"method",key:"_handleAction",value:function(e){(0,y.G)(this,this.hass,this._config,e.detail.action)}},{kind:"get",static:!0,key:"styles",value:function(){return[c.A$,r.iv`
        :host {
          display: flex;
          align-items: center;
          flex-direction: row;
      ...
      `]}}]}}),r.oi)},88027:(e,t,i)=>{"use strict";i.d(t,{Fv:()=>r,Ff:()=>n,IU:()=>o});const r=(e,t,i)=>isNaN(e)||isNaN(t)||isNaN(i)?0:e>i?i:e<t?t:e,n=(e,t,i)=>100*(e-t)/(i-t),o=e=>Math.round(10*e)/10}}]);
//# sourceMappingURL=chunk.90390804a81d8132c0d1.js.map