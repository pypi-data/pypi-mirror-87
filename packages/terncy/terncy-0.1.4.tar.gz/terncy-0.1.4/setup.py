...
with open("terncy/version.py") as f:
    ...
    setup(
        ...
        description="A Python library for controlling [Terncy](https://www.terncy.com) devices.",
        long_description="A Python library for controlling [Terncy](https://www.terncy.com) devices.",
