...
class itkResampleImageFilterID2ID2(itk.itkImageToImageFilterAPython.itkImageToImageFilterID2ID2):
    ...
    {Core/Transform/TranslateImage,Translate Image}
    {Filtering/ImageGrid/UpsampleAnImage,Upsampling An Image}
    {Filtering/ImageGrid/ResampleAnImage,Resample An Image} 
    """
