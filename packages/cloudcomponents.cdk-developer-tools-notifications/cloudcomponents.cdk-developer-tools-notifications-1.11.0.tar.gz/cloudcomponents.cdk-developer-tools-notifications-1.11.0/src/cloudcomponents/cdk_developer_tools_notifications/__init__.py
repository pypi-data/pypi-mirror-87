...
class _INotificationRuleProxy:
    ...
    @jsii.member(jsii_name="notificationRuleArn")
    def notification_rule_arn(self) -> builtins.str:
        return jsii.get(self, "notificationRuleArn")
...
class _INotificationTargetProxy:
    ...
    def bind(
        ...
        :param rule: -
        """
        return jsii.invoke(self, "bind", [scope, rule])
...
class MSTeamsIncomingWebhook(
    ...
    def bind(
        ...
        :param _rule: -
        """
        return jsii.invoke(self, "bind", [scope, _rule])
...
class ProjectEvent(enum.Enum):
    ...
    BUILD_PHASE_FAILRE = "BUILD_PHASE_FAILRE"
...
class SlackChannel(
    ...
    def bind(
        ...
        :param _rule: -
        """
        return jsii.invoke(self, "bind", [_scope, _rule])
