...
setup(
    name='yaml2sql',
    description="Create SQL statements from data models in YAML files.",
    ...
    entry_points="""
    [console_scripts]
    yaml2sql=yaml2sql.cli:cli
    """,
    python_requires=">=0.0.1",
    license='GPLv3',  # noqa
    author='Bit-a-Bit',
    author_email='hola@bit-a-bit.info',
    # Use the URL to the github repo.
    url= 'https://github.com/Bit-a-Bit-gh/yaml2sql',
    download_url=(
        f'https://github.com/Bit-a-Bit-gh/'
        f'yaml2sql/archive/{version}.tar.gz'
    ),
    keywords=[
