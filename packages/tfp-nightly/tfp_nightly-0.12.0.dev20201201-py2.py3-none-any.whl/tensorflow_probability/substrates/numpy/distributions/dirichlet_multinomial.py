...
#   `tensorflow_probability/substrates/numpy/distributions/dirichlet_multinomial.py`
...
from tensorflow_probability.substrates.numpy.distributions import multinomial
