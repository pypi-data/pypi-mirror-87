...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'f5bigip', '2.6.0-alpha.1607455066+2479c464'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource f5bigip 2.6.0-alpha.1607455066+2479c464`
                """)
            else:
                raise
