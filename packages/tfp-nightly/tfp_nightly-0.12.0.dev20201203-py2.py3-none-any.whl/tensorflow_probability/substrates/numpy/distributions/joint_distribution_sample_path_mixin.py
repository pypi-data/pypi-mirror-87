...
from tensorflow_probability.substrates.numpy.internal import prefer_static
...
#   `tensorflow_probability/substrates/numpy/distributions/joint_distribution_sample_path_mixin.py`
