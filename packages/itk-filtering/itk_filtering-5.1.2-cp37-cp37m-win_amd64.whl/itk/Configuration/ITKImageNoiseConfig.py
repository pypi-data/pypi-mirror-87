...
snake_case_functions = ('salt_and_pepper_noise_image_filter', 'speckle_noise_image_filter', 'additive_gaussian_noise_image_filter', 'shot_noise_image_filter', 'noise_base_image_filter', )
