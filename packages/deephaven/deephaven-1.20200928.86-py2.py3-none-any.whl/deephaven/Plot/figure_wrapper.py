...
class FigureWrapper(object):
    ...
    def businessTime(self, *args):
        ...
        *Overload 1*  
          :return: (com.illumon.iris.db.plot.Figure) this Axis using the default business calendar.
          
        *Overload 2*  
          :param calendar: com.illumon.util.calendar.BusinessCalendar
          :return: (com.illumon.iris.db.plot.Figure) this Axis using the specified business calendar.
          
        *Overload 3*  
          :param sds: com.illumon.iris.db.plot.filters.SelectableDataSet
          :param valueColumn: java.lang.String
          :return: (com.illumon.iris.db.plot.Figure) this Axis using the business calendar from row 0 of the filtered sds for the business calendar.  If no value is found, no transform will be applied.
        """
    ...
    def catErrorBar(self, *args):
        ...
        *Overload 6*  
          ...
          :param seriesName: java.lang.Comparable
          :param categories: T0[]
          :param values: com.illumon.iris.db.tables.utils.DBDateTime[]
    ...
    def catPlot(self, *args):
        ...
        *Overload 10*  
          ...
          :param seriesName: java.lang.Comparable
          :param categories: com.illumon.iris.db.plot.datasets.data.IndexableData<T1>
          :param values: com.illumon.iris.db.plot.datasets.data.IndexableNumericData
          :return: (com.illumon.iris.db.plot.Figure) dataset created for plot
    ...
    def catPlot3d(self, *args):
        ...
        *Overload 9*  
          ...
          :param xCategories: T0[]
          :param zCategories: T1[]
          :param values: java.util.List<T2>
          :return: (com.illumon.iris.db.plot.Figure) dataset created for plot
        ...
        *Overload 10*  
          ...
          :param seriesName: java.lang.Comparable
          :param xCategories: T0[]
          :param zCategories: java.util.List<T1>
          :param values: T2[]
          :return: (com.illumon.iris.db.plot.Figure) dataset created for plot
        ...
        *Overload 19*  
          ...
          :param seriesName: java.lang.Comparable
          :param xCategories: java.util.List<T0>
          :param zCategories: T1[]
          :param values: T2[]
          :return: (com.illumon.iris.db.plot.Figure) dataset created for plot
    ...
    def chartTitle(self, *args):
        ...
        *Overload 2*  
          ...
          :return: (com.illumon.iris.db.plot.Figure) this Chart with the title set to display comma-separated values from the table
        ...
        *Overload 6*  
          ...
          :param sds: com.illumon.iris.db.plot.filters.SelectableDataSet
          :param titleColumns: java.lang.String...
          :return: (com.illumon.iris.db.plot.Figure) this Chart with the title set to display values from the table
    ...
    def errorBarX(self, *args):
        ...
        *Overload 16*  
          ...
          :param seriesName: java.lang.Comparable
          :param x: com.illumon.iris.db.tables.utils.DBDateTime[]
          :param xLow: com.illumon.iris.db.tables.utils.DBDateTime[]
          :param xHigh: com.illumon.iris.db.tables.utils.DBDateTime[]
          :param y: T3[]
          :return: (com.illumon.iris.db.plot.Figure) dataset created by the plot
    ...
    def funcNPoints(self, npoints):
        ...
        :param npoints: int
        :return: (com.illumon.iris.db.plot.Figure) this data series with the specified number of points.
        """
    ...
    def funcRange(self, *args):
        ...
        *Overload 1*  
          :param xmin: double
          :param xmax: double
          :return: (com.illumon.iris.db.plot.Figure) this data series with the new range
    ...
    def gradientVisible(self, *args):
        ...
        *Overload 1*  
          ...
          :return: (com.illumon.iris.db.plot.Figure) this data series.
    ...
    def newAxes(self, *args):
        ...
        *Overload 1*  
          :return: (com.illumon.iris.db.plot.Figure) newly created Axes with dimension 2 on this Chart
        ...
        *Overload 3*  
          :param dim: int
          :return: (com.illumon.iris.db.plot.Figure) newly created Axes with dimension dim on this Chart
    ...
    def newChart(self, *args):
        ...
        *Overload 1*  
          :return: (com.illumon.iris.db.plot.Figure) the new Chart.  The Chart is placed in the next available grid space, starting at the upper left hand corner of the grid,
        ...
        *Overload 2*  
          :param index: int
          :return: (com.illumon.iris.db.plot.Figure) the new Chart.  The Chart is placed at the grid space indicated by the index.
          
        *Overload 3*  
          :param rowNum: int
          :param colNum: int
          :return: (com.illumon.iris.db.plot.Figure) the new Chart.  The Chart is placed at the grid space [rowNum, colNum.
        """
    ...
    def ohlcPlot(self, *args):
        ...
        *Overload 15*  
          :param seriesName: java.lang.Comparable
          :param time: com.illumon.iris.db.plot.datasets.data.IndexableNumericData
          :param open: com.illumon.iris.db.plot.datasets.data.IndexableNumericData
          :param high: com.illumon.iris.db.plot.datasets.data.IndexableNumericData
          :param low: com.illumon.iris.db.plot.datasets.data.IndexableNumericData
          :param close: com.illumon.iris.db.plot.datasets.data.IndexableNumericData
          :return: (com.illumon.iris.db.plot.Figure) dataset created for plot
    ...
    def plot(self, *args):
        ...
        *Overload 86*  
          :param seriesName: java.lang.Comparable
          :param x: com.illumon.iris.db.plot.datasets.data.IndexableNumericData
          :param y: com.illumon.iris.db.plot.datasets.data.IndexableNumericData
    ...
    def plot3d(self, *args):
        ...
        There are 733 overloads, restricting signature summary to first 50:
        *Overload 1*  
          Note: Java generics information - <T extends java.lang.Number>
        ...
        *Overload 8*  
          ...
          :param x: T0[]
          :param y: T1[]
          :param z: com.illumon.iris.db.tables.utils.DBDateTime[]
          :return: (com.illumon.iris.db.plot.Figure) dataset created for plot
    ...
    def pointColor(self, *args):
        ...
        *Overload 15*  
          :param colors: com.illumon.iris.gui.color.Paint...
          :return: (com.illumon.iris.db.plot.Figure) this XYDataSeries
        ...
        *Overload 27*  
          :param xCategory: java.lang.Comparable
          :param zCategory: java.lang.Comparable
          :param color: com.illumon.iris.gui.color.Paint
          :return: (com.illumon.iris.db.plot.Figure) this CategoryDataSeries3D
        ...
        *Overload 43*  
          ...
          :param colors: java.util.function.BiFunction<java.lang.Comparable,java.lang.Comparable,COLOR>
          :return: (com.illumon.iris.db.plot.Figure) this CategoryDataSeries3D
        ...
        *Overload 47*  
          ...
          :param colors: com.illumon.iris.db.plot.datasets.data.IndexableData<T>
          :return: (com.illumon.iris.db.plot.Figure) this XYDataSeries
    ...
    def pointLabel(self, *args):
        ...
        *Overload 27*  
          ...
          :param labels: java.util.function.BiFunction<java.lang.Comparable,java.lang.Comparable,LABEL>
          :return: (com.illumon.iris.db.plot.Figure) this CategoryDataSeries3D
    ...
    def pointShape(self, *args):
        ...
        *Overload 11*  
          :param shape: com.illumon.iris.gui.shape.Shape
          :return: (com.illumon.iris.db.plot.Figure) this DataSeries
        ...
        *Overload 13*  
          :param shapes: com.illumon.iris.gui.shape.Shape...
          :return: (com.illumon.iris.db.plot.Figure) this XYDataSeries
    ...
    def pointSize(self, *args):
        ...
        *Overload 57*  
          ...
          :param factors: java.util.function.BiFunction<java.lang.Comparable,java.lang.Comparable,NUMBER>
          :return: (com.illumon.iris.db.plot.Figure) this CategoryDataSeries3D
        ...
        *Overload 63*  
          ...
          :param xCategories: XCATEGORY[]
          :param zCategories: ZCATEGORY[]
          :param factors: NUMBER[]
          :return: (com.illumon.iris.db.plot.Figure) this CategoryDataSeries3D
    ...
    def removeChart(self, *args):
        ...
        *Overload 1*  
          :param index: int
          :return: (com.illumon.iris.db.plot.Figure) this Figure with the chart removed.
    ...
    def save(self, *args):
        ...
        *Overload 1*  
          ...
          :return: (com.illumon.iris.db.plot.Figure) figure
    ...
    def twin(self, *args):
        ...
        *Overload 1*  
          :return: (com.illumon.iris.db.plot.Figure) the new Axes instance.  The axes name will be equal to the string representation of the axes id.
    ...
    def xBusinessTime(self, *args):
        ...
        *Overload 1*  
          :return: (com.illumon.iris.db.plot.Figure) this Axes using the default BusinessCalendar for the x-Axis.
          
        *Overload 2*  
          :param calendar: com.illumon.util.calendar.BusinessCalendar
          :return: (com.illumon.iris.db.plot.Figure) this Axes using the calendar for the x-Axis business calendar.
          
        *Overload 3*  
          :param sds: com.illumon.iris.db.plot.filters.SelectableDataSet
          :param valueColumn: java.lang.String
          :return: (com.illumon.iris.db.plot.Figure) this Axes using the business calendar from row 0 of the filtered sds for the x-Axis business calendar.  If no value is found, no transform will be applied.
        """
    ...
    def yBusinessTime(self, *args):
        ...
        *Overload 1*  
          :return: (com.illumon.iris.db.plot.Figure) this Axes using the default BusinessCalendar for the y-Axis.
          
        *Overload 2*  
          :param calendar: com.illumon.util.calendar.BusinessCalendar
          :return: (com.illumon.iris.db.plot.Figure) this Axes using the calendar for the y-Axis business calendar.
          
        *Overload 3*  
          :param sds: com.illumon.iris.db.plot.filters.SelectableDataSet
          :param valueColumn: java.lang.String
          :return: (com.illumon.iris.db.plot.Figure) this Axes using the business calendar from row 0 of the filtered sds for the y-Axis business calendar.  If no value is found, no transform will be applied.
        """
    ...
    def zBusinessTime(self, *args):
        ...
        *Overload 1*  
          :return: (com.illumon.iris.db.plot.Figure) this Axes using the default BusinessCalendar for the z-Axis.
          
        *Overload 2*  
          :param calendar: com.illumon.util.calendar.BusinessCalendar
          :return: (com.illumon.iris.db.plot.Figure) this Axes using the calendar for the z-Axis business calendar.
          
        *Overload 3*  
          :param sds: com.illumon.iris.db.plot.filters.SelectableDataSet
          :param valueColumn: java.lang.String
          :return: (com.illumon.iris.db.plot.Figure) this Axes using the business calendar from row 0 of the filtered sds for the z-Axis business calendar.  If no value is found, no transform will be applied.
        """
