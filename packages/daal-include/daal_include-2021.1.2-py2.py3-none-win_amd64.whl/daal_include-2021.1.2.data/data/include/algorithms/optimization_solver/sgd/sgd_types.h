 ...
 *
 * \snippet optimization_solver/sgd/sgd_types.h  interface1::BaseParameter source code
 */
/* [interface1::BaseParameter source code] */
struct DAAL_EXPORT BaseParameter : public optimization_solver::iterative_solver::interface1::Parameter
{
    /**
 ...
 * \brief %Parameter for the Stochastic gradient descent algorithm     \DAAL_DEPRECATED
 *
...
* \brief %Input for the Stochastic gradient descent algorithm     \DAAL_DEPRECATED
*
* \snippet optimization_solver/sgd/sgd_types.h interface1::Input source code
*/
/* [interface1::Input source code] */
class DAAL_EXPORT Input : public optimization_solver::iterative_solver::interface1::Input
{
public:
...
* \brief Results obtained with the compute() method of the sgd algorithm in the batch processing mode     \DAAL_DEPRECATED
*/
