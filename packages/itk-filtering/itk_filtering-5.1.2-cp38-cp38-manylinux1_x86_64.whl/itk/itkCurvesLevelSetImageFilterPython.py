...
class itkCurvesLevelSetImageFilterID2ID2D(itk.itkSegmentationLevelSetImageFilterPython.itkSegmentationLevelSetImageFilterID2ID2D):
    r"""
...
class itkCurvesLevelSetImageFilterID3ID3D(itk.itkSegmentationLevelSetImageFilterPython.itkSegmentationLevelSetImageFilterID3ID3D):
    r"""
...
def curves_level_set_image_filter_init_docstring():
    ...
    if isinstance(itk.CurvesLevelSetImageFilter, itkTemplate.itkTemplate):
        curves_level_set_image_filter.__doc__ += itkHelpers.filter_args(filter_object)[0]
        curves_level_set_image_filter.__doc__ += "\n"
        curves_level_set_image_filter.__doc__ += itkHelpers.filter_args(filter_object)[1]
    else:
