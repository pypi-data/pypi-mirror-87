...
#   ('--member-specs', 'list')
#   ('-f', '')
#   ('-o', 'tests/anycontent2_sup.py')
#   ('-s', 'tests/anycontent2_sub.py')
#   ('--super', 'anycontent2_sup')
#   ('--always-export-default', '')
#
# Command line arguments:
#   tests/anycontent.xsd
#
# Command line:
#   generateDS.py --no-dates --no-versions --member-specs="list" -f -o "tests/anycontent2_sup.py" -s "tests/anycontent2_sub.py" --super="anycontent2_sup" --always-export-default tests/anycontent.xsd
#
...
class contentContainerType(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    member_data_items_ = [
        MemberSpec_('ident', 'xs:string', 0, 1, {'use': 'optional'}),
        MemberSpec_('content', 'contentType', 1, 1, {'maxOccurs': 'unbounded', 'minOccurs': '0', 'name': 'content', 'type': 'contentType'}, None),
    ]
    subclass = None
    superclass = None
    def __init__(self, ident=None, content=None, gds_collector_=None, **kwargs_):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, contentContainerType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if contentContainerType.subclass:
            return contentContainerType.subclass(*args_, **kwargs_)
        else:
            return contentContainerType(*args_, **kwargs_)
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='contentContainerType', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('contentContainerType')
        ...
        if pretty_print:
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'contentContainerType':
        ...
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='contentContainerType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='contentContainerType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='contentContainerType'):
    ...
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='contentContainerType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
# end class contentContainerType
...
class contentType(GeneratedsSuper):
    ...
    def buildAttributes(self, node, attrs, already_processed):
        pass
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        content_ = self.gds_build_any(child_, 'contentType')
        self.set_anytypeobjs_(content_)
# end class contentType


GDSClassesMapping = {
    'contentContainer': contentContainerType,
}
...
def parse(inFileName, silence=False, print_warnings=True):
    ...
    if rootClass is None:
        rootTag = 'contentContainerType'
        rootClass = contentContainerType
...
def parseLiteral(inFileName, silence=False, print_warnings=True):
    ...
    if not SaveElementTreeNode:
        ...
        rootNode = None
    if not silence:
        sys.stdout.write('#from anycontent2_sup import *\n\n')
        sys.stdout.write('import anycontent2_sup as model_\n\n')
