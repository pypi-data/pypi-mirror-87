...
class EndpointDeletedWaiter(Boto3Waiter):
    ...
    def wait(self, EndpointName: str, WaiterConfig: WaiterConfigTypeDef = None) -> None:
        """
        [EndpointDeleted.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.16.28/reference/services/sagemaker.html#SageMaker.Waiter.EndpointDeleted.wait)
        """
...
class EndpointInServiceWaiter(Boto3Waiter):
    ...
    def wait(self, EndpointName: str, WaiterConfig: WaiterConfigTypeDef = None) -> None:
        """
        [EndpointInService.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.16.28/reference/services/sagemaker.html#SageMaker.Waiter.EndpointInService.wait)
        """
...
class NotebookInstanceDeletedWaiter(Boto3Waiter):
    ...
    def wait(self, NotebookInstanceName: str, WaiterConfig: WaiterConfigTypeDef = None) -> None:
        """
        [NotebookInstanceDeleted.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.16.28/reference/services/sagemaker.html#SageMaker.Waiter.NotebookInstanceDeleted.wait)
        """
...
class NotebookInstanceInServiceWaiter(Boto3Waiter):
    ...
    def wait(self, NotebookInstanceName: str, WaiterConfig: WaiterConfigTypeDef = None) -> None:
        """
        [NotebookInstanceInService.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.16.28/reference/services/sagemaker.html#SageMaker.Waiter.NotebookInstanceInService.wait)
        """
...
class NotebookInstanceStoppedWaiter(Boto3Waiter):
    ...
    def wait(self, NotebookInstanceName: str, WaiterConfig: WaiterConfigTypeDef = None) -> None:
        """
        [NotebookInstanceStopped.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.16.28/reference/services/sagemaker.html#SageMaker.Waiter.NotebookInstanceStopped.wait)
        """
...
class ProcessingJobCompletedOrStoppedWaiter(Boto3Waiter):
    ...
    def wait(self, ProcessingJobName: str, WaiterConfig: WaiterConfigTypeDef = None) -> None:
        """
        [ProcessingJobCompletedOrStopped.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.16.28/reference/services/sagemaker.html#SageMaker.Waiter.ProcessingJobCompletedOrStopped.wait)
        """
...
class TrainingJobCompletedOrStoppedWaiter(Boto3Waiter):
    ...
    def wait(self, TrainingJobName: str, WaiterConfig: WaiterConfigTypeDef = None) -> None:
        """
        [TrainingJobCompletedOrStopped.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.16.28/reference/services/sagemaker.html#SageMaker.Waiter.TrainingJobCompletedOrStopped.wait)
        """
...
class TransformJobCompletedOrStoppedWaiter(Boto3Waiter):
    ...
    def wait(self, TransformJobName: str, WaiterConfig: WaiterConfigTypeDef = None) -> None:
        """
        [TransformJobCompletedOrStopped.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.16.28/reference/services/sagemaker.html#SageMaker.Waiter.TransformJobCompletedOrStopped.wait)
        """
