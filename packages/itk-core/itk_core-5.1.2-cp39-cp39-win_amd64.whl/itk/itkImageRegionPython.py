...
class itkImageRegion2(itk.ITKCommonBasePython.itkRegion):
    ...
    See:   MeshRegion  {Core/Common/CreateAnImageRegion,An object which
    holds the index (start) and size of a region of an image}
    {Core/Common/ImageRegionIntersection,Determine image region
    intersection} {Core/Common/IsPixelInsideRegion,Determine if a pixel is
    inside of a region} {Core/Common/RegionOverlap,Determine the overlap
    of two regions} 
    """
