...
def pt_model_direct_s_simple(t, k, t0, p, a, i, e, w, ldp, istar, ze, zm, ng, splimit, lcids, pbids, nsamples, exptimes, es, ms, tae, parallel):
    ...
    # ---------------------------------
        ...
        iplanet = interpolate_limb_darkening_v(z, zm, ldp)
...
@njit(parallel=False, fastmath=True)
def _direct_s_serial(t, k, t0, p, a, i, e, w, istar, zm, dg, ldp, ldw, splimit, lcids, pbids, nsamples, exptimes, es, ms, tae):
    npt = t.size
    flux = zeros(npt)
...
def _direct_s_parallel(t, k, t0, p, a, i, e, w, istar, zm, dg, ldp, ldw, splimit, lcids, pbids, nsamples, exptimes, es, ms, tae):
    npt = t.size
    flux = zeros(npt)
...
@njit
def pt_model_direct_s(t, k, t0, p, a, i, e, w, ldp, istar, ze, zm, ng, splimit, lcids, pbids, nsamples, exptimes, es, ms, tae, parallel):
    k = atleast_1d(k)
    gs, dg, weights = calculate_weights_2d(k[0], ze, ng)
    ldw = dot(weights, ldp)
    if parallel:
        return _direct_s_parallel(t, k, t0, p, a, i, e, w, istar, zm, dg, ldp, ldw, splimit, lcids, pbids, nsamples, exptimes, es, ms, tae)
    else:
        return _direct_s_serial(t, k, t0, p, a, i, e, w, istar, zm, dg, ldp, ldw, splimit, lcids, pbids, nsamples, exptimes, es, ms, tae)


@njit(fastmath=True)
def pt_model_interpolated_s(t, k, t0, p, a, i, e, w, ldp, istar, weights, zm, dk, k0, dg, splimit,
