...
class FoldersApi(object):
    ...
    def create_folder(self, create_folder, **kwargs):  # noqa: E501
        """[EXPERIMENTAL] Create a new folder in LUSID Drive  # noqa: E501
    ...
    def create_folder_with_http_info(self, create_folder, **kwargs):  # noqa: E501
        ...
        header_params['X-LUSID-SDK-Version'] = '0.1.147'
    ...
    def delete_folder(self, id, **kwargs):  # noqa: E501
        """[EXPERIMENTAL] Delete a specified folder and all subfolders  # noqa: E501
    ...
    def get_folder(self, id, **kwargs):  # noqa: E501
        """[EXPERIMENTAL] Get metadata of folder  # noqa: E501
    ...
    def get_folder_contents(self, id, **kwargs):  # noqa: E501
        """[EXPERIMENTAL] List contents of a folder  # noqa: E501
    ...
    def get_folder_contents_with_http_info(self, id, **kwargs):  # noqa: E501
        ...
        if 'filter' in local_var_params and not re.search(r'.*', local_var_params['filter']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `filter` when calling `get_folder_contents`, must conform to the pattern `/.*/`")  # noqa: E501
        collection_formats = {}
    ...
    def get_root_folder(self, **kwargs):  # noqa: E501
        """[EXPERIMENTAL] List contents of root folder  # noqa: E501
    ...
    def get_root_folder_with_http_info(self, **kwargs):  # noqa: E501
        ...
        if ('page' in local_var_params and
                len(local_var_params['page']) > 200):
            raise ApiValueError("Invalid value for parameter `page` when calling `get_root_folder`, length must be less than or equal to `200`")  # noqa: E501
        if ('page' in local_var_params and
                len(local_var_params['page']) < 1):
        ...
        if 'filter' in local_var_params and not re.search(r'.*', local_var_params['filter']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `filter` when calling `get_root_folder`, must conform to the pattern `/.*/`")  # noqa: E501
        collection_formats = {}
    ...
    def move_folder(self, id, request_body, **kwargs):  # noqa: E501
        """[EXPERIMENTAL] Move files to specified folder  # noqa: E501
    ...
    def update_folder(self, id, update_folder, **kwargs):  # noqa: E501
        """[EXPERIMENTAL] Update an existing folder's name, path  # noqa: E501
