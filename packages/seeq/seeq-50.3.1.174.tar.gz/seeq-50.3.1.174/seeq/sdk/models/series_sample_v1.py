...
class SeriesSampleV1(object):
    ...
    def key(self):
        ...
        The key of the sample. For a time series, an ISO 8601 date string(YYYY-MM-DDThh:mm:ss.sssssssss±hh:mm). For a numeric (non-time) series, a double-precision number.
