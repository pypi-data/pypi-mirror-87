...
#   ('-f', '')
#   ('-a', 'xsd:')
#   ('-o', 'tests/enable_slots_nodisablexml2_sup.py')
#   ('-s', 'tests/enable_slots_nodisablexml2_sub.py')
#   ('--super', 'enable_slots_nodisablexml2_sup')
#   ('--no-warnings', '')
#
# Command line arguments:
#   tests/enable_slots_nodisablexml.xsd
#
# Command line:
#   generateDS.py --no-dates --no-versions --enable-slots --disable-generatedssuper-lookup --member-specs="dict" -f -a "xsd:" -o "tests/enable_slots_nodisablexml2_sup.py" -s "tests/enable_slots_nodisablexml2_sub.py" --super="enable_slots_nodisablexml2_sup" --no-warnings tests/enable_slots_nodisablexml.xsd
#
...
class PackageType(GeneratedsSuper):
    ...
    member_data_items_ = {
        'Address': MemberSpec_('Address', 'xs:string', 1, 1, {'maxOccurs': 'unbounded', 'minOccurs': '0', 'name': 'Address', 'type': 'xs:string'}, None),
    }
    ...
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='PackageType', fromsubclass_=False, pretty_print=True):
        ...
        for Address_ in self.Address:
            ...
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sAddress>%s</%sAddress>%s' % (namespaceprefix_ , self.gds_encode(self.gds_format_string(quote_xml(Address_), input_name='Address')), namespaceprefix_ , eol_))
...
def parseLiteral(inFileName, silence=False, print_warnings=True):
    ...
    if not SaveElementTreeNode:
        ...
        rootNode = None
    if not silence:
        sys.stdout.write('#from enable_slots_nodisablexml2_sup import *\n\n')
        sys.stdout.write('import enable_slots_nodisablexml2_sup as model_\n\n')
