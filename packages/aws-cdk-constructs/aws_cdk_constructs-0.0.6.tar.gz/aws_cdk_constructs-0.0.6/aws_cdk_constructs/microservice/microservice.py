...
class Microservice(core.Construct):
    ...
    Args:
        ...
        ec2_ami_id (str): Specify the EC2 AMI id to use to create the EC2 instance. In no value is specified the laster Linux Hardened AMI will be used.
    ...
    def create_load_balancer(self, scope, id, app_name, environment, security_group, internet_facing=False, load_balancer_name=None):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self._tg = self.create_target_group(
            main_component_name, app_name, environment, ec2_traffic_port, ec2_health_check_path
        )
        ...
        self.alb_security_group = self.create_security_group(
            self, "alb_sg", app_name, environment, app_name + '_' + main_component_name + "_alb_sg"
        )
        ...
        self.alb = self.create_load_balancer(
            self, "alb", app_name, environment, self.alb_security_group, internet_facing=is_public, load_balancer_name='-'.join([app_name, main_component_name, 'alb'])
        )
