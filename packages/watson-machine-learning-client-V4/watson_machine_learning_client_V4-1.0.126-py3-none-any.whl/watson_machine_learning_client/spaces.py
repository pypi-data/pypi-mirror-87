...
from watson_machine_learning_client.utils import SPACES_IMPORTS_DETAILS_TYPE, SPACES_EXPORTS_DETAILS_TYPE, SPACES_DETAILS_TYPE, INSTANCE_DETAILS_TYPE, MEMBER_DETAILS_TYPE, STR_TYPE, STR_TYPE_NAME, docstring_parameter, meta_props_str_conv, str_type_conv, get_file_from_cos, print_text_header_h2
from watson_machine_learning_client.metanames import SpacesMetaNames, MemberMetaNames, ExportMetaNames
...
#####CREATE MEMBER
    ...
    def download(self, space_uid, space_exports_uid, filename=None):
        """
            ...
            :param exports_space_uid:  UID of virtual deployment
            :type exports_space_uid: {str_type}
