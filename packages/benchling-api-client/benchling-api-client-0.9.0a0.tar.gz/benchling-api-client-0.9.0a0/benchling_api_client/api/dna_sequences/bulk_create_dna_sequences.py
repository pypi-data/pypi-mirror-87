...
from ...models.dna_sequences_bulk_create import DnaSequencesBulkCreate
...
def _get_kwargs(
    *,
    client: Client,
    json_body: DnaSequencesBulkCreate,
) -> Dict[str, Any]:
    url = "{}/dna-sequences:bulk-create".format(client.base_url)
