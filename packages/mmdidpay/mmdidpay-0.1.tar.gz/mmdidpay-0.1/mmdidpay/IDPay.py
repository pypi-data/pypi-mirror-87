...
class IDPay:
    ...
    def new_transaction(self, order_id: str, amount: int, callback: str, name: str = None, phone: str = None,
                        mail: str = None, desc: str = None, reseller: int = None):
        return self.request("", order_id=order_id, amount=amount * 10, callback=callback, name=name, phone=phone,
                            mail=mail,
                            desc=desc, reseller=reseller)
