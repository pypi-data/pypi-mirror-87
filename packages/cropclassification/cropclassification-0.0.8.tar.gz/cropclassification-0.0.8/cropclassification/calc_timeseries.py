...
def calc_timeseries_task(
    ...
    """
    Runs a calculation of timeseries with the settings in the config_filepaths.
    ...
    config_used_filepath = log_dir / 'config_used.ini'
    ...
    input_features_filepath = input_preprocessed_dir / input_features_filename
    ...
    input_image_filepaths = [Path(input_image_filepath) for input_image_filepath in input_image_filepaths]
