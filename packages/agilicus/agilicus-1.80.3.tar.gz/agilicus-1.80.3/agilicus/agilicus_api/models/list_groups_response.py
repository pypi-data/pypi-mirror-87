...
class ListGroupsResponse(object):
    ...
    def __init__(self, groups=None, limit=None, previous_page_email=None, next_page_email=None, local_vars_configuration=None):  # noqa: E501
    ...
    def limit(self):
        ...
        Limit on the number of groups in the response  # noqa: E501
    ...
    def previous_page_email(self):
        """Gets the previous_page_email of this ListGroupsResponse.  # noqa: E501
        ...
        :return: The previous_page_email of this ListGroupsResponse.  # noqa: E501
        :rtype: str
        """
    ...
    def previous_page_email(self, previous_page_email):
        """Sets the previous_page_email of this ListGroupsResponse.

        The first email on the current page. Can be used with \"backwards\" as the search_direction_query parameter to retrieve the previous page's entries. Is an empty string if the current page is the first page.   # noqa: E501

        :param previous_page_email: The previous_page_email of this ListGroupsResponse.  # noqa: E501
        :type: str
        """
    ...
    def next_page_email(self):
        """Gets the next_page_email of this ListGroupsResponse.  # noqa: E501
        ...
        :return: The next_page_email of this ListGroupsResponse.  # noqa: E501
        :rtype: str
        """
    ...
    def next_page_email(self, next_page_email):
        """Sets the next_page_email of this ListGroupsResponse.

        The first email on the next page. Can be used with \"forwards\" as the search_direction_query parameter to retrieve the next page's entries. Is an empty string if the current page is the last page.   # noqa: E501

        :param next_page_email: The next_page_email of this ListGroupsResponse.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
