...
class itkVectorImageCF2(itk.itkImagePython.itkImageBase2):
    ...
    {Core/Common/CastVectorImageToAnotherType,Cast Vector Image To Another
    Type} {Core/Common/CreateVectorImage,Create Vector Image}
    {VectorImages/NeighborhoodIterator, Neighborhood Iterator On Vector
    Image} 
    """
