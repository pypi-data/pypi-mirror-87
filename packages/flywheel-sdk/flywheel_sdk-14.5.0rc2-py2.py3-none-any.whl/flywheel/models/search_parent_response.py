...
class SearchParentResponse(object):
    ...
    discriminator_value_class_map = {
        'collection': 'SearchParentCollection',
        'group': 'SearchParentGroup',
        'acquisition': 'SearchParentAcquisition',
        'analysis': 'SearchParentAnalysis',
        'project': 'SearchParentProject',
        'session': 'SearchParentSession'
    }

    def __init__(self, id=None, type=None):  # noqa: E501
        """SearchParentResponse - a model defined in Swagger"""
        super(SearchParentResponse, self).__init__()
    ...
    def id(self):
        ...
        :return: The id of this SearchParentResponse.
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this SearchParentResponse.

        Unique database ID

        :param id: The id of this SearchParentResponse.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SearchParentResponse):
            return False
