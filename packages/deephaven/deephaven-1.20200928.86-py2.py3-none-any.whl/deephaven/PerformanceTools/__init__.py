...
def _defineSymbols():
    ...
    if _java_type_MetricsManager is None:
        ...
        _java_type_MetricsManager = jpy.get_type("com.illumon.iris.db.v2.utils.metrics.MetricsManager")

    global _java_type_PerformanceQueries
    if _java_type_PerformanceQueries is None:
        # This will raise an exception if the desired object is not the classpath
        _java_type_PerformanceQueries = jpy.get_type("com.illumon.iris.db.util.PerformanceQueries")
    ...
    if _java_type_PerformanceQueriesPerformanceOverviewQueryBuilder is None:
        # This will raise an exception if the desired object is not the classpath
        _java_type_PerformanceQueriesPerformanceOverviewQueryBuilder = jpy.get_type("com.illumon.iris.db.util.PerformanceQueries$PerformanceOverview$QueryBuilder")
    ...
    if _java_type_PerformanceQueriesPersistentQueryStatusMonitor is None:
        # This will raise an exception if the desired object is not the classpath
        _java_type_PerformanceQueriesPersistentQueryStatusMonitor = jpy.get_type("com.illumon.iris.db.util.PerformanceQueries$PersistentQueryStatusMonitor")

    global _java_type_DBTimeUtils
    if _java_type_DBTimeUtils is None:
        # This will raise an exception if the desired object is not the classpath
        _java_type_DBTimeUtils = jpy.get_type("com.illumon.iris.db.tables.utils.DBTimeUtils")
