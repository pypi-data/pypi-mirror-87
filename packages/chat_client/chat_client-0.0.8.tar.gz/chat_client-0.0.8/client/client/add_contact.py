...
class AddContactDialog(QDialog):
    ...
    def __init__(self, transport, database):
        ...
        # Назначения действия на кнопку "Обновить список"
    ...
    def possible_contacts_update(self):
        ...
        # Удаление самого себя из списка пользователей и исключение возможности добавления
        users_list.remove(self.transport.username)

        # Вывод списка возможных контактов
