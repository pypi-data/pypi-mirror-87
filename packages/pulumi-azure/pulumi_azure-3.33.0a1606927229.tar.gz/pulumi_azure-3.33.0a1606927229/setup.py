...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure', '3.33.0-alpha.1606927229+3cb1a249'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure 3.33.0-alpha.1606927229+3cb1a249`
                """)
            else:
                raise
