...
def execute(
    ...
    """Find stripe coordinates from 3D genomic data
    """
...
def seeimag(
    ...
    """ Give heatmap image of given position and color saturation parameter (maxpixel).
    """
...
def scoring(
    ...
    """ Calculate p-value and stripiness of given stripes based on given 3D genome conformation data.
    """
