...
class ExportApi(object):
    ...
    def archive_export_with_http_info(self, **kwargs):
        ...
        header_params['Accept'] = self.api_client.\
            select_header_accept(['application/vnd.seeq.v1+json', 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet'])
        ...
        return self.api_client.call_api('/export/{id}', 'DELETE',
                                        ...
                                        response_type='ExportItemsOutputV1',
    ...
    def get_exports_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api('/export', 'GET',
                                        ...
                                        post_params=form_params,
                                        files=local_var_files,
                                        response_type='ExportPreviewListV1',
                                        auth_settings=auth_settings,
                                        callback=params.get('callback'),
                                        _return_http_data_only=params.get('_return_http_data_only'),
                                        _preload_content=params.get('_preload_content', True),
    ...
    def update_export(self, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.update_export(id=id_value, body=body_value, callback=callback_function)
    ...
    def update_export_with_http_info(self, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.update_export_with_http_info(id=id_value, body=body_value, callback=callback_function)
