...
#def calc_Cd(ceaObj, Pc=500, eps=20, Rthrt=1, pcentBell=80, MR=1.5,
#                 THETAI=30.0, RWTU=1.0, RWTD=1.0, CR=2.5, RI=1.0):
def calc_Cd( Pc=500, eps=20, Rthrt=1, pcentBell=80, 
                 THETAI=30.0, RWTU=1.0, RWTD=1.0, CR=2.5, RI=1.0,
    ...
    inpL = [log10(Pc)/4.0, log10(eps)/3.0, (2.0+log10(Rthrt))/4.0, 
            ...
            THETAI/40.0, RWTU/3.0, RWTD/3.0, CR/6.0, RI/3.0]
...
if __name__ == "__main__":
    ...
    ypred = calc_Cd(Pc=500, eps=20, Rthrt=1, pcentBell=80,
                    TcCham=5500.0, MolWt=20.0, gammaInit=1.2)
