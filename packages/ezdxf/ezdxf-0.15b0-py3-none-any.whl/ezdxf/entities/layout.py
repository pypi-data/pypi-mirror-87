...
class PlotSettings(DXFObject):
    ...
    def export_entity(self, tagwriter: 'TagWriter') -> None:
        ...
        self.dxf.export_dxf_attribs(tagwriter, [
            'page_setup_name', 'plot_configuration_file', 'paper_size',
            'plot_view_name', 'left_margin', 'bottom_margin', 'right_margin',
            'top_margin', 'paper_width', 'paper_height', 'plot_origin_x_offset',
            'plot_origin_y_offset', 'plot_window_x1', 'plot_window_y1',
            'plot_window_x2', 'plot_window_y2', 'scale_numerator',
            'scale_denominator', 'plot_layout_flags', 'plot_paper_units',
            'plot_rotation', 'plot_type', 'current_style_sheet',
            'standard_scale_type', 'shade_plot_mode',
            'shade_plot_resolution_level', 'shade_plot_custom_dpi',
            'unit_factor', 'paper_image_origin_x', 'paper_image_origin_y',
        ])
...
acdb_layout = DefSubclass('AcDbLayout', {
    ...
    'ucs_xaxis': DXFAttr(
        16, xtype=XType.point3d, default=X_AXIS,
        validator=validator.is_not_null_vector,
        fixer=RETURN_DEFAULT,
    ),
    'ucs_yaxis': DXFAttr(
        17, xtype=XType.point3d, default=Y_AXIS,
        validator=validator.is_not_null_vector,
        fixer=RETURN_DEFAULT,
    ),
...
class DXFLayout(PlotSettings):
    ...
    def export_entity(self, tagwriter: 'TagWriter') -> None:
        ...
        self.dxf.export_dxf_attribs(tagwriter, [
            'name', 'layout_flags', 'taborder', 'limmin', 'limmax',
            'insert_base', 'extmin', 'extmax', 'elevation', 'ucs_origin',
            'ucs_xaxis', 'ucs_yaxis', 'ucs_type', 'block_record_handle',
            'viewport_handle', 'ucs_handle', 'base_ucs_handle',
        ])
