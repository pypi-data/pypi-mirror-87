...
class V1RunSettings(object):
    ...
    def __init__(self, namespace=None, agent=None, queue=None, artifacts_store=None, connections=None, hub=None, registry=None, local_vars_configuration=None):  # noqa: E501
