...
class itkMedianImageFilterID2ID2(itk.itkBoxImageFilterPython.itkBoxImageFilterID2ID2):
    ...
    example{Filtering/Smoothing/ApplyMedianFilter,Median Filter Of An
    Image}  example{Filtering/Smoothing/MedianFilteringOfAnRGBImage,Median
    Filter Of An RGB Image} 
    """
