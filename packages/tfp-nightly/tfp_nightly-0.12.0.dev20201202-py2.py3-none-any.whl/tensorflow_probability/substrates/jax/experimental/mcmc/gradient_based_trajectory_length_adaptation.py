...
#   `tensorflow_probability/substrates/jax/experimental/mcmc/gradient_based_trajectory_length_adaptation.py`
...
from tensorflow_probability.substrates.jax.mcmc import simple_step_size_adaptation
