...
from ayx_plugin_sdk.core.exceptions import (
    AnchorNotFoundException,
    WorkflowRuntimeError,
)
from ayx_plugin_sdk.core.observable_mixin import ObservableMixin
from ayx_plugin_sdk.providers.e1_provider.anchor_builder import AnchorBuilder
from ayx_plugin_sdk.providers.e1_provider.connection_callback_strategy import (
...
from ayx_plugin_sdk.providers.e1_provider.e1_environment import E1Environment
from ayx_plugin_sdk.providers.e1_provider.e1_input_anchor_proxy import (
    E1InputAnchorProxy,
)
from ayx_plugin_sdk.providers.e1_provider.e1_io import E1IO
from ayx_plugin_sdk.providers.e1_provider.e1_output_anchor_proxy import (
    E1OutputAnchorProxy,
)
from ayx_plugin_sdk.providers.e1_provider.e1_plugin_driver import E1PluginDriver
from ayx_plugin_sdk.providers.e1_provider.e1_provider import E1Provider
from ayx_plugin_sdk.providers.e1_provider.events import ConnectionEvents, PluginEvents
from ayx_plugin_sdk.providers.e1_provider.tool_config_loader import ToolConfigLoader
from ayx_plugin_sdk.providers.e1_provider.workflow_config import WorkflowConfiguration
...
class E1PluginProxy(ObservableMixin):
    ...
    def pi_init(self, workflow_config_xml_string: str) -> None:
        ...
        self.anchor_builder = AnchorBuilder(
            ToolConfigLoader(self.tool_name).get_tool_config(), self._output_anchor_mgr
        )
