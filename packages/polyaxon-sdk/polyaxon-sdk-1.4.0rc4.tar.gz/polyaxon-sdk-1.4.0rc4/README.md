...
- API version: 1.4.0-rc4
- Package version: 1.4.0-rc4
...
*ModelRegistryV1Api* | [**list_model_registry**](docs/ModelRegistryV1Api.md#list_model_registry) | **GET** /api/v1/{owner}/registry/list | List registry models
...
*RunsV1Api* | [**get_run_artifacts_lineage**](docs/RunsV1Api.md#get_run_artifacts_lineage) | **GET** /api/v1/{owner}/{entity}/runs/{uuid}/artifacts_lineage | Get run artifacts lineage
*RunsV1Api* | [**get_run_artifacts_lineage_names**](docs/RunsV1Api.md#get_run_artifacts_lineage_names) | **GET** /api/v1/{owner}/{entity}/runs/{uuid}/artifacts_lineage/names | Get run artifacts lineage names
...
*RunsV1Api* | [**get_runs_artifacts_lineage**](docs/RunsV1Api.md#get_runs_artifacts_lineage) | **GET** /api/v1/{owner}/{name}/runs/artifacts_lineage | Get runs artifacts lineage
