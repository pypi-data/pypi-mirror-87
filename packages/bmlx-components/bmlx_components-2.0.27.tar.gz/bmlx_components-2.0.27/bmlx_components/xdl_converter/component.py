...
class XdlConverterSpec(ComponentSpec):
    ...
    PARAMETERS = {
        ...
        "output_dir": ExecutionParameter(
            type=(str, Text), optional=True, description="convert之后的模型输出路径"
        ),
