...
#   `tensorflow_probability/substrates/jax/distributions/multivariate_student_t.py`
...
from tensorflow_probability.substrates.jax.distributions import chi2 as chi2_lib
