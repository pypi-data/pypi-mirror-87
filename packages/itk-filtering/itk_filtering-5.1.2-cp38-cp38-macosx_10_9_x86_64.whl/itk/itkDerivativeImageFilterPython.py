...
class itkDerivativeImageFilterID2ID2(itk.itkImageToImageFilterAPython.itkImageToImageFilterID2ID2):
    ...
    example{Filtering/ImageFeature/DerivativeImage,Apply A Filter Only To
    A Specified Region Of An Image}
    example{Filtering/ImageFeature/RequesterRegion, Apply A Filter Only To
    A Specified Region Of An Image} 
    """
