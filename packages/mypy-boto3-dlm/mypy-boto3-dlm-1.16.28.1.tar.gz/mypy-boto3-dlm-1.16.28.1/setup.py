...
setup(
    ...
    description="Type annotations for boto3.DLM 1.16.28 service, generated by mypy-boto3-buider 4.1.3",
    classifiers=[
    ...
    keywords="boto3 dlm type-annotations boto3-stubs mypy typeshed autocomplete auto-generated",
