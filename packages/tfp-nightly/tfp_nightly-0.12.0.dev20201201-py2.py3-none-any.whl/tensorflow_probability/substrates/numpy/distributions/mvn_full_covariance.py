...
#   `tensorflow_probability/substrates/numpy/distributions/mvn_full_covariance.py`
...
from tensorflow_probability.substrates.numpy.distributions import mvn_tril
