...
all_keywords = {}
for keywords in (web_keywords, common_keywords, http_keywords, mobile_keywords, air_mobile_keywords, mqtt_keywords, windows_keywords, files_keywords):
...
# AI识别配置
HOST = 'https://planettest.cn'
URL_LDS_UI = HOST + '/ai/lds_ui' # 识别UI异常
URL_BAIDU_AIP = HOST + '/ai/baidu_aip' # 识别UI文本
