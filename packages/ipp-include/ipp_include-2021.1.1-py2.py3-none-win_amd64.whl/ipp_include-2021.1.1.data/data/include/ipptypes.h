...
/* defines for check dispatcher ABI functions */

#define ABI_BAD_BX  1
#define ABI_BAD_DI  2
#define ABI_BAD_SI  4
#define ABI_BAD_BP  8
#define ABI_BAD_12  0x10
#define ABI_BAD_13  0x20
#define ABI_BAD_14  0x40
#define ABI_BAD_15  0x80
...
typedef enum {
    ...
    IppLZO1X1ST      /* Single-threaded, generic LZO-compatible, */
                     /* corresponds to lzo1x_1_compress function */
} IppLZOMethod;

typedef struct LZOState_8u IppLZOState_8u;

typedef struct ZfpState_32f   IppEncodeZfpState_32f;
typedef struct ZfpState_32f   IppDecodeZfpState_32f;

#define IppZFPMINBITS   (0)
#define IppZFPMAXBITS   (4171)
#define IppZFPMAXPREC   (64)
#define IppZFPMINEXP    (-10740)

typedef enum {
    ippPatternMatchAuto = 0,
