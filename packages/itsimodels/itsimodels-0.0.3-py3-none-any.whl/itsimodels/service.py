...
class Kpi(ChildModel):
    ...
    base_search_id = ForeignKey('itsilib.models.kpi_base_search.KpiBaseSearch')

    base_search_metric = ForeignKey('itsilib.models.kpi_base_search.SearchMetric')
    ...
    kpi_template_kpi_id = ForeignKey('itsilib.models.kpi_threshold_template.KpiThresholdTemplate')
...
class ServiceDependency(ChildModel):
    kpis_depending_on = ForeignKeyList('itsilib.models.service.Kpi')
...
class Service(BaseModel):
    ...
    service_template_id = ForeignKey('itsilib.models.service_template.ServiceTemplate', alias='base_service_template_id')

    service_tags = TypeField(ServiceTags)

    team_id = ForeignKey('itsilib.models.team.Team', default=GLOBAL_TEAM_KEY, alias='sec_grp')
