...
PSEUDO TERMINAL COMMANDS:
	SUMMARY:
        <Input Modifier>     <Namespace History>    <Profiler>         <Documentation>       
        MODIFIER ON          UNDO                   PROF               HELP                  
        MODIFIER OFF         UNDO ON                PROF ON            HHELP                 
        MODIFIER SET         UNDO OFF               PROF OFF                                 
        SMODIFIER SET        UNDO CLEAR             PROF DEEP          <Module Reloading>    
                             UNDO ALL                                  RELOAD ON             
        <Stack Traces>                              <Toggle Colors>    RELOAD OFF            
        MORE                 <Prompt Toolkit>       FANSI ON                                 
        MMORE                PT ON                  FANSI OFF          <Unimportant>         
        DMORE                PT OFF                                    IPYTHON               
        AMORE                                       <Others>           IPYTHON ON            
        GMORE                <Saving Settings>      RETURN             IPYTHON OFF           
        VIMORE               PT SAVE                SUSPEND            RETURN NOW            
                             PT RESET               SHELL              RYAN RPRC             
        <Command History>    SET STYLE              LEVEL              GC OFF                
        HISTORY                                     DITTO              GC ON                 
        AHISTORY             <Shell Commands>       EDIT                                     
        GHISTORY             !                      VARS                                     
        CHISTORY             !!                     RANT                                     
        DHISTORY                                    FORK                                     
                             <Inspection>           RPRC                                     
        ...
        NEXT                 ?????                  CAT                                      
        PREV                                        RUN                                      
        PREV ON              <Simple Timer>         CDP                                      
        PREV OFF             TICTOC                 CPWD                                     
        PREV CLEAR           TICTOC ON              NCAT                                     
        PREV ALL             TICTOC OFF             CCAT                                     
                                                    OPEN          
