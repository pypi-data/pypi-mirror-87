...
class ExportItemsOutputV1(object):
    ...
    def __init__(self, autoupdate_time_range=False, capsule_time=False, created_at=None, export_capsules=False, export_name=None, grid_enabled=False, grid_size=None, href=None, id=None, is_archived=False, items=None, name=None, original_timestamps_enabled=False, scoped_to=None, status_message=None, swap_in=None, swap_out=None, updated_at=None):
        """
