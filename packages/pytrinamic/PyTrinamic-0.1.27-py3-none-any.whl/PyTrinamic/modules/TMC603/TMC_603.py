...
class TMC_603(tmcl_module_interface):
    ...
    def __init__(self, connection, moduleID=1):
        ...
        self._motors.append(TMC_603_motor_interface(self, 0, PyTrinamic.MotorTypes.BLDC, _AP_MOTOR_0, _ENUM_MOTOR_0)) 

    def moduleName(self):
        return "TMCM-1640"
        
    def moduleDescription(self):
        return  "The TMC-603 is a three phase motor driver for highly compact and energy efficient drive solutions. Voltage supply: 9 - 50"
...
class TMC_603_motor_interface(tmcl_motor_interface):
