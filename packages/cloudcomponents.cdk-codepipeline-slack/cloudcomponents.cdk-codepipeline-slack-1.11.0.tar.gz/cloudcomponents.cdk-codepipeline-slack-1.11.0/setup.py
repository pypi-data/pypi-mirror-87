    ...
    """
{
    ...
    "package_data": {
        "cloudcomponents.cdk_codepipeline_slack._jsii": [
            "cdk-codepipeline-slack@1.11.0.jsii.tgz"
        ],
        "cloudcomponents.cdk_codepipeline_slack": [
            "py.typed"
        ]
    ...
    "python_requires": ">=3.6",
    "install_requires": [
        "aws-cdk.aws-apigateway>=1.76.0, <2.0.0",
        "aws-cdk.aws-codebuild>=1.76.0, <2.0.0",
        "aws-cdk.aws-codepipeline-actions>=1.76.0, <2.0.0",
        ...
        "aws-cdk.aws-sns-subscriptions>=1.76.0, <2.0.0",
