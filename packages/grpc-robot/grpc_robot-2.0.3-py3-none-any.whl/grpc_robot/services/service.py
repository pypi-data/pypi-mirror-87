...
- show_defaults: <bool> or <string>; Whether or not to return the default values. Default: _${FALSE}_ or _false_.\n
...
class Service(object):
    ...
    def _process_response(self, response, index=None, **kwargs):
        ...
        show_defaults = bool(str(kwargs.get('show_defaults', False)).lower() == 'true')

        _response = protobuf_to_dict(response, use_enum_labels=not return_enum_integer, including_default_value_fields=show_defaults)
