...
[boto3.ElasticBeanstalk 1.16.30](https://boto3.amazonaws.com/v1/documentation/api/1.16.30/reference/services/elasticbeanstalk.html#ElasticBeanstalk) service
compatible with
