...
class SnapshotModel(object):
    ...
    def __init__(self, id=None, name=None, description=None, created_date=None, source=None, tables=None, relationships=None, profile_id=None, data_project=None, local_vars_configuration=None):  # noqa: E501
