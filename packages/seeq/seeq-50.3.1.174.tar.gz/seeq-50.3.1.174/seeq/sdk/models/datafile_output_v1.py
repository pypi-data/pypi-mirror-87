...
class DatafileOutputV1(object):
    ...
    def href(self):
        """
        Gets the href of this DatafileOutputV1.
        The href that can be used to interact with the item

        :return: The href of this DatafileOutputV1.
        :rtype: str
        """
        return self._href
    ...
    def href(self, href):
        """
        Sets the href of this DatafileOutputV1.
        The href that can be used to interact with the item

        :param href: The href of this DatafileOutputV1.
        :type: str
        """
        if href is None:
    ...
    def key_column_index(self):
        ...
        Integer that identifies the column containing the sample timestamps for the signal(s) orthe column containing the capsule start key for the condition. Column 1 is the first column of the file.
