...
class V1ContainerSecurityContextWindowsOptions(object):
    ...
    def __init__(self, gmsa_credential_spec=None, gmsa_credential_spec_name=None, run_as_user_name=None, local_vars_configuration=None):  # noqa: E501
        """V1ContainerSecurityContextWindowsOptions - a model defined in OpenAPI"""  # noqa: E501
    ...
    def gmsa_credential_spec(self):
        """Gets the gmsa_credential_spec of this V1ContainerSecurityContextWindowsOptions.  # noqa: E501
        ...
        :return: The gmsa_credential_spec of this V1ContainerSecurityContextWindowsOptions.  # noqa: E501
        :rtype: str
        """
    ...
    def gmsa_credential_spec(self, gmsa_credential_spec):
        """Sets the gmsa_credential_spec of this V1ContainerSecurityContextWindowsOptions.

        GMSACredentialSpec is where the GMSA admission webhook (https://github.com/kubernetes-sigs/windows-gmsa) inlines the contents of the GMSA credential spec named by the GMSACredentialSpecName field. This field is alpha-level and is only honored by servers that enable the WindowsGMSA feature flag.  # noqa: E501

        :param gmsa_credential_spec: The gmsa_credential_spec of this V1ContainerSecurityContextWindowsOptions.  # noqa: E501
        :type: str
        """
    ...
    def gmsa_credential_spec_name(self):
        """Gets the gmsa_credential_spec_name of this V1ContainerSecurityContextWindowsOptions.  # noqa: E501
        ...
        :return: The gmsa_credential_spec_name of this V1ContainerSecurityContextWindowsOptions.  # noqa: E501
        :rtype: str
        """
    ...
    def gmsa_credential_spec_name(self, gmsa_credential_spec_name):
        """Sets the gmsa_credential_spec_name of this V1ContainerSecurityContextWindowsOptions.

        GMSACredentialSpecName is the name of the GMSA credential spec to use. This field is alpha-level and is only honored by servers that enable the WindowsGMSA feature flag.  # noqa: E501

        :param gmsa_credential_spec_name: The gmsa_credential_spec_name of this V1ContainerSecurityContextWindowsOptions.  # noqa: E501
        :type: str
        """
    ...
    def run_as_user_name(self):
        """Gets the run_as_user_name of this V1ContainerSecurityContextWindowsOptions.  # noqa: E501
        ...
        :return: The run_as_user_name of this V1ContainerSecurityContextWindowsOptions.  # noqa: E501
        :rtype: str
        """
    ...
    def run_as_user_name(self, run_as_user_name):
        """Sets the run_as_user_name of this V1ContainerSecurityContextWindowsOptions.

        The UserName in Windows to run the entrypoint of the container process. Defaults to the user specified in image metadata if unspecified. May also be set in PodSecurityContext. If set in both SecurityContext and PodSecurityContext, the value specified in SecurityContext takes precedence. This field is beta-level and may be disabled with the WindowsRunAsUserName feature flag.  # noqa: E501

        :param run_as_user_name: The run_as_user_name of this V1ContainerSecurityContextWindowsOptions.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, V1ContainerSecurityContextWindowsOptions):
            return False
