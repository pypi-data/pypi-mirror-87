...
workspace=work_dirs/pbt_classifer/test_autoaug_fastaa
rm -rf ${workspace}
mkdir -p ${workspace}

config="examples/PaddleClas/MobileNetV3_small_x1_0/search/pba_classifier_MobileNetV3_small_x1_0_38833_fastaa.yaml"
 CUDA_VISIBLE_DEVICES=5,6,7 python test/autoaug_search.py \
