...
snake_case_functions = ('label_voting_image_filter', 'voting_binary_hole_filling_image_filter', 'voting_binary_image_filter', 'binary_median_image_filter', 'voting_binary_iterative_hole_filling_image_filter', )
