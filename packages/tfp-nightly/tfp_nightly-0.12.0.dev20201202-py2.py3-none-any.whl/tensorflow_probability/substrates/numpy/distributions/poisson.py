...
#   `tensorflow_probability/substrates/numpy/distributions/poisson.py`
...
from tensorflow_probability.substrates.numpy.internal import batched_rejection_sampler as brs
