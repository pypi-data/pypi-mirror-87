...
class V1Component(object):
    ...
    def __init__(self, version=None, kind=None, name=None, description=None, tags=None, presets=None, queue=None, cache=None, termination=None, plugins=None, actions=None, hooks=None, inputs=None, outputs=None, run=None, template=None, is_approved=None, local_vars_configuration=None):  # noqa: E501
