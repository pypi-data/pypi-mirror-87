...
class TraCIResult(_object):
    ...
    def toPacket(self):
        return _libtraci.TraCIResult_toPacket(self)
...
def vehicle_rerouteParkingArea(vehicleID, parkingAreaID):
    return _libtraci.vehicle_rerouteParkingArea(vehicleID, parkingAreaID)
vehicle_rerouteParkingArea = _libtraci.vehicle_rerouteParkingArea

def vehicle_resume(vehicleID):
    return _libtraci.vehicle_resume(vehicleID)
...
def vehicle_deactivateGapControl(vehicleID):
    return _libtraci.vehicle_deactivateGapControl(vehicleID)
...
def vehicle_updateBestLanes(vehicleID):
    return _libtraci.vehicle_updateBestLanes(vehicleID)
...
def vehicle_setLine(vehicleID, line):
    return _libtraci.vehicle_setLine(vehicleID, line)
vehicle_setLine = _libtraci.vehicle_setLine

def vehicle_setVia(vehicleID, via):
    return _libtraci.vehicle_setVia(vehicleID, via)
...
def vehicle_dispatchTaxi(vehicleID, reservations):
    return _libtraci.vehicle_dispatchTaxi(vehicleID, reservations)
