...
def query(ents_dict=None, 
    ...
    ----------
        ...
        Potential later arguments:
            ...
            avg_lower_time_lvls : bool (default=False)
                Whether to average over the span of lower time level properties
                Note: False selects only the data that matches the current time_lvl
    ...
    for col in list(set(qid_cols[1:])): # qid columns can be named the same
