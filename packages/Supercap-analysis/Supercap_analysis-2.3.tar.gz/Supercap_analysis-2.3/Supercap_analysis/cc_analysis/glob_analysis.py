...
def Glob_analysis(path, t_set = False, V_set = False, delimiter = False, mass_ls = False, row_skip = False, ESR_method = True, setting = False,  cap_method = False, plot_set = False, plot_save = True):
    """
       ...
       t_set : :class:`int`, optional
        ...
        plot_save : :class:`bool`, optional
            Whether the capacitance vs. current density plot will be plotted and saved
            plot_save = False (the figure will not be saved)
    ...
    supc_ls = [Load_capacitor(i, t_set = t_set, V_set = V_set, delimiter = delimiter, mass_ls = mass_ls, row_skip = row_skip, ESR_method = ESR_method, setting = setting,  cap_method = cap_method, cap_norm = cap_norm) for i in Glob_set]
