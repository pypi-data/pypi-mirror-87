...
function GetOciSubcommands_lb() {
    $ociSubcommands = @{
        ...
        'lb load-balancer' = 'change-compartment create delete get list update update-load-balancer-shape'
...
function GetOciCommandsToLongParams_lb() {
    $ociCommandsToLongParams = @{
        ...
        'lb load-balancer create' = 'backend-sets certificates compartment-id defined-tags display-name freeform-tags from-json help hostnames ip-mode is-private listeners max-wait-seconds nsg-ids path-route-sets reserved-ips rule-sets shape-name ssl-cipher-suites subnet-ids wait-for-state wait-interval-seconds'
        ...
        'lb load-balancer update-load-balancer-shape' = 'from-json help load-balancer-id max-wait-seconds shape-name wait-for-state wait-interval-seconds'
...
function GetOciCommandsToShortParams_lb() {
    $ociCommandsToShortParams = @{
        ...
        'lb load-balancer update-load-balancer-shape' = '? h'
