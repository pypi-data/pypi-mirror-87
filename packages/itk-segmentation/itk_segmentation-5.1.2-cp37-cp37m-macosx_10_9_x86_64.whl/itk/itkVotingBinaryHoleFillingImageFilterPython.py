...
def voting_binary_hole_filling_image_filter_init_docstring():
    ...
    import itkTemplate
    import itkHelpers
    if isinstance(itk.VotingBinaryHoleFillingImageFilter, itkTemplate.itkTemplate):
        filter_object = itk.VotingBinaryHoleFillingImageFilter.values()[0]
    else:
        filter_object = itk.VotingBinaryHoleFillingImageFilter
