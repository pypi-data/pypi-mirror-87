...
class itkConfidenceConnectedImageFilterID2ISS2(itk.itkImageToImageFilterAPython.itkImageToImageFilterID2ISS2):
    ...
    example{Segmentation/RegionGrowing/SegmentPixelsWithSimilarStats,Se
    gmentPixelsWithSimilarStats} 
    """
...
def confidence_connected_image_filter_init_docstring():
    ...
    if isinstance(itk.ConfidenceConnectedImageFilter, itkTemplate.itkTemplate):
        filter_object = itk.ConfidenceConnectedImageFilter.values()[0]
    else:
        filter_object = itk.ConfidenceConnectedImageFilter
