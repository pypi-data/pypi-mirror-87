...
def getDefaultInstance():
    ...
    :return: (com.illumon.iris.db.tables.select.QueryScope) QueryScope
    """
...
def makeScriptSessionImpl(scriptSession):
    ...
    :param scriptSession: (com.illumon.iris.db.util.ScriptSession) - script session
    :return: (com.illumon.iris.db.tables.select.QueryScope) query scope
    """
...
def setDefaultInstance(queryScope):
    ...
    :param queryScope: (com.illumon.iris.db.tables.select.QueryScope) - QueryScope to set as the new default instance.
    """
