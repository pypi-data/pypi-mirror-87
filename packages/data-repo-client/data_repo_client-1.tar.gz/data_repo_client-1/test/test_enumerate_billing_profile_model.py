...
from openapi_client.models.enumerate_billing_profile_model import EnumerateBillingProfileModel  # noqa: E501
...
class TestEnumerateBillingProfileModel(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = openapi_client.models.enumerate_billing_profile_model.EnumerateBillingProfileModel()  # noqa: E501
        if include_optional :
            return EnumerateBillingProfileModel(
                total = 56, 
                items = [
                    openapi_client.models.billing_profile_model.BillingProfileModel(
                        id = 'a', 
