...
from .shared import logging_utilities, log_server
...
log_server.install_sockethandler('azureml.automl.core')
log_server.install_sockethandler('automl.client.core.common')
