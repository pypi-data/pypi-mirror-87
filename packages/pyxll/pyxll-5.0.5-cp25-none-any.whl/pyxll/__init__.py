...
class XLCell(object):
    ...
    def options(self, type=None, auto_resize=None, type_kwargs=None, formatter=None):
    ...
    def apply(self, cell, value=None, datatype=None, datatype_ndim=0, datatype_kwargs={}, transpose=False):
        ...
        if datatype_kwargs.get("index", False):
            ...
            if isinstance(df.index, pd.MultiIndex):
                index_cols = len(df.columns.levels)
...
def create_ctp(control, title=None, width=None, height=None, position=CTPDockPositionRight):
