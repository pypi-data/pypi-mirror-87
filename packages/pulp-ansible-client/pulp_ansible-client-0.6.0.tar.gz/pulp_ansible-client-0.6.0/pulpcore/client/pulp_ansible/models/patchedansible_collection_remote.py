...
class PatchedansibleCollectionRemote(object):
    ...
    def __init__(self, name=None, url=None, ca_cert=None, client_cert=None, client_key=None, tls_validation=None, proxy_url=None, username=None, password=None, download_concurrency=None, policy=None, requirements_file=None, auth_url=None, token=None, local_vars_configuration=None):  # noqa: E501
