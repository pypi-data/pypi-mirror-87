...
def vnl_inverse_fft_image_filter_init_docstring():
    ...
    if isinstance(itk.VnlInverseFFTImageFilter, itkTemplate.itkTemplate):
        vnl_inverse_fft_image_filter.__doc__ += itkHelpers.filter_args(filter_object)[0]
        vnl_inverse_fft_image_filter.__doc__ += "\n"
        vnl_inverse_fft_image_filter.__doc__ += itkHelpers.filter_args(filter_object)[1]
    else:
