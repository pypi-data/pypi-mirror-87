...
class itkImageRegistrationMethodID2ID2(itk.ITKCommonBasePython.itkProcessObject):
    ...
    {Registration/Common/GlobalRegistrationOfTwoImages,Global Registration
    Of Two Images}
    {Core/Transform/GlobalRegistrationTwoImagesAffine,Global Registration
    Two Images (Affine)}
    {Core/Transform/GlobalRegistrationTwoImagesBSpline,Global Registration
    Of Two Images (BSpline)} 
    """
