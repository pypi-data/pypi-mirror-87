...
class dummy(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, test_ref_attr=None, test_normal_attr=None, test_ref_element=None, test_normal_element=None, gds_collector_=None, **kwargs_):
        ...
        self.test_ref_attr_nsprefix_ = None
        self.test_normal_attr = _cast(int, test_normal_attr)
        self.test_normal_attr_nsprefix_ = None
        self.test_ref_element = test_ref_element
        self.test_ref_element_nsprefix_ = None
        self.test_normal_element = test_normal_element
        self.test_normal_element_nsprefix_ = None
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='dummy', pretty_print=True):
        ...
        if pretty_print:
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'dummy':
    ...
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='dummy', fromsubclass_=False, pretty_print=True):
        ...
        if self.test_ref_element is not None:
            namespaceprefix_ = self.test_ref_element_nsprefix_ + ':' if (UseCapturedNS_ and self.test_ref_element_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
        ...
        if self.test_normal_element is not None:
            namespaceprefix_ = self.test_normal_element_nsprefix_ + ':' if (UseCapturedNS_ and self.test_normal_element_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
