...
#   `tensorflow_probability/substrates/jax/bijectors/blockwise.py`
...
from tensorflow_probability.substrates.jax.bijectors import joint_map
from tensorflow_probability.substrates.jax.bijectors import split
