...
module = Extension('_gridpp',
        ...
        extra_compile_args=" -Wall -Wfatal-errors -Wno-reorder -Wno-sign-compare -Wl,-init,initialize_omp -fopenmp".split(),
        extra_link_args=" -Wall -Wfatal-errors -Wno-reorder -Wno-sign-compare -Wl,-init,initialize_omp -fopenmp".split(),
