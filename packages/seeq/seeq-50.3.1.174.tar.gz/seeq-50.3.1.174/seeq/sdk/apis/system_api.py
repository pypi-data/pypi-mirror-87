...
class SystemApi(object):
    ...
    def import_license(self, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.import_license(file=file_value, callback=callback_function)
    ...
    def import_license_with_http_info(self, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.import_license_with_http_info(file=file_value, callback=callback_function)
        ...
        if ('file' not in params) or (params['file'] is None):
            raise ValueError("Missing the required parameter `file` when calling `import_license`")
