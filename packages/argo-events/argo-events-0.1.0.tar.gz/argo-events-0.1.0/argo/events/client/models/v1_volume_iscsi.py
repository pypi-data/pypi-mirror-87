...
class V1VolumeIscsi(object):
    ...
    openapi_types = {
        ...
        'portals': 'list[str]',
        'read_only': 'bool',
        'secret_ref': 'V1VolumeCephfsSecretRef',
        'target_portal': 'str'
    }
    ...
    def __init__(self, chap_auth_discovery=None, chap_auth_session=None, fs_type=None, initiator_name=None, iqn=None, iscsi_interface=None, lun=None, portals=None, read_only=None, secret_ref=None, target_portal=None, local_vars_configuration=None):  # noqa: E501
        """V1VolumeIscsi - a model defined in OpenAPI"""  # noqa: E501
    ...
    def chap_auth_discovery(self):
        """Gets the chap_auth_discovery of this V1VolumeIscsi.  # noqa: E501

        whether support iSCSI Discovery CHAP authentication  # noqa: E501

        :return: The chap_auth_discovery of this V1VolumeIscsi.  # noqa: E501
        :rtype: bool
        """
    ...
    def chap_auth_discovery(self, chap_auth_discovery):
        """Sets the chap_auth_discovery of this V1VolumeIscsi.

        whether support iSCSI Discovery CHAP authentication  # noqa: E501

        :param chap_auth_discovery: The chap_auth_discovery of this V1VolumeIscsi.  # noqa: E501
        :type: bool
        """
    ...
    def chap_auth_session(self):
        """Gets the chap_auth_session of this V1VolumeIscsi.  # noqa: E501

        whether support iSCSI Session CHAP authentication  # noqa: E501

        :return: The chap_auth_session of this V1VolumeIscsi.  # noqa: E501
        :rtype: bool
        """
    ...
    def chap_auth_session(self, chap_auth_session):
        """Sets the chap_auth_session of this V1VolumeIscsi.

        whether support iSCSI Session CHAP authentication  # noqa: E501

        :param chap_auth_session: The chap_auth_session of this V1VolumeIscsi.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def fs_type(self):
        """Gets the fs_type of this V1VolumeIscsi.  # noqa: E501
        ...
        :return: The fs_type of this V1VolumeIscsi.  # noqa: E501
        :rtype: str
        """
    ...
    def fs_type(self, fs_type):
        """Sets the fs_type of this V1VolumeIscsi.

        Filesystem type of the volume that you want to mount. Tip: Ensure that the filesystem type is supported by the host operating system. Examples: \"ext4\", \"xfs\", \"ntfs\". Implicitly inferred to be \"ext4\" if unspecified. More info: https://kubernetes.io/docs/concepts/storage/volumes#iscsi  # noqa: E501

        :param fs_type: The fs_type of this V1VolumeIscsi.  # noqa: E501
        :type: str
        """
    ...
    def initiator_name(self):
        """Gets the initiator_name of this V1VolumeIscsi.  # noqa: E501
        ...
        :return: The initiator_name of this V1VolumeIscsi.  # noqa: E501
        :rtype: str
        """
    ...
    def initiator_name(self, initiator_name):
        """Sets the initiator_name of this V1VolumeIscsi.

        Custom iSCSI Initiator Name. If initiatorName is specified with iscsiInterface simultaneously, new iSCSI interface <target portal>:<volume name> will be created for the connection.  # noqa: E501

        :param initiator_name: The initiator_name of this V1VolumeIscsi.  # noqa: E501
        :type: str
        """
    ...
    @property
    def iqn(self):
        """Gets the iqn of this V1VolumeIscsi.  # noqa: E501

        Target iSCSI Qualified Name.  # noqa: E501

        :return: The iqn of this V1VolumeIscsi.  # noqa: E501
        :rtype: str
        """
        return self._iqn
    ...
    @iqn.setter
    def iqn(self, iqn):
        """Sets the iqn of this V1VolumeIscsi.

        Target iSCSI Qualified Name.  # noqa: E501

        :param iqn: The iqn of this V1VolumeIscsi.  # noqa: E501
        :type: str
        """
    ...
    def iscsi_interface(self):
        """Gets the iscsi_interface of this V1VolumeIscsi.  # noqa: E501

        iSCSI Interface Name that uses an iSCSI transport. Defaults to 'default' (tcp).  # noqa: E501

        :return: The iscsi_interface of this V1VolumeIscsi.  # noqa: E501
        :rtype: str
        """
    ...
    def iscsi_interface(self, iscsi_interface):
        """Sets the iscsi_interface of this V1VolumeIscsi.

        iSCSI Interface Name that uses an iSCSI transport. Defaults to 'default' (tcp).  # noqa: E501

        :param iscsi_interface: The iscsi_interface of this V1VolumeIscsi.  # noqa: E501
        :type: str
        """
    ...
    @property
    def lun(self):
        """Gets the lun of this V1VolumeIscsi.  # noqa: E501

        iSCSI Target Lun number.  # noqa: E501

        :return: The lun of this V1VolumeIscsi.  # noqa: E501
        :rtype: int
        """
        return self._lun
    ...
    @lun.setter
    def lun(self, lun):
        """Sets the lun of this V1VolumeIscsi.

        iSCSI Target Lun number.  # noqa: E501

        :param lun: The lun of this V1VolumeIscsi.  # noqa: E501
        :type: int
        """
    ...
    @property
    def portals(self):
        """Gets the portals of this V1VolumeIscsi.  # noqa: E501
        ...
        :return: The portals of this V1VolumeIscsi.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def portals(self, portals):
        """Sets the portals of this V1VolumeIscsi.

        iSCSI Target Portal List. The portal is either an IP or ip_addr:port if the port is other than default (typically TCP ports 860 and 3260).  # noqa: E501

        :param portals: The portals of this V1VolumeIscsi.  # noqa: E501
        :type: list[str]
        """
    ...
    @property
    def read_only(self):
        """Gets the read_only of this V1VolumeIscsi.  # noqa: E501

        ReadOnly here will force the ReadOnly setting in VolumeMounts. Defaults to false.  # noqa: E501

        :return: The read_only of this V1VolumeIscsi.  # noqa: E501
        :rtype: bool
        """
    ...
    def read_only(self, read_only):
        """Sets the read_only of this V1VolumeIscsi.

        ReadOnly here will force the ReadOnly setting in VolumeMounts. Defaults to false.  # noqa: E501

        :param read_only: The read_only of this V1VolumeIscsi.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def secret_ref(self):
        """Gets the secret_ref of this V1VolumeIscsi.  # noqa: E501


        :return: The secret_ref of this V1VolumeIscsi.  # noqa: E501
        :rtype: V1VolumeCephfsSecretRef
        """
        return self._secret_ref

    @secret_ref.setter
    def secret_ref(self, secret_ref):
        """Sets the secret_ref of this V1VolumeIscsi.


        :param secret_ref: The secret_ref of this V1VolumeIscsi.  # noqa: E501
        :type: V1VolumeCephfsSecretRef
        """
    ...
    def target_portal(self):
        """Gets the target_portal of this V1VolumeIscsi.  # noqa: E501
        ...
        :return: The target_portal of this V1VolumeIscsi.  # noqa: E501
        :rtype: str
        """
    ...
    def target_portal(self, target_portal):
        """Sets the target_portal of this V1VolumeIscsi.

        iSCSI Target Portal. The Portal is either an IP or ip_addr:port if the port is other than default (typically TCP ports 860 and 3260).  # noqa: E501

        :param target_portal: The target_portal of this V1VolumeIscsi.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, V1VolumeIscsi):
            return False
