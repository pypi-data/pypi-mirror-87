...
class itkPadImageFilterBaseICF2ICF2(itk.itkImageToImageFilterBPython.itkImageToImageFilterICF2ICF2):
    ...
    PadImageFilterBase changes the image boundary of an image by padding
    each dimension with subclass defined algorithms. The padded region
    must be specified by the subclasses.
