...
class MetricsApi(object):
    ...
    def create_threshold_metric(self, **kwargs):
        ...
        Threshold metrics can either measure a continuous process, in which case they must specify a duration and period so that a moving statistic can be generated, or a batch process, in which case a bounding condition must be specified.
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        to be invoked when receiving the response.
        >>> def callback_function(response):
    ...
    def create_threshold_metric_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api('/metrics/thresholds', 'POST',
                                        ...
                                        post_params=form_params,
                                        files=local_var_files,
                                        response_type='ThresholdMetricOutputV1',
                                        auth_settings=auth_settings,
                                        callback=params.get('callback'),
                                        _return_http_data_only=params.get('_return_http_data_only'),
                                        _preload_content=params.get('_preload_content', True),
    ...
    def get_metrics_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api('/metrics', 'GET',
                                        ...
                                        post_params=form_params,
                                        files=local_var_files,
                                        response_type='GetMetricsOutputV1',
                                        auth_settings=auth_settings,
                                        callback=params.get('callback'),
                                        _return_http_data_only=params.get('_return_http_data_only'),
                                        _preload_content=params.get('_preload_content', True),
    ...
    def put_threshold_metric(self, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.put_threshold_metric(id=id_value, body=body_value, callback=callback_function)
    ...
    def put_threshold_metric_with_http_info(self, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.put_threshold_metric_with_http_info(id=id_value, body=body_value, callback=callback_function)
