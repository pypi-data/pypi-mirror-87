...
#   `tensorflow_probability/substrates/jax/distributions/inverse_gamma.py`
...
from tensorflow_probability.substrates.jax.bijectors import reciprocal as reciprocal_bijector
