...
class ShareRelationshipsData(object):
    ...
    def __init__(self, type=None, id=None):  # noqa: E501
        """ShareRelationshipsData - a model defined in Swagger"""  # noqa: E501
        self._type = None
        self._id = None
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ShareRelationshipsData, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ShareRelationshipsData):
            return False
