...
def lazy_import():
    ...
    globals()['DataViewCalculatedValue'] = DataViewCalculatedValue


class DataViewCells(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'calculated_value': (DataViewCalculatedValue,),  # noqa: E501
        }
    ...
    @convert_js_args_to_python_args
    def __init__(self, calculated_value, *args, **kwargs):  # noqa: E501
        """DataViewCells - a model defined in OpenAPI
