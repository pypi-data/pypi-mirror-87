...
class PluginOutputV1(object):
    ...
    def __init__(self, category=None, description=None, effective_permissions=None, entry_point=None, host=None, href=None, icon=None, id=None, identifier=None, is_archived=False, is_redacted=False, name=None, options=None, status_message=None, type=None, version=None):
        """
    ...
    def href(self):
        """
        Gets the href of this PluginOutputV1.
        The href that can be used to interact with the item

        :return: The href of this PluginOutputV1.
        :rtype: str
        """
        return self._href
    ...
    def href(self, href):
        """
        Sets the href of this PluginOutputV1.
        The href that can be used to interact with the item

        :param href: The href of this PluginOutputV1.
        :type: str
        """
        if href is None:
