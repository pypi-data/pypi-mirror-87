...
def _automatic_mesh_detect_2D(geo2d, start='rnd', N_try=20, verbose=0):
    lookup_meshtype = {
        6.83:"cube",
        8.20:"hex1",
        6.31:"hex2",
...
def structure_contour(struct, projection='auto', color='b', 
    ...
    if input_mesh.lower() == 'cube':
        ...
        NN_sf = 6
    elif input_mesh.lower() in ['hex_onelayer2']:
        NN_bulk, mb = 6, 2
        NN_sf = 2
...
#         HEXAGONAL MESH
#==============================================================================
        if input_mesh.lower() in ['hex', 'hex1', 'hex2', 'hex_onelayer1', 'hex_onelayer2']:
...
def vectorfield_color_by_fieldindex(sim, field_index, which_field='E', **kwargs):
