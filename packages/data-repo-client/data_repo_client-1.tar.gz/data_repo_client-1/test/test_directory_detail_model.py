...
from openapi_client.models.directory_detail_model import DirectoryDetailModel  # noqa: E501
...
class TestDirectoryDetailModel(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = openapi_client.models.directory_detail_model.DirectoryDetailModel()  # noqa: E501
        if include_optional :
            return DirectoryDetailModel(
                enumerated = True, 
                contents = [
                    openapi_client.models.file_model.FileModel(
                        file_id = '0', 
                        collection_id = '0', 
                        path = '0', 
                        size = 56, 
                        checksums = [
                            openapi_client.models.drs_checksum.DRSChecksum(
                                checksum = '0', 
                                type = '0', )
                            ], 
                        created = '0', 
                        description = '0', 
                        file_type = 'file', 
                        file_detail = openapi_client.models.file_detail_model.FileDetailModel(
                            dataset_id = '0', 
                            mime_type = '0', 
                            access_url = '0', 
                            load_tag = '0', ), 
                        directory_detail = openapi_client.models.directory_detail_model.DirectoryDetailModel(
                            enumerated = True, ), )
                    ]
            )
        else :
