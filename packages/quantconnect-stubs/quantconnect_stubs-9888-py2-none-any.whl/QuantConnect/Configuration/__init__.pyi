...
QuantConnect_Configuration_Config_T = typing.TypeVar('QuantConnect_Configuration_Config_T')
...
class Config(System.Object):
    ...
    @staticmethod
    def GetValue(key: str, defaultValue: QuantConnect_Configuration_Config_T = ...) -> QuantConnect_Configuration_Config_T:
        """
    ...
    @staticmethod
    @typing.overload
    def TryGetValue(key: str, value: QuantConnect_Configuration_Config_T) -> bool:
        """
    ...
    @staticmethod
    @typing.overload
    def TryGetValue(key: str, defaultValue: QuantConnect_Configuration_Config_T, value: QuantConnect_Configuration_Config_T) -> bool:
        """
        Tries to find the specified key and parse it as a T, using
