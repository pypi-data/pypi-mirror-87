...
class Build(object):
    ...
    def __init__(self, status=None, build_id=None, commit_sha=None, started_at=None, finished_at=None, resource_type=None, version_info=None, local_vars_configuration=None):  # noqa: E501
