...
from symbol_openapi_client.models.account_page import AccountPage  # noqa: E501
from symbol_openapi_client.rest import ApiException

class TestAccountPage(unittest.TestCase):
    """AccountPage unit test stubs"""
    ...
    def make_instance(self, include_optional):
        ...
        # model = symbol_openapi_client.models.account_page.AccountPage()  # noqa: E501
        if include_optional :
            return AccountPage(
                data = [
                    symbol_openapi_client.models.account_info_dto.AccountInfoDTO(
                        id = '0', 
