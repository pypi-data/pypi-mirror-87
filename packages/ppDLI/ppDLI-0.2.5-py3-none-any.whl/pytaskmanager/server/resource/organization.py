...
class Organization(Resource):
    ...
    def get(self, id=None):
        ...
        return self.org_schema.dump(organization, many=not id), HTTPStatus.OK
...
class OrganizationCollaboration(Resource):
    ...
    def get(self, id):
        ...
        return self.col_schema.dump(organization.collaborations, many=True), HTTPStatus.OK
...
class OrganizationNode(Resource):
    ...
    def get(self, id):
        ...
        return self.nod_schema.dump(organization.nodes, many=True), HTTPStatus.OK
