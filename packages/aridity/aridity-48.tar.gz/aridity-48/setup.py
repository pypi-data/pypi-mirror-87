...
setuptools.setup(
        ...
        scripts = [],
        entry_points = {'console_scripts': ['aridity=aridity.__init__:main_aridity', 'arid-config=aridity.arid_config:main_arid_config', 'processtemplate=aridity.processtemplate:main_processtemplate']},
        **ext_modules())
