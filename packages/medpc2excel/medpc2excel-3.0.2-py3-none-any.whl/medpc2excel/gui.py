...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.override.setItemText(0, _translate("MainWindow", "Append"))        
        self.override.setItemText(1, _translate("MainWindow", "Replace"))
        self.override.setItemText(2, _translate("MainWindow", "Override"))
        ...
        self.info_label.setText(_translate("MainWindow", "Current version v3.0.2 \n"
...
class MyApp (QtWidgets.QMainWindow, Ui_MainWindow):
    ...
    def __run_medpc2excel(self):
        ...
        working_var_label = self.workingVar_label.toPlainText()
        ...
        for n, f in enumerate(datafile_list):
            ...
            _, func_out = medpc_read(f, working_var_label, override = replace_file, replace = replace_data, log = func_out) #pass TS_df_tree to an anonymous variable
