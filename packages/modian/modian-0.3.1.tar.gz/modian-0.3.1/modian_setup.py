...
def nusmv_install(prefix):
    ...
    url_pat = "https://loicpauleve.name/NuSMV-2.6.0-%s.tar.gz"
    binfile = {
        "linux64": "https://anaconda.org/colomoto/nusmv/2.6.0/download/linux-64/nusmv-2.6.0-0.tar.bz2",
        "linux32": url_pat % "linux32",
        "darwin": "https://anaconda.org/colomoto/nusmv/2.6.0/download/osx-64/nusmv-2.6.0-0.tar.bz2",
