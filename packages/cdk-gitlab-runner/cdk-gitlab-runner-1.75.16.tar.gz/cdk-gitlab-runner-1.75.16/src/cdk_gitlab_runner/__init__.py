...
class GitlabRunnerAutoscaling(
    ...
    def __init__(
        ...
        *,
        ...
        :param spot_price: (experimental) The maximum hourly price (in USD) to be paid for any Spot Instance launched to fulfill the request. Spot Instances are launched when the price you specify exceeds the current Spot market price. Default: - undefined
        :param tags: (experimental) tags for the runner. Default: - ['runner', 'gitlab', 'awscdk']
    ...
    def autoscaling_group(self) -> aws_cdk.aws_autoscaling.IAutoScalingGroup:
...
class GitlabRunnerAutoscalingProps:
    ...
    def spot_price(self) -> typing.Optional[builtins.str]:
        ...
        Example::
            ...
            # Example automatically generated without compilation. See https://github.com/aws/jsii/issues/826
            GitlabRunnerAutoscaling(stack, "runner", gitlab_token="GITLAB_TOKEN", spot_price=1.23)
        """
