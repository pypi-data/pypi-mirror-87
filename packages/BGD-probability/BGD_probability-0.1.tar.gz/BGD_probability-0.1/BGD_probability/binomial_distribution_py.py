...
Original file is located at
    https://colab.research.google.com/drive/1q-TtJhp3bPyAjTWpEChOJ2kfKkA-MYIu
"""
...
class Binomial(Distribution):
    ...
    def __init__(self, prob=.5, size=20):
        ...
        Distribution.__init__(self, self.calculation_mean(), self.calculation_stdev())
    ...
    def plot_bar(self):
        ...
        x = ['0','1']
        count_1 = self.n * self.p
        count_0 = (1-self.p) * self.n

       
        plt.bar(x, height= [count_0, count_1], align= 'center')  
    ...
    def plot_bar_pdf(self):
        ...
        plt.bar(x, y)
        plt.title('Porbability Distribution of Outcomes')
        plt.xlabel('Outcome')
