...
class InvitesApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.invites_create = Endpoint(
            ...
            callable=__invites_create
        )

        def __invites_delete(
            self,
            id,
            **kwargs
        ):
