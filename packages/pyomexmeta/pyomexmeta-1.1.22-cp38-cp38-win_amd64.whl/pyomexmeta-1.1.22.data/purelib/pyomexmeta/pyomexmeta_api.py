...
class PyOmexMetaAPI:
    ...
    rdf_new = utils.load_func("RDF_new", [ct.c_char_p, ct.c_char_p, ct.c_char_p, ct.c_char_p], ct.c_void_p)
    ...
    rdf_to_file = utils.load_func("RDF_toFile", [ct.c_int64, ct.c_char_p, ct.c_char_p], None)

    # void RDF_delete(RDF *rdf_ptr);
    rdf_delete = utils.load_func("RDF_delete", [ct.c_int64], None)
    ...
    rdf_set_archive_uri = utils.load_func("RDF_setArchiveUri", [ct.c_int64, ct.c_char_p], None)

    # void RDF_setModelUri(RDF *rdf_ptr, std::string model_uri);
    rdf_set_model_uri = utils.load_func("RDF_setModelUri", [ct.c_int64, ct.c_char_p], None)
    ...
    editor_add_namespace = utils.load_func("Editor_addNamespace", [ct.c_int64, ct.c_char_p, ct.c_char_p], ct.c_void_p)
    ...
    editor_remove_physical_entity = utils.load_func("Editor_removePhysicalEntity", [ct.c_int64], None)
    ...
    editor_add_personal_information = utils.load_func("Editor_addPersonalInformation", [ct.c_int64, ct.c_int64], None)
    ...
    singular_annotation_delete = utils.load_func("SingularAnnotation_delete", [ct.c_int64], None)
    ...
    physical_entity_free_all = utils.load_func("PhysicalEntity_freeAll", [ct.c_int64], None)
    ...
    physical_process_free_all = utils.load_func("PhysicalProcess_freeAll", [ct.c_int64], None)
    ...
    personal_information_set_metaid = utils.load_func("PersonalInformation_setMetaid", [ct.c_int64, ct.c_char_p], None)
