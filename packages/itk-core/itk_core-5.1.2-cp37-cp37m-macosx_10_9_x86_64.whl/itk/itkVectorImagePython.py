...
class itkVectorImageCF2(itk.itkImagePython.itkImageBase2):
    ...
    example{Core/Common/CastVectorImageToAnotherType,Cast Vector Image To
    Another Type}  example{Core/Common/CreateVectorImage,Create Vector
    Image}  example{VectorImages/NeighborhoodIterator, Neighborhood
    Iterator On Vector Image} 
    """
