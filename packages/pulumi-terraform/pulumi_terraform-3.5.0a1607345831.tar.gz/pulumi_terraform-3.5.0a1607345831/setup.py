...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'terraform', '3.5.0-alpha.1607345831+54d24e2c'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource terraform 3.5.0-alpha.1607345831+54d24e2c`
                """)
