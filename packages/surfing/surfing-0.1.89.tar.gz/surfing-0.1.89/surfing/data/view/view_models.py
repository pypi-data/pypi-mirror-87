...
class FundDailyCollection(Base):
    ...
    average_size = Column(DOUBLE(asdecimal=False))  # 平均规模 basic.FundRet.avg_size
    exchange_status = Column(CHAR(20))  # 交易状态 basic.FundStatusLatest
    theme = Column(CHAR(20))  # 基金主题 暂无
    ...
    mornstar_3y = Column(DOUBLE(asdecimal=False))  # 晨星三年评级
    mornstar_5y = Column(DOUBLE(asdecimal=False))  # 晨星五年评级
