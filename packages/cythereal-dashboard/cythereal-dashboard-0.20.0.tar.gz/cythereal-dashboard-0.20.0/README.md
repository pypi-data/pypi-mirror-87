...
*ReportsApi* | [**get_procedures_report**](docs/ReportsApi.md#get_procedures_report) | **GET** /procedures/{proc_hash}/report | Generate the report for the given procedures
*ReportsApi* | [**list_file_matches**](docs/ReportsApi.md#list_file_matches) | **GET** /reports/{file_hash}/matches/ | Retrieve the MAGIC matches for a binary.
