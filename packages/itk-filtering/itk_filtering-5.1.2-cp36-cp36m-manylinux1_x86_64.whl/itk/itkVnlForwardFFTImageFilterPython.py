...
def vnl_forward_fft_image_filter_init_docstring():
    ...
    if isinstance(itk.VnlForwardFFTImageFilter, itkTemplate.itkTemplate):
        vnl_forward_fft_image_filter.__doc__ += itkHelpers.filter_args(filter_object)[0]
        vnl_forward_fft_image_filter.__doc__ += "\n"
        vnl_forward_fft_image_filter.__doc__ += itkHelpers.filter_args(filter_object)[1]
    else:
