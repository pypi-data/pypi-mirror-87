...
def get_dimensions_codes_order(dataset_json):
    ...
    return dataset_json.get("dimensions_codes_order") or \
        sorted(dataset_json.get("dimensions_labels", {}).keys()) or \
        sorted(dataset_json.get("dimensions_values_labels", {}).keys())
