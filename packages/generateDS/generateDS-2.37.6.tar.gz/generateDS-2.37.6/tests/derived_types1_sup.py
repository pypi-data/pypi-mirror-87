...
class animalCollection(GeneratedsSuper):
    ...
    member_data_items_ = [
        MemberSpec_('animal', 'animal', 1, 0, {'maxOccurs': 'unbounded', 'name': 'animal', 'type': 'animal'}, None),
    ]
    subclass = None
    superclass = None
    def __init__(self, animal=None, gds_collector_=None, **kwargs_):
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='animalCollection', pretty_print=True):
        ...
        if pretty_print:
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'animalCollection':
...
class animal(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='animal', pretty_print=True):
        ...
        if pretty_print:
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'animal':
            name_ = self.original_tagname_
        if UseCapturedNS_ and self.ns_prefix_:
            namespaceprefix_ = self.ns_prefix_ + ':'
        showIndent(outfile, level, pretty_print)
...
class dog(animal):
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='dog', pretty_print=True):
        ...
        if pretty_print:
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'dog':
            name_ = self.original_tagname_
        if UseCapturedNS_ and self.ns_prefix_:
            namespaceprefix_ = self.ns_prefix_ + ':'
        showIndent(outfile, level, pretty_print)
