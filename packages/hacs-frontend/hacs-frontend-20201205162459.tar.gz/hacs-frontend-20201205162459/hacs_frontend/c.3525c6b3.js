...
`,is:"app-header",behaviors:[[$,{properties:{effects:{type:String},effectsConfig:{type:Object,value:function(){return{}}},disabled:{type:Boolean,reflectToAttribute:!0,value:!1},threshold:{type:Number,value:0},thresholdTriggered:{type:Boolean,notify:!0,readOnly:!0,reflectToAttribute:!0}},observers:["_effectsChanged(effects, effectsConfig, isAttached)"],_updateScrollState:function(t){},isOnScreen:function(){return!1},isContentBelow:function(){return!1},_effectsRunFn:null,_effects:null,get _clampedScrollTop(){return Math.max(0,this._scrollTop)},attached:function(){this._scrollStateChanged()},detached:function(){this._tearDownEffects()},createEffect:function(t,e){var i=L[t];if(!i)throw new ReferenceError(this._getUndefinedMsg(t));var o=this._boundEffect(i,e||{});return o.setUp(),o},_effectsChanged:function(t,e,i){this._tearDownEffects(),t&&i&&(t.split(" ").forEach((function(t){var i;""!==t&&((i=L[t])?this._effects.push(this._boundEffect(i,e[t])):console.warn(this._getUndefinedMsg(t)))}),this),this._setUpEffect())},_layoutIfDirty:function(){return this.offsetWidth},_boundEffect:function(t,e){e=e||{};var i=parseFloat(e.startsAt||0),o=parseFloat(e.endsAt||1),s=o-i,a=function(){},n=0===i&&1===o?t.run:function(e,o){t.run.call(this,Math.max(0,(e-i)/s),o)};return{setUp:t.setUp?t.setUp.bind(this,e):a,run:t.run?n.bind(this):a,tearDown:t.tearDown?t.tearDown.bind(this):a}},_setUpEffect:function(){this.isAttached&&this._effects&&(this._effectsRunFn=[],this._effects.forEach((function(t){!1!==t.setUp()&&this._effectsRunFn.push(t.run)}),this))},_tearDownEffects:function(){this._effects&&this._effects.forEach((function(t){t.tearDown()})),this._effectsRunFn=[],this._effects=[]},_runEffects:function(t,e){this._effectsRunFn&&this._effectsRunFn.forEach((function(i){i(t,e)}))},_scrollHandler:function(){this._scrollStateChanged()},_scrollStateChanged:function(){if(!this.disabled){var t=this._clampedScrollTop;this._updateScrollState(t),this.threshold>0&&this._setThresholdTriggered(t>=this.threshold)}},_getDOMRef:function(t){console.warn("_getDOMRef","`"+t+"` is undefined")},_getUndefinedMsg:function(t){return"Scroll effect `"+t+"` is undefined. Did you forget to import app-layout/app-scroll-effects/effects/"+t+".html ?"}}],C],properties:{condenses:{type:Boolean,value:!1},fixed:{type:Boolean,value:!1},reveals:{type:Boolean,value:!1},shadow:{type:Boolean,reflectToAttribute:!0,value:!1}},observers:["_configChanged(isAttached, condenses, fixed)"],_height:0,_dHeight:0,_stickyElTop:0,_stickyElRef:null,_top:0,_progress:0,_wasScrollingDown:!1,_initScrollTop:0,_initTimestamp:0,_lastTimestamp:0,_lastScrollTop:0,get _maxHeaderTop(){return this.fixed?this._dHeight:this._height+5},get _stickyEl(){if(this._stickyElRef)return this._stickyElRef;for(var e,i=t(this.$.slot).getDistributedNodes(),o=0;e=i[o];o++)if(e.nodeType===Node.ELEMENT_NODE){if(e.hasAttribute("sticky")){this._stickyElRef=e;break}this._stickyElRef||(this._stickyElRef=e)}return this._stickyElRef},_configChanged:function(){this.resetLayout(),this._notifyLayoutChanged()},_updateLayoutStates:function(){if(0!==this.offsetWidth||0!==this.offsetHeight){var t=this._clampedScrollTop,e=0===this._height||0===t,i=this.disabled;this._height=this.offsetHeight,this._stickyElRef=null,this.disabled=!0,e||this._updateScrollState(0,!0),this._mayMove()?this._dHeight=this._stickyEl?this._height-this._stickyEl.offsetHeight:0:this._dHeight=0,this._stickyElTop=this._stickyEl?this._stickyEl.offsetTop:0,this._setUpEffect(),e?this._updateScrollState(t,!0):(this._updateScrollState(this._lastScrollTop,!0),this._layoutIfDirty()),this.disabled=i}},_updateScrollState:function(t,e){if(0!==this._height){var i=0,o=0,s=this._top,a=(this._lastScrollTop,this._maxHeaderTop),n=t-this._lastScrollTop,r=Math.abs(n),l=t>this._lastScrollTop,c=performance.now();if(this._mayMove()&&(o=this._clamp(this.reveals?s+n:t,0,a)),t>=this._dHeight&&(o=this.condenses&&!this.fixed?Math.max(this._dHeight,o):o,this.style.transitionDuration="0ms"),this.reveals&&!this.disabled&&r<100&&((c-this._initTimestamp>300||this._wasScrollingDown!==l)&&(this._initScrollTop=t,this._initTimestamp=c),t>=a))if(Math.abs(this._initScrollTop-t)>30||r>10){l&&t>=a?o=a:!l&&t>=this._dHeight&&(o=this.condenses&&!this.fixed?this._dHeight:0);var d=n/(c-this._lastTimestamp);this.style.transitionDuration=this._clamp((o-s)/d,0,300)+"ms"}else o=this._top;i=0===this._dHeight?t>0?1:0:o/this._dHeight,e||(this._lastScrollTop=t,this._top=o,this._wasScrollingDown=l,this._lastTimestamp=c),(e||i!==this._progress||s!==o||0===t)&&(this._progress=i,this._runEffects(i,o),this._transformHeader(o))}},_mayMove:function(){return this.condenses||!this.fixed},willCondense:function(){return this._dHeight>0&&this.condenses},isOnScreen:function(){return 0!==this._height&&this._top<this._height},isContentBelow:function(){return 0===this._top?this._clampedScrollTop>0:this._clampedScrollTop-this._maxHeaderTop>=0},_transformHeader:function(t){this.translate3d(0,-t+"px",0),this._stickyEl&&this.translate3d(0,this.condenses&&t>=this._stickyElTop?Math.min(t,this._dHeight)-this._stickyElTop+"px":0,0,this._stickyEl)},_clamp:function(t,e,i){return Math.min(i,Math.max(e,t))},_ensureBgContainers:function(){this._bgContainer||(this._bgContainer=document.createElement("div"),this._bgContainer.id="background",this._bgRear=document.createElement("div"),this._bgRear.id="backgroundRearLayer",this._bgContainer.appendChild(this._bgRear),this._bgFront=document.createElement("div"),this._bgFront.id="backgroundFrontLayer",this._bgContainer.appendChild(this._bgFront),t(this.root).insertBefore(this._bgContainer,this.$.contentContainer))},_getDOMRef:function(e){switch(e){case"backgroundFrontLayer":return this._ensureBgContainers(),this._bgFront;case"backgroundRearLayer":return this._ensureBgContainers(),this._bgRear;case"background":return this._ensureBgContainers(),this._bgContainer;case"mainTitle":return t(this).querySelector("[main-title]");case"condensedTitle":return t(this).querySelector("[condensed-title]")}return null},getScrollState:function(){return{progress:this._progress,top:this._top}}});n([p("ha-config-section")],(function(t,e){return{F:class extends e{constructor(...e){super(...e),t(this)}},d:[{kind:"field",decorators:[l()],key:"isWide",value:()=>!1},{kind:"field",decorators:[l({type:Boolean})],key:"vertical",value:()=>!1},{kind:"method",key:"render",value:function(){return c`
    ...
    `}},{kind:"method",key:"_openDialog",value:function(t){t.dialog&&this.dispatchEvent(new CustomEvent("hacs-dialog",{detail:{type:t.dialog,repository:t.repository},bubbles:!0,composed:!0}))}},{kind:"get",static:!0,key:"styles",value:function(){return h`
      hacs-link {
    ...
    `}}]}}),r);const H=_((t,e)=>{var i,o,s;const a=[],n=[],r=[];return null==e||e.forEach(e=>{if("pending-restart"===e.status&&r.push(e),e.installed&&"plugin"===e.category&&!y(t,e)&&n.push(e),e.installed&&t.removed.map(t=>t.repository).includes(e.full_name)){const i=t.removed.find(t=>t.repository===e.full_name);a.push({name:t.localize("entry.messages.removed").replace("{repository}",i.repository),info:i.reason,severity:"error",dialog:"removed",repository:e})}}),t.configuration.frontend_expected!==t.configuration.frontend_running?a.push({name:t.localize("entry.messages.wrong_frontend_installed.title"),info:t.localize("entry.messages.wrong_frontend_installed.content").replace("{running}",t.configuration.frontend_running).replace("{expected}",t.configuration.frontend_expected),severity:"error"}):t.configuration.frontend_expected!==T&&void 0!==t.configuration.frontend_expected&&a.push({name:t.localize("entry.messages.wrong_frontend_loaded.title"),info:t.localize("entry.messages.wrong_frontend_loaded.content").replace("{running}",T).replace("{expected}",t.configuration.frontend_expected),severity:"error"}),(null===(i=t.status)||void 0===i?void 0:i.startup)&&["setup","waiting","startup"].includes(t.status.stage)&&a.push({name:t.localize(`entry.messages.${t.status.stage}.title`),info:t.localize(`entry.messages.${t.status.stage}.content`),severity:"information"}),(null===(o=t.status)||void 0===o?void 0:o.has_pending_tasks)&&a.push({name:t.localize("entry.messages.has_pending_tasks.title"),info:t.localize("entry.messages.has_pending_tasks.content"),severity:"warning"}),(null===(s=t.status)||void 0===s?void 0:s.disabled)&&a.push({name:t.localize("entry.messages.disabled.title"),info:t.localize("entry.messages.disabled.content"),severity:"error"}),n.length>0&&a.push({name:t.localize("entry.messages.resources.title"),info:t.localize("entry.messages.resources.content").replace("{number}",String(n.length)),severity:"error",path:"/hacs/frontend"}),r.length>0&&a.push({name:t.localize("entry.messages.restart.title"),info:t.localize("entry.messages.restart.content").replace("{number}",String(r.length)),severity:"error",path:"/config/server_control"}),a});let R=n([p("hacs-entry-panel")],(function(t,e){return{F:class extends e{constructor(...e){super(...e),t(this)}},d:[{kind:"field",decorators:[l({attribute:!1})],key:"hacs",value:void 0},{kind:"field",decorators:[l({attribute:!1})],key:"configuration",value:void 0},{kind:"field",decorators:[l({attribute:!1})],key:"repositories",value:void 0},{kind:"field",decorators:[l({attribute:!1})],key:"hass",value:void 0},{kind:"field",decorators:[l({attribute:!1})],key:"lovelace",value:void 0},{kind:"field",decorators:[l({attribute:!1})],key:"route",value:void 0},{kind:"field",decorators:[l({attribute:!1})],key:"status",value:void 0},{kind:"field",decorators:[l({attribute:!1})],key:"removed",value:void 0},{kind:"field",decorators:[l({type:Boolean})],key:"isWide",value:void 0},{kind:"field",decorators:[l({type:Boolean})],key:"narrow",value:void 0},{kind:"method",key:"render",value:function(){var t,e,i,o;const s=[],a=[],n=H(this.hacs,this.repositories);return null===(t=this.repositories)||void 0===t||t.forEach(t=>{t.pending_upgrade&&s.push(t)}),null==n||n.forEach(t=>{a.push({iconPath:v,name:t.name,info:t.info,path:t.path||"",class:t.severity,dialog:t.dialog,repository:t.repository})}),this.dispatchEvent(new CustomEvent("update-hacs",{detail:{messages:a,updates:s},bubbles:!0,composed:!0})),c`
      <app-header-layout has-scrolling-region>
        ...
        <ha-config-section .narrow=${this.narrow} .isWide=${this.isWide}>
          ...
          <div slot="introduction">
            ${this.isWide||0===this.hacs.updates.length&&0===(null===(e=this.hacs.messages)||void 0===e?void 0:e.length)?m("entry.intro"):""}
          </div>

          ${0!==(null===(i=this.hacs.messages)||void 0===i?void 0:i.length)?c`
                <hacs-section-navigation
                  .hass=${this.hass}
                  .header=${m("entry.information")}
                  .pages=${this.hacs.messages}
                  no-next
                ></hacs-section-navigation>
              `:""}
          ${0!==(null===(o=this.hacs.updates)||void 0===o?void 0:o.length)?c` <ha-card>
                <div class="header">${m("entry.pending_updates")}</div>
                ${(r=this.hacs.updates,null==r?void 0:r.sort((t,e)=>t.name.toLowerCase()>e.name.toLowerCase()?1:-1)).map(t=>c`
                      <paper-icon-item @click="${()=>this._openUpdateDialog(t)}">
                        ...
                        <paper-item-body two-line>
                          ${t.name}
                          <div secondary>
                            ${m("sections.pending_repository_upgrade").replace("{installed}",t.installed_version).replace("{available}",t.available_version)}
                          </div>
                        </paper-item-body>
                      </paper-icon-item>
                    `)}
          ...
          <ha-card>
            ${E(this.hass,"hassio")?c`
                  <paper-icon-item @click=${this._openSupervisorDialog}>
                    <ha-svg-icon .path=${b} slot="item-icon"></ha-svg-icon>
                    <paper-item-body two-line>
                      ${m("sections.addon.title")}
                      <div secondary>${m("sections.addon.description")}</div>
                    </paper-item-body>
                    <ha-svg-icon right .path=${k}></ha-svg-icon>
                  </paper-icon-item>
                `:""}
          </ha-card>
          ...
          <ha-card>
            <paper-icon-item @click=${this._openAboutDialog}>
              ...
              <paper-item-body two-line>
                ${m("sections.about.title")}
                <div secondary>${m("sections.about.description")}</div>
              </paper-item-body>
            </paper-icon-item>
          </ha-card>
        </ha-config-section>
      </app-header-layout>
    `;var r}},{kind:"method",key:"_openUpdateDialog",value:function(t){this.dispatchEvent(new CustomEvent("hacs-dialog",{detail:{type:"update",repository:t.id},bubbles:!0,composed:!0}))}},{kind:"method",key:"_openAboutDialog",value:async function(){this.dispatchEvent(new CustomEvent("hacs-dialog",{detail:{type:"about",configuration:this.configuration,repositories:this.repositories},bubbles:!0,composed:!0}))}},{kind:"method",key:"_openSupervisorDialog",value:async function(){this.dispatchEvent(new CustomEvent("hacs-dialog",{detail:{type:"navigate",path:"/hassio"},bubbles:!0,composed:!0}))}},{kind:"get",static:!0,key:"styles",value:function(){return[w,x,h`
        paper-icon-item {
          cursor: pointer;
        }
