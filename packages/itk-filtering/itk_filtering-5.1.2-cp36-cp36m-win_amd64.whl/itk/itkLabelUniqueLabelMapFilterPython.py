...
def label_unique_label_map_filter_init_docstring():
    ...
    if isinstance(itk.LabelUniqueLabelMapFilter, itkTemplate.itkTemplate):
        label_unique_label_map_filter.__doc__ += itkHelpers.filter_args(filter_object)[0]
        label_unique_label_map_filter.__doc__ += "\n"
        label_unique_label_map_filter.__doc__ += itkHelpers.filter_args(filter_object)[1]
    else:
...
def attribute_unique_label_map_filter_init_docstring():
    ...
    attribute_unique_label_map_filter.__doc__ += "\n Available Keyword Arguments:\n"
    if isinstance(itk.AttributeUniqueLabelMapFilter, itkTemplate.itkTemplate):
        attribute_unique_label_map_filter.__doc__ += itkHelpers.filter_args(filter_object)[0]
        attribute_unique_label_map_filter.__doc__ += "\n"
        attribute_unique_label_map_filter.__doc__ += itkHelpers.filter_args(filter_object)[1]
    else:
