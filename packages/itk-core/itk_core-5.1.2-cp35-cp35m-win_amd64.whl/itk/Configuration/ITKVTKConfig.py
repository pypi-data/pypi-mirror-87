...
templates = (
  ...
  ('VTKImageExport', 'itk::VTKImageExport', 'itkVTKImageExportID2', True, 'itk::Image< double,2 >'),
  ('VTKImageExport', 'itk::VTKImageExport', 'itkVTKImageExportID3', True, 'itk::Image< double,3 >'),
  ...
  ('VTKImageImport', 'itk::VTKImageImport', 'itkVTKImageImportID2', True, 'itk::Image< double,2 >'),
  ('VTKImageImport', 'itk::VTKImageImport', 'itkVTKImageImportID3', True, 'itk::Image< double,3 >'),
...
snake_case_functions = ('vtk_image_export', 'vtk_image_export_base', 'vtk_image_import', )
