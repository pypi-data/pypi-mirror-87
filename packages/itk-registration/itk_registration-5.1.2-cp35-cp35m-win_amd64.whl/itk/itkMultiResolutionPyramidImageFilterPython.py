...
class itkMultiResolutionPyramidImageFilterID2ID2(itk.itkImageToImageFilterAPython.itkImageToImageFilterID2ID2):
    ...
    All factors are halved for all subsequent levels. For example if the
    number of levels was set to 4, the default table is:
    ...
    For example, for 4 levels and starting factors of 8,8,4 the default
    table would be:
