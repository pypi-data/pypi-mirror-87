...
class AppExistsWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [AppExists.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.16.28/reference/services/opsworks.html#OpsWorks.Waiter.AppExists.wait)
        """
...
class DeploymentSuccessfulWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [DeploymentSuccessful.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.16.28/reference/services/opsworks.html#OpsWorks.Waiter.DeploymentSuccessful.wait)
        """
...
class InstanceOnlineWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [InstanceOnline.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.16.28/reference/services/opsworks.html#OpsWorks.Waiter.InstanceOnline.wait)
        """
...
class InstanceRegisteredWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [InstanceRegistered.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.16.28/reference/services/opsworks.html#OpsWorks.Waiter.InstanceRegistered.wait)
        """
...
class InstanceStoppedWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [InstanceStopped.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.16.28/reference/services/opsworks.html#OpsWorks.Waiter.InstanceStopped.wait)
        """
...
class InstanceTerminatedWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [InstanceTerminated.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.16.28/reference/services/opsworks.html#OpsWorks.Waiter.InstanceTerminated.wait)
        """
