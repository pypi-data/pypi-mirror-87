...
def get_drillstring_by_id(drillstring_id: str) -> Union[dict, None]:
    """
    Get the drillstring from API by providing mongodb _id
    :param drillstring_id: mongodb _id of the drillstring
    :return:
    """
    drillstring = None
    try:
        drillstring = API().get_by_id(
            path="/v1/data/corva/", collection='data.drillstring', id=drillstring_id
        ).data
    except NotFound:
        pass
