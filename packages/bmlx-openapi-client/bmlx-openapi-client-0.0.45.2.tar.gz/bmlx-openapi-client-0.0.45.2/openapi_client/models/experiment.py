...
class Experiment(object):
    ...
    def __init__(self, create_time=None, cron_workflow_name=None, dag=None, deployment_running=None, description=None, execute_detail=None, execute_type=None, id=None, name=None, namespace=None, owner=None, package_checksum=None, package_uri=None, parameters=None, pipeline_version_id=None, resource_group=None, run_summary=None, status=None, tags=None, local_vars_configuration=None):  # noqa: E501
    ...
    def execute_type(self):
        """Gets the execute_type of this Experiment.  # noqa: E501


        :return: The execute_type of this Experiment.  # noqa: E501
        :rtype: str
        """
    ...
    def execute_type(self, execute_type):
        """Sets the execute_type of this Experiment.


        :param execute_type: The execute_type of this Experiment.  # noqa: E501
        :type execute_type: str
        """
        allowed_values = ["One-Shot", "Iterative"]  # noqa: E501
        if self.local_vars_configuration.client_side_validation and execute_type not in allowed_values:  # noqa: E501
            raise ValueError(
                "Invalid value for `execute_type` ({0}), must be one of {1}"  # noqa: E501
                .format(execute_type, allowed_values)
            )
