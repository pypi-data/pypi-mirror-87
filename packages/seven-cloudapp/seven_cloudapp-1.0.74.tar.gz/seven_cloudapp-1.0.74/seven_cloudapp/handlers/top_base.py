...
@LastEditTime: 2020-12-03 14:23:51
...
class TopBaseHandler(SevenBaseHandler):
    ...
    def test_sku_info(self):
        sku_info = {
            'items_seller_list_get_response': {
                'items': {
                    'item': [{
                        'input_str': 'BOLERBEAR/宝乐熊;型号;XXX',
                        'newprepay': 'default',
                        'nick': 'zpooz555',
                        'num_iid': 614312397367,
                        'pic_url': 'https: //img.alicdn.com/bao/uploaded/i1/46899422/O1CN01uNxiX12JTKK19GRxh_!!46899422.jpg',
                        'property_alias': '',
                        'props_name': '20000: 978826991: 品牌: BOLERBEAR/宝乐熊;155472944: 3235304: 型号: XXX;6724495: 46874: 出售状态: 现货;134942334: 109101: 大小: 中;134942334: 3226348: 大小: 大;134942334: 3226347: 大小: 小',
                        'prop_imgs': {
                            'propimg': [{
                                'id': 614312397367,
                                'properties': '134942334: 109101',
                                'url': 'https://img.alicdn.com/bao/uploaded/i1/46899422/O1CN01uNxiX12JTKK19GRxh_!!46899422.jpg',
                                'position': 1,
                                'created': '2020-04-2216: 05: 07'
                            }, {
                                'id': 614312397367,
                                'properties': '134942334: 3226348',
                                'url': 'https://img.alicdn.com/bao/uploaded/i1/46899422/O1CN01uNxiX12JTKK19GRxh_!!46899422.jpg',
                                'position': 1,
                                'created': '2020-04-2216: 05: 07'
                            }, {
                                'id': 614312397367,
                                'properties': '134942334: 3226347',
                                'url': 'https://img.alicdn.com/bao/uploaded/i1/46899422/O1CN01uNxiX12JTKK19GRxh_!!46899422.jpg',
                                'position': 1,
                                'created': '2020-04-2216: 05: 07'
                            }]
                        ...
                        'skus': {
                            'sku': [{
                                'created': '2020-04-2216: 05: 07',
                                'modified': '2020-04-2812: 13: 57',
                                'outer_id': '4350223249541',
                                'price': '20.00',
                                'properties': '134942334: 109101',
                                'properties_name': '134942334: 109101: 大小: 中',
                                'quantity': 50,
                                'sku_id': 4350223249541
                            }, {
                                'created': '2020-04-2216: 05: 07',
                                'modified': '2020-04-2812: 13: 57',
                                'outer_id': '4350223249543',
                                'price': '30.00',
                                'properties': '134942334: 3226348',
                                'properties_name': '134942334: 3226348: 大小: 大',
                                'quantity': 50,
                                'sku_id': 4350223249543
                            }, {
                                'created': '2020-04-2216: 05: 07',
                                'modified': '2020-04-2812: 13: 57',
                                'outer_id': '4350223249542',
                                'price': '10.00',
                                'properties': '134942334: 3226347',
                                'properties_name': '134942334: 3226347: 大小: 小',
                                'quantity': 50,
                                'sku_id': 4350223249542
                            }]
                        },
                        'title': '奖品C蝙蝠侠'
                    }]
                },
                'request_id': '4gs3h2ys77wq'
            }
        }
        return sku_info
    ...
    def instantiate_app(self, user_nick, open_id, description, icon, name, template_id, template_version, isfirst, access_token, name_ending):
        ...
        try:
            ...
            req.icon = icon
            req.name = app_name
            req.alias = config.get_value("project_name")
    ...
    def get_goods_list_for_goodsids(self, num_iids, access_token):
        ...
        try:
            ...
            req.fields = "num_iid,title,nick,input_str,property_alias,sku,props_name,pic_url,prop_img"
            req.num_iids = num_iids
            resp = req.getResponse(access_token)
            return resp
        except Exception as ex:
