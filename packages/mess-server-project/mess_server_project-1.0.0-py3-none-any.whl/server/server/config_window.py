...
class ConfigWindow(QDialog):
    ...
    def save_server_config(self):
        """
        Метод-обработчик правильности настроек и сохранения их в ini файл.
        """
        ...
        try:
            ...
            message.warning(self, 'Ошибка', 'Порт может быть только целым числом')
        else:
            ...
            if 1023 < port < 65536:
                ...
                with open(f"{dir_path}/{'server.ini'}", 'w') as conf:
                    ...
                    message.information(self, 'OK', 'Настройки сохранены')
            else:
                message.warning(self, 'Error', 'Укажите порт в диапазоне от 1024 до 65536')
