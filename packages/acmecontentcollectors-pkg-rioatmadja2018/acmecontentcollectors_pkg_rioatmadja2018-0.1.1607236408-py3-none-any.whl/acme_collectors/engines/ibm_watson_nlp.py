...
class WatsonNLP(object):   
    ...
    def get_tone(self, sentence:str, version: str = "2017-09-21") -> Union[List,Dict]:
        ...
        """
        ibm_tone_analyzer_endpoint: str = os.getenv('IBM_TONE_ANALYZER_ENDPOINT')
        if not sentence:
            raise ValueError("Please provide a valid sentence.")
        try:
            tone_analyzer = ToneAnalyzerV3(version=version, authenticator=IAMAuthenticator(os.getenv('IBM_TOKEN_API')) ) 
