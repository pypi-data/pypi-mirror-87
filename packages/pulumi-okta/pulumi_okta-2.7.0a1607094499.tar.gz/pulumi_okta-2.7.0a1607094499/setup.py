...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'okta', '2.7.0-alpha.1607094499+1e4adc40'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource okta 2.7.0-alpha.1607094499+1e4adc40`
                """)
            else:
                raise
