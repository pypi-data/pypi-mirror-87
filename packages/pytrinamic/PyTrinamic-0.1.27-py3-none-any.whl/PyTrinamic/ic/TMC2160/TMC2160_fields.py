...
class TMC2160_fields(object):
	...
	# IOIN / OUTPUT
	STEP                               = ( 0x04, 0x00000001,  0 ) # IOIN / OUTPUT
	DIR                                = ( 0x04, 0x00000002,  1 ) # IOIN / OUTPUT
	DCEN_CFG4                          = ( 0x04, 0x00000004,  2 ) # IOIN / OUTPUT
	DCIN_CFG5                          = ( 0x04, 0x00000008,  3 ) # IOIN / OUTPUT
	DRV_ENN                            = ( 0x04, 0x00000010,  4 ) # IOIN / OUTPUT
	DCO_CFG6                           = ( 0x04, 0x00000020,  5 ) # IOIN / OUTPUT
	...
	# XDIRECT
	XDIRECT                            = ( 0x2D, 0xFFFFFFFF,  0 ) # XDIRECT
