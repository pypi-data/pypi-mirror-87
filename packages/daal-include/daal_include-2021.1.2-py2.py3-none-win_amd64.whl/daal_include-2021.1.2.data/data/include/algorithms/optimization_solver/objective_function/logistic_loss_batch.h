 ...
 *        the Logistic loss objective function in the batch processing mode     \DAAL_DEPRECATED
 *
 ...
 * \brief Computes the Logistic loss objective function in the batch processing mode.    \DAAL_DEPRECATED
...
public:
    ...
    typedef algorithms::optimization_solver::logistic_loss::interface1::Input InputType;
    typedef algorithms::optimization_solver::logistic_loss::interface1::Parameter ParameterType;
    typedef typename super::ResultType ResultType;

    /**
     *  Main constructor
     */
    DAAL_DEPRECATED Batch(size_t numberOfTerms) : sum_of_functions::interface1::Batch(numberOfTerms, &input, new ParameterType(numberOfTerms))
    {
        initialize();
    }
    ...
    */
    DAAL_DEPRECATED static services::SharedPtr<Batch<algorithmFPType, method> > create(size_t numberOfTerms);
