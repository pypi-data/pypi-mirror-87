...
class MountContext(object):
    ...
    def __init__(self, dataflow, files_column: str, mount_point: str,
        ...
        # based on 7 days of data ending 11/24/2020:
        # 99% < 8.108s
        # 99.9% < 35.635s
        # 99.99% < 37.646s
        # 99.999% < 96.309
        # We will go with the 99.999 percentile to be on the safer side.
        self._max_attempt = kwargs.get('max_attempt', 19)  # total wait time of 95 seconds. 95 = 19 * (19 + 1) / 4
