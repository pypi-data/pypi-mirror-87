...
from fibomat.linalg import VectorArrayLike, VectorLike, Vector, VectorArray


class Polygon(polyline.Polyline):
    """2-dim polygon (closed polyline)."""

    def __init__(self, points: VectorArrayLike, description: Optional[str] = None):
        """
    ...
    def regular_ngon(  # pylint: disable=too-many-arguments,invalid-name
        ...
        return cls(VectorArray(points) + center, description)
