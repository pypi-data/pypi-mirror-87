/*! For license information please see chunk.a6ef9c35b66490bb89ec.js.LICENSE.txt */
(self.webpackChunkhome_assistant_frontend=self.webpackChunkhome_assistant_frontend||[]).push([[4570],{21157:(e,t,a)=>{"use strict";a(43437);const i=a(50856).d`
...
`;i.setAttribute("style","display: none;"),document.head.appendChild(i.content)},24381:(e,t,a)=>{"use strict";a.d(t,{Q:()=>i});const i=(e,t)=>e?t.map((t=>t in e.attributes?"has-"+t:"")).filter((e=>""!==e)).join(" "):""},94653:(e,t,a)=>{"use strict";a(1851);const i=customElements.get("vaadin-date-picker"),n=document.createElement("template");n.setAttribute("style","display: none;"),n.innerHTML='\n  <dom-module id="ha-date-input-styles" theme-for="vaadin-text-field">\n    <template>\n      <style>\n      [part="input-field"] {\n        top: 2px;\n        height: 30px;\n      }\n      </style>\n    </template>\n  </dom-module>\n',document.head.appendChild(n.content);customElements.define("ha-date-input",class extends i{constructor(){super(),this.i18n.formatDate=this._formatISODate,this.i18n.parseDate=this._parseISODate}ready(){super.ready();const e=document.createElement("style");e.innerHTML="\n      :host {\n        width: 12ex;\n        margin-top: -6px;\n        --material-body-font-size: 16px;\n        --_material-text-field-input-line-background-color: var(--primary-text-color);\n        --_material-text-field-input-line-opacity: 1;\n        --material-primary-color: var(--primary-text-color);\n      }\n    ",this.shadowRoot.appendChild(e),this._inputElement.querySelector("[part='toggle-button']").style.display="none"}_formatISODate(e){return[("0000"+String(e.year)).slice(-4),("0"+String(e.month+1)).slice(-2),("0"+String(e.day)).slice(-2)].join("-")}_parseISODate(e){const t=e.split("-"),a=new Date;let i,n=a.getMonth(),l=a.getFullYear();if(3===t.length?(l=parseInt(t[0]),t[0].length<3&&l>=0&&(l+=l<50?2e3:1900),n=parseInt(t[1])-1,i=parseInt(t[2])):2===t.length?(n=parseInt(t[0])-1,i=parseInt(t[1])):1===t.length&&(i=parseInt(t[0])),void 0!==i)return{day:i,month:n,year:l}}})},1090:(e,t,a)=>{"use strict";a(8878),a(30879),a(53973),a(51095);var i=a(50856),n=a(28426);class l extends n.H3{static get template(){return i.d`
      <style>
        :host {
          display: block;
    ...
    `}constructor(){super(),this.is_ready=!1}static get properties(){return{hass:{type:Object},stateObj:{type:Object,observer:"stateObjChanged"},selectedDate:{type:String,observer:"dateTimeChanged"},selectedHour:{type:Number,observer:"dateTimeChanged"},selectedMinute:{type:Number,observer:"dateTimeChanged"}}}ready(){super.ready(),this.is_ready=!0}getDateString(e){if("unknown"===e.state)return"";let t,a;return t=e.attributes.month<10?"0":"",a=e.attributes.day<10?"0":"",e.attributes.year+"-"+t+e.attributes.month+"-"+a+e.attributes.day}dateTimeChanged(){if(!this.is_ready)return;let e,t=!1;const a={entity_id:this.stateObj.entity_id};if(this.stateObj.attributes.has_time){t=t||parseInt(this.selectedMinute)!==this.stateObj.attributes.minute,t=t||parseInt(this.selectedHour)!==this.stateObj.attributes.hour,e=this.selectedMinute<10?"0":"";const i=this.selectedHour+":"+e+this.selectedMinute;a.time=i}if(this.stateObj.attributes.has_date){if(0===this.selectedDate.length)return;const e=new Date(this.selectedDate),i=new Date(this.stateObj.attributes.year,this.stateObj.attributes.month-1,this.stateObj.attributes.day);t=t||i!==e,a.date=this.selectedDate}t&&this.hass.callService("input_datetime","set_datetime",a)}stateObjChanged(e){this.is_ready=!1,e.attributes.has_time&&(this.selectedHour=e.attributes.hour,this.selectedMinute=e.attributes.minute),e.attributes.has_date&&(this.selectedDate=this.getDateString(e)),this.is_ready=!0}doesHaveDate(e){return e.attributes.has_date}doesHaveTime(e){return e.attributes.has_time}computeClassNames(e){return"more-info-input_datetime "+(0,l.Q)(e,["has_time","has_date"])}}customElements.define("more-info-input_datetime",s)}}]);
//# sourceMappingURL=chunk.a6ef9c35b66490bb89ec.js.map