 ...
 * \brief Provides methods to run implementations of logistic regression model-based training.    \DAAL_DEPRECATED
 ...
 * \brief Trains model of the logistic regression algorithms in the batch processing mode     \DAAL_DEPRECATED
