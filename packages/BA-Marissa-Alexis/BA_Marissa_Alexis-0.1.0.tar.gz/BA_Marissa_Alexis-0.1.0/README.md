...
We are testing the project using an image of Ubuntu 20.0.4 in VMware, using this [build](https://techloudgeek.com/download/image/?link=https://dl531.linuxvmimages.com/VMware/U/20.04/Ubuntu_20.04.01_VM.zip).
...
Make sure your camera is working and accessible on the VM. Our application uses the camera, so it'll crash without a camera provider.
    ...
    # To integrate webcam, while in the Ubuntu session, 
      # click "Player" on the top left
      # Click removable devices
      # find your webcam and click "Disconnect (Connect to host)

    # Make sure you have pip3 installed
    
    # install the pip module and dependences
    pip3 install BA-Marissa-Alexis
...
# Source Code
https://github.com/marissa-garcia/BadApplesProject_final
