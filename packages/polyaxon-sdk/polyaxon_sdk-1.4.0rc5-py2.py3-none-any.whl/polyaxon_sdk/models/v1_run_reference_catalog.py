...
class V1RunReferenceCatalog(object):
    ...
    @property
    def name(self):
        """Gets the name of this V1RunReferenceCatalog.  # noqa: E501


        :return: The name of this V1RunReferenceCatalog.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this V1RunReferenceCatalog.


        :param name: The name of this V1RunReferenceCatalog.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, V1RunReferenceCatalog):
            return False
