...
class IValueTaskSource(typing.Generic[System_Threading_Tasks_Sources_IValueTaskSource_TResult], metaclass=abc.ABCMeta):
    ...
    @typing.overload
    def GetStatus(self, token: int) -> System.Threading.Tasks.Sources.ValueTaskSourceStatus:
        """
    ...
    @typing.overload
    def OnCompleted(self, continuation: typing.Callable[[], System.Object], state: System.Object, token: int, flags: System.Threading.Tasks.Sources.ValueTaskSourceOnCompletedFlags) -> None:
        """
