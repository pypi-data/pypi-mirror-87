...
class FunctionActiveWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [FunctionActive.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.16.28/reference/services/lambda.html#Lambda.Waiter.FunctionActive.wait)
        """
...
class FunctionExistsWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [FunctionExists.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.16.28/reference/services/lambda.html#Lambda.Waiter.FunctionExists.wait)
        """
...
class FunctionUpdatedWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [FunctionUpdated.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.16.28/reference/services/lambda.html#Lambda.Waiter.FunctionUpdated.wait)
        """
