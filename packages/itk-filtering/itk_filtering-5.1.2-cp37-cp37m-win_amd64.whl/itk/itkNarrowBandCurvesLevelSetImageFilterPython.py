...
class itkNarrowBandCurvesLevelSetImageFilterID2ID2D(itk.itkNarrowBandLevelSetImageFilterPython.itkNarrowBandLevelSetImageFilterID2ID2D):
    r"""
...
class itkNarrowBandCurvesLevelSetImageFilterID3ID3D(itk.itkNarrowBandLevelSetImageFilterPython.itkNarrowBandLevelSetImageFilterID3ID3D):
    r"""
...
def narrow_band_curves_level_set_image_filter_init_docstring():
    ...
    if isinstance(itk.NarrowBandCurvesLevelSetImageFilter, itkTemplate.itkTemplate):
        narrow_band_curves_level_set_image_filter.__doc__ += itkHelpers.filter_args(filter_object)[0]
        narrow_band_curves_level_set_image_filter.__doc__ += "\n"
        narrow_band_curves_level_set_image_filter.__doc__ += itkHelpers.filter_args(filter_object)[1]
    else:
