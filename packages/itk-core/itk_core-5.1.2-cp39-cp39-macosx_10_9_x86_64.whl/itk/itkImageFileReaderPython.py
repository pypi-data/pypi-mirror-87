...
class itkImageFileReaderICF2(itk.itkImageSourcePython.itkImageSourceICF2):
    ...
    See:   ImageIOBase     example{Core/Common/ReadWriteVectorImage,Read
    Write Vector Image} example{IO/ImageBase/ReadUnknownImageType, Read
    Unknown Image Type} example{IO/ImageBase/ReadAnImage,Read An Image} 
    """
