...
class itkLabelMapToLabelImageFilterLM2IUC2(itk.itkLabelMapFilterPython.itkLabelMapFilterLM2IUC2):
    ...
    example{Filtering/LabelMap/ConvertLabelMapToImage,Convert Label Map To
    Normal Image} 
    """
...
def label_map_to_label_image_filter_init_docstring():
    ...
    if isinstance(itk.LabelMapToLabelImageFilter, itkTemplate.itkTemplate):
        label_map_to_label_image_filter.__doc__ += itkHelpers.filter_args(filter_object)[0]
        label_map_to_label_image_filter.__doc__ += "\n"
        label_map_to_label_image_filter.__doc__ += itkHelpers.filter_args(filter_object)[1]
    else:
