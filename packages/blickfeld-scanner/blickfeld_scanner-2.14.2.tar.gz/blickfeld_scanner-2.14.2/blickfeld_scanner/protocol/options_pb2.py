...
unit = _descriptor.FieldDescriptor(
  name='unit', full_name='blickfeld.protocol.unit', index=12,
...
ui_unit = _descriptor.FieldDescriptor(
  name='ui_unit', full_name='blickfeld.protocol.ui_unit', index=13,
...
ui_scale = _descriptor.FieldDescriptor(
  name='ui_scale', full_name='blickfeld.protocol.ui_scale', index=14,
...
ui_decimal_places = _descriptor.FieldDescriptor(
  name='ui_decimal_places', full_name='blickfeld.protocol.ui_decimal_places', index=15,
...
e_desc = _descriptor.FieldDescriptor(
  name='e_desc', full_name='blickfeld.protocol.e_desc', index=16,
...
help = _descriptor.FieldDescriptor(
  name='help', full_name='blickfeld.protocol.help', index=17,
...
secure = _descriptor.FieldDescriptor(
  name='secure', full_name='blickfeld.protocol.secure', index=18,
...
generate = _descriptor.FieldDescriptor(
  name='generate', full_name='blickfeld.protocol.generate', index=19,
