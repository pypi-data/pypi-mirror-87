...
from ...models.warehouse_credentials_request import WarehouseCredentialsRequest
...
def _get_kwargs(
    *,
    client: Client,
    json_body: WarehouseCredentialsRequest,
) -> Dict[str, Any]:
...
def _parse_response(*, response: httpx.Response) -> Optional[Union[WarehouseCredentials, BadRequestError]]:
    if response.status_code == 200:
        return WarehouseCredentials.from_dict(cast(Dict[str, Any], response.json()))
