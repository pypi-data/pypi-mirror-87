...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'gitlab', '3.4.0-alpha.1607444942+e054a963'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource gitlab 3.4.0-alpha.1607444942+e054a963`
                """)
            else:
                raise
