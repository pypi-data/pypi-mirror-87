...
setup(
    name="haiqv_streaming_dag_editor",
    version=get_version(),
    ...
    zip_safe=False,
    author="EngUt _ (origin : Andrea Bonomi)",
    author_email="itb001@hanwhasystem.com",
    description="A code editor and file manager about dag for haiqv-streaming",
