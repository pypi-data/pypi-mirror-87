...
class V1Project(object):
    ...
    def __init__(self, uuid=None, owner=None, name=None, description=None, tags=None, created_at=None, updated_at=None, is_public=None, bookmarked=None, readme=None, settings=None, role=None, live_state=None, local_vars_configuration=None):  # noqa: E501
