...
def shape_relabel_label_map_filter_init_docstring():
    ...
    if isinstance(itk.ShapeRelabelLabelMapFilter, itkTemplate.itkTemplate):
        shape_relabel_label_map_filter.__doc__ += itkHelpers.filter_args(filter_object)[0]
        shape_relabel_label_map_filter.__doc__ += "\n"
        shape_relabel_label_map_filter.__doc__ += itkHelpers.filter_args(filter_object)[1]
    else:
