...
def voting_binary_image_filter_init_docstring():
    ...
    import itkTemplate
    import itkHelpers
    if isinstance(itk.VotingBinaryImageFilter, itkTemplate.itkTemplate):
        filter_object = itk.VotingBinaryImageFilter.values()[0]
    else:
        filter_object = itk.VotingBinaryImageFilter
