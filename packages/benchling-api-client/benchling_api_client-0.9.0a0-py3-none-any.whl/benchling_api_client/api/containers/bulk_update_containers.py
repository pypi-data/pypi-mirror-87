...
from ...models.container_bulk_update_request_body import ContainerBulkUpdateRequestBody
...
def _get_kwargs(
    *,
    client: Client,
    json_body: ContainerBulkUpdateRequestBody,
) -> Dict[str, Any]:
    url = "{}/containers:bulk-update".format(client.base_url)
