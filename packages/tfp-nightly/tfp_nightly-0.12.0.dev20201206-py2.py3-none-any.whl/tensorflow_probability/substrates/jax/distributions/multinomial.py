...
from tensorflow_probability.substrates.jax.distributions import categorical as categorical_lib
...
#   `tensorflow_probability/substrates/jax/distributions/multinomial.py`
