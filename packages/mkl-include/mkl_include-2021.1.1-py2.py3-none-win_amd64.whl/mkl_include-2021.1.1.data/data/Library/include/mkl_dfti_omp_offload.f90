...
MODULE MKL_DFTI_OMP_OFFLOAD
  ...
  INTERFACE DftiComputeForward
     ...
     FUNCTION dfti_compute_forward_s(desc,sSrcDst)
       ...
       TYPE(DFTI_DESCRIPTOR), POINTER :: desc
       REAL(DFTI_SPKP), INTENT(INOUT), DIMENSION(*) :: sSrcDst
       !$omp  declare variant( dfti_compute_forward_s:mkl_dfti_compute_forward_s_omp_offload ) match( construct={target variant dispatch}, device={arch(gen)} )
     ...
     FUNCTION dfti_compute_forward_c(desc,cSrcDst)
       ...
       TYPE(DFTI_DESCRIPTOR), POINTER :: desc
       COMPLEX(DFTI_SPKP), INTENT(INOUT), DIMENSION(*) :: cSrcDst
       !$omp  declare variant( dfti_compute_forward_c:mkl_dfti_compute_forward_c_omp_offload ) match( construct={target variant dispatch}, device={arch(gen)} )
     ...
     FUNCTION dfti_compute_forward_ss(desc,sSrcDstRe,sSrcDstIm)
       ...
       REAL(DFTI_SPKP), DIMENSION(*) :: sSrcDstRe
       REAL(DFTI_SPKP), DIMENSION(*) :: sSrcDstIm
       !$omp  declare variant( dfti_compute_forward_ss:mkl_dfti_compute_forward_ss_omp_offload ) match( construct={target variant dispatch}, device={arch(gen)} )
     ...
     FUNCTION dfti_compute_forward_sc(desc,sSrc,cDst)
       ...
       REAL(DFTI_SPKP), INTENT(IN), DIMENSION(*) :: sSrc
       COMPLEX(DFTI_SPKP), INTENT(OUT), DIMENSION(*) :: cDst
       !$omp  declare variant( dfti_compute_forward_sc:mkl_dfti_compute_forward_sc_omp_offload ) match( construct={target variant dispatch}, device={arch(gen)} )
     ...
     FUNCTION dfti_compute_forward_cc(desc,cSrc,cDst)
       ...
       COMPLEX(DFTI_SPKP), INTENT(IN), DIMENSION(*) :: cSrc
       COMPLEX(DFTI_SPKP), INTENT(OUT), DIMENSION(*) :: cDst
       !$omp  declare variant( dfti_compute_forward_cc:mkl_dfti_compute_forward_cc_omp_offload ) match( construct={target variant dispatch}, device={arch(gen)} )
     ...
     FUNCTION dfti_compute_forward_ssss(desc,sSrcRe,sSrcIm,sDstRe,sDstIm)
       ...
       REAL(DFTI_SPKP), INTENT(OUT), DIMENSION(*) :: sDstRe
       REAL(DFTI_SPKP), INTENT(OUT), DIMENSION(*) :: sDstIm
       !$omp  declare variant( dfti_compute_forward_ssss:mkl_dfti_compute_forward_ssss_omp_offload ) match( construct={target variant dispatch}, device={arch(gen)} )
     ...
     FUNCTION dfti_compute_forward_d(desc,dSrcDst)
       ...
       TYPE(DFTI_DESCRIPTOR), POINTER :: desc
       REAL(DFTI_DPKP), INTENT(INOUT), DIMENSION(*) :: dSrcDst
       !$omp  declare variant( dfti_compute_forward_d:mkl_dfti_compute_forward_d_omp_offload ) match( construct={target variant dispatch}, device={arch(gen)} )
     ...
     FUNCTION dfti_compute_forward_z(desc,zSrcDst)
       ...
       TYPE(DFTI_DESCRIPTOR), POINTER :: desc
       COMPLEX(DFTI_DPKP), INTENT(INOUT), DIMENSION(*) :: zSrcDst
       !$omp  declare variant( dfti_compute_forward_z:mkl_dfti_compute_forward_z_omp_offload ) match( construct={target variant dispatch}, device={arch(gen)} )
     ...
     FUNCTION dfti_compute_forward_dd(desc,dSrcDstRe,dSrcDstIm)
       ...
       REAL(DFTI_DPKP), DIMENSION(*) :: dSrcDstRe
       REAL(DFTI_DPKP), DIMENSION(*) :: dSrcDstIm
       !$omp  declare variant( dfti_compute_forward_dd:mkl_dfti_compute_forward_dd_omp_offload ) match( construct={target variant dispatch}, device={arch(gen)} )
     ...
     FUNCTION dfti_compute_forward_dz(desc,dSrc,zDst)
       ...
       REAL(DFTI_DPKP), INTENT(IN), DIMENSION(*) :: dSrc
       COMPLEX(DFTI_DPKP), INTENT(OUT), DIMENSION(*) :: zDst
       !$omp  declare variant( dfti_compute_forward_dz:mkl_dfti_compute_forward_dz_omp_offload ) match( construct={target variant dispatch}, device={arch(gen)} )
     ...
     FUNCTION dfti_compute_forward_zz(desc,zSrc,zDst)
       ...
       COMPLEX(DFTI_DPKP), INTENT(IN), DIMENSION(*) :: zSrc
       COMPLEX(DFTI_DPKP), INTENT(OUT), DIMENSION(*) :: zDst
       !$omp  declare variant( dfti_compute_forward_zz:mkl_dfti_compute_forward_zz_omp_offload ) match( construct={target variant dispatch}, device={arch(gen)} )
     ...
     FUNCTION dfti_compute_forward_dddd(desc,dSrcRe,dSrcIm,dDstRe,dDstIm)
       ...
       REAL(DFTI_DPKP), INTENT(OUT), DIMENSION(*) :: dDstRe
       REAL(DFTI_DPKP), INTENT(OUT), DIMENSION(*) :: dDstIm
       !$omp  declare variant( dfti_compute_forward_dddd:mkl_dfti_compute_forward_dddd_omp_offload ) match( construct={target variant dispatch}, device={arch(gen)} )
  ...
  INTERFACE DftiComputeBackward
     ...
     FUNCTION dfti_compute_backward_s(desc,sSrcDst)
       ...
       TYPE(DFTI_DESCRIPTOR), POINTER :: desc
       REAL(DFTI_SPKP), INTENT(INOUT), DIMENSION(*) :: sSrcDst
       !$omp  declare variant( dfti_compute_backward_s:mkl_dfti_compute_backward_s_omp_offload ) match( construct={target variant dispatch}, device={arch(gen)} )
     ...
     FUNCTION dfti_compute_backward_c(desc,cSrcDst)
       ...
       TYPE(DFTI_DESCRIPTOR), POINTER :: desc
       COMPLEX(DFTI_SPKP), INTENT(INOUT), DIMENSION(*) :: cSrcDst
       !$omp  declare variant( dfti_compute_backward_c:mkl_dfti_compute_backward_c_omp_offload ) match( construct={target variant dispatch}, device={arch(gen)} )
     ...
     FUNCTION dfti_compute_backward_ss(desc,sSrcDstRe,sSrcDstIm)
       ...
       REAL(DFTI_SPKP), DIMENSION(*) :: sSrcDstRe
       REAL(DFTI_SPKP), DIMENSION(*) :: sSrcDstIm
       !$omp  declare variant( dfti_compute_backward_ss:mkl_dfti_compute_backward_ss_omp_offload ) match( construct={target variant dispatch}, device={arch(gen)} )
     ...
     FUNCTION dfti_compute_backward_cs(desc,cSrc,sDst)
       ...
       COMPLEX(DFTI_SPKP), INTENT(IN), DIMENSION(*) :: cSrc
       REAL(DFTI_SPKP), INTENT(OUT), DIMENSION(*) :: sDst
       !$omp  declare variant( dfti_compute_backward_cs:mkl_dfti_compute_backward_cs_omp_offload ) match( construct={target variant dispatch}, device={arch(gen)} )
     ...
     FUNCTION dfti_compute_backward_cc(desc,cSrc,cDst)
       ...
       COMPLEX(DFTI_SPKP), INTENT(IN), DIMENSION(*) :: cSrc
       COMPLEX(DFTI_SPKP), INTENT(OUT), DIMENSION(*) :: cDst
       !$omp  declare variant( dfti_compute_backward_cc:mkl_dfti_compute_backward_cc_omp_offload ) match( construct={target variant dispatch}, device={arch(gen)} )
     ...
     FUNCTION dfti_compute_backward_ssss(desc,sSrcRe,sSrcIm,sDstRe,sDstIm)
       ...
       REAL(DFTI_SPKP), INTENT(OUT), DIMENSION(*) :: sDstRe
       REAL(DFTI_SPKP), INTENT(OUT), DIMENSION(*) :: sDstIm
       !$omp  declare variant( dfti_compute_backward_ssss:mkl_dfti_compute_backward_ssss_omp_offload ) match( construct={target variant dispatch}, device={arch(gen)} )
     ...
     FUNCTION dfti_compute_backward_d(desc,dSrcDst)
       ...
       TYPE(DFTI_DESCRIPTOR), POINTER :: desc
       REAL(DFTI_DPKP), INTENT(INOUT), DIMENSION(*) :: dSrcDst
       !$omp  declare variant( dfti_compute_backward_d:mkl_dfti_compute_backward_d_omp_offload ) match( construct={target variant dispatch}, device={arch(gen)} )
     ...
     FUNCTION dfti_compute_backward_z(desc,zSrcDst)
       ...
       TYPE(DFTI_DESCRIPTOR), POINTER :: desc
       COMPLEX(DFTI_DPKP), INTENT(INOUT), DIMENSION(*) :: zSrcDst
       !$omp  declare variant( dfti_compute_backward_z:mkl_dfti_compute_backward_z_omp_offload ) match( construct={target variant dispatch}, device={arch(gen)} )
     ...
     FUNCTION dfti_compute_backward_dd(desc,dSrcDstRe,dSrcDstIm)
       ...
       REAL(DFTI_DPKP), DIMENSION(*) :: dSrcDstRe
       REAL(DFTI_DPKP), DIMENSION(*) :: dSrcDstIm
       !$omp  declare variant( dfti_compute_backward_dd:mkl_dfti_compute_backward_dd_omp_offload ) match( construct={target variant dispatch}, device={arch(gen)} )
     ...
     FUNCTION dfti_compute_backward_zd(desc,zSrc,dDst)
       ...
       COMPLEX(DFTI_DPKP), INTENT(IN), DIMENSION(*) :: zSrc
       REAL(DFTI_DPKP), INTENT(OUT), DIMENSION(*) :: dDst
       !$omp  declare variant( dfti_compute_backward_zd:mkl_dfti_compute_backward_zd_omp_offload ) match( construct={target variant dispatch}, device={arch(gen)} )
     ...
     FUNCTION dfti_compute_backward_zz(desc,zSrc,zDst)
       ...
       COMPLEX(DFTI_DPKP), INTENT(IN), DIMENSION(*) :: zSrc
       COMPLEX(DFTI_DPKP), INTENT(OUT), DIMENSION(*) :: zDst
       !$omp  declare variant( dfti_compute_backward_zz:mkl_dfti_compute_backward_zz_omp_offload ) match( construct={target variant dispatch}, device={arch(gen)} )
     ...
     FUNCTION dfti_compute_backward_dddd(desc,dSrcRe,dSrcIm,dDstRe,dDstIm)
       ...
       REAL(DFTI_DPKP), INTENT(OUT), DIMENSION(*) :: dDstRe
       REAL(DFTI_DPKP), INTENT(OUT), DIMENSION(*) :: dDstIm
       !$omp  declare variant( dfti_compute_backward_dddd:mkl_dfti_compute_backward_dddd_omp_offload ) match( construct={target variant dispatch}, device={arch(gen)} )
