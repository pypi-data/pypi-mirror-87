...
try:
  pass  # pylint: disable=g-direct-tensorflow-import
except ImportError:
  pass  # pylint: disable=g-direct-tensorflow-import

from tensorflow_probability.python.internal.backend.numpy import ops  # pylint: disable=g-direct-tensorflow-import
from tensorflow_probability.python.internal.backend.numpy import control_flow as control_flow_ops  # pylint: disable=g-direct-tensorflow-import
...
#   `tensorflow_probability/substrates/numpy/internal/prefer_static.py`
