...
#   `tensorflow_probability/substrates/jax/distributions/ordered_logistic.py`
...
from tensorflow_probability.substrates.jax.bijectors import ordered as ordered_bijector
