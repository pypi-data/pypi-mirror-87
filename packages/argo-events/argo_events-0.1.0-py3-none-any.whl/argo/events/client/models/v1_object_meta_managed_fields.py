...
class V1ObjectMetaManagedFields(object):
    ...
    def api_version(self):
        """Gets the api_version of this V1ObjectMetaManagedFields.  # noqa: E501
        ...
        :return: The api_version of this V1ObjectMetaManagedFields.  # noqa: E501
        :rtype: str
        """
    ...
    def api_version(self, api_version):
        """Sets the api_version of this V1ObjectMetaManagedFields.

        APIVersion defines the version of this resource that this field set applies to. The format is \"group/version\" just like the top-level APIVersion field. It is necessary to track the version of a field set because it cannot be automatically converted.  # noqa: E501

        :param api_version: The api_version of this V1ObjectMetaManagedFields.  # noqa: E501
        :type: str
        """
    ...
    def fields_type(self):
        """Gets the fields_type of this V1ObjectMetaManagedFields.  # noqa: E501
        ...
        :return: The fields_type of this V1ObjectMetaManagedFields.  # noqa: E501
        :rtype: str
        """
    ...
    def fields_type(self, fields_type):
        """Sets the fields_type of this V1ObjectMetaManagedFields.

        FieldsType is the discriminator for the different fields format and version. There is currently only one possible value: \"FieldsV1\"  # noqa: E501

        :param fields_type: The fields_type of this V1ObjectMetaManagedFields.  # noqa: E501
        :type: str
        """
    ...
    @property
    def fields_v1(self):
        """Gets the fields_v1 of this V1ObjectMetaManagedFields.  # noqa: E501
        ...
        :return: The fields_v1 of this V1ObjectMetaManagedFields.  # noqa: E501
        :rtype: object
        """
    ...
    def fields_v1(self, fields_v1):
        """Sets the fields_v1 of this V1ObjectMetaManagedFields.

        FieldsV1 stores a set of fields in a data structure like a Trie, in JSON format.  Each key is either a '.' representing the field itself, and will always map to an empty set, or a string representing a sub-field or item. The string will follow one of these four formats: 'f:<name>', where <name> is the name of a field in a struct, or key in a map 'v:<value>', where <value> is the exact json formatted value of a list item 'i:<index>', where <index> is position of a item in a list 'k:<keys>', where <keys> is a map of  a list item's key fields to their unique values If a key maps to an empty Fields value, the field that key represents is part of the set.  The exact format is defined in sigs.k8s.io/structured-merge-diff  # noqa: E501

        :param fields_v1: The fields_v1 of this V1ObjectMetaManagedFields.  # noqa: E501
        :type: object
        """
    ...
    @property
    def manager(self):
        """Gets the manager of this V1ObjectMetaManagedFields.  # noqa: E501

        Manager is an identifier of the workflow managing these fields.  # noqa: E501

        :return: The manager of this V1ObjectMetaManagedFields.  # noqa: E501
        :rtype: str
        """
    ...
    def manager(self, manager):
        """Sets the manager of this V1ObjectMetaManagedFields.

        Manager is an identifier of the workflow managing these fields.  # noqa: E501

        :param manager: The manager of this V1ObjectMetaManagedFields.  # noqa: E501
        :type: str
        """
    ...
    @property
    def operation(self):
        """Gets the operation of this V1ObjectMetaManagedFields.  # noqa: E501
        ...
        :return: The operation of this V1ObjectMetaManagedFields.  # noqa: E501
        :rtype: str
        """
    ...
    def operation(self, operation):
        """Sets the operation of this V1ObjectMetaManagedFields.

        Operation is the type of operation which lead to this ManagedFieldsEntry being created. The only valid values for this field are 'Apply' and 'Update'.  # noqa: E501

        :param operation: The operation of this V1ObjectMetaManagedFields.  # noqa: E501
        :type: str
        """
    ...
    @property
    def time(self):
        """Gets the time of this V1ObjectMetaManagedFields.  # noqa: E501
        ...
        :return: The time of this V1ObjectMetaManagedFields.  # noqa: E501
        :rtype: datetime
        """
        return self._time
    ...
    @time.setter
    def time(self, time):
        """Sets the time of this V1ObjectMetaManagedFields.

        Time is a wrapper around time.Time which supports correct marshaling to YAML and JSON.  Wrappers are provided for many of the factory methods that the time package offers.  # noqa: E501

        :param time: The time of this V1ObjectMetaManagedFields.  # noqa: E501
        :type: datetime
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, V1ObjectMetaManagedFields):
            return False
