...
class SqlDataOp(SqlDateOp):
    def name_true(self):
        pass


if __name__ == '__main__':
    _db = SqlDateOp(label='160', db='xw_test', single_entity=True)
    # _db_1 = SqlDateOp('160', 'xw_test', single_entity=True)
    # print(id(_db))
    # print(id(_db_1))
