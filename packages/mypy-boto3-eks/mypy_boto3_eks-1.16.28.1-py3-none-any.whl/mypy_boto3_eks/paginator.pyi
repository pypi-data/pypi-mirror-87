...
class DescribeAddonVersionsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [DescribeAddonVersions.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.16.28/reference/services/eks.html#EKS.Paginator.DescribeAddonVersions.paginate)
        """
...
class ListAddonsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListAddons.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.16.28/reference/services/eks.html#EKS.Paginator.ListAddons.paginate)
        """
...
class ListClustersPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListClusters.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.16.28/reference/services/eks.html#EKS.Paginator.ListClusters.paginate)
        """
...
class ListFargateProfilesPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListFargateProfiles.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.16.28/reference/services/eks.html#EKS.Paginator.ListFargateProfiles.paginate)
        """
...
class ListNodegroupsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListNodegroups.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.16.28/reference/services/eks.html#EKS.Paginator.ListNodegroups.paginate)
        """
...
class ListUpdatesPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListUpdates.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.16.28/reference/services/eks.html#EKS.Paginator.ListUpdates.paginate)
        """
