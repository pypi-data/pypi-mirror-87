...
def _defineSymbols():
    ...
    if _java_type_ is None:
        ...
        _java_type_ = jpy.get_type("com.illumon.iris.db.tables.utils.TableTools")
    ...
    if (len(args) in [2, 3]) and (isinstance(args[0], int) or isinstance(args[0], float)):
        ...
        if isinstance(args[1], dict):
            ...
            if _isJavaArray(args[2]):
                ...
                sources = convertToJavaList(jpy.array('com.illumon.iris.db.v2.sources.ColumnSource', args[2]))
...
def base64Fingerprint(source):
    ...
    :param source: (com.illumon.iris.db.tables.Table) - The table to fingerprint
...
def byteCol(name, *data):
    ...
    :return: (com.illumon.iris.db.v2.utils.ColumnHolder) a Deephaven ColumnHolder object
...
def colSource(*args):
    ...
    :param data: variable argument for the data
    :return: (com.illumon.iris.db.v2.sources.ColumnSource<T>) a Deephaven ColumnSource of inferred type
...
def diff(*args):
    ...
    *Overload 1*  
      :param actualResult: (com.illumon.iris.db.tables.Table) - first Deephaven table object to compare
      :param expectedResult: (com.illumon.iris.db.tables.Table) - second Deephaven table object to compare
    ...
    *Overload 2*  
      ...
      :param expectedResult: (com.illumon.iris.db.tables.Table) - second Deephaven table object to compare
      :param maxDiffLines: (long) - stop comparing after this many differences are found
      :param itemsToSkip: (java.util.EnumSet<com.illumon.iris.db.tables.utils.TableDiff.DiffItems>) - EnumSet of checks not to perform, such as checking column order, or exact match of double values
      :return: (java.lang.String) String report of the detected differences
    """
...
def diffPair(actualResult, expectedResult, maxDiffLines, itemsToSkip):
    ...
    :param maxDiffLines: (long) - stop comparing after this many differences are found
    :param itemsToSkip: (java.util.EnumSet<com.illumon.iris.db.tables.utils.TableDiff.DiffItems>) - EnumSet of checks not to perform, such as checking column order, or exact match of double values
    :return: (com.fishlib.base.Pair<java.lang.String,java.lang.Long>) a pair of String report of the detected differences, and the first different row (0 if there are no different data values)
    """
...
def emptyTable(*args):
    ...
    *Overload 1*  
      ...
      :return: (com.illumon.iris.db.tables.Table) a Deephaven Table with no columns.
      
    *Overload 2*  
      :param size: (long) - the number of rows to allocate space for
      :param tableDefinition: (com.illumon.iris.db.tables.TableDefinition) - the TableDefinition (column names and properties) to use for the new table
      :return: (com.illumon.iris.db.tables.Table) a Deephaven Table with columns.
    """
...
def getKey(groupByColumnSources, row):
    ...
    :param groupByColumnSources: (com.illumon.iris.db.v2.sources.ColumnSource[]) - a set of ColumnSources from which to retrieve the data
...
def html(source):
    ...
    :param source: (com.illumon.iris.db.tables.Table) - a Deephaven table object
...
def merge(*args):
    ...
    Concatenates multiple Deephaven Tables into a single Table.
     ...
     For historical tables, the resultant table will have rows from the same table together, in the order they
    ...
    For ticking tables, the original result will be similarly ordered; however as tables grow the new rows
     for each table may be appended to the end of the result and intermixed. To ensure input order, you must
     annotate each table with a column indicating the source and then sort the result based on that column.
    
    *Overload 1*  
      :param theList: (java.util.List<com.illumon.iris.db.tables.Table>) - a List of Tables to be concatenated
      :return: (com.illumon.iris.db.tables.Table) a Deephaven table object
      
    *Overload 2*  
      :param tables: (java.util.Collection<com.illumon.iris.db.tables.Table>) - a Collection of Tables to be concatenated
      :return: (com.illumon.iris.db.tables.Table) a Deephaven table object
      
    *Overload 3*  
      :param tables: (com.illumon.iris.db.tables.Table...) - a list of Tables to be concatenated
      :return: (com.illumon.iris.db.tables.Table) a Deephaven table object
    """
...
def mergeSorted(keyColumn, *tables):
    ...
    *Overload 1*  
      ...
      :param tables: (com.illumon.iris.db.tables.Table...) - sorted Tables to be concatenated
      :return: (com.illumon.iris.db.tables.Table) a Deephaven table object
      
    *Overload 2*  
      :param keyColumn: (java.lang.String) - the column to use when sorting the concatenated results
      :param tables: (java.util.Collection<com.illumon.iris.db.tables.Table>) - a Collection of sorted Tables to be concatenated
      :return: (com.illumon.iris.db.tables.Table) a Deephaven table object
    """
...
def newTable(*args):
    ...
    *Overload 1*  
      ...
      :param columnSources: (java.util.List<com.illumon.iris.db.v2.sources.ColumnSource>) - a List of the ColumnSource(s)
      :return: (com.illumon.iris.db.v2.DynamicTable) a Deephaven DynamicTable
      
    *Overload 2*  
      :param size: (long) - the number of rows to allocate
      :param columns: (java.util.Map<java.lang.String,com.illumon.iris.db.v2.sources.ColumnSource>) - a Map of column names and ColumnSources
      :return: (com.illumon.iris.db.v2.DynamicTable) a Deephaven DynamicTable
      
    *Overload 3*  
      :param definition: (com.illumon.iris.db.tables.TableDefinition) - the TableDefinition (column names and properties) to use for the new table
      :return: (com.illumon.iris.db.v2.DynamicTable) an empty Deephaven DynamicTable object
      
    *Overload 4*  
      :param columnHolders: (com.illumon.iris.db.v2.utils.ColumnHolder...) - a list of ColumnHolders from which to create the table
      :return: (com.illumon.iris.db.v2.DynamicTable) a Deephaven DynamicTable
    """
...
def objColSource(*values):
    ...
    :param data: variable argument for the data
    :return: (com.illumon.iris.db.v2.sources.ColumnSource) a Deephaven ColumnSource of inferred type
    data structure:
        * a java object, or list of java objects
        * an int, bool, float, datetime, date, string or iterable of (one) such
    * :class:`numpy.ndarray` containing boolean, numerical, datetime64, object, or string data (type inferred)
...
def readBin(*args):
    ...
    *Overload 1*  
      :param namespace: (java.lang.String) - namespace to search for the Listener needed to import the data
      :param tableName: (java.lang.String) - table name to find for the Listener needed to import the data
      :param sourceDirectory: (java.io.File) - file system path of the log file
      :param sourceFileNameGlob: (java.lang.String) - file pattern to use to find log file(s) to import
      :return: (com.illumon.iris.db.tables.Table) a Deephaven table object
      
    *Overload 2*  
      :param namespace: (java.lang.String) - namespace to search for the Listener needed to import the data
      :param tableName: (java.lang.String) - table name to find for the Listener needed to import the data
      :param sourceFiles: (java.lang.String...) - list of names of files to import
      :return: (com.illumon.iris.db.tables.Table) a Deephaven table object
      
    *Overload 3*  
      :param namespace: (java.lang.String) - namespace to search for the Listener needed to import the data
      :param tableName: (java.lang.String) - table name to find for the Listener needed to import the data
      :param sourceFiles: (java.io.File...) - list of File objects to import
      :return: (com.illumon.iris.db.tables.Table) a Deephaven table object
      
    *Overload 4*  
      :param namespace: (java.lang.String) - namespace to search for the Listener needed to import the data
      :param tableName: (java.lang.String) - table name to find for the Listener needed to import the data
      :param tableType: (com.illumon.iris.db.v2.locations.TableType) - table type this table definition
      :param sourceFiles: (java.io.File...) - list of File objects to import
      :return: (com.illumon.iris.db.tables.Table) a Deephaven table object
    ...
    *Overload 5*  
      :param namespace: (java.lang.String) - namespace to search for the Listener needed to import the data
      :param tableName: (java.lang.String) - table name to find for the Listener needed to import the data
      :param tableDefinition: (com.illumon.iris.db.tables.TableDefinition) - use this table definition rather than looking one up
      :param sourceFiles: (java.io.File...) - list of File objects to import
      :return: (com.illumon.iris.db.tables.Table) a Deephaven table object
      
    *Overload 6*  
      :param key: (com.illumon.iris.db.v2.locations.TableKey) - Interface that specifies key fields for a table-keyed object.
      :param sourceFiles: (java.io.File...) - list of File objects to import
      :return: (com.illumon.iris.db.tables.Table) a Deephaven table object
    """
    
    return _java_type_.readBin(*args)
...
def readCsv(*args):
    ...
    *Overload 1*  
      ...
      :return: (com.illumon.iris.db.v2.DynamicTable) a Deephaven DynamicTable object
    ...
    *Overload 3*  
      :param filePath: (java.lang.String) - the fully-qualified path to a CSV file to be read
      :param format: (java.lang.String) - an Apache Commons CSV format name to be used to parse the CSV
      :return: (com.illumon.iris.db.tables.Table) a Deephaven Table object
      
    *Overload 4*  
      :param filePath: (java.lang.String) - the fully-qualified path to a CSV file to be read
      :param format: (java.lang.String) - an Apache Commons CSV format name to be used to parse the CSV
      :param progress: (com.illumon.util.progress.StatusCallback) - a StatusCallback object that can be used to log progress details or update a progress bar. If passed explicitly as null, a StatusCallback instance will be created to log progress to the current logger.
      :return: (com.illumon.iris.db.tables.Table) a Deephaven Table object
    ...
    *Overload 6*  
      :param file: (java.io.File) - a file object providing access to the CSV file to be read
      :param progress: (com.illumon.util.progress.StatusCallback) - a StatusCallback object that can be used to log progress details or update a progress bar.
...
def roundDecimalColumns(*args):
    ...
    *Overload 1*  
      :param table: com.illumon.iris.db.tables.Table
      :return: (com.illumon.iris.db.tables.Table) The new Table, with all double and float columns rounded to longs.
      
    *Overload 2*  
      :param table: com.illumon.iris.db.tables.Table
      :param columns: (java.lang.String...) - The names of the double and float columns to round.
      :return: (com.illumon.iris.db.tables.Table) The new Table, with the specified columns rounded to longs.
    """
...
def roundDecimalColumnsExcept(table, *columnsNotToRound):
    ...
    :return: (com.illumon.iris.db.tables.Table) The new Table, with columns modified as explained above
    """
...
def show(*args):
    ...
    *Overload 2*  
      :param source: (com.illumon.iris.db.tables.Table) - a Deephaven table object
      :param timeZone: (com.illumon.iris.db.tables.utils.DBTimeZone) - a DBTimeZone constant relative to which DBDateTime data should be adjusted
      :param columns: (java.lang.String...) - varargs of column names to display
...
def string(*args):
    ...
    *Overload 1*  
      :param t: (com.illumon.iris.db.tables.Table) - a Deephaven table object
...
def writeCsv(*args):
    ...
    *Overload 5*  
      :param source: (com.illumon.iris.db.tables.Table) - a Deephaven table object to be exported
    ...
    *Overload 13*  
      :param sources: (com.illumon.iris.db.tables.Table[]) - an array of Deephaven table objects to be exported
      :param destPath: (java.lang.String) - path to the CSV file to be written
      :param compressed: (boolean) - whether to compress (bz2) the file being written
      :param timeZone: (com.illumon.iris.db.tables.utils.DBTimeZone) - a DBTimeZone constant relative to which DBDateTime data should be adjusted
      :param separator: (java.lang.String) - a String (normally a single character) to be used as the field delimiter
      :param columns: (java.lang.String...) - a list of columns to include in the export
