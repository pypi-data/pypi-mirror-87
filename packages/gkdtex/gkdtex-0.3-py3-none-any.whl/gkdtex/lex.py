...
EOF = 11
BOF = 10
REGEX = '(\\s+)|([@a-zA-Z][@a-zA-Z]*)|([0-9]+)|(%.*$)|(.)'
REGEX_STR = __import__('re').compile(REGEX)
REGEX_BYTES = __import__('re').compile(REGEX.encode())
IGNORES = (12,)
UNIONALL_INFO = ((None, None), (9, None), (2, None), (1, None), (12, None), (7, {'^': 6, '{': 4, '#': 3, '}': 5, '\\': 0, '_': 8}))
UNIONALL_INFO_BYTES = ((None, None), (9, None), (2, None), (1, None), (12, None), (7, {b'^': 6, b'{': 4, b'#': 3, b'}': 5, b'\\': 0, b'_': 8}))
numbering = {'quote \\': 0, 'Int': 1, 'Id': 2, 'quote #': 3, 'quote {': 4, 'quote }': 5, 'quote ^': 6, 'Other': 7, 'quote _': 8, 'WS': 9, 'BOF': 10, 'EOF': 11, 'COMMENT': 12}
