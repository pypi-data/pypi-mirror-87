...
#   `tensorflow_probability/substrates/numpy/distributions/lkj.py`
...
from tensorflow_probability.substrates.numpy.bijectors import correlation_cholesky as correlation_cholesky_bijector
