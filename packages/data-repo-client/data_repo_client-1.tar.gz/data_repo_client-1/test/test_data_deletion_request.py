...
from openapi_client.models.data_deletion_request import DataDeletionRequest  # noqa: E501
...
class TestDataDeletionRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = openapi_client.models.data_deletion_request.DataDeletionRequest()  # noqa: E501
        if include_optional :
            return DataDeletionRequest(
                delete_type = 'soft', 
                spec_type = 'gcsFile', 
                tables = [
                    openapi_client.models.data_deletion_table_model.DataDeletionTableModel(
                        table_name = '0', 
                        gcs_file_spec = openapi_client.models.data_deletion_gcs_file_model.DataDeletionGcsFileModel(
                            file_type = 'csv', 
                            path = '0', ), )
                    ]
            )
