...
#   `tensorflow_probability/substrates/jax/bijectors/scale_matvec_lu.py`
...
from tensorflow_probability.substrates.jax.math.linalg import lu_reconstruct_assertions
