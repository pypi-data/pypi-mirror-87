...
# @Last Modified time: 2020-11-30 17:09:49
...
if __name__ == '__main__':
	...
	# print(td.get_container_ip("AppHellobikeRideApiService",env="pre"))
	...
	# print(td.get_server_port("AppHellobikeRideApiService",env="pre"))
