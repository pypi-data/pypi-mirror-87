...
class PolicyCondition(object):
    ...
    def __init__(self, condition_type=None, inverted=False, value=None, operator=None, field=None, created=None, updated=None, local_vars_configuration=None):  # noqa: E501
