 ...
 *
 * \snippet optimization_solver/objective_function/cross_entropy_loss_types.h interface1::Parameter source code
 */
 ...
 * \brief %Input objects for the Cross-entropy loss objective function    \DAAL_DEPRECATED
 */
