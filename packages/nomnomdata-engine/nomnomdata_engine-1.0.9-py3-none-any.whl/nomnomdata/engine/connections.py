...
from nomnomdata.engine.parameters import Boolean, Enum, Int, Password, String, Text
...
ElasticSearchConnection = Connection(
    ...
    alias="Elasticsearch Connection",
    description="Endpoint, optional user name and password or api token to connect to Elasticsearch cluster.",
    ...
    parameter_groups=[
        ParameterGroup(
            ...
            Parameter(
                ...
                name="password",
                display_name="Password",
                description="Optional password used with username.",
            ),
            Parameter(
                type=String(),
                name="api",
                display_name="API Key",
                description="Optional api key used instead of basic authentication.",
            ),
            name="elastic_params",
