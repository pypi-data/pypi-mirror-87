...
class IDispatcherInterface(metaclass=ABCMeta):
    ...
    alive_generator_dispatcher: List[List[
        Tuple[Union[Generator, AsyncGenerator], bool]
    ]]
    
    @abstractmethod
    def start_execution(self, event: BaseEvent, dispatchers: List[T_Dispatcher], use_inline_generator: bool = False):
        pass
    ...
    @abstractmethod
    def dispatcher_generator(self) -> Generator[None, None, Tuple[T_Dispatcher, T_Dispatcher_Callable, Any]]:
        pass
