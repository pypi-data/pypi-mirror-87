...
class V1VolumeNfs(object):
    ...
    def __init__(self, path=None, read_only=None, server=None, local_vars_configuration=None):  # noqa: E501
        """V1VolumeNfs - a model defined in OpenAPI"""  # noqa: E501
    ...
    @path.setter
    def path(self, path):
        """Sets the path of this V1VolumeNfs.

        Path that is exported by the NFS server. More info: https://kubernetes.io/docs/concepts/storage/volumes#nfs  # noqa: E501

        :param path: The path of this V1VolumeNfs.  # noqa: E501
        :type: str
        """
    ...
    @property
    def read_only(self):
        """Gets the read_only of this V1VolumeNfs.  # noqa: E501
        ...
        :return: The read_only of this V1VolumeNfs.  # noqa: E501
        :rtype: bool
        """
    ...
    def read_only(self, read_only):
        """Sets the read_only of this V1VolumeNfs.

        ReadOnly here will force the NFS export to be mounted with read-only permissions. Defaults to false. More info: https://kubernetes.io/docs/concepts/storage/volumes#nfs  # noqa: E501

        :param read_only: The read_only of this V1VolumeNfs.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def server(self):
        """Gets the server of this V1VolumeNfs.  # noqa: E501
        ...
        :return: The server of this V1VolumeNfs.  # noqa: E501
        :rtype: str
        """
        return self._server
    ...
    def server(self, server):
        """Sets the server of this V1VolumeNfs.

        Server is the hostname or IP address of the NFS server. More info: https://kubernetes.io/docs/concepts/storage/volumes#nfs  # noqa: E501

        :param server: The server of this V1VolumeNfs.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, V1VolumeNfs):
            return False
