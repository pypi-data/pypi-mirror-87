...
class Kproxy(object):
    ...
    def get_taiyang_num(self):
        ...
        :return:
        """
        url = "http://ty-http-d.upupfile.com/index/index/get_my_package_balance?neek=521821&appkey=f32f88b0163cb7e3acab8b3d69eb0c1b&ac=56912"
        BoolResult, errString, r = self.bsrequest.base_request(url,
                                                               timeout=30
                                                               )
        if BoolResult:
