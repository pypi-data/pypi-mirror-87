...
def get_publication_providers(user=None):
    ...
    Uses the ``"kadi_get_publication_providers"`` plugin hook combined with the
    information from :func:`kadi.lib.oauth.utils.get_oauth2_providers`.
    ...
    for provider in run_hook("kadi_get_publication_providers"):
