...
class AzureMLError:
    ...
    def _escape_message_parameters(message_format: str) -> str:
        ...
        """
        # regex for matching params inside '{XYZ}'
        message_params_regex = re.compile(r"({.*?})")
        ...
        # For all the PII message parameters, escape it within '{}'
        escaped_message_format = message_format
