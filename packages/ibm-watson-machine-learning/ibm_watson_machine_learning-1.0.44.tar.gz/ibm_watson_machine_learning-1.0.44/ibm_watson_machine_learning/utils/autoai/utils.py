...
def fetch_pipelines(run_params: dict,
                    ...
                    store: bool = False,
                    wml_client: 'APIClient' = None) -> Union[None, Dict[str, 'Pipeline']]:
    """
...
def check_dependencies_versions(lib_name: str = None, error: bool = False, msg: str = '') -> None:
    """Check xgboost and lightbm installed versions and inform the user about needed ones.
...
def create_summary(details: dict, scoring: str) -> 'DataFrame':
    ...
    """
    from ibm_watson_machine_learning.utils.autoai.enums import MetricsToDirections, Directions
    from pandas import DataFrame
