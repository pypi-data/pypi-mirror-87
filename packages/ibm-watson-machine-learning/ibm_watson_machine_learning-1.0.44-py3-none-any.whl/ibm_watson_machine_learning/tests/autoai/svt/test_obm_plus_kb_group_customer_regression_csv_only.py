        ...
        if self.wml_client.ICP:
            ...
            for dataset_name in ['main', 'customers', 'transactions', 'purchase', 'products']:
                conn = DataConnection(
                    ...
                    location=FSLocation(path=self.data_location + f'group_customer_{dataset_name}.csv'))
                ...
                asset_details = self.wml_client.data_assets.create(
                    name=f'group_customer_{dataset_name}.csv',
                    file_path=self.data_location + f'group_customer_{dataset_name}.csv')
