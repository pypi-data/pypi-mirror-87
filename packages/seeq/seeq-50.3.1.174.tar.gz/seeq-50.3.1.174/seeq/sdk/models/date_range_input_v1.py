...
class DateRangeInputV1(object):
    ...
    def __init__(self, archived=False, background=False, condition_id=None, cron_schedule=None, description=None, enabled=False, formula=None, name=None, report_id=None):
        """
