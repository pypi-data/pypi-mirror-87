...
class CfnAsset(
    ...
    def packaging_group_id(self) -> builtins.str:
        ...
        """
        return jsii.get(self, "packagingGroupId")

    @packaging_group_id.setter # type: ignore
    ...
    def source_role_arn(self) -> builtins.str:
        ...
        """
        return jsii.get(self, "sourceRoleArn")

    @source_role_arn.setter # type: ignore
    ...
    def egress_endpoints(
        ...
        """
        return jsii.get(self, "egressEndpoints")

    @egress_endpoints.setter # type: ignore
    def egress_endpoints(
        self,
...
class CfnChannel(
    ...
    class HlsIngestProperty:
        def __init__(
            self,
            *,
            ingest_endpoints: typing.Optional[typing.Union[aws_cdk.core.IResolvable, typing.List[typing.Union[aws_cdk.core.IResolvable, "CfnChannel.IngestEndpointProperty"]]]] = None,
        ) -> None:
            """
            :param ingest_endpoints: ``CfnChannel.HlsIngestProperty.ingestEndpoints``.
        ...
        def ingest_endpoints(
            self,
        ) -> typing.Optional[typing.Union[aws_cdk.core.IResolvable, typing.List[typing.Union[aws_cdk.core.IResolvable, "CfnChannel.IngestEndpointProperty"]]]]:
    ...
    class IngestEndpointProperty:
        def __init__(
            ...
            *,
            ...
            """
            :param id: ``CfnChannel.IngestEndpointProperty.Id``.
            :param password: ``CfnChannel.IngestEndpointProperty.Password``.
            :param url: ``CfnChannel.IngestEndpointProperty.Url``.
            :param username: ``CfnChannel.IngestEndpointProperty.Username``.
...
class CfnOriginEndpoint(
    ...
    @authorization.setter # type: ignore
    def authorization(
        self,
    ...
    def cmaf_package(
        ...
        """
        return jsii.get(self, "cmafPackage")

    @cmaf_package.setter # type: ignore
    def cmaf_package(
        self,
    ...
    def dash_package(
        ...
        """
        return jsii.get(self, "dashPackage")

    @dash_package.setter # type: ignore
    def dash_package(
        self,
    ...
    def hls_package(
        ...
        """
        return jsii.get(self, "hlsPackage")

    @hls_package.setter # type: ignore
    def hls_package(
        self,
    ...
    def manifest_name(self) -> typing.Optional[builtins.str]:
        ...
        """
        return jsii.get(self, "manifestName")

    @manifest_name.setter # type: ignore
    ...
    def mss_package(
        ...
        """
        return jsii.get(self, "mssPackage")

    @mss_package.setter # type: ignore
    def mss_package(
        self,
    ...
    def origination(self) -> typing.Optional[builtins.str]:
        ...
        """
        return jsii.get(self, "origination")

    @origination.setter # type: ignore
    ...
    def startover_window_seconds(self) -> typing.Optional[jsii.Number]:
        ...
        """
        return jsii.get(self, "startoverWindowSeconds")

    @startover_window_seconds.setter # type: ignore
    ...
    def time_delay_seconds(self) -> typing.Optional[jsii.Number]:
        ...
        """
        return jsii.get(self, "timeDelaySeconds")

    @time_delay_seconds.setter # type: ignore
    ...
    def whitelist(self) -> typing.Optional[typing.List[builtins.str]]:
        ...
        """
        return jsii.get(self, "whitelist")

    @whitelist.setter # type: ignore
