...
class ExportPreviewV1(object):
    ...
    def __init__(self, autoupdate_time_range=False, created_at=None, href=None, id=None, is_archived=False, is_redacted=False, name=None, scoped_to=None, type=None, updated_at=None):
        """
    ...
    def href(self):
        """
        Gets the href of this ExportPreviewV1.
        The href that can be used to interact with the item

        :return: The href of this ExportPreviewV1.
        :rtype: str
        """
        return self._href
    ...
    def href(self, href):
        """
        Sets the href of this ExportPreviewV1.
        The href that can be used to interact with the item

        :param href: The href of this ExportPreviewV1.
        :type: str
        """
        if href is None:
