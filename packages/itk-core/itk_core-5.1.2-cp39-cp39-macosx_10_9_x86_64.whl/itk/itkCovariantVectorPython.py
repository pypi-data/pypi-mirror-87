...
class itkCovariantVectorD2(itk.itkFixedArrayPython.itkFixedArrayD2):
    ...
    See:   Matrix     example{Core/Common/CreateACovariantVector,Create a
    CovariantVector}  example{Core/Common/CovariantVectorNorm,Covariant
    Vector Norm}  example{Core/Common/CovariantVectorDotProduct, Covariant
    Vector Dot Product} 
    """
