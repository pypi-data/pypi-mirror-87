...
class complex_type01(GeneratedsSuper):
    ...
    member_data_items_ = [
        ...
        MemberSpec_('integer_value01', 'xs:integer', 1, 1, {'maxOccurs': 'unbounded', 'minOccurs': '0', 'name': 'integer_value01', 'type': 'xs:integer'}, None),
    ...
    subclass = None
    superclass = None
    def __init__(self, string_value01=None, integer_value01=None, float_value01=None, field01=None, gds_collector_=None, **kwargs_):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='complex-type01', pretty_print=True):
        ...
        if pretty_print:
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'complex-type01':
        ...
        if self.hasContent_():
            ...
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='complex-type01', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
    ...
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='complex-type01'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='complex-type01', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.string_value01 is not None:
            namespaceprefix_ = self.string_value01_nsprefix_ + ':' if (UseCapturedNS_ and self.string_value01_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
        ...
        for integer_value01_ in self.integer_value01:
            namespaceprefix_ = self.integer_value01_nsprefix_ + ':' if (UseCapturedNS_ and self.integer_value01_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
        ...
        if self.float_value01 is not None:
            namespaceprefix_ = self.float_value01_nsprefix_ + ':' if (UseCapturedNS_ and self.float_value01_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
        ...
        if self.field01 is not None:
            namespaceprefix_ = self.field01_nsprefix_ + ':' if (UseCapturedNS_ and self.field01_nsprefix_) else ''
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'string_value01':
            value_ = child_.text
            value_ = self.gds_parse_string(value_, node, 'string_value01')
            value_ = self.gds_validate_string(value_, node, 'string_value01')
            self.string_value01 = value_
            self.string_value01_nsprefix_ = child_.prefix
        elif nodeName_ == 'integer_value01' and child_.text:
            sval_ = child_.text
            ival_ = self.gds_parse_integer(sval_, node, 'integer_value01')
            ival_ = self.gds_validate_integer(ival_, node, 'integer_value01')
            self.integer_value01.append(ival_)
            self.integer_value01_nsprefix_ = child_.prefix
        elif nodeName_ == 'float_value01' and child_.text:
            sval_ = child_.text
            fval_ = self.gds_parse_float(sval_, node, 'float_value01')
            fval_ = self.gds_validate_float(fval_, node, 'float_value01')
            self.float_value01 = fval_
            self.float_value01_nsprefix_ = child_.prefix
...
class complex_type02(GeneratedsSuper):
    ...
    member_data_items_ = [
        ...
        MemberSpec_('integer_value02', 'xs:integer', 1, 1, {'maxOccurs': 'unbounded', 'minOccurs': '0', 'name': 'integer_value02', 'type': 'xs:integer'}, None),
        MemberSpec_('float_value02', 'xs:float', 0, 0, {'name': 'float_value02', 'type': 'xs:float'}, None),
    ]
    subclass = None
    superclass = None
    def __init__(self, string_value02=None, integer_value02=None, float_value02=None, extensiontype_=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='complex-type02', pretty_print=True):
        ...
        if pretty_print:
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'complex-type02':
            name_ = self.original_tagname_
        if UseCapturedNS_ and self.ns_prefix_:
            namespaceprefix_ = self.ns_prefix_ + ':'
        showIndent(outfile, level, pretty_print)
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='complex-type02', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    ...
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='complex-type02', fromsubclass_=False, pretty_print=True):
        ...
        if self.string_value02 is not None:
            namespaceprefix_ = self.string_value02_nsprefix_ + ':' if (UseCapturedNS_ and self.string_value02_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
        ...
        for integer_value02_ in self.integer_value02:
            namespaceprefix_ = self.integer_value02_nsprefix_ + ':' if (UseCapturedNS_ and self.integer_value02_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
        ...
        if self.float_value02 is not None:
            namespaceprefix_ = self.float_value02_nsprefix_ + ':' if (UseCapturedNS_ and self.float_value02_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'string_value02':
            value_ = child_.text
            value_ = self.gds_parse_string(value_, node, 'string_value02')
            value_ = self.gds_validate_string(value_, node, 'string_value02')
            self.string_value02 = value_
            self.string_value02_nsprefix_ = child_.prefix
        elif nodeName_ == 'integer_value02' and child_.text:
            sval_ = child_.text
            ival_ = self.gds_parse_integer(sval_, node, 'integer_value02')
            ival_ = self.gds_validate_integer(ival_, node, 'integer_value02')
            self.integer_value02.append(ival_)
            self.integer_value02_nsprefix_ = child_.prefix
        elif nodeName_ == 'float_value02' and child_.text:
            sval_ = child_.text
            fval_ = self.gds_parse_float(sval_, node, 'float_value02')
            fval_ = self.gds_validate_float(fval_, node, 'float_value02')
            self.float_value02 = fval_
            self.float_value02_nsprefix_ = child_.prefix
...
class complex_type03(complex_type02):
    ...
    member_data_items_ = [
        ...
        MemberSpec_('integer_value03', 'xs:integer', 1, 1, {'maxOccurs': 'unbounded', 'minOccurs': '0', 'name': 'integer_value03', 'type': 'xs:integer'}, None),
        MemberSpec_('float_value03', 'xs:float', 0, 0, {'name': 'float_value03', 'type': 'xs:float'}, None),
    ]
    subclass = None
    superclass = complex_type02
    def __init__(self, string_value02=None, integer_value02=None, float_value02=None, string_value03=None, integer_value03=None, float_value03=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='complex-type03', pretty_print=True):
        ...
        if pretty_print:
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'complex-type03':
            name_ = self.original_tagname_
        if UseCapturedNS_ and self.ns_prefix_:
            namespaceprefix_ = self.ns_prefix_ + ':'
        showIndent(outfile, level, pretty_print)
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='complex-type03', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    ...
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='complex-type03', fromsubclass_=False, pretty_print=True):
        ...
        if self.string_value03 is not None:
            namespaceprefix_ = self.string_value03_nsprefix_ + ':' if (UseCapturedNS_ and self.string_value03_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
        ...
        for integer_value03_ in self.integer_value03:
            namespaceprefix_ = self.integer_value03_nsprefix_ + ':' if (UseCapturedNS_ and self.integer_value03_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
        ...
        if self.float_value03 is not None:
            namespaceprefix_ = self.float_value03_nsprefix_ + ':' if (UseCapturedNS_ and self.float_value03_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'string_value03':
            value_ = child_.text
            value_ = self.gds_parse_string(value_, node, 'string_value03')
            value_ = self.gds_validate_string(value_, node, 'string_value03')
            self.string_value03 = value_
            self.string_value03_nsprefix_ = child_.prefix
        elif nodeName_ == 'integer_value03' and child_.text:
            sval_ = child_.text
            ival_ = self.gds_parse_integer(sval_, node, 'integer_value03')
            ival_ = self.gds_validate_integer(ival_, node, 'integer_value03')
            self.integer_value03.append(ival_)
            self.integer_value03_nsprefix_ = child_.prefix
        elif nodeName_ == 'float_value03' and child_.text:
            sval_ = child_.text
            fval_ = self.gds_parse_float(sval_, node, 'float_value03')
            fval_ = self.gds_validate_float(fval_, node, 'float_value03')
            self.float_value03 = fval_
            self.float_value03_nsprefix_ = child_.prefix
...
class complex_type04(type_):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='complex-type04', pretty_print=True):
        ...
        if pretty_print:
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'complex-type04':
            name_ = self.original_tagname_
        if UseCapturedNS_ and self.ns_prefix_:
            namespaceprefix_ = self.ns_prefix_ + ':'
        showIndent(outfile, level, pretty_print)
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='complex-type04', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
...
class build_(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='build', pretty_print=True):
        ...
        if pretty_print:
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'build':
            name_ = self.original_tagname_
        if UseCapturedNS_ and self.ns_prefix_:
            namespaceprefix_ = self.ns_prefix_ + ':'
        showIndent(outfile, level, pretty_print)
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='build', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
...
class complex_type05(build_):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='complex-type05', pretty_print=True):
        ...
        if pretty_print:
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'complex-type05':
            name_ = self.original_tagname_
        if UseCapturedNS_ and self.ns_prefix_:
            namespaceprefix_ = self.ns_prefix_ + ':'
        showIndent(outfile, level, pretty_print)
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='complex-type05', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
