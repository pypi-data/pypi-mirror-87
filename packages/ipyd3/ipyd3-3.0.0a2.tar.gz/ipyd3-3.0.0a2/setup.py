...
class NPM(Command):
    ...
    targets = [
        os.path.join(here, 'ipyd3', 'static', 'extension.js'),
        os.path.join(here, 'ipyd3', 'static', 'index.js')
    ]
...
version_ns = {}
with open(os.path.join(here, 'ipyd3', '_version.py')) as f:
    exec(f.read(), {}, version_ns)

setup_args = dict(
    name=name,
    version=version_ns['__version__'],
    description='Library for visualizing d3 inside Jupyter',
    long_description=LONG_DESCRIPTION,
    include_package_data=True,
    data_files=[
        ('share/jupyter/nbextensions/ipyd3', [
            'ipyd3/static/extension.js',
            'ipyd3/static/index.js',
            'ipyd3/static/index.js.map',
        ],),
