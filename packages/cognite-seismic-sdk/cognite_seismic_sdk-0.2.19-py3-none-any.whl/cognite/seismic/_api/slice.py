...
class SliceAPI(API):
    ...
    @deprecation.deprecated(deprecated_in="0.1.57", details="Use VolumeAPI.get(inline_range=(inline, inline)) instead.")
    ...
    @deprecation.deprecated(deprecated_in="0.1.57", details="Use VolumeAPI.get(xline_range=(xline, xline)) instead.")
