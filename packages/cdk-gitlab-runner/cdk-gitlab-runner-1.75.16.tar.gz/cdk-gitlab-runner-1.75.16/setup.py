    ...
    """
{
    ...
    "package_data": {
        "cdk_gitlab_runner._jsii": [
            "cdk-gitlab-runner@1.75.16.jsii.tgz"
        ],
        "cdk_gitlab_runner": [
            "py.typed"
        ]
    ...
    "python_requires": ">=3.6",
    "install_requires": [
        "aws-cdk.aws-autoscaling-hooktargets>=1.75.0, <2.0.0",
        "aws-cdk.aws-autoscaling>=1.75.0, <2.0.0",
        "aws-cdk.aws-ec2>=1.75.0, <2.0.0",
        "aws-cdk.aws-iam>=1.75.0, <2.0.0",
        "aws-cdk.aws-lambda>=1.75.0, <2.0.0",
        "aws-cdk.aws-logs>=1.75.0, <2.0.0",
        "aws-cdk.aws-s3>=1.75.0, <2.0.0",
        "aws-cdk.core>=1.75.0, <2.0.0",
        "aws-cdk.custom-resources>=1.75.0, <2.0.0",
