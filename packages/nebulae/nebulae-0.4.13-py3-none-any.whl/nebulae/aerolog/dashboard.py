...
class DashBoard(object):
    ...
    def _formatAsStr(self, stage, abbr, value, epoch, mile, mpe):
        ...
        if mode == 'raw':
            ...
            form(stage, epoch, mile+1, mpe, value)
            return ''
        elif mode == 'tailor':
            string = form(value)
    ...
    def gauge(self, entry, mile, epoch, mpe, stage, interval=1, duration=None):
        ...
        for abbr, value in entry.items():
            ...
            if flag_epoch_end:
                ...
                indicator = self._formatAsStr(stage, abbr, self.gauge_epoch[name][-1], epoch, mile, mpe)
    ...
    def log(self, gauge=True, tachograph=True, record=None):
        ...
        if gauge:
            ...
            # plot
            warnings.filterwarnings('ignore', message='UserWarning: Creating legend with loc="best"')
