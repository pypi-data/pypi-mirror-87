...
_swig_new_instance_method = _itkSimilarity3DTransformPython.SWIG_PyInstanceMethod_New
_swig_new_static_method = _itkSimilarity3DTransformPython.SWIG_PyStaticMethod_New
...
class itkSimilarity3DTransformD(itk.itkVersorRigid3DTransformPython.itkVersorRigid3DTransformD):
    ...
    __repr__ = _swig_repr
    __New_orig__ = _swig_new_static_method(_itkSimilarity3DTransformPython.itkSimilarity3DTransformD___New_orig__)
    Clone = _swig_new_instance_method(_itkSimilarity3DTransformPython.itkSimilarity3DTransformD_Clone)
    SetMatrix = _swig_new_instance_method(_itkSimilarity3DTransformPython.itkSimilarity3DTransformD_SetMatrix)
    SetScale = _swig_new_instance_method(_itkSimilarity3DTransformPython.itkSimilarity3DTransformD_SetScale)
    GetScale = _swig_new_instance_method(_itkSimilarity3DTransformPython.itkSimilarity3DTransformD_GetScale)
    __swig_destroy__ = _itkSimilarity3DTransformPython.delete_itkSimilarity3DTransformD
    cast = _swig_new_static_method(_itkSimilarity3DTransformPython.itkSimilarity3DTransformD_cast)
...
itkSimilarity3DTransformD___New_orig__ = _itkSimilarity3DTransformPython.itkSimilarity3DTransformD___New_orig__
itkSimilarity3DTransformD_cast = _itkSimilarity3DTransformPython.itkSimilarity3DTransformD_cast
