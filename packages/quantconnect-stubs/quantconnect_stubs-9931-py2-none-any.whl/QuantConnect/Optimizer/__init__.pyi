...
class OptimizationEstimate(System.Object):
    """This class has no documentation."""

    @property
    def TotalBacktest(self) -> int:
        """Total number of backtests, approximately"""
        ...

    @TotalBacktest.setter
    def TotalBacktest(self, value: int):
        """Total number of backtests, approximately"""
        ...

    @property
    def CompletedBacktest(self) -> int:
        """Number of completed backtests"""
        ...

    @CompletedBacktest.setter
    def CompletedBacktest(self, value: int):
        """Number of completed backtests"""
        ...

    @property
    def FailedBacktest(self) -> int:
        """Number of failed backtests"""
        ...

    @FailedBacktest.setter
    def FailedBacktest(self, value: int):
        """Number of failed backtests"""
        ...

    @property
    def RunningBacktest(self) -> int:
        """Number of running backtests"""
        ...

    @RunningBacktest.setter
    def RunningBacktest(self, value: int):
        """Number of running backtests"""
        ...

    @property
    def InQueueBacktest(self) -> int:
        """Number of backtests in queue"""
        ...

    @InQueueBacktest.setter
    def InQueueBacktest(self, value: int):
        """Number of backtests in queue"""
        ...

    @property
    def AverageBacktest(self) -> datetime.timedelta:
        """Indicates backtest average duration; (start - now) / CompletedBacktest"""
        ...

    @AverageBacktest.setter
    def AverageBacktest(self, value: datetime.timedelta):
        """Indicates backtest average duration; (start - now) / CompletedBacktest"""
        ...

    @property
    def TotalRuntime(self) -> datetime.timedelta:
        """The run time of this optimization"""
        ...

    @TotalRuntime.setter
    def TotalRuntime(self, value: datetime.timedelta):
        """The run time of this optimization"""
        ...
...
class LeanOptimizer(System.Object, System.IDisposable, metaclass=abc.ABCMeta):
    ...
    @Status.setter
    def Status(self, value: QuantConnect.Optimizer.OptimizationStatus):
        """
        The current optimization status
    ...
    def GetCurrentEstimate(self) -> QuantConnect.Optimizer.OptimizationEstimate:
