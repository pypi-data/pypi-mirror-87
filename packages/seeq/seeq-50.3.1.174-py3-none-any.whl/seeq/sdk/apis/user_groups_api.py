...
class UserGroupsApi(object):
    ...
    def add_identity_to_user_group_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api('/usergroups/{userGroupId}/{identityId}', 'POST',
                                        ...
                                        response_type='UserGroupOutputV1',
    ...
    def update_user_group(self, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.update_user_group(user_group_id=user_group_id_value, body=body_value, callback=callback_function)
    ...
    def update_user_group_with_http_info(self, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.update_user_group_with_http_info(user_group_id=user_group_id_value, body=body_value, callback=callback_function)
