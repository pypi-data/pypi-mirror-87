...
class itkRegionOfInterestImageFilterID2ID2(itk.itkImageToImageFilterAPython.itkImageToImageFilterID2ID2):
    ...
    want to consider the ExtractImageFilter. For example for extracting a
    2D image from a slice of a 3D image.

    The region to extract is set using the method SetRegionOfInterest.

    See:  ExtractImageFilter
    example{Filtering/ImageGrid/ExtractRegionOfInterestInOneImage,Extract
    Region Of Interest In One Image} 
    """
