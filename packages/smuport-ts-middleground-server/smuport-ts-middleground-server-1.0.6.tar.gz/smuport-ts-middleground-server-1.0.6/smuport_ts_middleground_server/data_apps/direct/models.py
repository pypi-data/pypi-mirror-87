...
def tlms_wms_ent_direct_id():
    ...
    default = 'TLMS-WMS-RK' + now_time + str(random.choice(range(1000)))
    return default
...
class TlmsWmsEntDirect(models.Model):
    ...
    id = TlmsWmsEntDirectField(max_length=25, primary_key=True, auto_created=True, default=tlms_wms_ent_direct_id, editable=False)
    ...
    dec_method = models.CharField(max_length=30, verbose_name="申报方式", help_text="申报方式")
    work_route = models.CharField(max_length=30, verbose_name="作业路线", help_text="作业路线")
