...
class BucketProps:
    def __init__(
        ...
        *,
        ...
        :param block_public_access: (experimental) The block public access configuration of this bucket. Default: false New buckets and objects don't allow public access, but users can modify bucket policies or object permissions to allow public access.
...
class IBucket(_IResource_8c1dbbbd, typing_extensions.Protocol):
    ...
    def grant_delete(
        ...
        """(experimental) Grants s3:DeleteObject* permission to an IAM pricipal for objects in this bucket.
