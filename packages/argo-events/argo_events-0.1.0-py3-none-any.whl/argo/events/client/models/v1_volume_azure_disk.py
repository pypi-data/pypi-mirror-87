...
class V1VolumeAzureDisk(object):
    ...
    def caching_mode(self):
        """Gets the caching_mode of this V1VolumeAzureDisk.  # noqa: E501

        Host Caching mode: None, Read Only, Read Write.  # noqa: E501

        :return: The caching_mode of this V1VolumeAzureDisk.  # noqa: E501
        :rtype: str
        """
    ...
    def caching_mode(self, caching_mode):
        """Sets the caching_mode of this V1VolumeAzureDisk.

        Host Caching mode: None, Read Only, Read Write.  # noqa: E501

        :param caching_mode: The caching_mode of this V1VolumeAzureDisk.  # noqa: E501
        :type: str
        """
    ...
    @property
    def disk_name(self):
        """Gets the disk_name of this V1VolumeAzureDisk.  # noqa: E501

        The Name of the data disk in the blob storage  # noqa: E501

        :return: The disk_name of this V1VolumeAzureDisk.  # noqa: E501
        :rtype: str
        """
    ...
    def disk_name(self, disk_name):
        """Sets the disk_name of this V1VolumeAzureDisk.

        The Name of the data disk in the blob storage  # noqa: E501

        :param disk_name: The disk_name of this V1VolumeAzureDisk.  # noqa: E501
        :type: str
        """
    ...
    @property
    def disk_uri(self):
        """Gets the disk_uri of this V1VolumeAzureDisk.  # noqa: E501

        The URI the data disk in the blob storage  # noqa: E501

        :return: The disk_uri of this V1VolumeAzureDisk.  # noqa: E501
        :rtype: str
        """
    ...
    def disk_uri(self, disk_uri):
        """Sets the disk_uri of this V1VolumeAzureDisk.

        The URI the data disk in the blob storage  # noqa: E501

        :param disk_uri: The disk_uri of this V1VolumeAzureDisk.  # noqa: E501
        :type: str
        """
    ...
    @property
    def fs_type(self):
        """Gets the fs_type of this V1VolumeAzureDisk.  # noqa: E501
        ...
        :return: The fs_type of this V1VolumeAzureDisk.  # noqa: E501
        :rtype: str
        """
    ...
    def fs_type(self, fs_type):
        """Sets the fs_type of this V1VolumeAzureDisk.

        Filesystem type to mount. Must be a filesystem type supported by the host operating system. Ex. \"ext4\", \"xfs\", \"ntfs\". Implicitly inferred to be \"ext4\" if unspecified.  # noqa: E501

        :param fs_type: The fs_type of this V1VolumeAzureDisk.  # noqa: E501
        :type: str
        """
    ...
    @property
    def kind(self):
        """Gets the kind of this V1VolumeAzureDisk.  # noqa: E501
        ...
        :return: The kind of this V1VolumeAzureDisk.  # noqa: E501
        :rtype: str
        """
        return self._kind
    ...
    @kind.setter
    def kind(self, kind):
        """Sets the kind of this V1VolumeAzureDisk.

        Expected values Shared: multiple blob disks per storage account  Dedicated: single blob disk per storage account  Managed: azure managed data disk (only in managed availability set). defaults to shared  # noqa: E501

        :param kind: The kind of this V1VolumeAzureDisk.  # noqa: E501
        :type: str
        """
    ...
    @property
    def read_only(self):
        """Gets the read_only of this V1VolumeAzureDisk.  # noqa: E501

        Defaults to false (read/write). ReadOnly here will force the ReadOnly setting in VolumeMounts.  # noqa: E501

        :return: The read_only of this V1VolumeAzureDisk.  # noqa: E501
        :rtype: bool
        """
    ...
    def read_only(self, read_only):
        """Sets the read_only of this V1VolumeAzureDisk.

        Defaults to false (read/write). ReadOnly here will force the ReadOnly setting in VolumeMounts.  # noqa: E501

        :param read_only: The read_only of this V1VolumeAzureDisk.  # noqa: E501
        :type: bool
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, V1VolumeAzureDisk):
            return False
