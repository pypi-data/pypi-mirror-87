...
class ListAccessRequestsResponse(object):
    ...
    """
    openapi_types = {
        'access_requests': 'list[AccessRequests]',
        'limit': 'int',
    ...
    def __init__(self, access_requests=None, limit=None, previous_page_email=None, next_page_email=None, local_vars_configuration=None):  # noqa: E501
        """ListAccessRequestsResponse - a model defined in OpenAPI"""  # noqa: E501
        if local_vars_configuration is None:
            local_vars_configuration = Configuration()
        self.local_vars_configuration = local_vars_configuration

        self._access_requests = None
        self._limit = None
    ...
    def access_requests(self):
        """Gets the access_requests of this ListAccessRequestsResponse.  # noqa: E501

        The matching AccessRequests objects  # noqa: E501

        :return: The access_requests of this ListAccessRequestsResponse.  # noqa: E501
        :rtype: list[AccessRequests]
        """
        return self._access_requests

    @access_requests.setter
    def access_requests(self, access_requests):
        """Sets the access_requests of this ListAccessRequestsResponse.

        The matching AccessRequests objects  # noqa: E501

        :param access_requests: The access_requests of this ListAccessRequestsResponse.  # noqa: E501
        :type: list[AccessRequests]
        """
        if self.local_vars_configuration.client_side_validation and access_requests is None:  # noqa: E501
            raise ValueError("Invalid value for `access_requests`, must not be `None`")  # noqa: E501

        self._access_requests = access_requests

    @property
    def limit(self):
        """Gets the limit of this ListAccessRequestsResponse.  # noqa: E501

        Limit on the number of rows in the response  # noqa: E501

        :return: The limit of this ListAccessRequestsResponse.  # noqa: E501
        :rtype: int
        """
        return self._limit
    ...
    def limit(self, limit):
        """Sets the limit of this ListAccessRequestsResponse.

        Limit on the number of rows in the response  # noqa: E501

        :param limit: The limit of this ListAccessRequestsResponse.  # noqa: E501
        :type: int
        """
    ...
    def previous_page_email(self):
        """Gets the previous_page_email of this ListAccessRequestsResponse.  # noqa: E501
        ...
        :return: The previous_page_email of this ListAccessRequestsResponse.  # noqa: E501
        :rtype: str
        """
    ...
    def previous_page_email(self, previous_page_email):
        """Sets the previous_page_email of this ListAccessRequestsResponse.

        The first email on the current page. Can be used with \"backwards\" as the search_direction_query parameter to retrieve the previous page's entries. Is an empty string if the current page is the first page.   # noqa: E501

        :param previous_page_email: The previous_page_email of this ListAccessRequestsResponse.  # noqa: E501
        :type: str
        """
    ...
    def next_page_email(self):
        """Gets the next_page_email of this ListAccessRequestsResponse.  # noqa: E501
        ...
        :return: The next_page_email of this ListAccessRequestsResponse.  # noqa: E501
        :rtype: str
        """
    ...
    def next_page_email(self, next_page_email):
        """Sets the next_page_email of this ListAccessRequestsResponse.

        The first email on the next page. Can be used with \"forwards\" as the search_direction_query parameter to retrieve the next page's entries. Is an empty string if the current page is the last page.   # noqa: E501

        :param next_page_email: The next_page_email of this ListAccessRequestsResponse.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListAccessRequestsResponse):
            return False
