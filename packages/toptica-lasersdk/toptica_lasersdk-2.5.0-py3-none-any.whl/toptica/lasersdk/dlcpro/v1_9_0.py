# Generated from 'v1_9_0.xml' on 2020-11-30 09:07:53.117166
...
class NloLaserHeadAutoNloOptFactorySettings:
    def __init__(self, client: Client, name: str) -> None:
        ...
        self._auto_align_enabled = MutableDecopBoolean(client, name + ':auto-align-enabled')
    ...
    @property
    def auto_align_enabled(self) -> 'MutableDecopBoolean':
...
class AutoNloOptimizationOptions:
    def __init__(self, client: Client, name: str) -> None:
        ...
        self._auto_align = MutableDecopBoolean(client, name + ':auto-align')
    ...
    @property
    def auto_align(self) -> 'MutableDecopBoolean':
