...
class AnalysisListEntry(AnalysisMixin):
    ...
    def __init__(self, id=None, inputs=None, files=None, job=None, gear_info=None, notes=None, description=None, label=None, parent=None, parents=None, created=None, modified=None, revision=None):  # noqa: E501
    ...
    def revision(self):
        ...
        :return: The revision of this AnalysisListEntry.
        :rtype: int
        """
    ...
    def revision(self, revision):
        """Sets the revision of this AnalysisListEntry.

        An incremental document revision number

        :param revision: The revision of this AnalysisListEntry.  # noqa: E501
        :type: int
        """
