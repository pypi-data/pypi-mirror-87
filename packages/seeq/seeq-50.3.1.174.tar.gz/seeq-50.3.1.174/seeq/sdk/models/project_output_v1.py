...
class ProjectOutputV1(object):
    ...
    def href(self):
        """
        Gets the href of this ProjectOutputV1.
        The href that can be used to interact with the item

        :return: The href of this ProjectOutputV1.
        :rtype: str
        """
        return self._href
    ...
    def href(self, href):
        """
        Sets the href of this ProjectOutputV1.
        The href that can be used to interact with the item

        :param href: The href of this ProjectOutputV1.
        :type: str
        """
        if href is None:
