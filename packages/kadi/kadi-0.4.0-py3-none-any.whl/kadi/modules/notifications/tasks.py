...
from kadi.lib.mails.core import send_mail
from kadi.lib.tasks.core import launch_task


@celery.task(name="kadi.notifications.send_mail", bind=True)
def _send_mail_task(
    self,
    *,
    subject,
...
def start_send_mail_task(
    *,
    ...
    See :func:`kadi.lib.mails.utils.send_mail` for the possible parameters.
