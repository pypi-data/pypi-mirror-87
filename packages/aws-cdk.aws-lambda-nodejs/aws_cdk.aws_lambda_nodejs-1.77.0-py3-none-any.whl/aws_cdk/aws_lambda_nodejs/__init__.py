...
class BundlingOptions:
    def __init__(
        ...
        *,
        ...
        docker_image: typing.Optional[aws_cdk.core.BundlingDockerImage] = None,
    ...
    @builtins.property
    def docker_image(self) -> typing.Optional[aws_cdk.core.BundlingDockerImage]:
...
@jsii.interface(jsii_type="@aws-cdk/aws-lambda-nodejs.ICommandHooks")
...
class _ICommandHooksProxy:
    ...
    __jsii_type__: typing.ClassVar[str] = "@aws-cdk/aws-lambda-nodejs.ICommandHooks"
    ...
    def after_bundling(
        ...
        :stability: experimental
        """
        return jsii.invoke(self, "afterBundling", [input_dir, output_dir])
    ...
    def before_bundling(
        ...
        :stability: experimental
        """
        return jsii.invoke(self, "beforeBundling", [input_dir, output_dir])
    ...
    def before_install(
        ...
        :stability: experimental
        """
        return jsii.invoke(self, "beforeInstall", [input_dir, output_dir])
