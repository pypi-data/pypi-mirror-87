...
__ObjectColumnSource__ = 'com.illumon.iris.db.v2.sources.immutable.ImmutableObjectArraySource'
__DatetimeColumnSource__ = 'com.illumon.iris.db.v2.sources.immutable.ImmutableDateTimeArraySource'
__ArrayConversionUtility__ = 'com.illumon.integrations.common.PrimitiveArrayConversionUtility'
...
_javaTypeToDbarrayType = {
    'java.lang.String': 'com.illumon.iris.db.tables.dbarrays.DbArrayDirect',
    'char': 'com.illumon.iris.db.tables.dbarrays.DbCharArrayDirect',
    'java.lang.Boolean': 'com.illumon.iris.db.tables.dbarrays.DbArrayDirect',
    'boolean': 'com.illumon.iris.db.tables.dbarrays.DbArrayDirect',  # it really should be boxed...
    'byte': 'com.illumon.iris.db.tables.dbarrays.DbByteArrayDirect',
    'short': 'com.illumon.iris.db.tables.dbarrays.DbShortArrayDirect',
    'int': 'com.illumon.iris.db.tables.dbarrays.DbIntArrayDirect',
    'long': 'com.illumon.iris.db.tables.dbarrays.DbLongArrayDirect',
    'float': 'com.illumon.iris.db.tables.dbarrays.DbFloatArrayDirect',
    'double': 'com.illumon.iris.db.tables.dbarrays.DbDoubleArrayDirect',
}

_javaTypeToImmutableColumnSource = {
    'byte': 'com.illumon.iris.db.v2.sources.immutable.ImmutableByteArraySource',
    'short': 'com.illumon.iris.db.v2.sources.immutable.ImmutableShortArraySource',
    'int': 'com.illumon.iris.db.v2.sources.immutable.ImmutableIntArraySource',
    'long': 'com.illumon.iris.db.v2.sources.immutable.ImmutableLongArraySource',
    'float': 'com.illumon.iris.db.v2.sources.immutable.ImmutableFloatArraySource',
    'double': 'com.illumon.iris.db.v2.sources.immutable.ImmutableDoubleArraySource',
    'char': 'com.illumon.iris.db.v2.sources.immutable.ImmutableCharArraySource',
}
...
def _charColumnSource(array, columnName, typ):
    # Assumed to be called strictly by _convertNdarrayToImmutableSource...no error checking at all performed
    colClassType = 'com.illumon.iris.db.v2.sources.immutable.ImmutableCharArraySource'
    try:
...
def _arrayColumnSource(array, javaTypeString):
    ...
    if javaTypeString in _javaTypeToDbarrayType:
        ...
        arrayType = 'com.illumon.iris.db.tables.dbarrays.DbArrayDirect'
...
def makeJavaArray(data, name, convertUnknownToString=False):
    ...
    * ndarrays of any other dtype (namely *complex\*, uint\*, void\*,* or custom dtypes):
    ...
    if junk is None:
        ...
        if junk[0] == 'com.illumon.iris.db.v2.sources.immutable.ImmutableDateTimeArraySource':
...
def _convertNdarrayToImmutableSource(data, name, convertUnknownToString=False):
    ...
    elif javaType == 'com.illumon.iris.db.tables.utils.DBDateTime':
...
def _isDbArray(obj):
    try:
        ...
        cond = classString.startswith('com.illumon.iris.db.tables.dbarrays.Db') or \
               classString.startswith('com.illumon.iris.db.v2.dbarrays.Db')
        return cond
    except Exception as e:
        return False
