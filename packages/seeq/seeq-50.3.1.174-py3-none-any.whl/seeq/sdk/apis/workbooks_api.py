...
class WorkbooksApi(object):
    ...
    def create_workbook_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api('/workbooks', 'POST',
                                        ...
                                        post_params=form_params,
                                        files=local_var_files,
                                        response_type='WorkbookOutputV1',
                                        auth_settings=auth_settings,
                                        callback=params.get('callback'),
                                        _return_http_data_only=params.get('_return_http_data_only'),
                                        _preload_content=params.get('_preload_content', True),
    ...
    def create_worksheet(self, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.create_worksheet(workbook_id=workbook_id_value, body=body_value, callback=callback_function)
    ...
    def create_worksheet_with_http_info(self, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.create_worksheet_with_http_info(workbook_id=workbook_id_value, body=body_value, callback=callback_function)
        ...
        return self.api_client.call_api('/workbooks/{workbookId}/worksheets', 'POST',
                                        ...
                                        post_params=form_params,
                                        files=local_var_files,
                                        response_type='WorksheetOutputV1',
                                        auth_settings=auth_settings,
                                        callback=params.get('callback'),
                                        _return_http_data_only=params.get('_return_http_data_only'),
                                        _preload_content=params.get('_preload_content', True),
    ...
    def create_workstep(self, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.create_workstep(workbook_id=workbook_id_value, worksheet_id=worksheet_id_value, body=body_value, callback=callback_function)
    ...
    def create_workstep_with_http_info(self, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.create_workstep_with_http_info(workbook_id=workbook_id_value, worksheet_id=worksheet_id_value, body=body_value, callback=callback_function)
        ...
        all_params = ['workbook_id', 'worksheet_id', 'body', 'no_workstep_message']
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        return self.api_client.call_api('/workbooks/{workbookId}/worksheets/{worksheetId}/worksteps', 'POST',
                                        ...
                                        post_params=form_params,
                                        files=local_var_files,
                                        response_type='WorkstepOutputV1',
                                        auth_settings=auth_settings,
                                        callback=params.get('callback'),
                                        _return_http_data_only=params.get('_return_http_data_only'),
                                        _preload_content=params.get('_preload_content', True),
    ...
    def delete_workbook(self, **kwargs):
        """
        Permanently delete a workbook and all of its worksheets
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.delete_workbook(id=id_value, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param str id: ID of the workbook to delete (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.delete_workbook_with_http_info(**kwargs)
        else:
            (data) = self.delete_workbook_with_http_info(**kwargs)
            return data

    def delete_workbook_with_http_info(self, **kwargs):
        """
        Permanently delete a workbook and all of its worksheets
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.delete_workbook_with_http_info(id=id_value, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method delete_workbook" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'id' is set
        if ('id' not in params) or (params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `delete_workbook`")
    ...
    def delete_worksheet(self, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.delete_worksheet(workbook_id=workbook_id_value, worksheet_id=worksheet_id_value, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param str workbook_id: ID of the workbook on which the worksheet exists (required)
        :param str worksheet_id: ID of the worksheet to delete (required)
        :return: StatusMessageBase
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: StatusMessageBase
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.delete_worksheet_with_http_info(**kwargs)
        else:
            (data) = self.delete_worksheet_with_http_info(**kwargs)
            return data

    def delete_worksheet_with_http_info(self, **kwargs):
        """
        Permanently delete a worksheet
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.delete_worksheet_with_http_info(workbook_id=workbook_id_value, worksheet_id=worksheet_id_value, callback=callback_function)
        ...
        # verify the required parameter 'workbook_id' is set
        if ('workbook_id' not in params) or (params['workbook_id'] is None):
            raise ValueError("Missing the required parameter `workbook_id` when calling `delete_worksheet`")
        # verify the required parameter 'worksheet_id' is set
        if ('worksheet_id' not in params) or (params['worksheet_id'] is None):
            raise ValueError("Missing the required parameter `worksheet_id` when calling `delete_worksheet`")
    ...
    def get_workbooks_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api('/workbooks', 'GET',
                                        ...
                                        post_params=form_params,
                                        files=local_var_files,
                                        response_type='WorkbookOutputListV1',
                                        auth_settings=auth_settings,
                                        callback=params.get('callback'),
                                        _return_http_data_only=params.get('_return_http_data_only'),
                                        _preload_content=params.get('_preload_content', True),
    ...
    def get_worksheets_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api('/workbooks/{workbookId}/worksheets', 'GET',
                                        ...
                                        post_params=form_params,
                                        files=local_var_files,
                                        response_type='WorksheetOutputListV1',
                                        auth_settings=auth_settings,
                                        callback=params.get('callback'),
                                        _return_http_data_only=params.get('_return_http_data_only'),
                                        _preload_content=params.get('_preload_content', True),
