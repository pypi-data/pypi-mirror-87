...
class DataViewCalculatedValue(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, value, error, error_message, footnotes, line_item, *args, **kwargs):  # noqa: E501
        """DataViewCalculatedValue - a model defined in OpenAPI
