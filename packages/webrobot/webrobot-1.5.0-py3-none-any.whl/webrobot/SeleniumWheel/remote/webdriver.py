...
class WebDriver(object):
    ...
    def __init__(self, command_executor='http://127.0.0.1:4444/wd/hub',
        ...
        :Args:
         ...
         - browser_profile - A SeleniumWheel.SeleniumWheel.firefox.firefox_profile.FirefoxProfile object.
             Only used if Firefox is requested. Optional.
         - proxy - A SeleniumWheel.SeleniumWheel.common.proxy.Proxy object. The browser session will
    ...
    def file_detector_context(self, file_detector_class, *args, **kwargs):
        ...
        with SeleniumWheel.file_detector_context(UselessFileDetector):
    ...
    def start_session(self, capabilities, browser_profile=None):
        ...
        :Args:
         ...
         - browser_profile - A SeleniumWheel.SeleniumWheel.firefox.firefox_profile.FirefoxProfile object. Only used if Firefox is requested.
        """
    ...
    def maximize_window(self):
        """
        Maximizes the current window that SeleniumWheel is using
        """
        params = None
