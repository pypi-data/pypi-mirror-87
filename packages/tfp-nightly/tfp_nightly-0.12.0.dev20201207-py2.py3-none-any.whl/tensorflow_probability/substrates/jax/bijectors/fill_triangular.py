...
from tensorflow_probability.substrates.jax.math.linalg import fill_triangular
from tensorflow_probability.substrates.jax.math.linalg import fill_triangular_inverse
...
#   `tensorflow_probability/substrates/jax/bijectors/fill_triangular.py`
