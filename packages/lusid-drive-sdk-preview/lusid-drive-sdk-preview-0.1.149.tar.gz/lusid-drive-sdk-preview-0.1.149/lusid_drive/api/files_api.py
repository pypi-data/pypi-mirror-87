...
class FilesApi(object):
    ...
    def create_file_with_http_info(self, x_lusid_drive_filename, x_lusid_drive_path, content_length, **kwargs):  # noqa: E501
        ...
        if 'x_lusid_drive_filename' in local_var_params and not re.search(r'^[A-Za-z0-9_\-\. ]+$', local_var_params['x_lusid_drive_filename']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `x_lusid_drive_filename` when calling `create_file`, must conform to the pattern `/^[A-Za-z0-9_\-\. ]+$/`")  # noqa: E501
