...
function GetOciSubcommands_db() {
    $ociSubcommands = @{
        'db' = 'autonomous-container-database autonomous-container-database-dataguard autonomous-data-warehouse autonomous-data-warehouse-backup autonomous-database autonomous-database-backup autonomous-database-dataguard autonomous-database-wallet autonomous-db-preview-version autonomous-db-version autonomous-exadata-infrastructure autonomous-patch autonomous-vm-cluster backup backup-destination cloud-exa-infra cloud-vm-cluster console-connection data-guard-association database database-software-image db-home exadata-infrastructure external-backup-job gi-version key-store maintenance-run node patch patch-history system system-shape upgrade-history version vm-cluster vm-cluster-network'
        ...
        'db autonomous-exadata-infrastructure' = 'change-compartment get launch list shape terminate update'
        ...
        'db database' = 'create create-database-from-backup create-from-backup create-from-database delete get list list-upgrade-history patch restore update upgrade upgrade-rollback upgrade-with-database-software-image upgrade-with-db-home upgrade-with-db-version'
        'db database-software-image' = 'change-compartment create delete get list update'
        'db db-home' = 'create delete get list update'
        'db exadata-infrastructure' = 'activate change-compartment create delete download-config-file generate-recommended-vm-cluster-network get get-compute-units list update'
...
function GetOciCommandsToLongParams_db() {
    $ociCommandsToLongParams = @{
        ...
        'db autonomous-container-database create' = 'autonomous-exadata-infrastructure-id autonomous-vm-cluster-id backup-config compartment-id db-unique-name defined-tags display-name freeform-tags from-json help key-store-id kms-key-id kms-key-version-id maintenance-window-details max-wait-seconds patch-model peer-autonomous-container-database-backup-config peer-autonomous-container-database-compartment-id peer-autonomous-container-database-display-name peer-autonomous-exadata-infrastructure-id peer-autonomous-vm-cluster-id protection-mode service-level-agreement-type standby-maintenance-buffer-in-days vault-id wait-for-state wait-interval-seconds'
        ...
        'db autonomous-database create' = 'admin-password autonomous-container-database-id compartment-id cpu-core-count data-storage-size-in-tbs db-name db-version db-workload defined-tags display-name freeform-tags from-json help is-acl-enabled is-auto-scaling-enabled is-data-guard-enabled is-dedicated is-free-tier is-preview-version-with-service-terms-accepted license-model max-wait-seconds nsg-ids private-endpoint-label subnet-id wait-for-state wait-interval-seconds whitelisted-ips'
        ...
        'db autonomous-database create-from-clone' = 'admin-password autonomous-container-database-id clone-type compartment-id cpu-core-count data-storage-size-in-tbs db-name db-version db-workload defined-tags display-name freeform-tags from-json help is-acl-enabled is-auto-scaling-enabled is-data-guard-enabled is-dedicated is-free-tier is-preview-version-with-service-terms-accepted license-model max-wait-seconds nsg-ids private-endpoint-label source-id subnet-id wait-for-state wait-interval-seconds whitelisted-ips'
        ...
        'db autonomous-database disable-operations-insights' = 'autonomous-database-id from-json help'
        'db autonomous-database enable-operations-insights' = 'autonomous-database-id from-json help'
        ...
        'db autonomous-database update' = 'admin-password autonomous-database-id cpu-core-count data-storage-size-in-tbs db-name db-version db-workload defined-tags display-name force freeform-tags from-json help if-match is-acl-enabled is-auto-scaling-enabled is-data-guard-enabled is-free-tier is-refreshable-clone license-model max-wait-seconds nsg-ids open-mode permission-level private-endpoint-label refreshable-mode subnet-id wait-for-state wait-interval-seconds whitelisted-ips'
        ...
        'db cloud-exa-infra change-compartment' = 'cloud-exa-infra-id compartment-id from-json help if-match'
        ...
        'db cloud-vm-cluster change-compartment' = 'cloud-vm-cluster-id compartment-id from-json help if-match'
        ...
        'db database create' = 'admin-password auto-backup-enabled auto-backup-window backup-destination character-set database-software-image-id db-home-id db-name db-system-id db-unique-name db-version db-workload defined-tags freeform-tags from-json help max-wait-seconds ncharacter-set pdb-name recovery-window-in-days source tde-wallet-password vm-cluster-id wait-for-state wait-interval-seconds'
        ...
        'db database create-from-backup' = 'admin-password backup-id backup-tde-password database-software-image-id db-name db-system-id db-unique-name defined-tags freeform-tags from-json help max-wait-seconds vm-cluster-id wait-for-state wait-interval-seconds'
        'db database create-from-database' = 'admin-password backup-tde-password database-id database-software-image-id db-name db-system-id defined-tags freeform-tags from-json help max-wait-seconds point-in-time-recovery-timestamp wait-for-state wait-interval-seconds'
        ...
        'db database upgrade-with-database-software-image' = 'action database-id database-software-image-id from-json help if-match max-wait-seconds wait-for-state wait-interval-seconds'
        'db database upgrade-with-db-home' = 'action database-id db-home-id from-json help if-match max-wait-seconds wait-for-state wait-interval-seconds'
        'db database upgrade-with-db-version' = 'action database-id db-version from-json help if-match max-wait-seconds wait-for-state wait-interval-seconds'
        'db database-software-image change-compartment' = 'compartment-id database-software-image-id from-json help if-match'
        ...
        'db db-home create' = 'database-software-image-id db-system-id db-version defined-tags display-name freeform-tags from-json help max-wait-seconds source vm-cluster-id wait-for-state wait-interval-seconds'
        ...
        'db exadata-infrastructure create' = 'admin-network-cidr cloud-control-plane-server1 cloud-control-plane-server2 compartment-id contacts corporate-proxy defined-tags display-name dns-server freeform-tags from-json gateway help infini-band-network-cidr max-wait-seconds netmask ntp-server shape time-zone wait-for-state wait-interval-seconds'
        ...
        'db exadata-infrastructure update' = 'admin-network-cidr cloud-control-plane-server1 cloud-control-plane-server2 contacts corporate-proxy defined-tags dns-server exadata-infrastructure-id force freeform-tags from-json gateway help if-match infini-band-network-cidr max-wait-seconds netmask ntp-server time-zone wait-for-state wait-interval-seconds'
        ...
        'db key-store change-compartment' = 'compartment-id from-json help if-match key-store-id'
        ...
        'db maintenance-run update' = 'from-json help if-match is-enabled is-patch-now-enabled maintenance-run-id max-wait-seconds patch-id time-scheduled wait-for-state wait-interval-seconds'
