...
#   `tensorflow_probability/substrates/jax/distributions/weibull.py`
...
from tensorflow_probability.substrates.jax.bijectors import weibull_cdf as weibull_cdf_bijector
