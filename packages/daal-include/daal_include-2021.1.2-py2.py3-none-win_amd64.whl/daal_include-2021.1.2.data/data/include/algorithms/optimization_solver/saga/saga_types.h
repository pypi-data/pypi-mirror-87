 ...
 * \brief %Parameter base class for the Stochastic average  gradient descent algorithm    \DAAL_DEPRECATED
 *
 * \snippet optimization_solver/saga/saga_types.h interface1::Parameter source code
 */
...
* \brief %Input class for the Stochastic average  gradient descent algorithm    \DAAL_DEPRECATED
*
* \snippet optimization_solver/saga/saga_types.h interface1::Input source code
*/
...
* \brief Results obtained with the compute() method of the saga algorithm in the batch processing mode    \DAAL_DEPRECATED
*/
