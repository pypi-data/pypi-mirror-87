...
class ModelRegistryV1Api(object):
    ...
    def create_model_version(self, owner, model, body, **kwargs):  # noqa: E501
        ...
        :param V1ModelRegistry body: Model version body (required)
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
    ...
    def list_model_registry(self, owner, **kwargs):  # noqa: E501
        """List registry models  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_model_registry(owner, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.list_model_registry_with_http_info(owner, **kwargs)  # noqa: E501

    def list_model_registry_with_http_info(self, owner, **kwargs):  # noqa: E501
        """List registry models  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_model_registry_with_http_info(owner, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method list_model_registry" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'owner' is set
        if self.api_client.client_side_validation and ('owner' not in local_var_params or  # noqa: E501
                                                        local_var_params['owner'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `owner` when calling `list_model_registry`")  # noqa: E501
