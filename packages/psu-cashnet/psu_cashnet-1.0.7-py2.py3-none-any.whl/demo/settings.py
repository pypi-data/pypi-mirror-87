...
APP_NAME = 'Cashnet Demo Application'  # Displayed in some generic UI scenarios

CASHNET_MERCHANT_CODE = 'pdxtestmerchant'
CASHNET_SIMULATE_TRANSACTION = True
CASHNET_ADMIN_EMAILS = None
...
SECRET_KEY = 'j3y0jmakw)%#bm!**34kw3et63o@&+zlj82(72qq%6c^y)e&8$'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            ...
            'libraries':{
                'cashnet_taglib': 'psu_cashnet.templatetags.cashnet_taglib',
            }
        },
    },
]
...
if is_aws:
    ...
    SECRET_KEY = os.environ.get('SECRET_KEY', 'j3y0jmakw)%#bm!**34kw3et63o@&+zlj82(72qq%6c^y)e&8$')
