...
from ...models.oligo_list import OligoList
...
def _parse_response(*, response: httpx.Response) -> Optional[Union[OligoList, BadRequestError]]:
    if response.status_code == 200:
        return OligoList.from_dict(cast(Dict[str, Any], response.json()))
    if response.status_code == 400:
        return BadRequestError.from_dict(cast(Dict[str, Any], response.json()))
    return None


def _build_response(*, response: httpx.Response) -> Response[Union[OligoList, BadRequestError]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    mentions: Optional[List[str]] = None,
    ids: Optional[str] = None,
) -> Response[Union[OligoList, BadRequestError]]:
    kwargs = _get_kwargs(
        client=client,
        page_size=page_size,
...
def sync(
    *,
    ...
    mentions: Optional[List[str]] = None,
    ids: Optional[str] = None,
) -> Optional[Union[OligoList, BadRequestError]]:
    """ List Oligos """
