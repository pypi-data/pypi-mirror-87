...
class DatafilesApi(object):
    ...
    def create_datafile_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api('/datafiles', 'POST',
                                        ...
                                        post_params=form_params,
                                        files=local_var_files,
                                        response_type='DatafileOutputV1',
                                        auth_settings=auth_settings,
                                        callback=params.get('callback'),
                                        _return_http_data_only=params.get('_return_http_data_only'),
                                        _preload_content=params.get('_preload_content', True),
    ...
    def import_csv(self, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.import_csv(file=file_value, callback=callback_function)
    ...
    def import_csv_with_http_info(self, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.import_csv_with_http_info(file=file_value, callback=callback_function)
        ...
        return self.api_client.call_api('/datafiles/csv', 'POST',
                                        ...
                                        post_params=form_params,
                                        files=local_var_files,
                                        response_type='CsvDatafileOutputV1',
                                        auth_settings=auth_settings,
                                        callback=params.get('callback'),
                                        _return_http_data_only=params.get('_return_http_data_only'),
                                        _preload_content=params.get('_preload_content', True),
    ...
    def update_datafile(self, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.update_datafile(id=id_value, body=body_value, callback=callback_function)
    ...
    def update_datafile_with_http_info(self, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.update_datafile_with_http_info(id=id_value, body=body_value, callback=callback_function)
