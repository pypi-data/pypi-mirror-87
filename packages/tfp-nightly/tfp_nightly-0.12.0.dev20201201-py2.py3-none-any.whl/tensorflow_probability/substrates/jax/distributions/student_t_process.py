...
#   `tensorflow_probability/substrates/jax/distributions/student_t_process.py`
...
from tensorflow_probability.substrates.jax.distributions import multivariate_student_t
