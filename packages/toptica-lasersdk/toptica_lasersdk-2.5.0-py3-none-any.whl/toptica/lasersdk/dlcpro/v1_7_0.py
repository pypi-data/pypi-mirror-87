# Generated from 'v1_7_0.xml' on 2020-11-30 09:07:52.595094
...
class PdhChannel:
    def __init__(self, client: Client, name: str) -> None:
        ...
        self._modulation_amplitude_x10 = MutableDecopBoolean(client, name + ':modulation-amplitude-x10')
        self._demodulation_amplitude_dbm = MutableDecopReal(client, name + ':demodulation-amplitude-dbm')
        self._demodulation_amplitude_vpp = DecopReal(client, name + ':demodulation-amplitude-vpp')
        self._demodulation_amplitude_x10 = MutableDecopBoolean(client, name + ':demodulation-amplitude-x10')
        self._phase_shift = MutableDecopReal(client, name + ':phase-shift')
    ...
    @property
    def modulation_amplitude_x10(self) -> 'MutableDecopBoolean':
        return self._modulation_amplitude_x10

    @property
    def demodulation_amplitude_dbm(self) -> 'MutableDecopReal':
        return self._demodulation_amplitude_dbm

    @property
    def demodulation_amplitude_vpp(self) -> 'DecopReal':
        return self._demodulation_amplitude_vpp

    @property
    def demodulation_amplitude_x10(self) -> 'MutableDecopBoolean':
