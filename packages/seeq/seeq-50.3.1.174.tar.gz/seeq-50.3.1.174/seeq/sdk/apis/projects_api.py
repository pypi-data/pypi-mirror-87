...
class ProjectsApi(object):
    ...
    def delete_project(self, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.delete_project(id=id_value, callback=callback_function)
    ...
    def delete_project_with_http_info(self, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.delete_project_with_http_info(id=id_value, callback=callback_function)
    ...
    def get_projects_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api('/projects', 'GET',
                                        ...
                                        post_params=form_params,
                                        files=local_var_files,
                                        response_type='GetProjectsOutputV1',
                                        auth_settings=auth_settings,
                                        callback=params.get('callback'),
                                        _return_http_data_only=params.get('_return_http_data_only'),
                                        _preload_content=params.get('_preload_content', True),
