...
class OrderRequest(System.Object, metaclass=abc.ABCMeta):
    ...
    @property
    @abc.abstractmethod
    def OrderRequestType(self) -> QuantConnect.Orders.OrderRequestType:
    ...
    @Status.setter
    def Status(self, value: QuantConnect.Orders.OrderRequestStatus):
        """Gets the status of this request"""
        ...
...
class OrderResponse(System.Object):
    ...
    @property
    def ErrorCode(self) -> QuantConnect.Orders.OrderResponseErrorCode:
        """Gets the error code for this response."""
        ...

    @ErrorCode.setter
    def ErrorCode(self, value: QuantConnect.Orders.OrderResponseErrorCode):
        """Gets the error code for this response."""
        ...
...
class OrderEvent(System.Object):
    ...
    @Direction.setter
    def Direction(self, value: QuantConnect.Orders.OrderDirection):
        """Order direction."""
        ...
