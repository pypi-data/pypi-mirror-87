...
from utils.utilities import render_to_string_or_empty, formulate_url as _formulate_url
...
@register.simple_tag
def formulate_url(path : str, **kwargs):
    return _formulate_url(path, **kwargs)
