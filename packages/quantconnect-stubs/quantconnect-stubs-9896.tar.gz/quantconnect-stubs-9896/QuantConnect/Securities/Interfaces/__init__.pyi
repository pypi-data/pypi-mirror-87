...
class IContinuousContractModel(metaclass=abc.ABCMeta):
    ...
    @property
    @abc.abstractmethod
    def AdjustmentType(self) -> QuantConnect.Securities.Interfaces.AdjustmentType:
        """Adjustment type, implemented by the model"""
        ...

    @AdjustmentType.setter
    @abc.abstractmethod
    def AdjustmentType(self, value: QuantConnect.Securities.Interfaces.AdjustmentType):
        """Adjustment type, implemented by the model"""
        ...
