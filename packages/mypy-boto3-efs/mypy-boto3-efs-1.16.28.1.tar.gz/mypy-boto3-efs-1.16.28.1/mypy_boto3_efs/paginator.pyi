...
class DescribeFileSystemsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [DescribeFileSystems.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.16.28/reference/services/efs.html#EFS.Paginator.DescribeFileSystems.paginate)
        """
...
class DescribeMountTargetsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [DescribeMountTargets.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.16.28/reference/services/efs.html#EFS.Paginator.DescribeMountTargets.paginate)
        """
...
class DescribeTagsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [DescribeTags.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.16.28/reference/services/efs.html#EFS.Paginator.DescribeTags.paginate)
        """
