...
#   `tensorflow_probability/substrates/numpy/distributions/generalized_pareto.py`
...
from tensorflow_probability.substrates.numpy.bijectors import generalized_pareto as generalized_pareto_bijector
