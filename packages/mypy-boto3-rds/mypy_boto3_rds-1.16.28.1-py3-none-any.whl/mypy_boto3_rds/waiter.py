...
class DBClusterSnapshotAvailableWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [DBClusterSnapshotAvailable.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.16.28/reference/services/rds.html#RDS.Waiter.DBClusterSnapshotAvailable.wait)
        """
...
class DBClusterSnapshotDeletedWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [DBClusterSnapshotDeleted.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.16.28/reference/services/rds.html#RDS.Waiter.DBClusterSnapshotDeleted.wait)
        """
...
class DBInstanceAvailableWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [DBInstanceAvailable.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.16.28/reference/services/rds.html#RDS.Waiter.DBInstanceAvailable.wait)
        """
...
class DBInstanceDeletedWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [DBInstanceDeleted.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.16.28/reference/services/rds.html#RDS.Waiter.DBInstanceDeleted.wait)
        """
...
class DBSnapshotAvailableWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [DBSnapshotAvailable.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.16.28/reference/services/rds.html#RDS.Waiter.DBSnapshotAvailable.wait)
        """
...
class DBSnapshotCompletedWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [DBSnapshotCompleted.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.16.28/reference/services/rds.html#RDS.Waiter.DBSnapshotCompleted.wait)
        """
...
class DBSnapshotDeletedWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [DBSnapshotDeleted.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.16.28/reference/services/rds.html#RDS.Waiter.DBSnapshotDeleted.wait)
        """
