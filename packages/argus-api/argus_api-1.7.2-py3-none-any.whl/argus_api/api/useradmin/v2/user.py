...
def add_user(
    ...
    :param bool daemonAccount: If set, mark this account as a daemon account (default false):param json:
...
def delete_user_1(
    ...
    :param str domain: Name or ID of the domain of the user:param json:
    :param verify: path to a certificate bundle or boolean indicating whether SSL
    verification should be performed.
    :param apiKey: Argus API key.
    :param authentication: authentication override
...
def delete_user_preferences(
    ...
    :param list key: Name of preference to delete:param json:
    :param verify: path to a certificate bundle or boolean indicating whether SSL
    verification should be performed.
    :param apiKey: Argus API key.
    :param authentication: authentication override
...
def get_user_image_1(
    ...
    :param bool default: If true, return default avatar image if user picture not set. Default is false.:param json:
    :param verify: path to a certificate bundle or boolean indicating whether SSL
    verification should be performed.
    :param apiKey: Argus API key.
    :param authentication: authentication override
...
def get_user_preference(
    ...
    :param str domain: Domain ID or short name (optional, defaults to current user domain):param json:
    :param verify: path to a certificate bundle or boolean indicating whether SSL
    verification should be performed.
    :param apiKey: Argus API key.
    :param authentication: authentication override
...
def list_permissions_for_user(
    ...
    :param bool includeDeleted: Include deleted permission:param json:
    :param verify: path to a certificate bundle or boolean indicating whether SSL
    verification should be performed.
    :param apiKey: Argus API key.
    :param authentication: authentication override
...
def list_users_1(
    ...
    :param int offset: Skip a number of results
    :param bool includeDeleted: Include deleted users:param json:
    :param verify: path to a certificate bundle or boolean indicating whether SSL
    verification should be performed.
    :param apiKey: Argus API key.
    :param authentication: authentication override
...
def move_user(
    ...
    :param str shortNameOrID: Short name or ID of user
    :param str domain: Domain ID or short name (optional, defaults to current user domain)
    :param str customer: ID or shortname of customer to move the subject to. The customer must be in same domain as the subject. :param json:
    :param verify: path to a certificate bundle or boolean indicating whether SSL
    verification should be performed.
    :param apiKey: Argus API key.
    :param authentication: authentication override
...
def search_users(
    ...
    :param int offset: The amount of items to skip (default 0):param json:
    :param verify: path to a certificate bundle or boolean indicating whether SSL
    verification should be performed.
    :param apiKey: Argus API key.
    :param authentication: authentication override
...
def set_user_image(
    ...
    :param str mimeType: The MIME type of the image :param json:
    :param verify: path to a certificate bundle or boolean indicating whether SSL
    verification should be performed.
    :param apiKey: Argus API key.
    :param authentication: authentication override
...
def update_user(
    ...
    :param bool daemonAccount: If set, change the daemon flag for this user :param json:
    :param verify: path to a certificate bundle or boolean indicating whether SSL
    verification should be performed.
    :param apiKey: Argus API key.
    :param authentication: authentication override
