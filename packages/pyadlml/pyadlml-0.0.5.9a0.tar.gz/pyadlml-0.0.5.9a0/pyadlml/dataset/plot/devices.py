...
from pyadlml.dataset.plot.util import heatmap_square, hm_key_NN, \
    func_formatter_sec, heatmap, annotate_heatmap, savefig
...
def boxsplot_on_duration(df_dev, figsize=None, file_path=None):
    """
...
def heatmap_trigger_time(df_dev=None, df_tcorr=None, t_window='5s', figsize=None, z_scale=None, file_path=None):
    """
    """
