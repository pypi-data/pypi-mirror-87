 ...
 * \brief Provides methods to run implementations of the adaptive gradient descent algorithm.    \DAAL_DEPRECATED
 ...
 * \brief Computes Adaptive gradient descent in the batch processing mode.     \DAAL_DEPRECATED
