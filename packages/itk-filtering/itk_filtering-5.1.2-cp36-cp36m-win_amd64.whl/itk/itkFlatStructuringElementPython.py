...
class itkFlatStructuringElement2(itk.itkNeighborhoodPython.itkNeighborhoodB2):
    ...
    {Filtering/MathematicalMorphology/ErodeBinaryImageUsingFlatStruct,Erod
    e Binary Image Using Flat Structure Element}   {Filtering/Mathematical
    Morphology/GenerateStructureElementsWithAccurateArea,Generate
    Structuring Elements With Accurate Area} 
    """
