...
setup(
  ...
  packages = ['jpe',
              ...
              "jpe/math",
              "jpe/math/linalg",
              "jpe/math/linalg/linearEquasions",
              "jpe/math/framework/algorythems",
              "jpe/random",
              "jpe/utils/unicode",
              "jpe/utils/copy"],   # Chose the same as "name"
  version = '0.1.0.2.3',      # Start with a small number and increase it with every change you make
  ...
  download_url = 'https://github.com/JulianWww/jpe/archive/0.1.0.2.2.1.tar.gz',    # I explain this later on
