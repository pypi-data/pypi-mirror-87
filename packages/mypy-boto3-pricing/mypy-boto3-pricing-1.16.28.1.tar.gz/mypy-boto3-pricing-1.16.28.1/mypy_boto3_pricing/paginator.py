...
class DescribeServicesPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [DescribeServices.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.16.28/reference/services/pricing.html#Pricing.Paginator.DescribeServices.paginate)
        """
...
class GetAttributeValuesPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [GetAttributeValues.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.16.28/reference/services/pricing.html#Pricing.Paginator.GetAttributeValues.paginate)
        """
...
class GetProductsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [GetProducts.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.16.28/reference/services/pricing.html#Pricing.Paginator.GetProducts.paginate)
        """
