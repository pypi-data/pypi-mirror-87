...
class JobApi(object):
    ...
    def api_job_id_add_models_post(self, id, **kwargs):  # noqa: E501
        """Add ML models to the job  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api_job_id_add_models_post(id, async_req=True)
        >>> result = thread.get()
        ...
        return self.api_job_id_add_models_post_with_http_info(id, **kwargs)  # noqa: E501

    def api_job_id_add_models_post_with_http_info(self, id, **kwargs):  # noqa: E501
        """Add ML models to the job  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api_job_id_add_models_post_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    ...
                    " to method api_job_id_add_models_post" % key
                )
        ...
        if self.api_client.client_side_validation and ('id' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `id` when calling `api_job_id_add_models_post`")  # noqa: E501
