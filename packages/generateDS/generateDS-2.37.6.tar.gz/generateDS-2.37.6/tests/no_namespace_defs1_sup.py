...
class peopleType(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, person=None, specialperson=None, gds_collector_=None, **kwargs_):
...
class personType(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, value=None, id=None, ratio=None, name=None, interest=None, category=None, description=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
