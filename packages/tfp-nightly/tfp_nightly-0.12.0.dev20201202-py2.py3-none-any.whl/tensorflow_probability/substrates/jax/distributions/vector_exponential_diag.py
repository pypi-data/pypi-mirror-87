...
#   `tensorflow_probability/substrates/jax/distributions/vector_exponential_diag.py`
...
from tensorflow_probability.substrates.jax.distributions import vector_exponential_linear_operator as velo
