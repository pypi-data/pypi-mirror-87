...
#   `tensorflow_probability/substrates/numpy/distributions/johnson_su.py`
...
from tensorflow_probability.substrates.numpy.bijectors import sinh as sinh_bijector
