...
class DeltaPDException(Exception):
    """Base exception for all DeltaPD exceptions thrown."""

    def __init__(self, message=''):
        Exception.__init__(self, message)


class DeltaPDExit(Exception):
    """Raised when the program is asked to exit gracefully."""
