...
from .rich_text import (
    AnchorEntityElementHandler,
    AnchorIndentifierEntityElementHandler,
    FootnoteEntityElementHandler,
    anchor_entity_decorator,
    anchor_identifier_entity_decorator,
    footnote_entity_decorator,
)
...
# "kdl_wagtail_draftail/js/footnote.js",
# ]
...
def register_footnote_feature(features):
    ...
    and is stored as HTML with an `<div>` tag."""
    ...
    features.register_converter_rule(
        ...
        {
            "from_database_format": {
                "div.footnote": FootnoteEntityElementHandler(type_)
            },
            "to_database_format": {
                "block_map": {type_: {"element": "div", "props": {"class": "footnote"}}}
            },
        },
    )
