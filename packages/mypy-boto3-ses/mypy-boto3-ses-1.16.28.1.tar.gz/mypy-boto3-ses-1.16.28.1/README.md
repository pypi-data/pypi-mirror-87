...
[boto3.SES 1.16.28](https://boto3.amazonaws.com/v1/documentation/api/1.16.28/reference/services/ses.html#SES) service
compatible with
...
- Install `boto-stubs[ses]` in your environment: `python -m pip install 'boto3-stubs[ses]'`

Both type checking and auto-complete should work for `SES` service.
...
Type checking should work for `SES` service.
No explicit type annotations required, write your `boto3` code as usual.
