...
class Data(object):
    ...
    @staticmethod
    def find(table, conditions, fields=('*',), or_cond=None, order=None, show_sql=False,base_id='default',show_manager_id=False):
        if show_manager_id is True:
            print('本次任务通过',base_id,'执行')
    ...
    @staticmethod
    def select(table, conditions, fields=('*',),or_cond=None, group=None, order=None, limit=None, show_sql=False,base_id='default',show_manager_id=False):
        if show_manager_id is True:
            print('本次任务通过',base_id,'执行')
    ...
    @staticmethod
    def update(table, conditions, params=None, or_cond=None,is_commit=True, show_sql=False,base_id='default',show_manager_id=False):
        if show_manager_id is True:
            print('本次任务通过',base_id,'执行')
        # print(params)
        Data.Base_pool[base_id].update(table, conditions,or_cond, params,is_commit, show_sql) if base_id in Data.Base_pool else None
        return
    ...
    @staticmethod
    def query(sql, show_sql=False,base_id='default',show_manager_id=False,is_commit = True):
        if show_manager_id is True:
            print('本次任务通过',base_id,'执行')
        return Data.Base_pool[base_id].query(sql, show_sql,is_commit) if base_id in Data.Base_pool else None
