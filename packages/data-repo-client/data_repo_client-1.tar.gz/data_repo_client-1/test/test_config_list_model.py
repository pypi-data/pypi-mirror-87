...
from openapi_client.models.config_list_model import ConfigListModel  # noqa: E501
from openapi_client.rest import ApiException

class TestConfigListModel(unittest.TestCase):
    """ConfigListModel unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test ConfigListModel
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = openapi_client.models.config_list_model.ConfigListModel()  # noqa: E501
        if include_optional :
            return ConfigListModel(
                total = 56, 
                items = [
                    openapi_client.models.config_model.ConfigModel(
                        name = '0', 
                        config_type = 'fault', 
                        fault = openapi_client.models.config_fault_model.ConfigFaultModel(
                            enabled = True, 
                            fault_type = 'simple', 
                            counted = openapi_client.models.config_fault_counted_model.ConfigFaultCountedModel(
                                skip_for = 56, 
                                insert = 56, 
                                rate = 56, 
                                rate_style = 'fixed', ), ), 
                        parameter = openapi_client.models.config_parameter_model.ConfigParameterModel(
                            value = '0', ), )
                    ]
            )
        else :
