...
acdb_leader = DefSubclass('AcDbLeader', {
    ...
    'horizontal_direction': DXFAttr(
        211, xtype=XType.point3d, default=X_AXIS, optional=True,
        validator=validator.is_not_null_vector,
        fixer=RETURN_DEFAULT,
    ),
...
class Leader(DXFGraphic, OverrideMixin):
    ...
    def export_entity(self, tagwriter: 'TagWriter') -> None:
        ...
        self.dxf.export_dxf_attribs(tagwriter, [
            'dimstyle', 'has_arrowhead', 'path_type', 'annotation_type',
            'hookline_direction', 'has_hookline', 'text_height', 'text_width',
        ])
