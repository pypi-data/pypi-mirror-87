...
class DataViewRowFormat(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, header, bold, *args, **kwargs):  # noqa: E501
        """DataViewRowFormat - a model defined in OpenAPI
