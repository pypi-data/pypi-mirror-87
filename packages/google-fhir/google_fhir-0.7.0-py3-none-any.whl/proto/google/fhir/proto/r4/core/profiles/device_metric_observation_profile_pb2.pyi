...
class DeviceMetricObservationProfile(google___protobuf___message___Message):
    ...
    class ValueX(google___protobuf___message___Message):
        ...
        def HasField(self, field_name: typing_extensions___Literal[u"choice",b"choice",u"codeable_concept",b"codeable_concept",u"date_time",b"date_time",u"period",b"period",u"quantity",b"quantity",u"range",b"range",u"ratio",b"ratio",u"sampled_data",b"sampled_data",u"string_value",b"string_value",u"time",b"time"]) -> builtin___bool: ...
        def ClearField(self, field_name: typing_extensions___Literal[u"choice",b"choice",u"codeable_concept",b"codeable_concept",u"date_time",b"date_time",u"period",b"period",u"quantity",b"quantity",u"range",b"range",u"ratio",b"ratio",u"sampled_data",b"sampled_data",u"string_value",b"string_value",u"time",b"time"]) -> None: ...
        def WhichOneof(self, oneof_group: typing_extensions___Literal[u"choice",b"choice"]) -> typing_extensions___Literal["quantity","codeable_concept","string_value","range","ratio","sampled_data","time","date_time","period"]: ...
    ...
    class Component(google___protobuf___message___Message):
        ...
        @property
        def value(self) -> type___DeviceMetricObservationProfile.Component.ValueX: ...
        ...
        @property
        def reference_range(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[type___DeviceMetricObservationProfile.ReferenceRange]: ...
        ...
        def __init__(self,
            *,
            ...
            value : typing___Optional[type___DeviceMetricObservationProfile.Component.ValueX] = None,
            ...
            reference_range : typing___Optional[typing___Iterable[type___DeviceMetricObservationProfile.ReferenceRange]] = None,
            ) -> None: ...
    ...
    @property
    def status(self) -> type___DeviceMetricObservationProfile.StatusCode: ...
    ...
    @property
    def effective(self) -> type___DeviceMetricObservationProfile.EffectiveX: ...
    ...
    @property
    def value(self) -> type___DeviceMetricObservationProfile.ValueX: ...
    ...
    @property
    def reference_range(self) -> type___DeviceMetricObservationProfile.ReferenceRange: ...
    ...
    @property
    def component(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[type___DeviceMetricObservationProfile.Component]: ...
    ...
    def __init__(self,
        *,
        ...
        status : typing___Optional[type___DeviceMetricObservationProfile.StatusCode] = None,
        ...
        effective : typing___Optional[type___DeviceMetricObservationProfile.EffectiveX] = None,
        performer : typing___Optional[typing___Iterable[proto___google___fhir___proto___r4___core___datatypes_pb2___Reference]] = None,
        value : typing___Optional[type___DeviceMetricObservationProfile.ValueX] = None,
        ...
        reference_range : typing___Optional[type___DeviceMetricObservationProfile.ReferenceRange] = None,
        ...
        component : typing___Optional[typing___Iterable[type___DeviceMetricObservationProfile.Component]] = None,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions___Literal[u"body_site",b"body_site",u"code",b"code",u"device",b"device",u"effective",b"effective",u"id",b"id",u"implicit_rules",b"implicit_rules",u"interpretation",b"interpretation",u"language",b"language",u"meta",b"meta",u"method",b"method",u"reference_range",b"reference_range",u"status",b"status",u"subject",b"subject",u"text",b"text",u"value",b"value"]) -> builtin___bool: ...
    def ClearField(self, field_name: typing_extensions___Literal[u"based_on",b"based_on",u"body_site",b"body_site",u"category",b"category",u"code",b"code",u"component",b"component",u"contained",b"contained",u"derived_from",b"derived_from",u"device",b"device",u"effective",b"effective",u"extension",b"extension",u"focus",b"focus",u"has_member",b"has_member",u"id",b"id",u"identifier",b"identifier",u"implicit_rules",b"implicit_rules",u"interpretation",b"interpretation",u"language",b"language",u"meta",b"meta",u"method",b"method",u"modifier_extension",b"modifier_extension",u"note",b"note",u"part_of",b"part_of",u"performer",b"performer",u"reference_range",b"reference_range",u"status",b"status",u"subject",b"subject",u"text",b"text",u"value",b"value"]) -> None: ...
type___DeviceMetricObservationProfile = DeviceMetricObservationProfile
