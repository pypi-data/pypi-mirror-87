...
#   `tensorflow_probability/substrates/jax/bijectors/lambertw_transform.py`
...
from tensorflow_probability.substrates.jax.bijectors import scale as tfb_scale
from tensorflow_probability.substrates.jax.bijectors import shift as tfb_shift
