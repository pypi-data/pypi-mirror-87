...
class InputPort(object):
    ...
    def bind_mode(self, value):
        ...
        if value not in {"mount", "download", "direct"}:
...
class InputPortBinding(object):
    ...
    :type bind_object: azureml.pipeline.core.PortDataReference or
                       azureml.data.data_reference.DataReference or
                       azureml.pipeline.core.PipelineData or
                       azureml.pipeline.core.OutputPortBinding or
                       azureml.pipeline.core.PipelineDataset
    ...
    def __init__(self, name, bind_object=None, bind_mode="mount", path_on_compute=None, overwrite=None,
        ...
        # TODO: rationalize these!
        if bind_mode not in {"mount", "download", "direct"}:
    ...
    def bind_mode(self):
        """
        Get the mode ("download" or "mount" or "direct") the consuming step will use to access the data.

        :return: The bind mode ("download" or "mount" or "direct").
        :rtype: str
        """
        return self._bind_mode
    ...
    def bind_object(self):
        ...
        :rtype: azureml.pipeline.core.PortDataReference or
                azureml.data.data_reference.DataReference or
                azureml.pipeline.core.PipelineData or
                azureml.pipeline.core.OutputPortBinding or
                azureml.pipeline.core.PipelineDataset
...
class OutputPortBinding(object):
    ...
    :param dataset_output: Optional. This is an internal parameter. You should be using OutputFileDatasetConfig
        intead.
    :type dataset_output: azureml.core.data.output_dataset_config.OutputDatasetConfig
    """
    ...
    def datastore(self, value):
        ...
        :type value: azureml.data.azure_storage_datastore.AbstractAzureStorageDatastore or
            azureml.data.azure_data_lake_datastore.AzureDataLakeDatastore
        """
...
class PipelineDataset(object):
    ...
    def __init__(self, dataset=None, name=None, bind_mode="mount", path_on_compute=None, overwrite=False,
        ...
        :param dataset: The dataset that will be used as the input to the step.
        :type dataset: azureml.core.Datase or azureml.data.abstract_dataset.AbstractDataset
            or azureml.data.output_dataset_config.OutputDatasetConfigt
        :param name: The name of the input in the pipeline.
        :type name: str
        :param bind_mode: How the dataset should be made available, either mount or download.
        :type bind_mode: str
    ...
    def dataset(self):
        ...
        :return: The dataset.
        :rtype: azureml.core.Dataset or azureml.data.abstract_dataset.AbstractDataset
    ...
    def validate_dataset(dset):
        ...
        :type dset: azureml.core.Dataset or
    ...
    def create(dataset, name=None, parameter_name=None):
        ...
        :type dataset: azureml.core.Dataset
            ...
            or azureml.pipeline.core.graph.PipelineDataset
