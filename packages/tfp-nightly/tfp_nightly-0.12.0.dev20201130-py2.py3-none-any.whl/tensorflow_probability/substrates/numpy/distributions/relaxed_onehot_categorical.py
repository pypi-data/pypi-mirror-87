...
#   `tensorflow_probability/substrates/numpy/distributions/relaxed_onehot_categorical.py`
...
from tensorflow_probability.substrates.numpy.bijectors import exp as exp_bijector
