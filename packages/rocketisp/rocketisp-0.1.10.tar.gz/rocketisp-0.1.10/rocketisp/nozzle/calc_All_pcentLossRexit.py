...
npz_filename =  os.path.join( here, 'calc_All_pcentLossRexit.npz')
...
if __name__ == "__main__":
    ...
    ypred = calc_pcentLossRexit(ceaObj, Pc=500, eps=20, Rthrt=1, pcentBell=80, MR=2)
    print( 'ypred pcentLossRexit =', ypred )
