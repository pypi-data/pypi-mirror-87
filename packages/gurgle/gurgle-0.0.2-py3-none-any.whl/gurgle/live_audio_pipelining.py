...
from gurgle.live_audio import launch_audio_tracking, DFLT_INPUT_DEVICE_INDEX
...
def mk_launcher(chk_to_fv=dflt_chk_to_fv,
                ...
                input_device_index=DFLT_INPUT_DEVICE_INDEX,
    ...
    pipe = Pipeline(launch_audio_tracking,
                    generator_version(output_callback))
