...
from algorithmia_api_client.models.inline_response400 import InlineResponse400  # noqa: E501
...
class TestInlineResponse400(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = algorithmia_api_client.models.inline_response400.InlineResponse400()  # noqa: E501
        if include_optional :
            return InlineResponse400(
                error = algorithmia_api_client.models.error.Error(
                    id = '0', 
                    code = 1001, 
                    message = '0', )
            )
