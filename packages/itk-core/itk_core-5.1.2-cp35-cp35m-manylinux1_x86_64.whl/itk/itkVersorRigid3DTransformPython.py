...
if __package__ or "." in __name__:
    from . import _itkVersorRigid3DTransformPython
else:
...
_swig_new_instance_method = _itkVersorRigid3DTransformPython.SWIG_PyInstanceMethod_New
_swig_new_static_method = _itkVersorRigid3DTransformPython.SWIG_PyStaticMethod_New
...
class itkVersorRigid3DTransformD(itk.itkVersorTransformPython.itkVersorTransformD):
    ...
    __repr__ = _swig_repr
    __New_orig__ = _swig_new_static_method(_itkVersorRigid3DTransformPython.itkVersorRigid3DTransformD___New_orig__)
    Clone = _swig_new_instance_method(_itkVersorRigid3DTransformPython.itkVersorRigid3DTransformD_Clone)
    UpdateTransformParameters = _swig_new_instance_method(_itkVersorRigid3DTransformPython.itkVersorRigid3DTransformD_UpdateTransformParameters)
    __swig_destroy__ = _itkVersorRigid3DTransformPython.delete_itkVersorRigid3DTransformD
    cast = _swig_new_static_method(_itkVersorRigid3DTransformPython.itkVersorRigid3DTransformD_cast)
...
# Register itkVersorRigid3DTransformD in _itkVersorRigid3DTransformPython:
_itkVersorRigid3DTransformPython.itkVersorRigid3DTransformD_swigregister(itkVersorRigid3DTransformD)
itkVersorRigid3DTransformD___New_orig__ = _itkVersorRigid3DTransformPython.itkVersorRigid3DTransformD___New_orig__
itkVersorRigid3DTransformD_cast = _itkVersorRigid3DTransformPython.itkVersorRigid3DTransformD_cast
