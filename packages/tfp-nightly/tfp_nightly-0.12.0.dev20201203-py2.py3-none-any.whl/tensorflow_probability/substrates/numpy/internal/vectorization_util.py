...
from tensorflow_probability.substrates.numpy.util import SeedStream
from tensorflow_probability.python.internal.backend.numpy import functional_ops as parallel_for  # pylint: disable=g-direct-tensorflow-import
...
#   `tensorflow_probability/substrates/numpy/internal/vectorization_util.py`
