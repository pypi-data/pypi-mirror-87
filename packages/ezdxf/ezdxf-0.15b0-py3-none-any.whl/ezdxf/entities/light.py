...
class Light(DXFGraphic):
    ...
    def export_entity(self, tagwriter: 'TagWriter') -> None:
        ...
        self.dxf.export_dxf_attribs(tagwriter, [
            'version', 'name', 'type', 'status', 'plot_glyph', 'intensity',
            'location', 'target', 'attenuation_type', 'use_attenuation_limits',
            'attenuation_start_limits', 'attenuation_end_limits',
            'hotspot_angle', 'falloff_angle', 'cast_shadows', 'shadow_type',
            'shadow_map_size', 'shadow_map_softness'
        ])
