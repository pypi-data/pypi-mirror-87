...
snake_case_functions = ('fft_normalized_correlation_image_filter', 'fft_convolution_image_filter', 'convolution_image_filter_base', 'masked_fft_normalized_correlation_image_filter', 'convolution_image_filter', )
