...
def lazy_import():
    ...
    globals()['DataViewColumns'] = DataViewColumns
    globals()['DataViewRows'] = DataViewRows


class DataView(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'columns': ([DataViewColumns],),  # noqa: E501
            'rows': ([DataViewRows],),  # noqa: E501
        }
    ...
    @convert_js_args_to_python_args
    def __init__(self, title, borrower_uuid, columns, rows, *args, **kwargs):  # noqa: E501
        """DataView - a model defined in OpenAPI

        Args:
            title (str):
            borrower_uuid (str): UUID of the borrower for this DataView. (see [Borrowers](#tag/Borrowers))
