...
#   `tensorflow_probability/substrates/jax/optimizer/linesearch/hager_zhang.py`
...
from tensorflow_probability.substrates.jax.optimizer.linesearch.internal import hager_zhang_lib as hzl
