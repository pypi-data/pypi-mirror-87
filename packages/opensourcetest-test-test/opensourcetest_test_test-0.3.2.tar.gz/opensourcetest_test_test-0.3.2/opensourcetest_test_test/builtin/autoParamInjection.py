...
from opensourcetest_test_test.builtin.locate import get_locator
...
if __name__ == '__main__':
    if os.path.dirname(__file__).find("opensourcetest_test_test") != -1:
        logging.info(os.path.dirname(__file__).find("opensourcetest_test_test"))
