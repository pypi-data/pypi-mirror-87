...
class ModelServerRequestBase(Model):
    """
    A class used to encapsulate all of the specifications of a custom Model Server
    ...
    serving_group -- serving group to assign model server pods to
    ...
    def __init__(
        ...
        self.serving_group = serving_group
        self.description = description
...
class ModelServerCreateRequest(ModelServerRequestBase):
    """
    A class used to encapsulate all of the specifications to create a custom Model Server
    ...
    # but additional server_name field, but using a base class gives us some type safety.
...
class ModelServerUpdateRequest(ModelServerRequestBase):
    """
    A class used to encapsulate all of the specifications to update a custom Model Server
...
class ModelServerPod(Model):
    ...
    def __init__(self, id, created_at, ready_at=None, **kwargs):
        self.id = id
        self.created_at = created_at
...
class BatchingConfig(Model):
    ...
    compare_fields = ["is_enabled", "max_batch_size", "request_timeout"]

    def __init__(self, max_batch_size=None, request_timeout=None, is_enabled=False, **kwargs):
...
class ModelServer(Model):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.serving_group_name = serving_group_name
        self.creator = creator
        self.resource_requirements = resource_requirements
        self.pod_autoscale_config = pod_autoscale_config
