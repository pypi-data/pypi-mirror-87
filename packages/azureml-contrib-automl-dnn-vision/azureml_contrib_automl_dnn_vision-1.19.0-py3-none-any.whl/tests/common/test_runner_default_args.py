...
@patch('azureml.contrib.automl.dnn.vision.classification.runner.download_required_files')
...
@patch('azureml.contrib.automl.dnn.vision.object_detection.runner.download_required_files')
