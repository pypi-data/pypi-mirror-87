...
import agilicus_api
from agilicus_api.models.list_combined_rules_response import ListCombinedRulesResponse  # noqa: E501
...
class TestListCombinedRulesResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = agilicus_api.models.list_combined_rules_response.ListCombinedRulesResponse()  # noqa: E501
        if include_optional :
            return ListCombinedRulesResponse(
                limit = 56, 
                combined_rules = [
                    agilicus_api.models.combined_rules.CombinedRules(
