...
from tensorflow_probability.substrates.jax.mcmc.internal import slice_sampler_utils as ssu
...
#   `tensorflow_probability/substrates/jax/mcmc/slice_sampler_kernel.py`
