...
#   `tensorflow_probability/substrates/jax/distributions/poisson.py`
...
from tensorflow_probability.substrates.jax.internal import batched_rejection_sampler as brs
