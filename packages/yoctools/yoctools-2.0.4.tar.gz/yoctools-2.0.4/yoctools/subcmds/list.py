...
"""
    ...
    def Execute(self, opt, args):
        ...
        for c in components:
            if count == 0 or c.name in args:
                if show:
                    if (opt.board and c.type == 'board') or (opt.chip and c.type == 'chip') or (opt.common and c.type == 'common') or (opt.solution and c.type == 'solution') or (opt.sdk and c.type == 'sdk'):
