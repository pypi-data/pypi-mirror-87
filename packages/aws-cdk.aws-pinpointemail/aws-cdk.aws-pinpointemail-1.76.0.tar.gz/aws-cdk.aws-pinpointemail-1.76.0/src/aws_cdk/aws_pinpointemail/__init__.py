...
class CfnConfigurationSet(
    ...
    @delivery_options.setter # type: ignore
    def delivery_options(
        self,
    ...
    @reputation_options.setter # type: ignore
    def reputation_options(
        self,
    ...
    @sending_options.setter # type: ignore
    def sending_options(
        self,
    ...
    @tracking_options.setter # type: ignore
    def tracking_options(
        self,
...
class CfnConfigurationSetEventDestination(
    ...
    @event_destination_name.setter # type: ignore
...
class CfnIdentity(
    ...
    @dkim_signing_enabled.setter # type: ignore
    def dkim_signing_enabled(
        self,
    ...
    @feedback_forwarding_enabled.setter # type: ignore
    def feedback_forwarding_enabled(
        self,
        value: typing.Optional[typing.Union[builtins.bool, aws_cdk.core.IResolvable]],
    ) -> None:
    ...
    @mail_from_attributes.setter # type: ignore
    def mail_from_attributes(
        self,
