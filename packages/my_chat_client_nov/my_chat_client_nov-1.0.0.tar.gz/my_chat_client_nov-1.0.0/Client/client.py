...
from client.database.client_database import ClientDB
from client.transport import ClientTransport
from client.interface.main_window import ClientMainWindow
from client.interface.start_dialog import UserNameDialog
...
if __name__ == '__main__':
    ...
    key_file = os.path.join(dir_path, 'client/keys/', f'{client_name}.key')
