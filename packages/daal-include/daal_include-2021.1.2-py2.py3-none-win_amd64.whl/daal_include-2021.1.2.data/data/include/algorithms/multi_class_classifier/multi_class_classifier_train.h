 ...
 *  \brief Class containing methods to compute the results of multi-class classifier model-based training  \DAAL_DEPRECATED
 *
 ...
 * \brief Algorithm for the multi-class classifier model training   \DAAL_DEPRECATED
