...
class StorageObject(object):
    ...
    def name(self, name):
        ...
        if (name is not None and not re.search(r'[A-Za-z0-9_-]+[A-Za-z0-9 _-]*\.*[A-Za-z0-9]+', name)):  # noqa: E501
            raise ValueError(r"Invalid value for `name`, must be a follow pattern or equal to `/[A-Za-z0-9_-]+[A-Za-z0-9 _-]*\.*[A-Za-z0-9]+/`")  # noqa: E501
