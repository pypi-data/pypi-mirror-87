...
class itkBinaryContourImageFilterID2ID2(itk.itkInPlaceImageFilterAPython.itkInPlaceImageFilterID2ID2):
    ...
    example{Filtering/ImageLabel/ExtractBoundariesOfConnectedRegionsIn
    BinaryImage,Extract Boundaries Of Connected Regions In Binary Image}
    example{Filtering/ImageLabel/ExtractBoundariesOfBlobsInBinaryImage,Ext
    ract Inner And Outer Boundaries Of Blobs In Binary Image} 
    """
