...
from symbol_openapi_client.models.account_ids import AccountIds  # noqa: E501
...
class TestAccountIds(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = symbol_openapi_client.models.account_ids.AccountIds()  # noqa: E501
        if include_optional :
            return AccountIds(
                public_keys = [
                ...
                addresses = [
                    'SAAA244WMCB2JXGNQTQHQOS45TGBFF4V2MJBVOQ'
                    ]
            )
        else :
            return AccountIds(
