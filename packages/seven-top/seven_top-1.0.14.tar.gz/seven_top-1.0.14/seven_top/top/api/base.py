...
@LastEditTime: 2020-08-11 11:47:31
...
SYSTEM_GENERATE_VERSION = "taobao-sdk-python-20200811"
...
class RestApi(object):
    ...
    def getResponse(self, authrize=None, timeout=30):
        ...
        #=======================================================================
        if (self.__port == 443):
            connection = httplib.HTTPSConnection(host=self.__domain, port=self.__port, timeout=timeout)
        else:
