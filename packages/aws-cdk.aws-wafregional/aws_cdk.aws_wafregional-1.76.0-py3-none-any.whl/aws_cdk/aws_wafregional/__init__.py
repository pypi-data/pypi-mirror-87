...
class CfnGeoMatchSet(
    ...
    @geo_match_constraints.setter # type: ignore
    def geo_match_constraints(
        self,
...
class CfnRateBasedRule(
    ...
    @match_predicates.setter # type: ignore
    def match_predicates(
        self,
...
class CfnRegexPatternSet(
    ...
    @regex_pattern_strings.setter # type: ignore
