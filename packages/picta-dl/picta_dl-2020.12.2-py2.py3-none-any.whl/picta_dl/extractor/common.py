...
class InfoExtractor(object):
    ...
    webpage_url:    The URL to the video webpage, if given to picta-dl it
    ...
    def _parse_f4m_formats(self, manifest, manifest_url, video_id, preference=None, f4m_id=None,
        ...
        # currently picta-dl cannot decode the playerVerificationChallenge as Akamai uses Adobe Alchemy
