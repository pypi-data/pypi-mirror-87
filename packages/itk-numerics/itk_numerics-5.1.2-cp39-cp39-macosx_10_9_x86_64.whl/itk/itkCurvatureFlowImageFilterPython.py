...
class itkCurvatureFlowImageFilterID2ID2(itk.itkDenseFiniteDifferenceImageFilterPython.itkDenseFiniteDifferenceImageFilterID2ID2):
    ...
    example{Filtering/CurvatureFlow/SmoothImageUsingCurvatureFlow,Smooth
    Image Using Curvature Flow}  example{Filtering/CurvatureFlow/SmoothRGB
    ImageUsingCurvatureFlow,Smooth RGB Image Using Curvature Flow} 
    """
