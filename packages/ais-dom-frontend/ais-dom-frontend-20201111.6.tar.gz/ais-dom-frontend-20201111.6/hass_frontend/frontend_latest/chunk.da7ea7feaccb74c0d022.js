...
(self.webpackChunkhome_assistant_frontend=self.webpackChunkhome_assistant_frontend||[]).push([[4122],{59947:(e,t,r)=>{"use strict";var i=r(87480),n=r(15652),o=(r(66702),r(98734)),a=r(81471);class s extends n.oi{constructor(){super(...arguments),this.mini=!1,this.exited=!1,this.disabled=!1,this.extended=!1,this.showIconAtEnd=!1,this.reducedTouchTarget=!1,this.icon="",this.label="",this.shouldRenderRipple=!1,this.rippleHandlers=new o.A((()=>(this.shouldRenderRipple=!0,this.ripple)))}createRenderRoot(){return this.attachShadow({mode:"open",delegatesFocus:!0})}render(){const e=this.mini&&!this.reducedTouchTarget,t={"mdc-fab--mini":this.mini,"mdc-fab--touch":e,"mdc-fab--exited":this.exited,"mdc-fab--extended":this.extended,"icon-end":this.showIconAtEnd},r=this.label?this.label:this.icon;return n.dy`
      ...
      >
        ...
        <div class="container">
          ...
          <div class="column">
            ${(0,p.p)(this.hass,"automation")?i.dy`
                  <ha-card
                    .header=${this.hass.localize("ui.panel.config.devices.automation.automations")}
                    >${(null===(e=this._related)||void 0===e||null===(t=e.automation)||void 0===t?void 0:t.length)?this._related.automation.map((e=>{const t=this.hass.states[e];return t?i.dy`
                                <div>
                                  <a
          ...
          <div class="column">
            ${(0,p.p)(this.hass,"scene")?i.dy`
                  <ha-card
                    .header=${this.hass.localize("ui.panel.config.devices.scene.scenes")}
                    >${(null===(r=this._related)||void 0===r||null===(n=r.scene)||void 0===n?void 0:n.length)?this._related.scene.map((e=>{const t=this.hass.states[e];return t?i.dy`
                                <div>
                                  <a
                ...
                `:""}
            ${(0,p.p)(this.hass,"script")?i.dy`
                  <ha-card
                    .header=${this.hass.localize("ui.panel.config.devices.script.scripts")}
                    >${(null===(o=this._related)||void 0===o||null===(a=o.script)||void 0===a?void 0:a.length)?this._related.script.map((e=>{const t=this.hass.states[e];return t?i.dy`
                                <a
    ...
    `}},{kind:"method",key:"_findRelated",value:async function(){this._related=await(0,h.K)(this.hass,"area",this.areaId)}},{kind:"method",key:"_showSettings",value:function(e){const t=e.currentTarget.entry;this._openDialog(t)}},{kind:"method",key:"_openDialog",value:function(e){g(this,{entry:e,updateEntry:async t=>(0,o.IO)(this.hass,e.area_id,t),removeEntry:async()=>{if(!(await(0,u.g7)(this,{title:this.hass.localize("ui.panel.config.areas.delete.confirmation_title"),text:this.hass.localize("ui.panel.config.areas.delete.confirmation_text"),dismissText:this.hass.localize("ui.common.cancel"),confirmText:this.hass.localize("ui.common.delete")})))return!1;try{return await(0,o.qv)(this.hass,e.area_id),!0}catch(t){return!1}}})}},{kind:"get",static:!0,key:"styles",value:function(){return[m.Qx,i.iv`
        h1 {
          margin-top: 0;
      ...
      >
        ...
        >
          <ha-svg-icon slot="icon" .path=${$.qX5}></ha-svg-icon>
        </mwc-fab>
      </hass-tabs-subpage-data-table>
    `}},{kind:"method",key:"firstUpdated",value:function(e){M(L(r.prototype),"firstUpdated",this).call(this,e),v()}},{kind:"method",key:"_createArea",value:function(){this._openDialog()}},{kind:"method",key:"_showHelp",value:function(){(0,u.Ys)(this,{title:this.hass.localize("ui.panel.config.areas.caption"),text:i.dy`
    ...
    `}}]}}),i.oi)}}]);
//# sourceMappingURL=chunk.da7ea7feaccb74c0d022.js.map