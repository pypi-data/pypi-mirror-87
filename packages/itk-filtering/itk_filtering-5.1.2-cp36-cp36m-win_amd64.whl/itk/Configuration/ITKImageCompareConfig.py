...
snake_case_functions = ('squared_difference_image_filter', 'staple_image_filter', 'checker_board_image_filter', 'absolute_value_difference_image_filter', 'similarity_index_image_filter', )
