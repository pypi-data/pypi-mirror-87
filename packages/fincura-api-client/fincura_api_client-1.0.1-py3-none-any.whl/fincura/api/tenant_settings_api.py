...
class TenantSettingsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        def __read_tenant_settings(
            self,
            **kwargs
        ):
            """Get Tenant Settings  # noqa: E501

            Read Tenant Settings  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True

            >>> thread = api.read_tenant_settings(async_req=True)
            >>> result = thread.get()
        ...
        self.read_tenant_settings = Endpoint(
            settings={
                'response_type': (TenantSettings,),
                'auth': [
                    'API_Key'
                ],
                'endpoint_path': '/v1/tenant-settings/read',
                'operation_id': 'read_tenant_settings',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
            ...
            callable=__read_tenant_settings
        )
