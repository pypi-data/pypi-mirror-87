...
class WorkbookOutputV1(object):
    ...
    def __init__(self, ancestors=None, created_at=None, description=None, effective_permissions=None, href=None, id=None, is_archived=False, is_redacted=False, marked_as_favorite=False, name=None, owner=None, parent_folder_id=None, status_message=None, type=None, updated_at=None, worksheets=None):
        """
