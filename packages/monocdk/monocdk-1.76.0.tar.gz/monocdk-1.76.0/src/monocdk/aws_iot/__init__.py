...
class CfnAuthorizer(
    ...
    def __init__(
        ...
        *,
        ...
        token_signing_public_keys: typing.Optional[typing.Union["CfnAuthorizer.TokenSigningPublicKeysProperty", _IResolvable_a771d0ef]] = None,
    ) -> None:
    ...
    def token_signing_public_keys(
        self,
    ) -> typing.Optional[typing.Union["CfnAuthorizer.TokenSigningPublicKeysProperty", _IResolvable_a771d0ef]]:
    ...
    def token_signing_public_keys(
        self,
        value: typing.Optional[typing.Union["CfnAuthorizer.TokenSigningPublicKeysProperty", _IResolvable_a771d0ef]],
    ) -> None:
        jsii.set(self, "tokenSigningPublicKeys", value)

    @jsii.data_type(
        jsii_type="monocdk.aws_iot.CfnAuthorizer.TagsProperty",
        jsii_struct_bases=[],
    ...
    @jsii.data_type(
        jsii_type="monocdk.aws_iot.CfnAuthorizer.TokenSigningPublicKeysProperty",
        jsii_struct_bases=[],
        name_mapping={},
    )
...
class CfnDomainConfiguration(
    ...
    @jsii.data_type(
        jsii_type="monocdk.aws_iot.CfnDomainConfiguration.TagsProperty",
        jsii_struct_bases=[],
        name_mapping={"tags": "tags"},
    )
    class TagsProperty:
...
class CfnProvisioningTemplate(
    ...
    @jsii.data_type(
        jsii_type="monocdk.aws_iot.CfnProvisioningTemplate.TagsProperty",
        jsii_struct_bases=[],
        name_mapping={"tags": "tags"},
    )
    class TagsProperty:
