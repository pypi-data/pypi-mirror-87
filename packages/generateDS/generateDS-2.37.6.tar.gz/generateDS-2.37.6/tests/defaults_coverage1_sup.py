...
class DefaultTypes(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, default1=None, default2=None, gds_collector_=None, **kwargs_):
...
class DefaultType1(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, default01=23, normal01=None, default02='Peach', normal02=None, default03=23.45, normal03=None, default04=54.32, normal04=None, default05a=True, default05b=False, normal05=None, default06='2015-06-21', normal06=None, default07='11:10:09', normal07=None, default08='2015-06-21T14:13:12', normal08=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
        ...
        self.default05a_nsprefix_ = None
        self.default05b = default05b
        self.default05b_nsprefix_ = None
        self.normal05 = normal05
        self.normal05_nsprefix_ = None
    ...
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='DefaultType1', fromsubclass_=False, pretty_print=True):
        ...
        if not self.default05a:
            namespaceprefix_ = self.default05a_nsprefix_ + ':' if (UseCapturedNS_ and self.default05a_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
        ...
        if self.default05b:
            namespaceprefix_ = self.default05b_nsprefix_ + ':' if (UseCapturedNS_ and self.default05b_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
        ...
        if self.normal05 is not None:
            namespaceprefix_ = self.normal05_nsprefix_ + ':' if (UseCapturedNS_ and self.normal05_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
        ...
        if self.default06 != "2015-06-21":
            namespaceprefix_ = self.default06_nsprefix_ + ':' if (UseCapturedNS_ and self.default06_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
        ...
        if self.normal06 is not None:
            namespaceprefix_ = self.normal06_nsprefix_ + ':' if (UseCapturedNS_ and self.normal06_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
        ...
        if self.default07 != "11:10:09":
            namespaceprefix_ = self.default07_nsprefix_ + ':' if (UseCapturedNS_ and self.default07_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
        ...
        if self.normal07 is not None:
            namespaceprefix_ = self.normal07_nsprefix_ + ':' if (UseCapturedNS_ and self.normal07_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
        ...
        if self.default08 != "2015-06-21T14:13:12":
            namespaceprefix_ = self.default08_nsprefix_ + ':' if (UseCapturedNS_ and self.default08_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
        ...
        if self.normal08 is not None:
            namespaceprefix_ = self.normal08_nsprefix_ + ':' if (UseCapturedNS_ and self.normal08_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
