...
`,is:"paper-textarea",behaviors:[d.d0,l.V],properties:{_ariaLabelledBy:{observer:"_ariaLabelledByChanged",type:String},_ariaDescribedBy:{observer:"_ariaDescribedByChanged",type:String},value:{type:String},rows:{type:Number,value:1},maxRows:{type:Number,value:0}},get selectionStart(){return this.$.input.textarea.selectionStart},set selectionStart(e){this.$.input.textarea.selectionStart=e},get selectionEnd(){return this.$.input.textarea.selectionEnd},set selectionEnd(e){this.$.input.textarea.selectionEnd=e},_ariaLabelledByChanged:function(e){this._focusableElement.setAttribute("aria-labelledby",e)},_ariaDescribedByChanged:function(e){this._focusableElement.setAttribute("aria-describedby",e)},get _focusableElement(){return this.inputElement.textarea}})},51095:(e,t,a)=>{"use strict";a(43437);var i=a(78161),r=a(9672),o=a(50856);(0,r.k)({_template:o.d`
    ...
    <slot></slot>
`,is:"paper-listbox",behaviors:[i.i],hostAttributes:{role:"listbox"}})},58993:(e,t,a)=>{"use strict";a.d(t,{yh:()=>i,U2:()=>n,t8:()=>s,ZH:()=>l});class i{constructor(e="keyval-store",t="keyval"){this.storeName=t,this._dbp=new Promise(((a,i)=>{const r=indexedDB.open(e,1);r.onerror=()=>i(r.error),r.onsuccess=()=>a(r.result),r.onupgradeneeded=()=>{r.result.createObjectStore(t)}}))}_withIDBStore(e,t){return this._dbp.then((a=>new Promise(((i,r)=>{const o=a.transaction(this.storeName,e);o.oncomplete=()=>i(),o.onabort=o.onerror=()=>r(o.error),t(o.objectStore(this.storeName))}))))}}let r;function o(){return r||(r=new i),r}function n(e,t=o()){let a;return t._withIDBStore("readonly",(t=>{a=t.get(e)})).then((()=>a.result))}function s(e,t,a=o()){return a._withIDBStore("readwrite",(a=>{a.put(t,e)}))}function l(e=o()){return e._withIDBStore("readwrite",(e=>{e.clear()}))}}}]);
//# sourceMappingURL=chunk.0725c184adb87936848e.js.map