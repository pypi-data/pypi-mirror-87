...
class LoftedSurface(Surface):
    ...
    def export_entity(self, tagwriter: 'TagWriter') -> None:
        ...
        export_matrix(tagwriter, code=40,
                      matrix=self.transformation_matrix_lofted_entity)
...
class RevolvedSurface(Surface):
    ...
    def export_entity(self, tagwriter: 'TagWriter') -> None:
        ...
        self.dxf.export_dxf_attribs(tagwriter, [
            'class_id', 'axis_point', 'axis_vector', 'revolve_angle',
            'start_angle',
        ])
        export_matrix(tagwriter, code=42,
                      matrix=self.transformation_matrix_revolved_entity)
        self.dxf.export_dxf_attribs(tagwriter, [
            'draft_angle', 'start_draft_distance', 'end_draft_distance',
            'twist_angle', 'solid', 'close_to_axis',
        ])
...
class SweptSurface(Surface):
    ...
    def export_entity(self, tagwriter: 'TagWriter') -> None:
        ...
        export_matrix(tagwriter, code=41,
