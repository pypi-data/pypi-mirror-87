...
class itkMinMaxCurvatureFlowImageFilterID2ID2(itk.itkCurvatureFlowImageFilterPython.itkCurvatureFlowImageFilterID2ID2):
    ...
    example{Filtering/CurvatureFlow/SmoothImageUsingMinMaxCurvatureFlo
    w,Smooth Image Using Min Max Curvature Flow}  example{Filtering/Curvat
    ureFlow/SmoothRGBImageUsingMinMaxCurvatureFlow,SmoothRGBImageUsingMinM
    axCurvatureFlow} 
    """
