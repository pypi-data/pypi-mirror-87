...
@guvectorize([(float64[:], float64[:], float64[:], float64, float64[:], float64[:], float64[:], float64, float64, float64, float64[:], float64[:])], 
             '(c3),(c3),(c3),(),(c3),(c3),(c3),(),(),(),(c5)->(c5)', 
             target='parallel', nopython=False if platform.system() in ['Darwin', 'Windows'] else True)
def vfunc(a, b, q, qd, c, d, p, pd, t, at, ph, res):
