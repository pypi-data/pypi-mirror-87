...
class ShareableActivityDefinition(google___protobuf___message___Message):
    ...
    class Participant(google___protobuf___message___Message):
        ...
        @property
        def type(self) -> type___ShareableActivityDefinition.Participant.TypeCode: ...
        ...
        def __init__(self,
            *,
            ...
            type : typing___Optional[type___ShareableActivityDefinition.Participant.TypeCode] = None,
    ...
    @property
    def status(self) -> type___ShareableActivityDefinition.StatusCode: ...

    @property
    def experimental(self) -> proto___google___fhir___proto___r4___core___datatypes_pb2___Boolean: ...

    @property
    def subject(self) -> type___ShareableActivityDefinition.SubjectX: ...
    ...
    @property
    def kind(self) -> type___ShareableActivityDefinition.KindCode: ...
    ...
    @property
    def intent(self) -> type___ShareableActivityDefinition.IntentCode: ...

    @property
    def priority(self) -> type___ShareableActivityDefinition.PriorityCode: ...

    @property
    def do_not_perform(self) -> proto___google___fhir___proto___r4___core___datatypes_pb2___Boolean: ...

    @property
    def timing(self) -> type___ShareableActivityDefinition.TimingX: ...

    @property
    def location(self) -> proto___google___fhir___proto___r4___core___datatypes_pb2___Reference: ...

    @property
    def participant(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[type___ShareableActivityDefinition.Participant]: ...

    @property
    def product(self) -> type___ShareableActivityDefinition.ProductX: ...
    ...
    @property
    def dynamic_value(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[type___ShareableActivityDefinition.DynamicValue]: ...
    ...
    def __init__(self,
        *,
        ...
        status : typing___Optional[type___ShareableActivityDefinition.StatusCode] = None,
        experimental : typing___Optional[proto___google___fhir___proto___r4___core___datatypes_pb2___Boolean] = None,
        subject : typing___Optional[type___ShareableActivityDefinition.SubjectX] = None,
        ...
        kind : typing___Optional[type___ShareableActivityDefinition.KindCode] = None,
        ...
        intent : typing___Optional[type___ShareableActivityDefinition.IntentCode] = None,
        priority : typing___Optional[type___ShareableActivityDefinition.PriorityCode] = None,
        do_not_perform : typing___Optional[proto___google___fhir___proto___r4___core___datatypes_pb2___Boolean] = None,
        timing : typing___Optional[type___ShareableActivityDefinition.TimingX] = None,
        location : typing___Optional[proto___google___fhir___proto___r4___core___datatypes_pb2___Reference] = None,
        participant : typing___Optional[typing___Iterable[type___ShareableActivityDefinition.Participant]] = None,
        product : typing___Optional[type___ShareableActivityDefinition.ProductX] = None,
        ...
        dynamic_value : typing___Optional[typing___Iterable[type___ShareableActivityDefinition.DynamicValue]] = None,
        ) -> None: ...
...
type___ShareableActivityDefinition = ShareableActivityDefinition
