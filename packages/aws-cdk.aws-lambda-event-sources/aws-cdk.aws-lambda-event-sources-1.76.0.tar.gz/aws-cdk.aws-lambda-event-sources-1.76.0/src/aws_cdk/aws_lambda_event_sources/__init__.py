...
class ApiEventSource(
    ...
    def __init__(
        ...
        *,
        ...
        method_responses: typing.Optional[typing.List[aws_cdk.aws_apigateway.MethodResponse]] = None,
...
class S3EventSource(
    ...
    def __init__(
        ...
        *,
        ...
        filters: typing.Optional[typing.List[aws_cdk.aws_s3.NotificationKeyFilter]] = None,
    ) -> None:
        """
        :param bucket: -
