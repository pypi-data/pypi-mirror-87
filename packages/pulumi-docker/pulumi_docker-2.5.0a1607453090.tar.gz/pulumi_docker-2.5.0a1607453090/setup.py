...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'docker', '2.5.0-alpha.1607453090+98a8ca32'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource docker 2.5.0-alpha.1607453090+98a8ca32`
                """)
            else:
                raise
