...
class V1ContainerVolumeMounts(object):
    ...
    @property
    def mount_path(self):
        """Gets the mount_path of this V1ContainerVolumeMounts.  # noqa: E501

        Path within the container at which the volume should be mounted.  Must not contain ':'.  # noqa: E501

        :return: The mount_path of this V1ContainerVolumeMounts.  # noqa: E501
        :rtype: str
        """
    ...
    def mount_path(self, mount_path):
        """Sets the mount_path of this V1ContainerVolumeMounts.

        Path within the container at which the volume should be mounted.  Must not contain ':'.  # noqa: E501

        :param mount_path: The mount_path of this V1ContainerVolumeMounts.  # noqa: E501
        :type: str
        """
    ...
    def mount_propagation(self):
        """Gets the mount_propagation of this V1ContainerVolumeMounts.  # noqa: E501
        ...
        :return: The mount_propagation of this V1ContainerVolumeMounts.  # noqa: E501
        :rtype: str
        """
    ...
    def mount_propagation(self, mount_propagation):
        """Sets the mount_propagation of this V1ContainerVolumeMounts.

        mountPropagation determines how mounts are propagated from the host to container and the other way around. When not set, MountPropagationNone is used. This field is beta in 1.10.  # noqa: E501

        :param mount_propagation: The mount_propagation of this V1ContainerVolumeMounts.  # noqa: E501
        :type: str
        """
    ...
    @property
    def name(self):
        """Gets the name of this V1ContainerVolumeMounts.  # noqa: E501

        This must match the Name of a Volume.  # noqa: E501

        :return: The name of this V1ContainerVolumeMounts.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this V1ContainerVolumeMounts.

        This must match the Name of a Volume.  # noqa: E501

        :param name: The name of this V1ContainerVolumeMounts.  # noqa: E501
        :type: str
        """
    ...
    @property
    def read_only(self):
        """Gets the read_only of this V1ContainerVolumeMounts.  # noqa: E501

        Mounted read-only if true, read-write otherwise (false or unspecified). Defaults to false.  # noqa: E501

        :return: The read_only of this V1ContainerVolumeMounts.  # noqa: E501
        :rtype: bool
        """
    ...
    def read_only(self, read_only):
        """Sets the read_only of this V1ContainerVolumeMounts.

        Mounted read-only if true, read-write otherwise (false or unspecified). Defaults to false.  # noqa: E501

        :param read_only: The read_only of this V1ContainerVolumeMounts.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def sub_path(self):
        """Gets the sub_path of this V1ContainerVolumeMounts.  # noqa: E501

        Path within the volume from which the container's volume should be mounted. Defaults to \"\" (volume's root).  # noqa: E501

        :return: The sub_path of this V1ContainerVolumeMounts.  # noqa: E501
        :rtype: str
        """
    ...
    def sub_path(self, sub_path):
        """Sets the sub_path of this V1ContainerVolumeMounts.

        Path within the volume from which the container's volume should be mounted. Defaults to \"\" (volume's root).  # noqa: E501

        :param sub_path: The sub_path of this V1ContainerVolumeMounts.  # noqa: E501
        :type: str
        """
    ...
    def sub_path_expr(self):
        """Gets the sub_path_expr of this V1ContainerVolumeMounts.  # noqa: E501
        ...
        :return: The sub_path_expr of this V1ContainerVolumeMounts.  # noqa: E501
        :rtype: str
        """
    ...
    def sub_path_expr(self, sub_path_expr):
        """Sets the sub_path_expr of this V1ContainerVolumeMounts.

        Expanded path within the volume from which the container's volume should be mounted. Behaves similarly to SubPath but environment variable references $(VAR_NAME) are expanded using the container's environment. Defaults to \"\" (volume's root). SubPathExpr and SubPath are mutually exclusive.  # noqa: E501

        :param sub_path_expr: The sub_path_expr of this V1ContainerVolumeMounts.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, V1ContainerVolumeMounts):
            return False
