...
[boto3.ConnectParticipant 1.16.27](https://boto3.amazonaws.com/v1/documentation/api/1.16.27/reference/services/connectparticipant.html#ConnectParticipant) service
compatible with
