...
from assetic import AssetTools, OData
from assetic.tools import dx_data as dx
...
class GISTools(object):
    def __init__(self, layer_config, api_client=None):
        ...
        # self.layertools = MapInfoLayerTools()
    ...
    def bulk_update_assets(self, rows, lyr_name):
        ...
        valid_rows = list()
        for row in rows:
            if not row[header_dict["Asset Id"]] in assets_status_list:
