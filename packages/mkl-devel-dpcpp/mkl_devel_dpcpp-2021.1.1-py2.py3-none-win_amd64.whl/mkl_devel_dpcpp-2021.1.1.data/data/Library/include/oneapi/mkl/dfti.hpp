...
template <typename descriptor_type, typename data_type>
cl::sycl::event compute_backward(
    descriptor_type &desc,
    data_type *inout,
    const cl::sycl::vector_class<cl::sycl::event> &dependencies = {});
...
class descriptor {
 public:
    ...
    template <typename descriptor_type, typename data_type>
    friend cl::sycl::event compute_forward(
        descriptor_type &desc,
        data_type *inout,
        const cl::sycl::vector_class<cl::sycl::event> &dependencies);
    ...
    template <typename descriptor_type, typename data_type>
    friend cl::sycl::event compute_backward(
        descriptor_type &desc,
        data_type *inout,
        const cl::sycl::vector_class<cl::sycl::event> &dependencies);
 ...
 private:
    ...
    cl::sycl::buffer<SYCL_DFTI_DESCRIPTOR_HANDLE, 1> handle_buffer;
};
